...
export interface ListAiDataPlatformClusterLibrariesResponse {
    /**
...
* 
    ...
    /**
     * The returned model.ClusterLibraryCollection instance.
     */
    'clusterLibraryCollection': model.ClusterLibraryCollection;
