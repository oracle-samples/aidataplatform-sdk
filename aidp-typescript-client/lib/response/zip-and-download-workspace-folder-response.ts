...
export interface ZipAndDownloadWorkspaceFolderResponse {
    /**
...
* 
    ...
    'opcRequestId': string;
    /**
     * The returned model.ZipAndDownloadFolderResult instance.
     */
    'zipAndDownloadFolderResult': model.ZipAndDownloadFolderResult;
