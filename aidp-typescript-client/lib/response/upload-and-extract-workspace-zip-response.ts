...
export interface UploadAndExtractWorkspaceZipResponse {
    /**
...
* 
    ...
    'opcRequestId': string;
    /**
     * The returned model.UploadAndExtractZipResult instance.
     */
    'uploadAndExtractZipResult': model.UploadAndExtractZipResult;
