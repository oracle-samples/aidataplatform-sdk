...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformJobs.ts.html |here} to see how to use ListAiDataPlatformJobsRequest.
 */
export interface ListAiDataPlatformJobsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformJobsRequest {
