...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/PreviewAgentAgentCard.ts.html |here} to see how to use PreviewAgentAgentCardRequest.
 */
export interface PreviewAgentAgentCardRequest extends common.BaseRequest {
/**
