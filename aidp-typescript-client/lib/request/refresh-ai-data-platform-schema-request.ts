...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RefreshAiDataPlatformSchema.ts.html |here} to see how to use RefreshAiDataPlatformSchemaRequest.
 */
export interface RefreshAiDataPlatformSchemaRequest extends common.BaseRequest {
/**
