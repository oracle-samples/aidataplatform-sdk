...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/CopyAgent.ts.html |here} to see how to use CopyAgentRequest.
 */
export interface CopyAgentRequest extends common.BaseRequest {
/**
