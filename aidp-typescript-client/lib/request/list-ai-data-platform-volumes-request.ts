...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformVolumes.ts.html |here} to see how to use ListAiDataPlatformVolumesRequest.
 */
export interface ListAiDataPlatformVolumesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformVolumesRequest {
