...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/UpdateAiDataPlatformView.ts.html |here} to see how to use UpdateAiDataPlatformViewRequest.
 */
export interface UpdateAiDataPlatformViewRequest extends common.BaseRequest {
/**
