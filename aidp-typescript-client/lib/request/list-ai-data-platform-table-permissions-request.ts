...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformTablePermissions.ts.html |here} to see how to use ListAiDataPlatformTablePermissionsRequest.
 */
export interface ListAiDataPlatformTablePermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformTablePermissionsRequest {
