...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformGitBranches.ts.html |here} to see how to use ListAiDataPlatformGitBranchesRequest.
 */
export interface ListAiDataPlatformGitBranchesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformGitBranchesRequest {
