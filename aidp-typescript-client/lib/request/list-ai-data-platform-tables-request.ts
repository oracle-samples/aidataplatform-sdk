...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformTables.ts.html |here} to see how to use ListAiDataPlatformTablesRequest.
 */
export interface ListAiDataPlatformTablesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformTablesRequest {
