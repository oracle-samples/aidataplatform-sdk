...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformViewPermissions.ts.html |here} to see how to use ListAiDataPlatformViewPermissionsRequest.
 */
export interface ListAiDataPlatformViewPermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformViewPermissionsRequest {
