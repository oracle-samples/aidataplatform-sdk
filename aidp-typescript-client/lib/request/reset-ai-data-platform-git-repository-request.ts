...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ResetAiDataPlatformGitRepository.ts.html |here} to see how to use ResetAiDataPlatformGitRepositoryRequest.
 */
export interface ResetAiDataPlatformGitRepositoryRequest extends common.BaseRequest {
/**
