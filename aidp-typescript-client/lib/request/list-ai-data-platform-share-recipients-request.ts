...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformShareRecipients.ts.html |here} to see how to use ListAiDataPlatformShareRecipientsRequest.
 */
export interface ListAiDataPlatformShareRecipientsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformShareRecipientsRequest {
