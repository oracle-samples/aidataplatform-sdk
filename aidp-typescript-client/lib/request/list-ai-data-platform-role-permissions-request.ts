...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformRolePermissions.ts.html |here} to see how to use ListAiDataPlatformRolePermissionsRequest.
 */
export interface ListAiDataPlatformRolePermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformRolePermissionsRequest {
