...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/DeleteAiDataPlatformSchema.ts.html |here} to see how to use DeleteAiDataPlatformSchemaRequest.
 */
export interface DeleteAiDataPlatformSchemaRequest extends common.BaseRequest {
/**
