...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformFiles.ts.html |here} to see how to use ListAiDataPlatformFilesRequest.
 */
export interface ListAiDataPlatformFilesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformFilesRequest {
