...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/MergeAiDataPlatformGitRepository.ts.html |here} to see how to use MergeAiDataPlatformGitRepositoryRequest.
 */
export interface MergeAiDataPlatformGitRepositoryRequest extends common.BaseRequest {
/**
