...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/PullAiDataPlatformGitRepository.ts.html |here} to see how to use PullAiDataPlatformGitRepositoryRequest.
 */
export interface PullAiDataPlatformGitRepositoryRequest extends common.BaseRequest {
/**
