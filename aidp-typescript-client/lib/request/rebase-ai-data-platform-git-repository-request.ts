...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RebaseAiDataPlatformGitRepository.ts.html |here} to see how to use RebaseAiDataPlatformGitRepositoryRequest.
 */
export interface RebaseAiDataPlatformGitRepositoryRequest extends common.BaseRequest {
/**
