...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/GetCatalog.ts.html |here} to see how to use GetCatalogRequest.
 */
