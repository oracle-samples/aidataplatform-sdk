...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformWorkspaces.ts.html |here} to see how to use ListAiDataPlatformWorkspacesRequest.
 */
export interface ListAiDataPlatformWorkspacesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformWorkspacesRequest {
