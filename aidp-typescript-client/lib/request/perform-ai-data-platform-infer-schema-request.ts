...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/PerformAiDataPlatformInferSchema.ts.html |here} to see how to use PerformAiDataPlatformInferSchemaRequest.
 */
export interface PerformAiDataPlatformInferSchemaRequest extends common.BaseRequest {
/**
