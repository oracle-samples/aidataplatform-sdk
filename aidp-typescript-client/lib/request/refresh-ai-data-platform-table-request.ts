...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/RefreshAiDataPlatformTable.ts.html |here} to see how to use RefreshAiDataPlatformTableRequest.
 */
export interface RefreshAiDataPlatformTableRequest extends common.BaseRequest {
/**
