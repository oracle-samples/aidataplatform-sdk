...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAgentPermissions.ts.html |here} to see how to use ListAgentPermissionsRequest.
 */
export interface ListAgentPermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListAgentPermissionsRequest {
