...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformCredentials.ts.html |here} to see how to use ListAiDataPlatformCredentialsRequest.
 */
export interface ListAiDataPlatformCredentialsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformCredentialsRequest {
