...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/UpdateAgentDeploymentMetadata.ts.html |here} to see how to use UpdateAgentDeploymentMetadataRequest.
 */
export interface UpdateAgentDeploymentMetadataRequest extends common.BaseRequest {
/**
