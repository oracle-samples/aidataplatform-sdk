...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformRecipientShares.ts.html |here} to see how to use ListAiDataPlatformRecipientSharesRequest.
 */
export interface ListAiDataPlatformRecipientSharesRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformRecipientSharesRequest {
