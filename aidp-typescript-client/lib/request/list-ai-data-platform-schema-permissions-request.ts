...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformSchemaPermissions.ts.html |here} to see how to use ListAiDataPlatformSchemaPermissionsRequest.
 */
export interface ListAiDataPlatformSchemaPermissionsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformSchemaPermissionsRequest {
