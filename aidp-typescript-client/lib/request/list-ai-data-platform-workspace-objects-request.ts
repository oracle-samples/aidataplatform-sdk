...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/ListAiDataPlatformWorkspaceObjects.ts.html |here} to see how to use ListAiDataPlatformWorkspaceObjectsRequest.
 */
export interface ListAiDataPlatformWorkspaceObjectsRequest extends common.BaseRequest {
/**
...
export namespace ListAiDataPlatformWorkspaceObjectsRequest {
