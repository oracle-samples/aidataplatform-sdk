...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/DeleteAiDataPlatformView.ts.html |here} to see how to use DeleteAiDataPlatformViewRequest.
 */
export interface DeleteAiDataPlatformViewRequest extends common.BaseRequest {
/**
