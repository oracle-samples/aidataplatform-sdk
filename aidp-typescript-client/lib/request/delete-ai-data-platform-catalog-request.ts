...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aidp/DeleteAiDataPlatformCatalog.ts.html |here} to see how to use DeleteAiDataPlatformCatalogRequest.
 */
export interface DeleteAiDataPlatformCatalogRequest extends common.BaseRequest {
/**
