...
*/
export interface GroupedSearchCriteria {
    /**
    * The maximum number of items to return in group Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
    */
    'groupLimit'?: number;
    /**
    * Search query string
...
export namespace GroupedSearchCriteria {
    ...
    export function getJsonObj(obj: GroupedSearchCriteria): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: GroupedSearchCriteria): object {
        const jsonObj = {...obj, ...{
