...
*/
export interface KnowledgeBaseJobRunSummary {
    /**
...
export namespace KnowledgeBaseJobRunSummary {
    ...
    export function getJsonObj(obj: KnowledgeBaseJobRunSummary): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: KnowledgeBaseJobRunSummary): object {
        const jsonObj = {...obj, ...{
