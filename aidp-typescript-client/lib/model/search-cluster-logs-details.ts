...
*/
export interface SearchClusterLogsDetails {
    /**
...
export namespace SearchClusterLogsDetails {
    ...
    export function getJsonObj(obj: SearchClusterLogsDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: SearchClusterLogsDetails): object {
        const jsonObj = {...obj, ...{
