...
* 
*/
export interface CreateAgentEdgeDetails {
    /**
...
export namespace CreateAgentEdgeDetails {
    ...
    export function getJsonObj(obj: CreateAgentEdgeDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: CreateAgentEdgeDetails): object {
        const jsonObj = {...obj, ...{
