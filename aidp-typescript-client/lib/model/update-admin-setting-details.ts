...
*/
export interface UpdateAdminSettingDetails {
    /**
...
export namespace UpdateAdminSettingDetails {




    export function getJsonObj(obj: UpdateAdminSettingDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: UpdateAdminSettingDetails): object {
        const jsonObj = {...obj, ...{
