...
export namespace UserSettingSummary {
    ...
    export function getJsonObj(obj: UserSettingSummary): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: UserSettingSummary): object {
        const jsonObj = {...obj, ...{
