...
*/
export interface SqlTool extends model.Tool {
    /**
...
export namespace SqlTool {



    export function getJsonObj(obj: SqlTool, isParentJsonObj?: boolean): object {
        const jsonObj = {...isParentJsonObj? obj : model.Tool.getJsonObj(obj) as SqlTool, ...{
    ...
    export function getDeserializedJsonObj(obj: SqlTool, isParentJsonObj?: boolean): object {
        const jsonObj = {...isParentJsonObj? obj : model.Tool.getDeserializedJsonObj(obj) as SqlTool, ...{
