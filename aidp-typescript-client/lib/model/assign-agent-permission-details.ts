...
*/
export interface AssignAgentPermissionDetails {
    'assignees': model.PermissionAssignees;
    /**
    * The permissions assigned to the assignees
    */
    'permissions': Array<AssignAgentPermissionDetails.Permissions>;
    /**
...
export namespace AssignAgentPermissionDetails {
    ...
    export function getJsonObj(obj: AssignAgentPermissionDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: AssignAgentPermissionDetails): object {
        const jsonObj = {...obj, ...{
