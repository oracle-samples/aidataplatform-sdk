...
*/
export interface DownloadClusterLogsDetails {
    /**
...
export namespace DownloadClusterLogsDetails {
    ...
    export function getJsonObj(obj: DownloadClusterLogsDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: DownloadClusterLogsDetails): object {
        const jsonObj = {...obj, ...{
