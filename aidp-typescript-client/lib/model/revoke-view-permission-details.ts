...
*/
export interface RevokeViewPermissionDetails {
    'assignees': model.PermissionAssignees;
    /**
    * The permissions revoked from the assignee.
    */
    'permissions': Array<RevokeViewPermissionDetails.Permissions>;
    /**
...
export namespace RevokeViewPermissionDetails {
    ...
    export function getJsonObj(obj: RevokeViewPermissionDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: RevokeViewPermissionDetails): object {
        const jsonObj = {...obj, ...{
