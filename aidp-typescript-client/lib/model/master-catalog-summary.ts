...
*/
export interface MasterCatalogSummary {
    /**
...
export namespace MasterCatalogSummary {
    ...
    export function getJsonObj(obj: MasterCatalogSummary): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: MasterCatalogSummary): object {
        const jsonObj = {...obj, ...{
