...
export interface Content {
    ...
    */
    'lastModified': Date;
    /**
    * Size of file or notebook in bytes. If no size is provided, defaults to null. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
    */
    'size'?: number;
    /**
...
export namespace Content {
    ...
    */
    ...
    export function getJsonObj(obj: Content): object {
        const jsonObj = {...obj, ...{
                ...
                'hash_algorithm': obj.hashAlgorithm,


        }};

        delete (jsonObj as Partial<Content>).lastModified;delete (jsonObj as Partial<Content>).hashAlgorithm;
        
        return jsonObj;
    }
    ;
    export function getDeserializedJsonObj(obj: Content): object {
        const jsonObj = {...obj, ...{
                ...
                'lastModified': (obj as any)["last_modified"],
                ...
                'hashAlgorithm': (obj as any)["hash_algorithm"],


         }};

        delete (jsonObj as any)["last_modified"];delete (jsonObj as any)["hash_algorithm"];
