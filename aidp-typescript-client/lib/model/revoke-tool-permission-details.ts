...
*/
export interface RevokeToolPermissionDetails {
    'assignees': model.PermissionAssignees;
    /**
    * The permissions revoked from the assignee.
    */
    'permissions': Array<RevokeToolPermissionDetails.Permissions>;
    /**
...
export namespace RevokeToolPermissionDetails {
    ...
    export function getJsonObj(obj: RevokeToolPermissionDetails): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: RevokeToolPermissionDetails): object {
        const jsonObj = {...obj, ...{
