...
*/
export interface CreateAgentDiagramAgentNodeDetails extends model.CreateAgentDiagramNodeDetails {
    /**
...
export namespace CreateAgentDiagramAgentNodeDetails {
    ...
    export function getJsonObj(obj: CreateAgentDiagramAgentNodeDetails, isParentJsonObj?: boolean): object {
        const jsonObj = {...isParentJsonObj? obj : model.CreateAgentDiagramNodeDetails.getJsonObj(obj) as CreateAgentDiagramAgentNodeDetails, ...{
    ...
    export function getDeserializedJsonObj(obj: CreateAgentDiagramAgentNodeDetails, isParentJsonObj?: boolean): object {
        const jsonObj = {...isParentJsonObj? obj : model.CreateAgentDiagramNodeDetails.getDeserializedJsonObj(obj) as CreateAgentDiagramAgentNodeDetails, ...{
