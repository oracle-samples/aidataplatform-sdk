...
* 
    ...
    */
    'lifecycleState'?: model.RecipientLifecycleState;
    /**
...
export namespace RecipientSummary {
    ...
    export function getJsonObj(obj: RecipientSummary): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: RecipientSummary): object {
        const jsonObj = {...obj, ...{
