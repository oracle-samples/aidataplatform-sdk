...
*/
export interface AgentGuardrailsSummary {
    /**
...
export namespace AgentGuardrailsSummary {
    ...
    export function getJsonObj(obj: AgentGuardrailsSummary): object {
        const jsonObj = {...obj, ...{
    ...
    ;
    export function getDeserializedJsonObj(obj: AgentGuardrailsSummary): object {
        const jsonObj = {...obj, ...{
