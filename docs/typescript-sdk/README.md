...
**Payload `AsyncOperation` Summary:** An async operation.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to AsyncOperationsClient](#client-asyncoperationsclient) • [Top](#top)

### <a id="operation-asyncoperationsclient-listasyncoperations"></a>`listAsyncOperations`
**Description:** List all async operations for a resource type.
...
**Payload `AsyncOperationCollection` Summary:** Result of listing Async Operations.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to AuditClient](#client-auditclient) • [Top](#top)
...
**Payload `AuditLogSearchResultCollection` Summary:** Search results for audit log search request.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to BundleClient](#client-bundleclient) • [Top](#top)
...
**Payload `BundleDeploymentStatus` Summary:** Summary of the most recent completed bundle deployment.
| Field | Type | Description |
| --- | --- | --- |
...
**Description:** (Preview) Synchronizes the code, descriptors, and mapping in the bundle by reconciling the contents with the resource origins.
...
**Return:** [Back to CatalogClient](#client-catalogclient) • [Top](#top)
...
**Payload `Catalog` Summary:** AI Data Platform Workbench catalogs enable you to manage your data and metadata.
...
**Payload `CatalogPermissionCollection` Summary:** Catalog permissions
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `CatalogCollection` Summary:** Catalog List
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `Cluster` Summary:** A Cluster is a compute subresource within AI Data Platform Workbench. Compute/Runtime Clusters are Spark execution environments.
...
| `sourceApi` | `string` | — |
**Return:** [Back to ClusterClient](#client-clusterclient) • [Top](#top)
...
**Payload `DefaultCluster` Summary:** The default cluster created by AI Data Platform Workbench.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ClusterLibraryCollection` Summary:** List of cluster libraries.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ClusterPermissionCollection` Summary:** List of cluster permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ClusterCollection` Summary:** Results of a cluster list.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ClusterLogCollection` Summary:** Results of a cluster log list.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `SummarizeMetricsResponse` Summary:** Response payload containing summarized metric data.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to CredentialsClient](#client-credentialsclient) • [Top](#top)
...
**Payload `Credential` Summary:** Represents a credential object for public API consumers.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `CredentialCollection` Summary:** Result set returned by listing credentials through the public API.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `Recipient` Summary:** A Delta Share recipient can access the data assets in AI Data Platform Workbench through Delta Share Protocol.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to DeltaShareClient](#client-deltashareclient) • [Top](#top)
...
**Payload `Share` Summary:** A share is used to access the data assets in AI Data Platform Workbench through Delta Share Protocol.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `RecipientPermissionCollection` Summary:** List of recipient permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ShareCollection` Summary:** Results of a listing Delta Shares. Contains summary information of shares.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `RecipientCollection` Summary:** Results of a listing Delta Share recipients. Contains summary information of recipients.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ShareDataAssetCollection` Summary:** Results of a listing Delta Shares assets. Contains summary information of shares assets.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `SharePermissionCollection` Summary:** List of share permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitBranch` Summary:** Git branch details.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to GitClient](#client-gitclient) • [Top](#top)
...
**Payload `CreateGitBranch` Summary:** Git branch details.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitDiffDetail` Summary:** Unified diff details for a Git file.
| Field | Type | Description |
| --- | --- | --- |
| `gitFilePath` | `string` | File path relative to repository root. |
...
**Description:** (Preview) Returns the current Git worktree status — including in-progress operations or detached HEAD indicators—for workspace folder
...
**Payload `GitOperationState` Summary:** Current git operation state for a repository folder context.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitRepository` Summary:** Details about a Git repository.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitBranchCollection` Summary:** Collection of Git branches. Contains summary information about a Git branch.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitDiffSummaryCollection` Summary:** Collection of Git diff summaries for files under a folder context.
| Field | Type | Description |
| --- | --- | --- |
...
**Description:** (Preview) Accepts conflict resolution instructions — choose source or target versions—and records resolution back to repo
...
**Payload `CreateExperimentResponseDetails` Summary:** Response object for creating an experiment.
| Field | Type | Description |
| --- | --- | --- |
| `experimentId` | `string` | Unique identifier for the experiment. |
**Return:** [Back to MLOpsClient](#client-mlopsclient) • [Top](#top)
...
**Payload `ExperimentRunMetricHistoryCollection` Summary:** Result of history of ExperimentRun metrics.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ArtifactList` Summary:** Result of listing artifacts.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ExperimentRunCollection` Summary:** Result of listing experiment runs.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ExperimentCollection` Summary:** Result of listing experiments.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `LoggedModelCollection` Summary:** Result of listing logged-models.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ModelVersionCollection` Summary:** Result of listing model versions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `RegisteredModelCollection` Summary:** Result of listing RegisteredModels.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `Content` Summary:** Content model provides a programmatic interface to interact with notebooks, files and directories within the AI Data Platform Workbench Notebook environment.
...
**Return:** [Back to NotebookClient](#client-notebookclient) • [Top](#top)
...
**Payload `Session` Summary:** Notebook Session describes the Session context for a running instance of a Notebook. Each opened Notebook has a separate Session,
...
**Payload `ExportedContents` Summary:** This model represents a file with contents, format and other details.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `SessionCollection` Summary:** A list of session summaries related to a workspace.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to RoleClient](#client-roleclient) • [Top](#top)
...
**Payload `Role` Summary:** Role details.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `RolePermissionCollection` Summary:** A collection of permission summaries associated with a role.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `RoleCollection` Summary:** The results of a role search. It contains RoleSummary objects.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to SchemaClient](#client-schemaclient) • [Top](#top)
...
**Payload `View` Summary:** Information about the view in the schema.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GenerateTempFileUploadTargetResponseDetails` Summary:** The details for a generated URI for uploading a temporary file in a schema.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `Schema` Summary:** Schema in data catalogs are constructs to organize data. Schema can contain tables, which contain structured data,
...
**Payload `Table` Summary:** Information about the table in the schema.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `SchemaPermissionCollection` Summary:** List of schema permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `SchemaCollection` Summary:** Result of listing schemas.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `TablePermissionCollection` Summary:** List of table permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `TableCollection` Summary:** Result of listing tables in a schema.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ViewPermissionCollection` Summary:** List of view permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ViewCollection` Summary:** Result of listing views in a schema.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `InferSchema` Summary:** Inferred schema from location.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `InferSchemaWithPreview` Summary:** Inferred schema and data.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `ParDetails` Summary:** The details of PAR URL associated with table.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `UserSetting` Summary:** User Setting
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to UserSettingClient](#client-usersettingclient) • [Top](#top)
...
**Payload `UserSettingCollection` Summary:** Result of listing settings.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `Volume` Summary:** A volumes is a container to store data in its original form and can store semi-structured or unstructured data.
...
**Return:** [Back to VolumeClient](#client-volumeclient) • [Top](#top)
...
**Payload `DownloadFileWithParResult` Summary:** Response object of generate PAR with download API.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `VolumeFileCollection` Summary:** Result of listing files in a volume.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `VolumePermissionCollection` Summary:** List of volume permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `VolumeCollection` Summary:** Result of listing volumes
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `UploadFileWithParResult` Summary:** Response object of generate PAR with Upload API.
| Field | Type | Description |
| --- | --- | --- |
| `parUrl` | `string` | String representing the PAR URL. |
| `eTag` | `string` | Etag after creating or closing a file. |
...
**Payload `JobRun` Summary:** Description of a job run.
| Field | Type | Description |
| --- | --- | --- |
...
| `clusterInstance` | `model.ClusterInstance` | — |
...
**Return:** [Back to WorkflowClient](#client-workflowclient) • [Top](#top)
...
**Payload `Job` Summary:** A description of a Job.
To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to
an administrator. If you're an administrator who needs to write policies to give users access, see
...
**Payload `ExportedTaskRunOutputContents` Summary:** This model represents a file with contents, format, and other details.
| Field | Type | Description |
| --- | --- | --- |
| `name` | `string` | Name of file, equivalent to the last part of the path. |
| `path` | `string` | Full path of the file. |
...
**Payload `TaskRunOutput` Summary:** Output of a task run.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `TaskRun` Summary:** A description of a task run.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `JobPermissionCollection` Summary:** List of job permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `JobRunCollection` Summary:** List of job runs.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `JobCollection` Summary:** List of jobs.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `TaskRunCollection` Summary:** List of TaskRuns.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `GitFolder` Summary:** Represents a Git folder object.
| Field | Type | Description |
| --- | --- | --- |
...
**Return:** [Back to WorkspaceClient](#client-workspaceclient) • [Top](#top)
...
**Payload `Workspace` Summary:** A AI Data Platform Workbench Workspace is a logical container that provides users with a collaborative development and runtime environment.
...
**Payload `CreateWorkspacePermissionCollection` Summary:** List of Create Workspace permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `WorkspacePermissionCollection` Summary:** List of workspace permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `WorkspaceCollection` Summary:** Results of a workspace search. Contains summary information of workspaces.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `WorkspaceObjectDetails` Summary:** A WorkspaceObject is a file or folder belonging to an AI Data Platform Workbench workspace.
To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to
an administrator. If you're an administrator who needs to write policies to give users access, see
<a href=\"https://docs.oracle.com/en/cloud/paas/ai-data-platform/aidug/iam-policies-oracle-ai-data-platform.html\" target=\"_blank\" rel=\"noopener noreferrer\">IAM Policies for Oracle AI Data Platform Workbench</a>.
| Field | Type | Description |
...
| `systemTags` | `{ [key: string]: { [key: string]: any; }; }` | System tags for this resource. Each key is predefined and scoped to a namespace. <p> Example: {@code {\"orcl-cloud\": {\"free-tier-retained\": \"true\"}}} |
**Return:** [Back to WorkspaceObjectClient](#client-workspaceobjectclient) • [Top](#top)
...
**Payload `WorkspaceObjectPermissionCollection` Summary:** List of workspace object permissions.
| Field | Type | Description |
| --- | --- | --- |
...
**Payload `WorkspaceObjectCollection` Summary:** Results of a workspace object list.
| Field | Type | Description |
| --- | --- | --- |
