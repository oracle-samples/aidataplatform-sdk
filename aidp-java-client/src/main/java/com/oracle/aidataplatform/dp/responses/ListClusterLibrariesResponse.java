...
public class ListClusterLibrariesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ListClusterLibrariesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, String opcPrevPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.ClusterLibraryCollection clusterLibraryCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListClusterLibrariesResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ListClusterLibrariesResponse o) {
         ...
         */
        @Override
        public ListClusterLibrariesResponse build() {
            return new ListClusterLibrariesResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, opcPrevPage, opcTotalItems, clusterLibraryCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListClusterLibrariesResponse)) {
            return false;
        }

        ListClusterLibrariesResponse other = (ListClusterLibrariesResponse) o;
