...
public class RebaseGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RebaseGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RebaseGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RebaseGitRepositoryResponse o) {
         ...
         */
        @Override
        public RebaseGitRepositoryResponse build() {
            return new RebaseGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebaseGitRepositoryResponse)) {
            return false;
        }

        RebaseGitRepositoryResponse other = (RebaseGitRepositoryResponse) o;
