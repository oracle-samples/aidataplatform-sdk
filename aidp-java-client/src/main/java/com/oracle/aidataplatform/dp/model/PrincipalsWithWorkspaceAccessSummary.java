...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=PrincipalsWithWorkspaceAccessSummary.Builder.class)

public final class PrincipalsWithWorkspaceAccessSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType"})
    public PrincipalsWithWorkspaceAccessSummary(String grantee, String granteeName, GranteeType granteeType) {
        super();
...
public Builder granteeType(GranteeType granteeType) {
    ...
    return this;
        ...
        public PrincipalsWithWorkspaceAccessSummary build() {
            PrincipalsWithWorkspaceAccessSummary model = new PrincipalsWithWorkspaceAccessSummary(this.grantee
                , this.granteeName
                , this.granteeType);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrincipalsWithWorkspaceAccessSummary model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrincipalsWithWorkspaceAccessSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrincipalsWithWorkspaceAccessSummary)) {
            return false;
        }

        PrincipalsWithWorkspaceAccessSummary other = (PrincipalsWithWorkspaceAccessSummary) o;
