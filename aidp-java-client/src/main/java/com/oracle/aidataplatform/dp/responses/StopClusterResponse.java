...
public class StopClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private StopClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<StopClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(StopClusterResponse o) {
         ...
         */
        @Override
        public StopClusterResponse build() {
            return new StopClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopClusterResponse)) {
            return false;
        }

        StopClusterResponse other = (StopClusterResponse) o;
