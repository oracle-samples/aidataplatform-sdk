...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=McpTool.Builder.class)
...
public Builder toolConfig(McpToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public McpTool build() {
            McpTool model = new McpTool(this.key
                , this.displayName
                , this.workspaceKey
                , this.description
                , this.isReference
        ...
        public Builder copy(McpTool model) {
...
return this;
    ...
    @Deprecated
    public McpTool(String key, String displayName, String workspaceKey, String description, Boolean isReference, Float positionX, Float positionY, java.util.Map<String, Object> properties, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, Object> inputSchema, McpToolConfiguration toolConfig) {
