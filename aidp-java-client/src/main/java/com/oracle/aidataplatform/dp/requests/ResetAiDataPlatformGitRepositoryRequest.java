...
public class ResetAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitResetDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.GitResetDetails getBody$() {
        return gitResetDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ResetAiDataPlatformGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitResetDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder gitResetDetails(com.oracle.aidataplatform.dp.model.GitResetDetails gitResetDetails) {
            this.gitResetDetails = gitResetDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ResetAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());gitResetDetails(o.getGitResetDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ResetAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResetAiDataPlatformGitRepositoryRequest
         */
        public ResetAiDataPlatformGitRepositoryRequest build() {
            ResetAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.GitResetDetails body) {
            gitResetDetails(body);
            return this;
        }
         ...
         * @return instance of ResetAiDataPlatformGitRepositoryRequest
         */
        public ResetAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            ResetAiDataPlatformGitRepositoryRequest request = new ResetAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.gitResetDetails = gitResetDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new ResetAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitResetDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",gitResetDetails=").append(String.valueOf(this.gitResetDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        ResetAiDataPlatformGitRepositoryRequest other = (ResetAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.gitResetDetails, other.gitResetDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.gitResetDetails == null ? 43 : this.gitResetDetails.hashCode());
