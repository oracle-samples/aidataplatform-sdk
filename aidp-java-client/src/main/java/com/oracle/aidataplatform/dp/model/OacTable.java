...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OacTable.Builder.class)
...
public final class OacTable extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public OacTable build() {
            OacTable model = new OacTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(OacTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OacTable)) {
            return false;
        }

        OacTable other = (OacTable) o;
