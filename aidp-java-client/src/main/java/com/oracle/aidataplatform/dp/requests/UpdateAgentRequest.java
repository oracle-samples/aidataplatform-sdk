...
public class UpdateAgentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateAgentDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.UpdateAgentDetails updateAgentDetails;
     ...
     * The information to be updated.
     */
    public com.oracle.aidataplatform.dp.model.UpdateAgentDetails getUpdateAgentDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateAgentDetails getBody$() {
        return updateAgentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAgentRequest, com.oracle.aidataplatform.dp.model.UpdateAgentDetails> {
     ...
     * The information to be updated.
     */
        private com.oracle.aidataplatform.dp.model.UpdateAgentDetails updateAgentDetails = null;
         ...
         * @return this builder instance
         */
        public Builder updateAgentDetails(com.oracle.aidataplatform.dp.model.UpdateAgentDetails updateAgentDetails) {
...
* 
        ...
        public Builder copy(UpdateAgentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());updateAgentDetails(o.getUpdateAgentDetails());shouldUpdateRecent(o.getShouldUpdateRecent());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateAgentDetails body) {
        ...
        public UpdateAgentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAgentRequest(aiDataPlatformId, workspaceKey, agentKey, updateAgentDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateAgentDetails == null ? 43 : this.updateAgentDetails.hashCode());
