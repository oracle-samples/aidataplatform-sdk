...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignToolPermissionDetails.Builder.class)

public final class AssignToolPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public AssignToolPermissionDetails(PermissionAssignees assignees, java.util.List<ToolPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
...
public Builder excludeColumns(java.util.List<String> excludeColumns) {
    ...
    return this;
        ...
        public AssignToolPermissionDetails build() {
            AssignToolPermissionDetails model = new AssignToolPermissionDetails(this.assignees
                , this.permissions
                , this.includeColumns
        ...
        public Builder copy(AssignToolPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignToolPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignToolPermissionDetails)) {
            return false;
        }

        AssignToolPermissionDetails other = (AssignToolPermissionDetails) o;
