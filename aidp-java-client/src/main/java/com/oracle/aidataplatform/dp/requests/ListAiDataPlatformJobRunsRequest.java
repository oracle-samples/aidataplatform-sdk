...
public class ListAiDataPlatformJobRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformJobRunsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformJobRunsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformJobRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformJobRunsRequest
         */
        public ListAiDataPlatformJobRunsRequest build() {
            ListAiDataPlatformJobRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformJobRunsRequest
         */
        public ListAiDataPlatformJobRunsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformJobRunsRequest request = new ListAiDataPlatformJobRunsRequest();
            ...
            return request;
            // new ListAiDataPlatformJobRunsRequest(aiDataPlatformId, workspaceKey, displayName, jobKey, status, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThanOrEqualTo, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformJobRunsRequest)) {
            return false;
        }

        ListAiDataPlatformJobRunsRequest other = (ListAiDataPlatformJobRunsRequest) o;
