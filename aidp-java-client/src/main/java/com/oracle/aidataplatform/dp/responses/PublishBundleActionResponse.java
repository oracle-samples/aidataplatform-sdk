...
public class PublishBundleActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PublishBundleActionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PublishBundleActionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PublishBundleActionResponse o) {
         ...
         */
        @Override
        public PublishBundleActionResponse build() {
            return new PublishBundleActionResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublishBundleActionResponse)) {
            return false;
        }

        PublishBundleActionResponse other = (PublishBundleActionResponse) o;
