...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ProcessNodeColumnLinksRequestDetails.Builder.class)

public final class ProcessNodeColumnLinksRequestDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"anchorNodeId", "processNodeId", "processDepth", "direction", "filter"})
    public ProcessNodeColumnLinksRequestDetails(String anchorNodeId, String processNodeId, Integer processDepth, LineageDirection direction, ProcessNodeColumnLinksFilter filter) {
        super();
...
public Builder filter(ProcessNodeColumnLinksFilter filter) {
    ...
    return this;
        ...
        public ProcessNodeColumnLinksRequestDetails build() {
            ProcessNodeColumnLinksRequestDetails model = new ProcessNodeColumnLinksRequestDetails(this.anchorNodeId
                , this.processNodeId
                , this.processDepth
                , this.direction
        ...
        public Builder copy(ProcessNodeColumnLinksRequestDetails model) {
...
* 
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ProcessNodeColumnLinksRequestDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessNodeColumnLinksRequestDetails)) {
            return false;
        }

        ProcessNodeColumnLinksRequestDetails other = (ProcessNodeColumnLinksRequestDetails) o;
