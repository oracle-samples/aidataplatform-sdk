...
public class RedeployAgentByKeyRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentDetails getBody$() {
        return updateAgentDeploymentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RedeployAgentByKeyRequest, com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder updateAgentDeploymentDetails(com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentDetails updateAgentDeploymentDetails) {
            this.updateAgentDeploymentDetails = updateAgentDeploymentDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RedeployAgentByKeyRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());updateAgentDeploymentDetails(o.getUpdateAgentDeploymentDetails());ifMatch(o.getIfMatch());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of RedeployAgentByKeyRequest as configured by this builder
         *
         ...
         *
         * @return instance of RedeployAgentByKeyRequest
         */
        public RedeployAgentByKeyRequest build() {
            RedeployAgentByKeyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentDetails body) {
            updateAgentDeploymentDetails(body);
            return this;
        }
         ...
         * @return instance of RedeployAgentByKeyRequest
         */
        public RedeployAgentByKeyRequest buildWithoutInvocationCallback() {
            RedeployAgentByKeyRequest request = new RedeployAgentByKeyRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.agentKey = agentKey;
            request.updateAgentDeploymentDetails = updateAgentDeploymentDetails;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RedeployAgentByKeyRequest(aiDataPlatformId, workspaceKey, agentKey, updateAgentDeploymentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateAgentDeploymentDetails=").append(String.valueOf(this.updateAgentDeploymentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RedeployAgentByKeyRequest)) {
            return false;
        }

        RedeployAgentByKeyRequest other = (RedeployAgentByKeyRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.updateAgentDeploymentDetails, other.updateAgentDeploymentDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateAgentDeploymentDetails == null ? 43 : this.updateAgentDeploymentDetails.hashCode());
