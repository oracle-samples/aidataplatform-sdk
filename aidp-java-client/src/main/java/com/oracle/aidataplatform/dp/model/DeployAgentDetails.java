...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=DeployAgentDetails.Builder.class)

public final class DeployAgentDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "description", "agentComputeKey", "agentKey", "sessionRetentionConfig", "oAuthConfig"})
    public DeployAgentDetails(String displayName, String description, String agentComputeKey, String agentKey, SessionRetentionConfiguration sessionRetentionConfig, OAuthConfiguration oAuthConfig) {
        super();
...
public Builder oAuthConfig(OAuthConfiguration oAuthConfig) {
    ...
    return this;
        ...
        public DeployAgentDetails build() {
            DeployAgentDetails model = new DeployAgentDetails(this.displayName
                , this.description
        ...
        public Builder copy(DeployAgentDetails model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployAgentDetails)) {
            return false;
        }

        DeployAgentDetails other = (DeployAgentDetails) o;
