...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OracleTableSummary.Builder.class)
...
public final class OracleTableSummary extends TableSummary {
...
public Builder lifecycleState(TableLifecycleState lifecycleState) {
    ...
    return this;
        ...
        public OracleTableSummary build() {
            OracleTableSummary model = new OracleTableSummary(this.key
                , this.displayName
                , this.tableType
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(OracleTableSummary model) {
...
return this;
    ...
    @Deprecated
    public OracleTableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleTableSummary)) {
            return false;
        }

        OracleTableSummary other = (OracleTableSummary) o;
