...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramHttpToolNode.Builder.class)
...
public final class AgentDiagramHttpToolNode extends AgentDiagramNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramHttpToolNode build() {
            AgentDiagramHttpToolNode model = new AgentDiagramHttpToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramHttpToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramHttpToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramHttpToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramHttpToolNode)) {
            return false;
        }

        AgentDiagramHttpToolNode other = (AgentDiagramHttpToolNode) o;
