...
public class FetchOutputResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code TaskRunOutput} instance.
     */
    ...
    private FetchOutputResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.TaskRunOutput taskRunOutput) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<FetchOutputResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(FetchOutputResponse o) {
         ...
         */
        @Override
        public FetchOutputResponse build() {
            return new FetchOutputResponse(__httpStatusCode__, headers, opcRequestId, etag, taskRunOutput);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FetchOutputResponse)) {
            return false;
        }

        FetchOutputResponse other = (FetchOutputResponse) o;
