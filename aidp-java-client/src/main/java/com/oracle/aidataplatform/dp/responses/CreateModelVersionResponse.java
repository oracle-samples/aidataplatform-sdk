...
public class CreateModelVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateModelVersionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.CreateModelVersionResponseDetails createModelVersionResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateModelVersionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateModelVersionResponse o) {
        ...
        public CreateModelVersionResponse build() {
            return new CreateModelVersionResponse(__httpStatusCode__, headers, etag, opcRequestId, createModelVersionResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateModelVersionResponse)) {
            return false;
        }

        CreateModelVersionResponse other = (CreateModelVersionResponse) o;
