...
public class GetWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private GetWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, String objectKey, String path, String type, java.util.Date timeUpdated, java.io.InputStream inputStream) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(GetWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public GetWorkspaceObjectResponse build() {
            return new GetWorkspaceObjectResponse(__httpStatusCode__, headers, etag, opcRequestId, objectKey, path, type, timeUpdated, inputStream);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWorkspaceObjectResponse)) {
            return false;
        }

        GetWorkspaceObjectResponse other = (GetWorkspaceObjectResponse) o;
