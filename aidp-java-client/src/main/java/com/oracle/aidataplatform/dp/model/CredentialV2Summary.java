...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CredentialV2Summary.Builder.class)

public final class CredentialV2Summary  {
    @Deprecated
    ...
    public CredentialV2Summary(String key, String displayName, String description, CredentialType credentialType, java.util.Date timeCreated, String createdBy, java.util.Date timeUpdated, String updatedBy, CredentialV2LifeCycleState lifeCycleState) {
        super();
        this.key = key;
...
private CredentialV2LifeCycleState lifeCycleState;
...
public Builder lifeCycleState(CredentialV2LifeCycleState lifeCycleState) {
    this.lifeCycleState = lifeCycleState;
    return this;
}


        public CredentialV2Summary build() {
            CredentialV2Summary model = new CredentialV2Summary(this.key
                , this.displayName
                , this.description
                , this.credentialType
                , this.timeCreated
        ...
        public Builder copy(CredentialV2Summary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("lifeCycleState")
    private final CredentialV2LifeCycleState lifeCycleState;
    ...
    public CredentialV2LifeCycleState getLifeCycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialV2Summary)) {
            return false;
        }

        CredentialV2Summary other = (CredentialV2Summary) o;
