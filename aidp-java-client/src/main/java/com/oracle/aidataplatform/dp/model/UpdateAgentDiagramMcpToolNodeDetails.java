...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramMcpToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramMcpToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public UpdateAgentDiagramMcpToolNodeDetails build() {
            UpdateAgentDiagramMcpToolNodeDetails model = new UpdateAgentDiagramMcpToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramMcpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramMcpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramMcpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramMcpToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramMcpToolNodeDetails other = (UpdateAgentDiagramMcpToolNodeDetails) o;
