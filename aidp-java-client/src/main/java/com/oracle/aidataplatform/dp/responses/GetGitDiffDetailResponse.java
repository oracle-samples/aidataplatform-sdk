...
public class GetGitDiffDetailResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetGitDiffDetailResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GitDiffDetail gitDiffDetail) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetGitDiffDetailResponse> {
