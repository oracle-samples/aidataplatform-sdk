...
public class CreateAiDataPlatformSchemaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     * URL for the created schema. The schema key is generated after this request is sent.
     */
...
* 
    ...
    private CreateAiDataPlatformSchemaResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAiDataPlatformSchemaResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateAiDataPlatformSchemaResponse o) {
         ...
         */
        @Override
        public CreateAiDataPlatformSchemaResponse build() {
            return new CreateAiDataPlatformSchemaResponse(__httpStatusCode__, headers, location, contentLocation, aidpAsyncOperationKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformSchemaResponse)) {
            return false;
        }

        CreateAiDataPlatformSchemaResponse other = (CreateAiDataPlatformSchemaResponse) o;
