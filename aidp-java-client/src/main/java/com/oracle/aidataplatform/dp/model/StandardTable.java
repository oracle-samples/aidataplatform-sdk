...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=StandardTable.Builder.class)
...
public final class StandardTable extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public StandardTable build() {
            StandardTable model = new StandardTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(StandardTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StandardTable)) {
            return false;
        }

        StandardTable other = (StandardTable) o;
