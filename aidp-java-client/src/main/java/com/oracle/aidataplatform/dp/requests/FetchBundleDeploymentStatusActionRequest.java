...
public class FetchBundleDeploymentStatusActionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.FetchBundleDeploymentStatusDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<FetchBundleDeploymentStatusActionRequest, com.oracle.aidataplatform.dp.model.FetchBundleDeploymentStatusDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(FetchBundleDeploymentStatusActionRequest o) {
        ...
        /**
         * Build the instance of FetchBundleDeploymentStatusActionRequest as configured by this builder
         *
         ...
         *
         * @return instance of FetchBundleDeploymentStatusActionRequest
         */
        public FetchBundleDeploymentStatusActionRequest build() {
            FetchBundleDeploymentStatusActionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of FetchBundleDeploymentStatusActionRequest
         */
        public FetchBundleDeploymentStatusActionRequest buildWithoutInvocationCallback() {
            FetchBundleDeploymentStatusActionRequest request = new FetchBundleDeploymentStatusActionRequest();
            ...
            return request;
            // new FetchBundleDeploymentStatusActionRequest(aiDataPlatformId, workspaceKey, fetchBundleDeploymentStatusDetails, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FetchBundleDeploymentStatusActionRequest)) {
            return false;
        }

        FetchBundleDeploymentStatusActionRequest other = (FetchBundleDeploymentStatusActionRequest) o;
