...
public class TransitionAiDataPlatformModelVersionStageResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private TransitionAiDataPlatformModelVersionStageResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.TransitionModelVersionStageResponseDetails transitionModelVersionStageResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<TransitionAiDataPlatformModelVersionStageResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(TransitionAiDataPlatformModelVersionStageResponse o) {
         ...
         */
        @Override
        public TransitionAiDataPlatformModelVersionStageResponse build() {
            return new TransitionAiDataPlatformModelVersionStageResponse(__httpStatusCode__, headers, etag, opcRequestId, transitionModelVersionStageResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TransitionAiDataPlatformModelVersionStageResponse)) {
            return false;
        }

        TransitionAiDataPlatformModelVersionStageResponse other = (TransitionAiDataPlatformModelVersionStageResponse) o;
