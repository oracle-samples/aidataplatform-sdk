...
public class SyncBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SyncBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SyncBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SyncBundleResponse o) {
         ...
         */
        @Override
        public SyncBundleResponse build() {
            return new SyncBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SyncBundleResponse)) {
            return false;
        }

        SyncBundleResponse other = (SyncBundleResponse) o;
