...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetWorkspaceRequest, java.lang.Void> {
...
* 
        ...
        public GetWorkspaceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetWorkspaceRequest(aiDataPlatformId, workspaceKey, opcRequestId);
        }
    }
