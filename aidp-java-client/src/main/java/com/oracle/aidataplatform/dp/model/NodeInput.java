...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=NodeInput.Builder.class)
...
@com.fasterxml.jackson.annotation.JsonProperty("isSingleConnection")
private Boolean isSingleConnection;

        /**
         * True if only one connection is allowed; false allows multiple.
         * @param isSingleConnection the value to set
         * @return this builder
         **/
        

public Builder isSingleConnection(Boolean isSingleConnection) {
    this.isSingleConnection = isSingleConnection;
    return this;
}
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("isSingleConnection")
    private final Boolean isSingleConnection;
    ...
    public Boolean getIsSingleConnection() {
