...
public class ListAgentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAgentsRequest, java.lang.Void> {
     ...
     * Compute key.
     */
        private String computeKey = null;
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAgentsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());computeKey(o.getComputeKey());displayName(o.getDisplayName());displayNameContains(o.getDisplayNameContains());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
         ...
         *
         * @return instance of ListAgentsRequest
         */
        public ListAgentsRequest build() {
            ListAgentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAgentsRequest
         */
        public ListAgentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAgentsRequest(aiDataPlatformId, workspaceKey, computeKey, displayName, displayNameContains, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAgentsRequest)) {
            return false;
        }
