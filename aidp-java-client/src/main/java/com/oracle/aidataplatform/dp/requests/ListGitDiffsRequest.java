...
public class ListGitDiffsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListGitDiffsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListGitDiffsRequest o) {
        ...
        /**
         * Build the instance of ListGitDiffsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListGitDiffsRequest
         */
        public ListGitDiffsRequest build() {
            ListGitDiffsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListGitDiffsRequest
         */
        public ListGitDiffsRequest buildWithoutInvocationCallback() {
            ListGitDiffsRequest request = new ListGitDiffsRequest();
            ...
            return request;
            // new ListGitDiffsRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitFolderPath, branchName, compareTo, filter, limit, page, opcRequestId, sortOrder, sortBy, displayName);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListGitDiffsRequest)) {
            return false;
        }

        ListGitDiffsRequest other = (ListGitDiffsRequest) o;
