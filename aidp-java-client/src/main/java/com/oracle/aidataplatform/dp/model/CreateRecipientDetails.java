...
public final class CreateRecipientDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "description", "properties"})
    public CreateRecipientDetails(String displayName, String description, java.util.Map<String, String> properties) {
        super();
...
public Builder properties(java.util.Map<String, String> properties) {
    ...
    return this;
        ...
        public CreateRecipientDetails build() {
            CreateRecipientDetails model = new CreateRecipientDetails(this.displayName
                , this.description
                , this.properties);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateRecipientDetails model) {
...
* 
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateRecipientDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRecipientDetails)) {
            return false;
        }

        CreateRecipientDetails other = (CreateRecipientDetails) o;
