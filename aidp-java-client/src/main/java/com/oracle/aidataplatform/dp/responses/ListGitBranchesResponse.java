...
public class ListGitBranchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.aidataplatform.dp.model.GitBranchCollection getGitBranchCollection() {
        return gitBranchCollection;
    }


    @java.beans.ConstructorProperties({"__httpStatusCode__", "headers", "opcRequestId", "opcNextPage", "opcTotalItems", "gitBranchCollection"})
    private ListGitBranchesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.GitBranchCollection gitBranchCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListGitBranchesResponse> {
        ...
        /**
         * The returned {@code GitBranchCollection} instance.
         * @param gitBranchCollection the value to set
         * @return this builder
         */
        public Builder gitBranchCollection(com.oracle.aidataplatform.dp.model.GitBranchCollection gitBranchCollection) {
            this.gitBranchCollection = gitBranchCollection;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(ListGitBranchesResponse o) {
         ...
         */
        @Override
        public ListGitBranchesResponse build() {
            return new ListGitBranchesResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, opcTotalItems, gitBranchCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListGitBranchesResponse)) {
            return false;
        }

        ListGitBranchesResponse other = (ListGitBranchesResponse) o;
