...
public class CommitPushAiDataPlatformGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CommitPushAiDataPlatformGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CommitPushAiDataPlatformGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CommitPushAiDataPlatformGitRepositoryResponse o) {
         ...
         */
        @Override
        public CommitPushAiDataPlatformGitRepositoryResponse build() {
            return new CommitPushAiDataPlatformGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommitPushAiDataPlatformGitRepositoryResponse)) {
            return false;
        }

        CommitPushAiDataPlatformGitRepositoryResponse other = (CommitPushAiDataPlatformGitRepositoryResponse) o;
