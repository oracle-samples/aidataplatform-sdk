...
public class RefreshAiDataPlatformTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshAiDataPlatformTableRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshAiDataPlatformTableRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());
        ...
        /**
         * Build the instance of RefreshAiDataPlatformTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshAiDataPlatformTableRequest
         */
        public RefreshAiDataPlatformTableRequest build() {
            RefreshAiDataPlatformTableRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshAiDataPlatformTableRequest
         */
        public RefreshAiDataPlatformTableRequest buildWithoutInvocationCallback() {
            RefreshAiDataPlatformTableRequest request = new RefreshAiDataPlatformTableRequest();
            ...
            return request;
            // new RefreshAiDataPlatformTableRequest(aiDataPlatformId, tableKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformTableRequest)) {
            return false;
        }

        RefreshAiDataPlatformTableRequest other = (RefreshAiDataPlatformTableRequest) o;
