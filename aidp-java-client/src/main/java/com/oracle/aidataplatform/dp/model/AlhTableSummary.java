...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AlhTableSummary.Builder.class)
...
public final class AlhTableSummary extends TableSummary {
...
public Builder lifecycleState(TableLifecycleState lifecycleState) {
    ...
    return this;
        ...
        public AlhTableSummary build() {
            AlhTableSummary model = new AlhTableSummary(this.key
                , this.displayName
                , this.tableType
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(AlhTableSummary model) {
...
return this;
    ...
    @Deprecated
    public AlhTableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlhTableSummary)) {
            return false;
        }

        AlhTableSummary other = (AlhTableSummary) o;
