...
public class CreateWorkspaceModelVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateWorkspaceModelVersionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.CreateModelVersionResponseDetails createModelVersionResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateWorkspaceModelVersionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateWorkspaceModelVersionResponse o) {
         ...
         */
        @Override
        public CreateWorkspaceModelVersionResponse build() {
            return new CreateWorkspaceModelVersionResponse(__httpStatusCode__, headers, etag, opcRequestId, createModelVersionResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateWorkspaceModelVersionResponse)) {
            return false;
        }

        CreateWorkspaceModelVersionResponse other = (CreateWorkspaceModelVersionResponse) o;
