...
public class GetOntologyProjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetOntologyProjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.aidataplatform.dp.model.OntologyProject ontologyProject) {
        super(__httpStatusCode__, headers);
        this.ontologyProject = ontologyProject;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetOntologyProjectResponse> {
         ...
         */
        @Override
        public Builder copy(GetOntologyProjectResponse o) {
         ...
         */
        @Override
        public GetOntologyProjectResponse build() {
            return new GetOntologyProjectResponse(__httpStatusCode__, headers, ontologyProject);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOntologyProjectResponse)) {
            return false;
        }

        GetOntologyProjectResponse other = (GetOntologyProjectResponse) o;
