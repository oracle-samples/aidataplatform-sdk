...
public class GenerateAiDataPlatformTempFileUploadTargetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GenerateAiDataPlatformTempFileUploadTargetRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GenerateAiDataPlatformTempFileUploadTargetRequest o) {
        ...
        /**
         * Build the instance of GenerateAiDataPlatformTempFileUploadTargetRequest as configured by this builder
         *
         ...
         *
         * @return instance of GenerateAiDataPlatformTempFileUploadTargetRequest
         */
        public GenerateAiDataPlatformTempFileUploadTargetRequest build() {
            GenerateAiDataPlatformTempFileUploadTargetRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GenerateAiDataPlatformTempFileUploadTargetRequest
         */
        public GenerateAiDataPlatformTempFileUploadTargetRequest buildWithoutInvocationCallback() {
            GenerateAiDataPlatformTempFileUploadTargetRequest request = new GenerateAiDataPlatformTempFileUploadTargetRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.schemaKey = schemaKey;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new GenerateAiDataPlatformTempFileUploadTargetRequest(aiDataPlatformId, schemaKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateAiDataPlatformTempFileUploadTargetRequest)) {
            return false;
        }

        GenerateAiDataPlatformTempFileUploadTargetRequest other = (GenerateAiDataPlatformTempFileUploadTargetRequest) o;
