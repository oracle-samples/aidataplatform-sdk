...
public class ListAiDataPlatformSchemasRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformSchemasRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformSchemasRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());catalogKey(o.getCatalogKey());displayName(o.getDisplayName());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformSchemasRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformSchemasRequest
         */
        public ListAiDataPlatformSchemasRequest build() {
            ListAiDataPlatformSchemasRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformSchemasRequest
         */
        public ListAiDataPlatformSchemasRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformSchemasRequest request = new ListAiDataPlatformSchemasRequest();
            ...
            return request;
            // new ListAiDataPlatformSchemasRequest(aiDataPlatformId, catalogKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformSchemasRequest)) {
            return false;
        }

        ListAiDataPlatformSchemasRequest other = (ListAiDataPlatformSchemasRequest) o;
