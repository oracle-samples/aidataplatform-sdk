...
* 
    ...
    private CreateAgentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.Agent agent) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAgentResponse> {
...
* 
        ...
        public CreateAgentResponse build() {
            return new CreateAgentResponse(__httpStatusCode__, headers, location, contentLocation, etag, opcRequestId, agent);
        }
    }
