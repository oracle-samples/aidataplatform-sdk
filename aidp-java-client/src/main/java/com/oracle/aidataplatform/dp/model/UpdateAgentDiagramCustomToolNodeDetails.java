...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramCustomToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramCustomToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder toolConfig(CustomToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public UpdateAgentDiagramCustomToolNodeDetails build() {
            UpdateAgentDiagramCustomToolNodeDetails model = new UpdateAgentDiagramCustomToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramCustomToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramCustomToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, CustomToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramCustomToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramCustomToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramCustomToolNodeDetails other = (UpdateAgentDiagramCustomToolNodeDetails) o;
