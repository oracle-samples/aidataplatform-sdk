...
public class GetRecipientRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetRecipientRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetRecipientRequest o) {
        ...
        /**
         * Build the instance of GetRecipientRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetRecipientRequest
         */
        public GetRecipientRequest build() {
            GetRecipientRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetRecipientRequest
         */
        public GetRecipientRequest buildWithoutInvocationCallback() {
            GetRecipientRequest request = new GetRecipientRequest();
            ...
            return request;
            // new GetRecipientRequest(aiDataPlatformId, recipientKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRecipientRequest)) {
            return false;
        }

        GetRecipientRequest other = (GetRecipientRequest) o;
