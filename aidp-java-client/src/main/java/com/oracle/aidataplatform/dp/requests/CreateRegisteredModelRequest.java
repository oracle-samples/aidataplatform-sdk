...
public class CreateRegisteredModelRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateRegisteredModelDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateRegisteredModelRequest, com.oracle.aidataplatform.dp.model.CreateRegisteredModelDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateRegisteredModelRequest o) {
        ...
        /**
         * Build the instance of CreateRegisteredModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateRegisteredModelRequest
         */
        public CreateRegisteredModelRequest build() {
            CreateRegisteredModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateRegisteredModelRequest
         */
        public CreateRegisteredModelRequest buildWithoutInvocationCallback() {
            CreateRegisteredModelRequest request = new CreateRegisteredModelRequest();
            ...
            return request;
            // new CreateRegisteredModelRequest(aiDataPlatformId, createRegisteredModelDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRegisteredModelRequest)) {
            return false;
        }

        CreateRegisteredModelRequest other = (CreateRegisteredModelRequest) o;
