...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ObjectNeighborsFetchRequestDetails.Builder.class)

public final class ObjectNeighborsFetchRequestDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"nodeId", "direction", "isWithColumns", "scopedColumns", "filter"})
    public ObjectNeighborsFetchRequestDetails(String nodeId, LineageDirection direction, Boolean isWithColumns, java.util.List<String> scopedColumns, LineageGraphNodeNeighborsFilter filter) {
        super();
        this.nodeId = nodeId;
...
public Builder filter(LineageGraphNodeNeighborsFilter filter) {
    ...
    return this;
        ...
        public ObjectNeighborsFetchRequestDetails build() {
            ObjectNeighborsFetchRequestDetails model = new ObjectNeighborsFetchRequestDetails(this.nodeId
                , this.direction
                , this.isWithColumns
                , this.scopedColumns
        ...
        public Builder copy(ObjectNeighborsFetchRequestDetails model) {
...
* 
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectNeighborsFetchRequestDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectNeighborsFetchRequestDetails)) {
            return false;
        }

        ObjectNeighborsFetchRequestDetails other = (ObjectNeighborsFetchRequestDetails) o;
