...
public class PullAiDataPlatformGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PullAiDataPlatformGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PullAiDataPlatformGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PullAiDataPlatformGitRepositoryResponse o) {
         ...
         */
        @Override
        public PullAiDataPlatformGitRepositoryResponse build() {
            return new PullAiDataPlatformGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PullAiDataPlatformGitRepositoryResponse)) {
            return false;
        }

        PullAiDataPlatformGitRepositoryResponse other = (PullAiDataPlatformGitRepositoryResponse) o;
