...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteJobRequest, java.lang.Void> {
...
* 
        ...
        public DeleteJobRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteJobRequest(aiDataPlatformId, workspaceKey, jobKey, ifMatch, opcRequestId);
        }
    }
