...
public class CreateDataTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateDataTableResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDataTableResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateDataTableResponse o) {
        ...
        public CreateDataTableResponse build() {
            return new CreateDataTableResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataTableResponse)) {
            return false;
        }

        CreateDataTableResponse other = (CreateDataTableResponse) o;
