...
public class ListAiDataPlatformWorkspaceObjectPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformWorkspaceObjectPermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformWorkspaceObjectPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());objectKey(o.getObjectKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformWorkspaceObjectPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformWorkspaceObjectPermissionsRequest
         */
        public ListAiDataPlatformWorkspaceObjectPermissionsRequest build() {
            ListAiDataPlatformWorkspaceObjectPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformWorkspaceObjectPermissionsRequest
         */
        public ListAiDataPlatformWorkspaceObjectPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformWorkspaceObjectPermissionsRequest request = new ListAiDataPlatformWorkspaceObjectPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformWorkspaceObjectPermissionsRequest(aiDataPlatformId, workspaceKey, objectKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformWorkspaceObjectPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformWorkspaceObjectPermissionsRequest other = (ListAiDataPlatformWorkspaceObjectPermissionsRequest) o;
