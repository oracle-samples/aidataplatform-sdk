...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdatePromptToolNodeDetails.Builder.class)
...
public final class UpdatePromptToolNodeDetails extends UpdateAgentFlowNodeDetails {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public UpdatePromptToolNodeDetails build() {
            UpdatePromptToolNodeDetails model = new UpdatePromptToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdatePromptToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdatePromptToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePromptToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePromptToolNodeDetails)) {
            return false;
        }

        UpdatePromptToolNodeDetails other = (UpdatePromptToolNodeDetails) o;
