...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CategoryConfig.Builder.class)

public final class CategoryConfig  {
    @Deprecated
    @java.beans.ConstructorProperties({"category", "isEnabled", "threshold", "action"})
    public CategoryConfig(String category, Boolean isEnabled, Float threshold, PolicyAction action) {
        super();
...
public Builder action(PolicyAction action) {
    ...
    return this;
        ...
        public CategoryConfig build() {
            CategoryConfig model = new CategoryConfig(this.category
                , this.isEnabled
                , this.threshold
        ...
        public Builder copy(CategoryConfig model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        CategoryConfig other = (CategoryConfig) o;
