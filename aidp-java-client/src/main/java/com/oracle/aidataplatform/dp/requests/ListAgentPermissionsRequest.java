...
public class ListAgentPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAgentPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAgentPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAgentPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAgentPermissionsRequest
         */
        public ListAgentPermissionsRequest build() {
            ListAgentPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAgentPermissionsRequest
         */
        public ListAgentPermissionsRequest buildWithoutInvocationCallback() {
            ListAgentPermissionsRequest request = new ListAgentPermissionsRequest();
            ...
            return request;
            // new ListAgentPermissionsRequest(aiDataPlatformId, workspaceKey, agentKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAgentPermissionsRequest)) {
            return false;
        }

        ListAgentPermissionsRequest other = (ListAgentPermissionsRequest) o;
