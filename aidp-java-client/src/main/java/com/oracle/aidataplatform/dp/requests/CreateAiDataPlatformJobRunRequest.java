...
public class CreateAiDataPlatformJobRunRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateJobRunDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.CreateJobRunDetails createJobRunDetails;
     ...
     * Details for the new job run.
     */
    public com.oracle.aidataplatform.dp.model.CreateJobRunDetails getCreateJobRunDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateJobRunDetails getBody$() {
        return createJobRunDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformJobRunRequest, com.oracle.aidataplatform.dp.model.CreateJobRunDetails> {
     ...
     * Details for the new job run.
     */
        private com.oracle.aidataplatform.dp.model.CreateJobRunDetails createJobRunDetails = null;
         ...
         * @return this builder instance
         */
        public Builder createJobRunDetails(com.oracle.aidataplatform.dp.model.CreateJobRunDetails createJobRunDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformJobRunRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createJobRunDetails(o.getCreateJobRunDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CreateAiDataPlatformJobRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformJobRunRequest
         */
        public CreateAiDataPlatformJobRunRequest build() {
            CreateAiDataPlatformJobRunRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateJobRunDetails body) {
         ...
         * @return instance of CreateAiDataPlatformJobRunRequest
         */
        public CreateAiDataPlatformJobRunRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformJobRunRequest request = new CreateAiDataPlatformJobRunRequest();
            ...
            return request;
            // new CreateAiDataPlatformJobRunRequest(aiDataPlatformId, workspaceKey, createJobRunDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformJobRunRequest)) {
            return false;
        }

        CreateAiDataPlatformJobRunRequest other = (CreateAiDataPlatformJobRunRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createJobRunDetails == null ? 43 : this.createJobRunDetails.hashCode());
