...
public class ListWorkspacesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code WorkspaceCollection} instance.
     */
    ...
    private ListWorkspacesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.WorkspaceCollection workspaceCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListWorkspacesResponse> {
...
* 
        ...
        public ListWorkspacesResponse build() {
            return new ListWorkspacesResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, workspaceCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkspacesResponse)) {
            return false;
        }
