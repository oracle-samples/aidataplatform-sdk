...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=Db2SchemaSummary.Builder.class)
...
public final class Db2SchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public Db2SchemaSummary build() {
            Db2SchemaSummary model = new Db2SchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(Db2SchemaSummary model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Db2SchemaSummary)) {
            return false;
        }

        Db2SchemaSummary other = (Db2SchemaSummary) o;
