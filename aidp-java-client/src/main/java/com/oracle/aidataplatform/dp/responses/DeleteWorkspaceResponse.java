...
* 
    ...
    private DeleteWorkspaceResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteWorkspaceResponse> {
...
* 
        ...
        public DeleteWorkspaceResponse build() {
            return new DeleteWorkspaceResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId);
        }
    }
