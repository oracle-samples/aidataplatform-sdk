...
public class ListRolesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListRolesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.RoleCollection roleCollection) {
