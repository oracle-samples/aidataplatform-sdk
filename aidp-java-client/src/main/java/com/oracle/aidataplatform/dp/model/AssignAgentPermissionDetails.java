...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignAgentPermissionDetails.Builder.class)

public final class AssignAgentPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public AssignAgentPermissionDetails(PermissionAssignees assignees, java.util.List<AgentPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
...
private java.util.List<AgentPrivilegeForManage> permissions;
...
public Builder permissions(java.util.List<AgentPrivilegeForManage> permissions) {
    this.permissions = permissions;
    return this;
}
            /**
...
public Builder excludeColumns(java.util.List<String> excludeColumns) {
    ...
    return this;
        ...
        public AssignAgentPermissionDetails build() {
            AssignAgentPermissionDetails model = new AssignAgentPermissionDetails(this.assignees
                , this.permissions
                , this.includeColumns
        ...
        public Builder copy(AssignAgentPermissionDetails model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("permissions")
    private final java.util.List<AgentPrivilegeForManage> permissions;
    ...
    public java.util.List<AgentPrivilegeForManage> getPermissions() {
        return permissions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignAgentPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignAgentPermissionDetails)) {
            return false;
        }

        AssignAgentPermissionDetails other = (AssignAgentPermissionDetails) o;
