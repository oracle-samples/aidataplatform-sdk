...
public class CreateAiDataPlatformCatalogRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateCatalogDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateCatalogDetails getBody$() {
        return createCatalogDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformCatalogRequest, com.oracle.aidataplatform.dp.model.CreateCatalogDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createCatalogDetails(com.oracle.aidataplatform.dp.model.CreateCatalogDetails createCatalogDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformCatalogRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());createCatalogDetails(o.getCreateCatalogDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CreateAiDataPlatformCatalogRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformCatalogRequest
         */
        public CreateAiDataPlatformCatalogRequest build() {
            CreateAiDataPlatformCatalogRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateCatalogDetails body) {
         ...
         * @return instance of CreateAiDataPlatformCatalogRequest
         */
        public CreateAiDataPlatformCatalogRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformCatalogRequest request = new CreateAiDataPlatformCatalogRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.createCatalogDetails = createCatalogDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new CreateAiDataPlatformCatalogRequest(aiDataPlatformId, createCatalogDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createCatalogDetails=").append(String.valueOf(this.createCatalogDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformCatalogRequest)) {
            return false;
        }

        CreateAiDataPlatformCatalogRequest other = (CreateAiDataPlatformCatalogRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.createCatalogDetails, other.createCatalogDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createCatalogDetails == null ? 43 : this.createCatalogDetails.hashCode());
