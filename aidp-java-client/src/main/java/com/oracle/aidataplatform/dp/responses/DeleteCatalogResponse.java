...
* 
    ...
    private DeleteCatalogResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteCatalogResponse> {
...
* 
        ...
        public DeleteCatalogResponse build() {
            return new DeleteCatalogResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId);
        }
    }
