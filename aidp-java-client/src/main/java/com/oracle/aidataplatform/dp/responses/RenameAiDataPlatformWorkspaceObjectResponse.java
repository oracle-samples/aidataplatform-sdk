...
public class RenameAiDataPlatformWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RenameAiDataPlatformWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.WorkspaceObjectDetails workspaceObjectDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RenameAiDataPlatformWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RenameAiDataPlatformWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public RenameAiDataPlatformWorkspaceObjectResponse build() {
            return new RenameAiDataPlatformWorkspaceObjectResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, workspaceObjectDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RenameAiDataPlatformWorkspaceObjectResponse)) {
            return false;
        }

        RenameAiDataPlatformWorkspaceObjectResponse other = (RenameAiDataPlatformWorkspaceObjectResponse) o;
