...
public class ListAiDataPlatformCatalogsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned {@code CatalogCollection} instance.
     */
    ...
    private ListAiDataPlatformCatalogsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.CatalogCollection catalogCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformCatalogsResponse> {
         ...
         */
        @Override
        public Builder copy(ListAiDataPlatformCatalogsResponse o) {
         ...
         */
        @Override
        public ListAiDataPlatformCatalogsResponse build() {
            return new ListAiDataPlatformCatalogsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, catalogCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformCatalogsResponse)) {
            return false;
        }

        ListAiDataPlatformCatalogsResponse other = (ListAiDataPlatformCatalogsResponse) o;
