...
* 
    ...
    private UpdateClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateClusterResponse o) {
        ...
        public UpdateClusterResponse build() {
            return new UpdateClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateClusterResponse)) {
            return false;
        }

        UpdateClusterResponse other = (UpdateClusterResponse) o;
