...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentPermissionSummary.Builder.class)

public final class AgentPermissionSummary  {
    @Deprecated
    ...
    public AgentPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<AgentPrivilege> granteePermissions, java.util.List<String> columns, java.util.List<String> excludeColumns, Boolean isInherited, String resourceName) {
        super();
...
private java.util.List<AgentPrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<AgentPrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}
            /**
...
public Builder resourceName(String resourceName) {
    ...
    return this;
        ...
        public AgentPermissionSummary build() {
            AgentPermissionSummary model = new AgentPermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(AgentPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<AgentPrivilege> granteePermissions;
    ...
    public java.util.List<AgentPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentPermissionSummary)) {
            return false;
        }

        AgentPermissionSummary other = (AgentPermissionSummary) o;
