...
public class DeleteWorkspaceObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteWorkspaceObjectRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteWorkspaceObjectRequest o) {
        ...
        /**
         * Build the instance of DeleteWorkspaceObjectRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteWorkspaceObjectRequest
         */
        public DeleteWorkspaceObjectRequest build() {
            DeleteWorkspaceObjectRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteWorkspaceObjectRequest
         */
        public DeleteWorkspaceObjectRequest buildWithoutInvocationCallback() {
            DeleteWorkspaceObjectRequest request = new DeleteWorkspaceObjectRequest();
            ...
            return request;
            // new DeleteWorkspaceObjectRequest(aiDataPlatformId, workspaceKey, objectPath, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWorkspaceObjectRequest)) {
            return false;
        }

        DeleteWorkspaceObjectRequest other = (DeleteWorkspaceObjectRequest) o;
