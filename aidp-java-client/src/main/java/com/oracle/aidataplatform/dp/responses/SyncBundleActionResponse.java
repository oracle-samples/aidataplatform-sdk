...
public class SyncBundleActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SyncBundleActionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SyncBundleActionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SyncBundleActionResponse o) {
         ...
         */
        @Override
        public SyncBundleActionResponse build() {
            return new SyncBundleActionResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SyncBundleActionResponse)) {
            return false;
        }

        SyncBundleActionResponse other = (SyncBundleActionResponse) o;
