...
public class DeleteAiDataPlatformCatalogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformCatalogRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformCatalogRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());catalogKey(o.getCatalogKey());isForced(o.getIsForced());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformCatalogRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformCatalogRequest
         */
        public DeleteAiDataPlatformCatalogRequest build() {
            DeleteAiDataPlatformCatalogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformCatalogRequest
         */
        public DeleteAiDataPlatformCatalogRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformCatalogRequest request = new DeleteAiDataPlatformCatalogRequest();
            ...
            return request;
            // new DeleteAiDataPlatformCatalogRequest(aiDataPlatformId, catalogKey, isForced, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformCatalogRequest)) {
            return false;
        }

        DeleteAiDataPlatformCatalogRequest other = (DeleteAiDataPlatformCatalogRequest) o;
