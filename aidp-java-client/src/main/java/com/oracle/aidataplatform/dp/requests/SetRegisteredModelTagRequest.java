...
public class SetRegisteredModelTagRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.SetRegisteredModelTagDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<SetRegisteredModelTagRequest, com.oracle.aidataplatform.dp.model.SetRegisteredModelTagDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(SetRegisteredModelTagRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());setRegisteredModelTagDetails(o.getSetRegisteredModelTagDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of SetRegisteredModelTagRequest as configured by this builder
         *
         ...
         *
         * @return instance of SetRegisteredModelTagRequest
         */
        public SetRegisteredModelTagRequest build() {
            SetRegisteredModelTagRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SetRegisteredModelTagRequest
         */
        public SetRegisteredModelTagRequest buildWithoutInvocationCallback() {
            SetRegisteredModelTagRequest request = new SetRegisteredModelTagRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.setRegisteredModelTagDetails = setRegisteredModelTagDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new SetRegisteredModelTagRequest(aiDataPlatformId, setRegisteredModelTagDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetRegisteredModelTagRequest)) {
            return false;
        }

        SetRegisteredModelTagRequest other = (SetRegisteredModelTagRequest) o;
