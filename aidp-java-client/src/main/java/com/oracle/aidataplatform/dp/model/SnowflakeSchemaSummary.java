...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SnowflakeSchemaSummary.Builder.class)
...
public final class SnowflakeSchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public SnowflakeSchemaSummary build() {
            SnowflakeSchemaSummary model = new SnowflakeSchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(SnowflakeSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public SnowflakeSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SnowflakeSchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnowflakeSchemaSummary)) {
            return false;
        }

        SnowflakeSchemaSummary other = (SnowflakeSchemaSummary) o;
