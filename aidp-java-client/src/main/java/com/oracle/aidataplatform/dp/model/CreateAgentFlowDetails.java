...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentFlowDetails.Builder.class)
...
public Builder diagram(AgentFlowDiagram diagram) {
    ...
    return this;
        ...
        public CreateAgentFlowDetails build() {
            CreateAgentFlowDetails model = new CreateAgentFlowDetails(this.displayName
                , this.description
                , this.pathInfo
                , this.type
                , this.entryFilePath
        ...
        public Builder copy(CreateAgentFlowDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentFlowDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentFlowDetails)) {
            return false;
        }

        CreateAgentFlowDetails other = (CreateAgentFlowDetails) o;
