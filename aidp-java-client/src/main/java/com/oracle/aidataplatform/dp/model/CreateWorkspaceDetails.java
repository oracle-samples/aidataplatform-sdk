...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateWorkspaceDetails.Builder.class)
...
public final class CreateWorkspaceDetails  {
    ...
    public CreateWorkspaceDetails(String displayName, String description, String defaultCatalogKey, WorkspaceNetworkConfigurationDetails networkConfigurationDetails) {
        super();
...
public Builder networkConfigurationDetails(WorkspaceNetworkConfigurationDetails networkConfigurationDetails) {
    ...
    return this;
        ...
        public CreateWorkspaceDetails build() {
            CreateWorkspaceDetails model = new CreateWorkspaceDetails(this.displayName
                , this.description
