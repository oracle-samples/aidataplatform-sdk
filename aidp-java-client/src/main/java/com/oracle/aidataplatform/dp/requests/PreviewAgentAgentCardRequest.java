...
public class PreviewAgentAgentCardRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.PreviewAgentCardDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.PreviewAgentCardDetails getBody$() {
        return previewAgentCardDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PreviewAgentAgentCardRequest, com.oracle.aidataplatform.dp.model.PreviewAgentCardDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder previewAgentCardDetails(com.oracle.aidataplatform.dp.model.PreviewAgentCardDetails previewAgentCardDetails) {
            this.previewAgentCardDetails = previewAgentCardDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PreviewAgentAgentCardRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());previewAgentCardDetails(o.getPreviewAgentCardDetails());opcRetryToken(o.getOpcRetryToken());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of PreviewAgentAgentCardRequest as configured by this builder
         *
         ...
         *
         * @return instance of PreviewAgentAgentCardRequest
         */
        public PreviewAgentAgentCardRequest build() {
            PreviewAgentAgentCardRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.PreviewAgentCardDetails body) {
            previewAgentCardDetails(body);
            return this;
        }
         ...
         * @return instance of PreviewAgentAgentCardRequest
         */
        public PreviewAgentAgentCardRequest buildWithoutInvocationCallback() {
            PreviewAgentAgentCardRequest request = new PreviewAgentAgentCardRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.previewAgentCardDetails = previewAgentCardDetails;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new PreviewAgentAgentCardRequest(aiDataPlatformId, workspaceKey, previewAgentCardDetails, opcRetryToken, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",previewAgentCardDetails=").append(String.valueOf(this.previewAgentCardDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PreviewAgentAgentCardRequest)) {
            return false;
        }

        PreviewAgentAgentCardRequest other = (PreviewAgentAgentCardRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.workspaceKey, other.workspaceKey)
            && java.util.Objects.equals(this.previewAgentCardDetails, other.previewAgentCardDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.previewAgentCardDetails == null ? 43 : this.previewAgentCardDetails.hashCode());
