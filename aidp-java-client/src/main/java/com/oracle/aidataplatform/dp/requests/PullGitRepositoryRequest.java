...
public class PullGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitPullDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PullGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitPullDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PullGitRepositoryRequest o) {
        ...
        /**
         * Build the instance of PullGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of PullGitRepositoryRequest
         */
        public PullGitRepositoryRequest build() {
            PullGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PullGitRepositoryRequest
         */
        public PullGitRepositoryRequest buildWithoutInvocationCallback() {
            PullGitRepositoryRequest request = new PullGitRepositoryRequest();
            ...
            return request;
            // new PullGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitPullDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PullGitRepositoryRequest)) {
            return false;
        }

        PullGitRepositoryRequest other = (PullGitRepositoryRequest) o;
