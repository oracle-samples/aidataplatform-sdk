...
public class CreateClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateClusterResponse> {
...
* 
        ...
        public CreateClusterResponse build() {
            return new CreateClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateClusterResponse)) {
            return false;
        }

        CreateClusterResponse other = (CreateClusterResponse) o;
