...
public class ListAiDataPlatformWorkspaceObjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformWorkspaceObjectsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformWorkspaceObjectsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());path(o.getPath());type(o.getType());displayName(o.getDisplayName());limit(o.getLimit());metadataKeys(o.getMetadataKeys());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformWorkspaceObjectsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformWorkspaceObjectsRequest
         */
        public ListAiDataPlatformWorkspaceObjectsRequest build() {
            ListAiDataPlatformWorkspaceObjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformWorkspaceObjectsRequest
         */
        public ListAiDataPlatformWorkspaceObjectsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformWorkspaceObjectsRequest request = new ListAiDataPlatformWorkspaceObjectsRequest();
            ...
            return request;
            // new ListAiDataPlatformWorkspaceObjectsRequest(aiDataPlatformId, workspaceKey, path, type, displayName, limit, metadataKeys, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformWorkspaceObjectsRequest)) {
            return false;
        }

        ListAiDataPlatformWorkspaceObjectsRequest other = (ListAiDataPlatformWorkspaceObjectsRequest) o;
