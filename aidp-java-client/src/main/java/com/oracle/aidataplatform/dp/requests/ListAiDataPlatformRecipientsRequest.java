...
public class ListAiDataPlatformRecipientsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformRecipientsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformRecipientsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());displayName(o.getDisplayName());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformRecipientsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformRecipientsRequest
         */
        public ListAiDataPlatformRecipientsRequest build() {
            ListAiDataPlatformRecipientsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformRecipientsRequest
         */
        public ListAiDataPlatformRecipientsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformRecipientsRequest request = new ListAiDataPlatformRecipientsRequest();
            ...
            return request;
            // new ListAiDataPlatformRecipientsRequest(aiDataPlatformId, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformRecipientsRequest)) {
            return false;
        }

        ListAiDataPlatformRecipientsRequest other = (ListAiDataPlatformRecipientsRequest) o;
