...
* 
    ...
    private DeleteExperimentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.DeleteExperimentResponseDetails deleteExperimentResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteExperimentResponse> {
