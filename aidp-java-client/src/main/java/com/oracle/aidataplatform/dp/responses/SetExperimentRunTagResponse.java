...
public class SetExperimentRunTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SetExperimentRunTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.SetExperimentRunTagResponseDetails setExperimentRunTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SetExperimentRunTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SetExperimentRunTagResponse o) {
         ...
         */
        @Override
        public SetExperimentRunTagResponse build() {
            return new SetExperimentRunTagResponse(__httpStatusCode__, headers, etag, opcRequestId, setExperimentRunTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetExperimentRunTagResponse)) {
            return false;
        }

        SetExperimentRunTagResponse other = (SetExperimentRunTagResponse) o;
