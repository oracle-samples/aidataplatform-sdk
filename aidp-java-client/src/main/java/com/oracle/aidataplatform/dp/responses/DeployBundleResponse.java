...
public class DeployBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private DeployBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeployBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeployBundleResponse o) {
         ...
         */
        @Override
        public DeployBundleResponse build() {
            return new DeployBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployBundleResponse)) {
            return false;
        }

        DeployBundleResponse other = (DeployBundleResponse) o;
