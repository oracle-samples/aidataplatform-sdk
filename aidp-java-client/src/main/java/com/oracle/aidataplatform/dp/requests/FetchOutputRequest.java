...
public class FetchOutputRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.FetchOutputDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<FetchOutputRequest, com.oracle.aidataplatform.dp.model.FetchOutputDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(FetchOutputRequest o) {
        ...
        /**
         * Build the instance of FetchOutputRequest as configured by this builder
         *
         ...
         *
         * @return instance of FetchOutputRequest
         */
        public FetchOutputRequest build() {
            FetchOutputRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of FetchOutputRequest
         */
        public FetchOutputRequest buildWithoutInvocationCallback() {
            FetchOutputRequest request = new FetchOutputRequest();
            ...
            return request;
            // new FetchOutputRequest(aiDataPlatformId, workspaceKey, taskRunKey, fetchOutputDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FetchOutputRequest)) {
            return false;
        }

        FetchOutputRequest other = (FetchOutputRequest) o;
