...
public class GetAiDataPlatformTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformTableRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformTableRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformTableRequest
         */
        public GetAiDataPlatformTableRequest build() {
            GetAiDataPlatformTableRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformTableRequest
         */
        public GetAiDataPlatformTableRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformTableRequest request = new GetAiDataPlatformTableRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.tableKey = tableKey;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new GetAiDataPlatformTableRequest(aiDataPlatformId, tableKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformTableRequest)) {
            return false;
        }

        GetAiDataPlatformTableRequest other = (GetAiDataPlatformTableRequest) o;
