...
public class ListAiDataPlatformAsyncOperationsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListAiDataPlatformAsyncOperationsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.AsyncOperationCollection asyncOperationCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformAsyncOperationsResponse> {
         ...
         */
        @Override
        public Builder copy(ListAiDataPlatformAsyncOperationsResponse o) {
         ...
         */
        @Override
        public ListAiDataPlatformAsyncOperationsResponse build() {
            return new ListAiDataPlatformAsyncOperationsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, asyncOperationCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformAsyncOperationsResponse)) {
            return false;
        }

        ListAiDataPlatformAsyncOperationsResponse other = (ListAiDataPlatformAsyncOperationsResponse) o;
