...
public class CreateAiDataPlatformBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateAiDataPlatformBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAiDataPlatformBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateAiDataPlatformBundleResponse o) {
         ...
         */
        @Override
        public CreateAiDataPlatformBundleResponse build() {
            return new CreateAiDataPlatformBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformBundleResponse)) {
            return false;
        }

        CreateAiDataPlatformBundleResponse other = (CreateAiDataPlatformBundleResponse) o;
