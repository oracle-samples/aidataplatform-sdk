...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramAgentNodeDetails.Builder.class)
...
public final class CreateAgentDiagramAgentNodeDetails extends CreateAgentDiagramNodeDetails {
...
public Builder tools(java.util.List<Tool> tools) {
    ...
    return this;
        ...
        public CreateAgentDiagramAgentNodeDetails build() {
            CreateAgentDiagramAgentNodeDetails model = new CreateAgentDiagramAgentNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramAgentNodeDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramAgentNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramAgentNodeDetails)) {
            return false;
        }

        CreateAgentDiagramAgentNodeDetails other = (CreateAgentDiagramAgentNodeDetails) o;
