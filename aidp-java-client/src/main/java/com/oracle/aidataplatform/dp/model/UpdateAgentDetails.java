...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDetails.Builder.class)
...
public final class UpdateAgentDetails  {
    ...
    public UpdateAgentDetails(String displayName, String description, String computeKey, AgentDiagram diagram, String entryFilePath, String dependenciesFilePath, java.util.List<String> deletedNodes, java.util.List<String> updatedNodes, java.util.List<String> addedNodes, GuardrailsConfiguration guardrails, SessionConfiguration sessionConfig, AgentCardConfigDetail agentCardConfig) {
        super();
...
public Builder agentCardConfig(AgentCardConfigDetail agentCardConfig) {
    ...
    return this;
        ...
        public UpdateAgentDetails build() {
            UpdateAgentDetails model = new UpdateAgentDetails(this.displayName
                , this.description
                , this.computeKey
                , this.diagram
                , this.entryFilePath
