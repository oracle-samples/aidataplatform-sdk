...
public class RenameWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RenameWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.WorkspaceObjectDetails workspaceObjectDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RenameWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RenameWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public RenameWorkspaceObjectResponse build() {
            return new RenameWorkspaceObjectResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, workspaceObjectDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RenameWorkspaceObjectResponse)) {
            return false;
        }

        RenameWorkspaceObjectResponse other = (RenameWorkspaceObjectResponse) o;
