...
public class ListAiDataPlatformGitDiffsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * Determines which reference is used for computing diffs.
     **/
    public enum CompareTo implements com.oracle.bmc.http.internal.BmcEnum {
        Head("HEAD"),
        Upstream("UPSTREAM"),
        Index("INDEX"),
        Worktree("WORKTREE"),
        ...
        private static java.util.Map<String, CompareTo> map;

        static {
            map = new java.util.HashMap<>();
            for (CompareTo v : CompareTo.values()) {
        ...
        public static CompareTo create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            throw new IllegalArgumentException("Invalid CompareTo: " + key);
        }
    };
     ...
     * Filter which files are returned.
     **/
    public enum Filter implements com.oracle.bmc.http.internal.BmcEnum {
        All("ALL"),
        DiffOnly("DIFF_ONLY"),
        ...
        private final String value;
        private static java.util.Map<String, Filter> map;

        static {
            map = new java.util.HashMap<>();
            for (Filter v : Filter.values()) {
                    map.put(v.getValue(), v);
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static Filter create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformGitDiffsRequest, java.lang.Void> {
     ...
     * Determines which reference is used for computing diffs.
     */
        private CompareTo compareTo = null;

        /**
         * Determines which reference is used for computing diffs.
         * @param compareTo the value to set
         * @return this builder instance
         */
        public Builder compareTo(CompareTo compareTo) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformGitDiffsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());gitFolderPath(o.getGitFolderPath());branchName(o.getBranchName());compareTo(o.getCompareTo());filter(o.getFilter());limit(o.getLimit());page(o.getPage());opcRequestId(o.getOpcRequestId());sortOrder(o.getSortOrder());sortBy(o.getSortBy());displayName(o.getDisplayName());
        ...
        /**
         * Build the instance of ListAiDataPlatformGitDiffsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformGitDiffsRequest
         */
        public ListAiDataPlatformGitDiffsRequest build() {
            ListAiDataPlatformGitDiffsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformGitDiffsRequest
         */
        public ListAiDataPlatformGitDiffsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformGitDiffsRequest request = new ListAiDataPlatformGitDiffsRequest();
            ...
            return request;
            // new ListAiDataPlatformGitDiffsRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitFolderPath, branchName, compareTo, filter, limit, page, opcRequestId, sortOrder, sortBy, displayName);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",compareTo=").append(String.valueOf(this.compareTo));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformGitDiffsRequest)) {
            return false;
        }

        ListAiDataPlatformGitDiffsRequest other = (ListAiDataPlatformGitDiffsRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.compareTo, other.compareTo)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.compareTo == null ? 43 : this.compareTo.hashCode());
