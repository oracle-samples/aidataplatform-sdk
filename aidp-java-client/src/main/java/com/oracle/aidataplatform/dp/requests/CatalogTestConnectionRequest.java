...
public class CatalogTestConnectionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CatalogTestConnectionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CatalogTestConnectionRequest, com.oracle.aidataplatform.dp.model.CatalogTestConnectionDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CatalogTestConnectionRequest o) {
        ...
        /**
         * Build the instance of CatalogTestConnectionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CatalogTestConnectionRequest
         */
        public CatalogTestConnectionRequest build() {
            CatalogTestConnectionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CatalogTestConnectionRequest
         */
        public CatalogTestConnectionRequest buildWithoutInvocationCallback() {
            CatalogTestConnectionRequest request = new CatalogTestConnectionRequest();
            ...
            return request;
            // new CatalogTestConnectionRequest(aiDataPlatformId, catalogTestConnectionDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogTestConnectionRequest)) {
            return false;
        }

        CatalogTestConnectionRequest other = (CatalogTestConnectionRequest) o;
