...
public class ResetGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ResetGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ResetGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ResetGitRepositoryResponse o) {
         ...
         */
        @Override
        public ResetGitRepositoryResponse build() {
            return new ResetGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetGitRepositoryResponse)) {
            return false;
        }

        ResetGitRepositoryResponse other = (ResetGitRepositoryResponse) o;
