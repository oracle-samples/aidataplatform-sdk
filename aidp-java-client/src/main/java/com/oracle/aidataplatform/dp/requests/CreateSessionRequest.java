...
public class CreateSessionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateSessionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateSessionRequest, com.oracle.aidataplatform.dp.model.CreateSessionDetails> {
...
* 
     ...
     */
        ...
        public CreateSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateSessionRequest(aiDataPlatformId, workspaceKey, createSessionDetails, opcRetryToken, opcRequestId, datalakeTenantId);
        }
    }
