...
public class ListTablePermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned {@code TablePermissionCollection} instance.
     */
    ...
    private ListTablePermissionsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.TablePermissionCollection tablePermissionCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListTablePermissionsResponse> {
         ...
         */
        @Override
        public Builder copy(ListTablePermissionsResponse o) {
         ...
         */
        @Override
        public ListTablePermissionsResponse build() {
            return new ListTablePermissionsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, tablePermissionCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTablePermissionsResponse)) {
            return false;
        }

        ListTablePermissionsResponse other = (ListTablePermissionsResponse) o;
