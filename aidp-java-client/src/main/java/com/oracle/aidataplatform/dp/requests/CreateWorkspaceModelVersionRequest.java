...
public class CreateWorkspaceModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateWorkspaceModelVersionRequest, com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateWorkspaceModelVersionRequest o) {
        ...
        /**
         * Build the instance of CreateWorkspaceModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateWorkspaceModelVersionRequest
         */
        public CreateWorkspaceModelVersionRequest build() {
            CreateWorkspaceModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateWorkspaceModelVersionRequest
         */
        public CreateWorkspaceModelVersionRequest buildWithoutInvocationCallback() {
            CreateWorkspaceModelVersionRequest request = new CreateWorkspaceModelVersionRequest();
            ...
            return request;
            // new CreateWorkspaceModelVersionRequest(aiDataPlatformId, workspaceKey, createModelVersionDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateWorkspaceModelVersionRequest)) {
            return false;
        }

        CreateWorkspaceModelVersionRequest other = (CreateWorkspaceModelVersionRequest) o;
