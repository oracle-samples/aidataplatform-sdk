...
public class ListViewPermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListViewPermissionsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.ViewPermissionCollection viewPermissionCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListViewPermissionsResponse> {
         ...
         */
        @Override
        public Builder copy(ListViewPermissionsResponse o) {
         ...
         */
        @Override
        public ListViewPermissionsResponse build() {
            return new ListViewPermissionsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, viewPermissionCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListViewPermissionsResponse)) {
            return false;
        }

        ListViewPermissionsResponse other = (ListViewPermissionsResponse) o;
