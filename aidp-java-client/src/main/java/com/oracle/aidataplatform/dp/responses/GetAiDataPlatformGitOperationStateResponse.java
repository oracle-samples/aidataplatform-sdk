...
public class GetAiDataPlatformGitOperationStateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetAiDataPlatformGitOperationStateResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GitOperationState gitOperationState) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetAiDataPlatformGitOperationStateResponse> {
