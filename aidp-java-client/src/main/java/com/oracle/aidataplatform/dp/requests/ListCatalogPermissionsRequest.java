...
public class ListCatalogPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListCatalogPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListCatalogPermissionsRequest o) {
        ...
        /**
         * Build the instance of ListCatalogPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCatalogPermissionsRequest
         */
        public ListCatalogPermissionsRequest build() {
            ListCatalogPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCatalogPermissionsRequest
         */
        public ListCatalogPermissionsRequest buildWithoutInvocationCallback() {
            ListCatalogPermissionsRequest request = new ListCatalogPermissionsRequest();
            ...
            return request;
            // new ListCatalogPermissionsRequest(aiDataPlatformId, catalogKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCatalogPermissionsRequest)) {
            return false;
        }

        ListCatalogPermissionsRequest other = (ListCatalogPermissionsRequest) o;
