...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SparkCluster.Builder.class)
...
public final class SparkCluster extends Cluster {
...
public Builder subscription(SubscriptionDetails subscription) {
    ...
    return this;
        ...
        public SparkCluster build() {
            SparkCluster model = new SparkCluster(this.key
                , this.displayName
                , this.description
                , this.type
                , this.timeCreated
        ...
        public Builder copy(SparkCluster model) {
...
* 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SparkCluster)) {
            return false;
        }

        SparkCluster other = (SparkCluster) o;
