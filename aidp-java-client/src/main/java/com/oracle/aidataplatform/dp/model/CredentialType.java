...
public enum CredentialType implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CredentialType.class);
    ...
    public static CredentialType create(String key) {
        ...
        LOG.warn("Received unknown value '{}' for enum 'CredentialType', returning UnknownEnumValue", key);
