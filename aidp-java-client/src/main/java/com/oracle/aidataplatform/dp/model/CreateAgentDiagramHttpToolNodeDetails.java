...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramHttpToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramHttpToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
public Builder toolConfig(HttpToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateAgentDiagramHttpToolNodeDetails build() {
            CreateAgentDiagramHttpToolNodeDetails model = new CreateAgentDiagramHttpToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramHttpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramHttpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, HttpToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramHttpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramHttpToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramHttpToolNodeDetails other = (CreateAgentDiagramHttpToolNodeDetails) o;
