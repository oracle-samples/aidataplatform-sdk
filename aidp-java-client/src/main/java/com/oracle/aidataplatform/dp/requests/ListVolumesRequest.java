...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListVolumesRequest, java.lang.Void> {
...
* 
        ...
        /**
         * Build the instance of ListVolumesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListVolumesRequest
         */
        public ListVolumesRequest build() {
            ListVolumesRequest request = buildWithoutInvocationCallback();
        ...
        public ListVolumesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVolumesRequest(aiDataPlatformId, catalogKey, schemaKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVolumesRequest)) {
            return false;
        }
