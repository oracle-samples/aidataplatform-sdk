...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramRagToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramRagToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
public Builder toolConfig(RagToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateAgentDiagramRagToolNodeDetails build() {
            CreateAgentDiagramRagToolNodeDetails model = new CreateAgentDiagramRagToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramRagToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramRagToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, RagToolInputSchema inputSchema, RagToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramRagToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramRagToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramRagToolNodeDetails other = (CreateAgentDiagramRagToolNodeDetails) o;
