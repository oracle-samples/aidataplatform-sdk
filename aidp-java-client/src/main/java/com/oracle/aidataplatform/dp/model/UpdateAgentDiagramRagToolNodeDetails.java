...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramRagToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramRagToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder inputSchema(RagToolInputSchema inputSchema) {
    ...
    return this;
        ...
        public UpdateAgentDiagramRagToolNodeDetails build() {
            UpdateAgentDiagramRagToolNodeDetails model = new UpdateAgentDiagramRagToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramRagToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramRagToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, RagToolInputSchema inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramRagToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramRagToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramRagToolNodeDetails other = (UpdateAgentDiagramRagToolNodeDetails) o;
