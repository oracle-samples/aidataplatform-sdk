...
public class DeleteAiDataPlatformExperimentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeleteExperimentDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.DeleteExperimentDetails getBody$() {
        return deleteExperimentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformExperimentRequest, com.oracle.aidataplatform.dp.model.DeleteExperimentDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder deleteExperimentDetails(com.oracle.aidataplatform.dp.model.DeleteExperimentDetails deleteExperimentDetails) {
            this.deleteExperimentDetails = deleteExperimentDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformExperimentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());deleteExperimentDetails(o.getDeleteExperimentDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformExperimentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformExperimentRequest
         */
        public DeleteAiDataPlatformExperimentRequest build() {
            DeleteAiDataPlatformExperimentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.DeleteExperimentDetails body) {
            deleteExperimentDetails(body);
            return this;
        }
         ...
         * @return instance of DeleteAiDataPlatformExperimentRequest
         */
        public DeleteAiDataPlatformExperimentRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformExperimentRequest request = new DeleteAiDataPlatformExperimentRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.deleteExperimentDetails = deleteExperimentDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.dhUserPrincipal = dhUserPrincipal;
            return request;
            // new DeleteAiDataPlatformExperimentRequest(aiDataPlatformId, workspaceKey, deleteExperimentDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",deleteExperimentDetails=").append(String.valueOf(this.deleteExperimentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformExperimentRequest)) {
            return false;
        }

        DeleteAiDataPlatformExperimentRequest other = (DeleteAiDataPlatformExperimentRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.workspaceKey, other.workspaceKey)
            && java.util.Objects.equals(this.deleteExperimentDetails, other.deleteExperimentDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.deleteExperimentDetails == null ? 43 : this.deleteExperimentDetails.hashCode());
