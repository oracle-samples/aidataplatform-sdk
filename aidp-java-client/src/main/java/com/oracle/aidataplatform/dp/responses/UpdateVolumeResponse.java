...
public class UpdateVolumeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private UpdateVolumeResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Volume volume) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateVolumeResponse> {
...
* 
        ...
        public UpdateVolumeResponse build() {
            return new UpdateVolumeResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, volume);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVolumeResponse)) {
            return false;
        }

        UpdateVolumeResponse other = (UpdateVolumeResponse) o;
