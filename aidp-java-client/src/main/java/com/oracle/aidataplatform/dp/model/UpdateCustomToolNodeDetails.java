...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateCustomToolNodeDetails.Builder.class)
...
public final class UpdateCustomToolNodeDetails extends UpdateAgentFlowNodeDetails {
...
public Builder toolConfig(CustomToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public UpdateCustomToolNodeDetails build() {
            UpdateCustomToolNodeDetails model = new UpdateCustomToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateCustomToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateCustomToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, CustomToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateCustomToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCustomToolNodeDetails)) {
            return false;
        }

        UpdateCustomToolNodeDetails other = (UpdateCustomToolNodeDetails) o;
