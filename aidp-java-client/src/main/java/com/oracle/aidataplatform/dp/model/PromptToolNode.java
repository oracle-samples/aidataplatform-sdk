...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=PromptToolNode.Builder.class)
...
public final class PromptToolNode extends AgentFlowNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public PromptToolNode build() {
            PromptToolNode model = new PromptToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(PromptToolNode model) {
...
return this;
    ...
    @Deprecated
    public PromptToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PromptToolNode)) {
            return false;
        }

        PromptToolNode other = (PromptToolNode) o;
