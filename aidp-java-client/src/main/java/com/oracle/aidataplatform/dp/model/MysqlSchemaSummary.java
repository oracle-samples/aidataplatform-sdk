...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MysqlSchemaSummary.Builder.class)
...
public final class MysqlSchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public MysqlSchemaSummary build() {
            MysqlSchemaSummary model = new MysqlSchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(MysqlSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public MysqlSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MysqlSchemaSummary)) {
            return false;
        }

        MysqlSchemaSummary other = (MysqlSchemaSummary) o;
