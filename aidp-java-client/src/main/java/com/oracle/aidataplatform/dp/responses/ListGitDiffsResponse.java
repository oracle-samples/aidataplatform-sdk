...
public class ListGitDiffsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.aidataplatform.dp.model.GitDiffSummaryCollection getGitDiffSummaryCollection() {
        return gitDiffSummaryCollection;
    }
    ...
    private ListGitDiffsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.GitDiffSummaryCollection gitDiffSummaryCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListGitDiffsResponse> {
        ...
        /**
         * The returned {@code GitDiffSummaryCollection} instance.
         * @param gitDiffSummaryCollection the value to set
         * @return this builder
         */
        public Builder gitDiffSummaryCollection(com.oracle.aidataplatform.dp.model.GitDiffSummaryCollection gitDiffSummaryCollection) {
            this.gitDiffSummaryCollection = gitDiffSummaryCollection;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(ListGitDiffsResponse o) {
         ...
         */
        @Override
        public ListGitDiffsResponse build() {
            return new ListGitDiffsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, opcTotalItems, gitDiffSummaryCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListGitDiffsResponse)) {
            return false;
        }

        ListGitDiffsResponse other = (ListGitDiffsResponse) o;
