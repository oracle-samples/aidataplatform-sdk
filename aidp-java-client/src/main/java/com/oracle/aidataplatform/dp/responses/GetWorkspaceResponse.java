...
* 
    ...
    private GetWorkspaceResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.Workspace workspace) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetWorkspaceResponse> {
...
* 
        ...
        public GetWorkspaceResponse build() {
            return new GetWorkspaceResponse(__httpStatusCode__, headers, etag, opcRequestId, workspace);
        }
    }
