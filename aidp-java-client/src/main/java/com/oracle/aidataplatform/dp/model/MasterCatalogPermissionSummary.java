...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MasterCatalogPermissionSummary.Builder.class)

public final class MasterCatalogPermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions"})
    public MasterCatalogPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<MasterCatalogPrivilege> granteePermissions) {
        super();
...
private java.util.List<MasterCatalogPrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<MasterCatalogPrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}


        public MasterCatalogPermissionSummary build() {
            MasterCatalogPermissionSummary model = new MasterCatalogPermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(MasterCatalogPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<MasterCatalogPrivilege> granteePermissions;
    ...
    public java.util.List<MasterCatalogPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MasterCatalogPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MasterCatalogPermissionSummary)) {
            return false;
        }

        MasterCatalogPermissionSummary other = (MasterCatalogPermissionSummary) o;
