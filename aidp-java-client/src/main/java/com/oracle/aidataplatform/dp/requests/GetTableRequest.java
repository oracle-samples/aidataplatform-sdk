...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetTableRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public Builder copy(GetTableRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());shouldSkipOcidTranslation(o.getShouldSkipOcidTranslation());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        public GetTableRequest build() {
            GetTableRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetTableRequest
         */
        public GetTableRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetTableRequest(aiDataPlatformId, tableKey, shouldSkipOcidTranslation, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTableRequest)) {
            return false;
        }
