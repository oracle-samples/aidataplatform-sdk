...
* 
    ...
    private CreateCatalogResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCatalogResponse> {
...
* 
        ...
        public CreateCatalogResponse build() {
            return new CreateCatalogResponse(__httpStatusCode__, headers, location, contentLocation, aidpAsyncOperationKey, opcRequestId);
        }
    }
