...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=TaskRunRetrySummary.Builder.class)

public final class TaskRunRetrySummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "name", "taskRunId", "startTime", "endTime", "clusterValidationStartTime", "state", "setupDuration", "executionDuration", "cleanupDuration", "outputKey", "externalId", "retryNumber"})
    public TaskRunRetrySummary(String key, String name, String taskRunId, Long startTime, Long endTime, Long clusterValidationStartTime, State state, Long setupDuration, Long executionDuration, Long cleanupDuration, String outputKey, String externalId, Integer retryNumber) {
        super();
        this.key = key;
        this.name = name;
...
@com.fasterxml.jackson.annotation.JsonProperty("taskRunId")
private String taskRunId;

        /**
         * The OCID of the task run.
         * @param taskRunId the value to set
         * @return this builder
         **/
...
public Builder retryNumber(Integer retryNumber) {
    ...
    return this;
        ...
        public TaskRunRetrySummary build() {
            TaskRunRetrySummary model = new TaskRunRetrySummary(this.key
                , this.name
                , this.taskRunId
                , this.startTime
                , this.endTime
        ...
        public Builder copy(TaskRunRetrySummary model) {
                this.key(model.getKey());
    this.name(model.getName());
    this.taskRunId(model.getTaskRunId());
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TaskRunRetrySummary(");
        sb.append("key=").append(String.valueOf(this.key));
        sb.append(", name=").append(String.valueOf(this.name));
        sb.append(", taskRunId=").append(String.valueOf(this.taskRunId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskRunRetrySummary)) {
            return false;
        }

        TaskRunRetrySummary other = (TaskRunRetrySummary) o;
        return java.util.Objects.equals(this.key, other.key) &&
            java.util.Objects.equals(this.name, other.name) &&
            java.util.Objects.equals(this.taskRunId, other.taskRunId) &&
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.taskRunId == null ? 43 : this.taskRunId.hashCode());
