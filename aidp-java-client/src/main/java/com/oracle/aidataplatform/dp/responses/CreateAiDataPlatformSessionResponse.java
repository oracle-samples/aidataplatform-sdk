...
* 
    ...
    private CreateAiDataPlatformSessionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String etag, String opcRequestId, String opcWorkRequestId, com.oracle.aidataplatform.dp.model.Session session) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAiDataPlatformSessionResponse> {
