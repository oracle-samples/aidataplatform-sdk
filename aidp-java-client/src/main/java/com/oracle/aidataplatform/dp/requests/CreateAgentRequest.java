...
public class CreateAgentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateAgentDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateAgentDetails getBody$() {
        return createAgentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAgentRequest, com.oracle.aidataplatform.dp.model.CreateAgentDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createAgentDetails(com.oracle.aidataplatform.dp.model.CreateAgentDetails createAgentDetails) {
            this.createAgentDetails = createAgentDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAgentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createAgentDetails(o.getCreateAgentDetails());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
         ...
         *
         * @return instance of CreateAgentRequest
         */
        public CreateAgentRequest build() {
            CreateAgentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateAgentDetails body) {
         ...
         * @return instance of CreateAgentRequest
         */
        public CreateAgentRequest buildWithoutInvocationCallback() {
            CreateAgentRequest request = new CreateAgentRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.createAgentDetails = createAgentDetails;
            request.shouldUpdateRecent = shouldUpdateRecent;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateAgentRequest(aiDataPlatformId, workspaceKey, createAgentDetails, shouldUpdateRecent, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createAgentDetails=").append(String.valueOf(this.createAgentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentRequest)) {
            return false;
        }
        ...
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.createAgentDetails, other.createAgentDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createAgentDetails == null ? 43 : this.createAgentDetails.hashCode());
