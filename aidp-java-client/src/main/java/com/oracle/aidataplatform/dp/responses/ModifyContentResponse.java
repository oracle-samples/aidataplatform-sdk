...
public class ModifyContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ModifyContentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String etag, String opcWorkRequestId, String opcRequestId, com.oracle.aidataplatform.dp.model.Content content) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ModifyContentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ModifyContentResponse o) {
         ...
         */
        @Override
        public ModifyContentResponse build() {
            return new ModifyContentResponse(__httpStatusCode__, headers, location, etag, opcWorkRequestId, opcRequestId, content);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModifyContentResponse)) {
            return false;
        }

        ModifyContentResponse other = (ModifyContentResponse) o;
