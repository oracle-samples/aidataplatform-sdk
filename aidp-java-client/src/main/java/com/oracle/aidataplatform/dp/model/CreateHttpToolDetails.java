...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateHttpToolDetails.Builder.class)
...
public final class CreateHttpToolDetails extends CreateToolDetails {
...
public Builder toolConfig(HttpToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateHttpToolDetails build() {
            CreateHttpToolDetails model = new CreateHttpToolDetails(this.displayName
                , this.description
                , this.properties
                , this.inputSchema
        ...
        public Builder copy(CreateHttpToolDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateHttpToolDetails(String displayName, String description, java.util.Map<String, Object> properties, java.util.Map<String, Object> inputSchema, HttpToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateHttpToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateHttpToolDetails)) {
            return false;
        }

        CreateHttpToolDetails other = (CreateHttpToolDetails) o;
