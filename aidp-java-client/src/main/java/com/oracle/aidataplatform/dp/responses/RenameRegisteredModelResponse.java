...
public class RenameRegisteredModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RenameRegisteredModelResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.RenameRegisteredModelResponseDetails renameRegisteredModelResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RenameRegisteredModelResponse> {
