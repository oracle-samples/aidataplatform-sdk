...
public class DeleteRegisteredModelTagRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeleteRegisteredModelTagDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteRegisteredModelTagRequest, com.oracle.aidataplatform.dp.model.DeleteRegisteredModelTagDetails> {
...
* 
        ...
        /**
         * Build the instance of DeleteRegisteredModelTagRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteRegisteredModelTagRequest
         */
        public DeleteRegisteredModelTagRequest build() {
            DeleteRegisteredModelTagRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteRegisteredModelTagRequest
         */
        public DeleteRegisteredModelTagRequest buildWithoutInvocationCallback() {
            DeleteRegisteredModelTagRequest request = new DeleteRegisteredModelTagRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRegisteredModelTagRequest)) {
            return false;
        }

        DeleteRegisteredModelTagRequest other = (DeleteRegisteredModelTagRequest) o;
