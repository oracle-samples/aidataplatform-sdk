...
public class SetExperimentTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code SetExperimentTagResponseDetails} instance.
     */
    ...
    private SetExperimentTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.SetExperimentTagResponseDetails setExperimentTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SetExperimentTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SetExperimentTagResponse o) {
         ...
         */
        @Override
        public SetExperimentTagResponse build() {
            return new SetExperimentTagResponse(__httpStatusCode__, headers, etag, opcRequestId, setExperimentTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetExperimentTagResponse)) {
            return false;
        }

        SetExperimentTagResponse other = (SetExperimentTagResponse) o;
