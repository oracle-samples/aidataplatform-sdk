...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=Db2Schema.Builder.class)
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public Db2Schema build() {
            Db2Schema model = new Db2Schema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(Db2Schema model) {
...
return this;
    ...
    @Deprecated
    public Db2Schema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Db2Schema)) {
            return false;
        }

        Db2Schema other = (Db2Schema) o;
