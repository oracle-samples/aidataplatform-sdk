...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AdwSchema.Builder.class)
...
public final class AdwSchema extends Schema {
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public AdwSchema build() {
            AdwSchema model = new AdwSchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(AdwSchema model) {
...
return this;
    ...
    @Deprecated
    public AdwSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdwSchema)) {
            return false;
        }

        AdwSchema other = (AdwSchema) o;
