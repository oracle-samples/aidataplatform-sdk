...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UserSetting.Builder.class)

public final class UserSetting  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "name", "isDefault", "data"})
    public UserSetting(String key, String name, Boolean isDefault, SettingData data) {
        super();
        this.key = key;
        this.name = name;
...
public Builder data(SettingData data) {
    ...
    return this;
        ...
        public UserSetting build() {
            UserSetting model = new UserSetting(this.key
                , this.name
                , this.isDefault
        ...
        public Builder copy(UserSetting model) {
