...
public class DeleteAiDataPlatformCredentialRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformCredentialRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformCredentialRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());credentialKey(o.getCredentialKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformCredentialRequest
         */
        public DeleteAiDataPlatformCredentialRequest build() {
            DeleteAiDataPlatformCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformCredentialRequest
         */
        public DeleteAiDataPlatformCredentialRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformCredentialRequest request = new DeleteAiDataPlatformCredentialRequest();
            ...
            return request;
            // new DeleteAiDataPlatformCredentialRequest(aiDataPlatformId, credentialKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformCredentialRequest)) {
            return false;
        }

        DeleteAiDataPlatformCredentialRequest other = (DeleteAiDataPlatformCredentialRequest) o;
