...
public class ListAiDataPlatformSharesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformSharesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformSharesRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformSharesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformSharesRequest
         */
        public ListAiDataPlatformSharesRequest build() {
            ListAiDataPlatformSharesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformSharesRequest
         */
        public ListAiDataPlatformSharesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformSharesRequest request = new ListAiDataPlatformSharesRequest();
            ...
            return request;
            // new ListAiDataPlatformSharesRequest(aiDataPlatformId, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformSharesRequest)) {
            return false;
        }

        ListAiDataPlatformSharesRequest other = (ListAiDataPlatformSharesRequest) o;
