...
public class ListAiDataPlatformClusterPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformClusterPermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformClusterPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());displayName(o.getDisplayName());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformClusterPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformClusterPermissionsRequest
         */
        public ListAiDataPlatformClusterPermissionsRequest build() {
            ListAiDataPlatformClusterPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformClusterPermissionsRequest
         */
        public ListAiDataPlatformClusterPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformClusterPermissionsRequest request = new ListAiDataPlatformClusterPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformClusterPermissionsRequest(aiDataPlatformId, workspaceKey, clusterKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformClusterPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformClusterPermissionsRequest other = (ListAiDataPlatformClusterPermissionsRequest) o;
