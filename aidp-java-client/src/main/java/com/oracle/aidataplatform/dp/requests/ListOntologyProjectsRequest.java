...
public class ListOntologyProjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListOntologyProjectsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListOntologyProjectsRequest o) {
            dataLakeId(o.getDataLakeId());workspaceId(o.getWorkspaceId());page(o.getPage());limit(o.getLimit());
        ...
        /**
         * Build the instance of ListOntologyProjectsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOntologyProjectsRequest
         */
        public ListOntologyProjectsRequest build() {
            ListOntologyProjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOntologyProjectsRequest
         */
        public ListOntologyProjectsRequest buildWithoutInvocationCallback() {
            ListOntologyProjectsRequest request = new ListOntologyProjectsRequest();
            request.dataLakeId = dataLakeId;
            request.workspaceId = workspaceId;
            request.page = page;
            request.limit = limit;
            return request;
            // new ListOntologyProjectsRequest(dataLakeId, workspaceId, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOntologyProjectsRequest)) {
            return false;
        }

        ListOntologyProjectsRequest other = (ListOntologyProjectsRequest) o;
