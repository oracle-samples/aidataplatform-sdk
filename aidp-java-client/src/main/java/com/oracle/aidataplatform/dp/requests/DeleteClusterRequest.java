...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteClusterRequest, java.lang.Void> {
...
* 
        ...
        public DeleteClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, ifMatch, opcRequestId);
        }
    }
