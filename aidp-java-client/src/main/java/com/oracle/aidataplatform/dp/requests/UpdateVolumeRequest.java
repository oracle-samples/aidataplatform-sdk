...
public class UpdateVolumeRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateVolumeDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateVolumeRequest, com.oracle.aidataplatform.dp.model.UpdateVolumeDetails> {
...
* 
        ...
        public UpdateVolumeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateVolumeRequest(aiDataPlatformId, volumeKey, updateVolumeDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
