...
* 
        ...
        public Builder copy(CreateExperimentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createExperimentDetails(o.getCreateExperimentDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        public CreateExperimentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateExperimentRequest(aiDataPlatformId, workspaceKey, createExperimentDetails, opcRetryToken, opcRequestId);
        }
    }
