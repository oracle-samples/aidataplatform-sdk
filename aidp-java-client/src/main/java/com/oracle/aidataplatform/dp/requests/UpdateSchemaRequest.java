...
public class UpdateSchemaRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateSchemaDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateSchemaRequest, com.oracle.aidataplatform.dp.model.UpdateSchemaDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateSchemaRequest o) {
        ...
        /**
         * Build the instance of UpdateSchemaRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateSchemaRequest
         */
        public UpdateSchemaRequest build() {
            UpdateSchemaRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateSchemaRequest
         */
        public UpdateSchemaRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSchemaRequest(aiDataPlatformId, schemaKey, updateSchemaDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSchemaRequest)) {
            return false;
        }

        UpdateSchemaRequest other = (UpdateSchemaRequest) o;
