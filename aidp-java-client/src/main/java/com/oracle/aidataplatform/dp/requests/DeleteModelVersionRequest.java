...
public class DeleteModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteModelVersionRequest, com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of DeleteModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteModelVersionRequest
         */
        public DeleteModelVersionRequest build() {
            DeleteModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteModelVersionRequest
         */
        public DeleteModelVersionRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteModelVersionRequest)) {
            return false;
        }

        DeleteModelVersionRequest other = (DeleteModelVersionRequest) o;
