...
public class ResetGitFolderStateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ResetGitFolderStateResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ResetGitFolderStateResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ResetGitFolderStateResponse o) {
         ...
         */
        @Override
        public ResetGitFolderStateResponse build() {
            return new ResetGitFolderStateResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetGitFolderStateResponse)) {
            return false;
        }

        ResetGitFolderStateResponse other = (ResetGitFolderStateResponse) o;
