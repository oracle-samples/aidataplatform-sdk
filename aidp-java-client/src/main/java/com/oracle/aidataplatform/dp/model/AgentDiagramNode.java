...
@com.fasterxml.jackson.annotation.JsonTypeInfo(use=com.fasterxml.jackson.annotation.JsonTypeInfo.Id.NAME, include=com.fasterxml.jackson.annotation.JsonTypeInfo.As.PROPERTY, property="type", defaultImpl=AgentDiagramNode.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramSupervisorAgentNode.class, name = "SUPERVISOR_AGENT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramSqlToolNode.class, name = "SQL_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramCustomToolNode.class, name = "CUSTOM_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramStartNode.class, name = "START_NODE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramPromptToolNode.class, name = "PROMPT_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramRagToolNode.class, name = "RAG_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramMcpToolNode.class, name = "MCP_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramGuardrailNode.class, name = "GUARDRAILS"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramAgentNode.class, name = "AGENT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = AgentDiagramHttpToolNode.class, name = "HTTP_TOOL")
})

public class AgentDiagramNode  {
    @Deprecated
    ...
    protected AgentDiagramNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors) {
        super();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramNode)) {
            return false;
        }

        AgentDiagramNode other = (AgentDiagramNode) o;
