...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=Db2TableSummary.Builder.class)
...
public final class Db2TableSummary extends TableSummary {
...
public Builder lifecycleState(TableLifecycleState lifecycleState) {
    ...
    return this;
        ...
        public Db2TableSummary build() {
            Db2TableSummary model = new Db2TableSummary(this.key
                , this.displayName
                , this.tableType
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(Db2TableSummary model) {
...
return this;
    ...
    @Deprecated
    public Db2TableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Db2TableSummary)) {
            return false;
        }

        Db2TableSummary other = (Db2TableSummary) o;
