...
public class DeleteAiDataPlatformSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformSessionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());sessionId(o.getSessionId());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformSessionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformSessionRequest
         */
        public DeleteAiDataPlatformSessionRequest build() {
            DeleteAiDataPlatformSessionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformSessionRequest
         */
        public DeleteAiDataPlatformSessionRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformSessionRequest request = new DeleteAiDataPlatformSessionRequest();
            ...
            return request;
            // new DeleteAiDataPlatformSessionRequest(aiDataPlatformId, workspaceKey, sessionId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformSessionRequest)) {
            return false;
        }

        DeleteAiDataPlatformSessionRequest other = (DeleteAiDataPlatformSessionRequest) o;
