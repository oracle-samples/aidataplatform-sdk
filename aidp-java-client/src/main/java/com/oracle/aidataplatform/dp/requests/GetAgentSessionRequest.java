...
public class GetAgentSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAgentSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAgentSessionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());sessionId(o.getSessionId());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAgentSessionRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAgentSessionRequest
         */
        public GetAgentSessionRequest build() {
            GetAgentSessionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAgentSessionRequest
         */
        public GetAgentSessionRequest buildWithoutInvocationCallback() {
            GetAgentSessionRequest request = new GetAgentSessionRequest();
            ...
            return request;
            // new GetAgentSessionRequest(aiDataPlatformId, workspaceKey, agentKey, sessionId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAgentSessionRequest)) {
            return false;
        }

        GetAgentSessionRequest other = (GetAgentSessionRequest) o;
