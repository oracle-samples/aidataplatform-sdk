...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteViewRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public DeleteViewRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteViewRequest(aiDataPlatformId, viewKey, displayName, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
