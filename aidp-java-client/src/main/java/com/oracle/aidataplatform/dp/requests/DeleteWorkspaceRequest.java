...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteWorkspaceRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public DeleteWorkspaceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteWorkspaceRequest(aiDataPlatformId, workspaceKey, ifMatch, opcRequestId, timeDataLakeDeletion);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWorkspaceRequest)) {
            return false;
        }
