...
public class ListCatalogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListCatalogsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.CatalogCollection catalogCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListCatalogsResponse> {
