...
public class CloneComputeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CloneComputeRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CloneComputeRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of CloneComputeRequest as configured by this builder
         *
         ...
         *
         * @return instance of CloneComputeRequest
         */
        public CloneComputeRequest build() {
            CloneComputeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CloneComputeRequest
         */
        public CloneComputeRequest buildWithoutInvocationCallback() {
            CloneComputeRequest request = new CloneComputeRequest();
            ...
            return request;
            // new CloneComputeRequest(aiDataPlatformId, workspaceKey, clusterKey, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneComputeRequest)) {
            return false;
        }

        CloneComputeRequest other = (CloneComputeRequest) o;
