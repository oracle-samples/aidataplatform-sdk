...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentGuardrailsSummary.Builder.class)

public final class AgentGuardrailsSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"policyType", "policyName", "policyDescription", "action", "scope", "threshold", "categories"})
    public AgentGuardrailsSummary(PolicyType policyType, String policyName, String policyDescription, PolicyAction action, PolicyScope scope, Float threshold, java.util.List<CategoryConfig> categories) {
        super();
...
public Builder categories(java.util.List<CategoryConfig> categories) {
    ...
    return this;
        ...
        public AgentGuardrailsSummary build() {
            AgentGuardrailsSummary model = new AgentGuardrailsSummary(this.policyType
                , this.policyName
        ...
        public Builder copy(AgentGuardrailsSummary model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentGuardrailsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentGuardrailsSummary)) {
            return false;
        }

        AgentGuardrailsSummary other = (AgentGuardrailsSummary) o;
