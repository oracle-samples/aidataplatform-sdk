...
public class UpdateContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private UpdateContentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String etag, String opcWorkRequestId, String opcRequestId, com.oracle.aidataplatform.dp.model.Content content) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateContentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateContentResponse o) {
        ...
        public UpdateContentResponse build() {
            return new UpdateContentResponse(__httpStatusCode__, headers, location, etag, opcWorkRequestId, opcRequestId, content);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateContentResponse)) {
            return false;
        }

        UpdateContentResponse other = (UpdateContentResponse) o;
