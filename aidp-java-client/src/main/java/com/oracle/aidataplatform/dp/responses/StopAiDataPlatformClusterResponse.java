...
public class StopAiDataPlatformClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private StopAiDataPlatformClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<StopAiDataPlatformClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(StopAiDataPlatformClusterResponse o) {
         ...
         */
        @Override
        public StopAiDataPlatformClusterResponse build() {
            return new StopAiDataPlatformClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopAiDataPlatformClusterResponse)) {
            return false;
        }

        StopAiDataPlatformClusterResponse other = (StopAiDataPlatformClusterResponse) o;
