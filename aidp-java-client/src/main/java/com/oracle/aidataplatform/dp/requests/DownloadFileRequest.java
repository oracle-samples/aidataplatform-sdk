...
public class DownloadFileRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DownloadFileRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadFileRequest o) {
        ...
        /**
         * Build the instance of DownloadFileRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadFileRequest
         */
        public DownloadFileRequest build() {
            DownloadFileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DownloadFileRequest
         */
        public DownloadFileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DownloadFileRequest(aiDataPlatformId, volumeKey, path, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadFileRequest)) {
            return false;
        }

        DownloadFileRequest other = (DownloadFileRequest) o;
