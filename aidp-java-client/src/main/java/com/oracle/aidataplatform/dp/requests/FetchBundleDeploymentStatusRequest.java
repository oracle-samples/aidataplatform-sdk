...
public class FetchBundleDeploymentStatusRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.FetchBundleDeploymentStatusDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<FetchBundleDeploymentStatusRequest, com.oracle.aidataplatform.dp.model.FetchBundleDeploymentStatusDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(FetchBundleDeploymentStatusRequest o) {
        ...
        /**
         * Build the instance of FetchBundleDeploymentStatusRequest as configured by this builder
         *
         ...
         *
         * @return instance of FetchBundleDeploymentStatusRequest
         */
        public FetchBundleDeploymentStatusRequest build() {
            FetchBundleDeploymentStatusRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of FetchBundleDeploymentStatusRequest
         */
        public FetchBundleDeploymentStatusRequest buildWithoutInvocationCallback() {
            FetchBundleDeploymentStatusRequest request = new FetchBundleDeploymentStatusRequest();
            ...
            return request;
            // new FetchBundleDeploymentStatusRequest(aiDataPlatformId, workspaceKey, fetchBundleDeploymentStatusDetails, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FetchBundleDeploymentStatusRequest)) {
            return false;
        }

        FetchBundleDeploymentStatusRequest other = (FetchBundleDeploymentStatusRequest) o;
