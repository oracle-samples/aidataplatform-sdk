...
public class GetUserSettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private GetUserSettingResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.UserSetting userSetting) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetUserSettingResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(GetUserSettingResponse o) {
        ...
        public GetUserSettingResponse build() {
            return new GetUserSettingResponse(__httpStatusCode__, headers, etag, opcRequestId, userSetting);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserSettingResponse)) {
            return false;
        }

        GetUserSettingResponse other = (GetUserSettingResponse) o;
