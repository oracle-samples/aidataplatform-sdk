...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=GoogleBigqueryTable.Builder.class)
...
public final class GoogleBigqueryTable extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public GoogleBigqueryTable build() {
            GoogleBigqueryTable model = new GoogleBigqueryTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(GoogleBigqueryTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleBigqueryTable)) {
            return false;
        }

        GoogleBigqueryTable other = (GoogleBigqueryTable) o;
