...
return this;
    ...
    @Deprecated
    public RagTool(String key, String displayName, String workspaceKey, String description, Float positionX, Float positionY, java.util.Map<String, Object> properties, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, RagToolInputSchema inputSchema, RagToolConfiguration toolConfig) {
