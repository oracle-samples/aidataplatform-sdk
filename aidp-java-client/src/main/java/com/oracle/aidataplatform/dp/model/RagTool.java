...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RagTool.Builder.class)
...
public final class RagTool extends Tool {
...
public Builder toolConfig(RagToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public RagTool build() {
            RagTool model = new RagTool(this.key
                , this.displayName
                , this.workspaceKey
                , this.description
                , this.isReference
        ...
        public Builder copy(RagTool model) {
...
return this;
    ...
    @Deprecated
    public RagTool(String key, String displayName, String workspaceKey, String description, Boolean isReference, Float positionX, Float positionY, java.util.Map<String, Object> properties, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, RagToolInputSchema inputSchema, RagToolConfiguration toolConfig) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RagTool)) {
            return false;
        }

        RagTool other = (RagTool) o;
