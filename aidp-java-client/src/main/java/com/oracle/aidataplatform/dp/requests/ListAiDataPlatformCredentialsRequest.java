...
public class ListAiDataPlatformCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     ...
     */
    private com.oracle.aidataplatform.dp.model.CredentialType credentialType;
     ...
     * The type of the Credential
     */
    public com.oracle.aidataplatform.dp.model.CredentialType getCredentialType() {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformCredentialsRequest, java.lang.Void> {
...
* 
     ...
     * The type of the Credential
     */
        private com.oracle.aidataplatform.dp.model.CredentialType credentialType = null;
         ...
         * @return this builder instance
         */
        public Builder credentialType(com.oracle.aidataplatform.dp.model.CredentialType credentialType) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformCredentialsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());displayName(o.getDisplayName());displayNameContains(o.getDisplayNameContains());lifecycleState(o.getLifecycleState());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());credentialType(o.getCredentialType());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformCredentialsRequest
         */
        public ListAiDataPlatformCredentialsRequest build() {
            ListAiDataPlatformCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformCredentialsRequest
         */
        public ListAiDataPlatformCredentialsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformCredentialsRequest request = new ListAiDataPlatformCredentialsRequest();
            ...
            return request;
            // new ListAiDataPlatformCredentialsRequest(aiDataPlatformId, displayName, displayNameContains, lifecycleState, limit, page, sortOrder, sortBy, credentialType, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformCredentialsRequest)) {
            return false;
        }

        ListAiDataPlatformCredentialsRequest other = (ListAiDataPlatformCredentialsRequest) o;
