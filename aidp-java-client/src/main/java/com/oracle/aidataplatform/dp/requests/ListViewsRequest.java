...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListViewsRequest, java.lang.Void> {
...
* 
        ...
        public ListViewsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListViewsRequest(aiDataPlatformId, catalogKey, schemaKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
