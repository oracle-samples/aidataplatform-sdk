...
public class RestartClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RestartClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RestartClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RestartClusterResponse o) {
        ...
        public RestartClusterResponse build() {
            return new RestartClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartClusterResponse)) {
            return false;
        }

        RestartClusterResponse other = (RestartClusterResponse) o;
