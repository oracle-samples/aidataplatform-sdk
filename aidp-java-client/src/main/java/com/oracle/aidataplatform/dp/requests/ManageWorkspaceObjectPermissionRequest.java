...
public class ManageWorkspaceObjectPermissionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ManageWorkspaceObjectPermissionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ManageWorkspaceObjectPermissionRequest, com.oracle.aidataplatform.dp.model.ManageWorkspaceObjectPermissionDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ManageWorkspaceObjectPermissionRequest o) {
        ...
        /**
         * Build the instance of ManageWorkspaceObjectPermissionRequest as configured by this builder
         *
         ...
         *
         * @return instance of ManageWorkspaceObjectPermissionRequest
         */
        public ManageWorkspaceObjectPermissionRequest build() {
            ManageWorkspaceObjectPermissionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ManageWorkspaceObjectPermissionRequest
         */
        public ManageWorkspaceObjectPermissionRequest buildWithoutInvocationCallback() {
            ManageWorkspaceObjectPermissionRequest request = new ManageWorkspaceObjectPermissionRequest();
            ...
            return request;
            // new ManageWorkspaceObjectPermissionRequest(aiDataPlatformId, workspaceKey, objectKey, manageWorkspaceObjectPermissionDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManageWorkspaceObjectPermissionRequest)) {
            return false;
        }

        ManageWorkspaceObjectPermissionRequest other = (ManageWorkspaceObjectPermissionRequest) o;
