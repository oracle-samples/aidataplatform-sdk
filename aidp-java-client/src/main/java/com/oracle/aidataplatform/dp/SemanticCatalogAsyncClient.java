...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
    ...
    public java.util.concurrent.Future<ExportLineageResponse> exportLineage(ExportLineageRequest request, final com.oracle.bmc.responses.AsyncHandler<ExportLineageRequest, ExportLineageResponse> handler) {
...
.callAsync(handler);
    ...
    public java.util.concurrent.Future<FetchEntityLineageResponse> fetchEntityLineage(FetchEntityLineageRequest request, final com.oracle.bmc.responses.AsyncHandler<FetchEntityLineageRequest, FetchEntityLineageResponse> handler) {
