...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramAgentNode.Builder.class)
...
public final class AgentDiagramAgentNode extends AgentDiagramNode {
...
public Builder toolReferences(java.util.List<String> toolReferences) {
    ...
    return this;
        ...
        public AgentDiagramAgentNode build() {
            AgentDiagramAgentNode model = new AgentDiagramAgentNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramAgentNode model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramAgentNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramAgentNode)) {
            return false;
        }

        AgentDiagramAgentNode other = (AgentDiagramAgentNode) o;
