...
public class ListAiDataPlatformShareRecipientsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformShareRecipientsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformShareRecipientsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());shareKey(o.getShareKey());displayName(o.getDisplayName());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformShareRecipientsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformShareRecipientsRequest
         */
        public ListAiDataPlatformShareRecipientsRequest build() {
            ListAiDataPlatformShareRecipientsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformShareRecipientsRequest
         */
        public ListAiDataPlatformShareRecipientsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformShareRecipientsRequest request = new ListAiDataPlatformShareRecipientsRequest();
            ...
            return request;
            // new ListAiDataPlatformShareRecipientsRequest(aiDataPlatformId, shareKey, displayName, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformShareRecipientsRequest)) {
            return false;
        }

        ListAiDataPlatformShareRecipientsRequest other = (ListAiDataPlatformShareRecipientsRequest) o;
