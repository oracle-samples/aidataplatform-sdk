...
public class ListAiDataPlatformVolumePermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformVolumePermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformVolumePermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());volumeKey(o.getVolumeKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformVolumePermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformVolumePermissionsRequest
         */
        public ListAiDataPlatformVolumePermissionsRequest build() {
            ListAiDataPlatformVolumePermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformVolumePermissionsRequest
         */
        public ListAiDataPlatformVolumePermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformVolumePermissionsRequest request = new ListAiDataPlatformVolumePermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformVolumePermissionsRequest(aiDataPlatformId, volumeKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformVolumePermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformVolumePermissionsRequest other = (ListAiDataPlatformVolumePermissionsRequest) o;
