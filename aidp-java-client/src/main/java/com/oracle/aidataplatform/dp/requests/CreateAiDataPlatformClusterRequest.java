...
public class CreateAiDataPlatformClusterRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateClusterDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.CreateClusterDetails createClusterDetails;
     ...
     * Details for the new cluster.
     */
    public com.oracle.aidataplatform.dp.model.CreateClusterDetails getCreateClusterDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateClusterDetails getBody$() {
        return createClusterDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformClusterRequest, com.oracle.aidataplatform.dp.model.CreateClusterDetails> {
     ...
     * Details for the new cluster.
     */
        private com.oracle.aidataplatform.dp.model.CreateClusterDetails createClusterDetails = null;
         ...
         * @return this builder instance
         */
        public Builder createClusterDetails(com.oracle.aidataplatform.dp.model.CreateClusterDetails createClusterDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformClusterRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createClusterDetails(o.getCreateClusterDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CreateAiDataPlatformClusterRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformClusterRequest
         */
        public CreateAiDataPlatformClusterRequest build() {
            CreateAiDataPlatformClusterRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateClusterDetails body) {
         ...
         * @return instance of CreateAiDataPlatformClusterRequest
         */
        public CreateAiDataPlatformClusterRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformClusterRequest request = new CreateAiDataPlatformClusterRequest();
            ...
            return request;
            // new CreateAiDataPlatformClusterRequest(aiDataPlatformId, workspaceKey, createClusterDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformClusterRequest)) {
            return false;
        }

        CreateAiDataPlatformClusterRequest other = (CreateAiDataPlatformClusterRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createClusterDetails == null ? 43 : this.createClusterDetails.hashCode());
