...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramMcpToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramMcpToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
private McpToolConfiguration toolConfig;



public Builder toolConfig(McpToolConfiguration toolConfig) {
    this.toolConfig = toolConfig;
    return this;
}


        public CreateAgentDiagramMcpToolNodeDetails build() {
            CreateAgentDiagramMcpToolNodeDetails model = new CreateAgentDiagramMcpToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramMcpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramMcpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, McpToolConfiguration toolConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("toolConfig")
    private final McpToolConfiguration toolConfig;

    
    public McpToolConfiguration getToolConfig() {
        return toolConfig;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramMcpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramMcpToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramMcpToolNodeDetails other = (CreateAgentDiagramMcpToolNodeDetails) o;
