...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AsyncOperation.Builder.class)
...
public Builder errorMessage(String errorMessage) {
    ...
    return this;
        ...
        public AsyncOperation build() {
            AsyncOperation model = new AsyncOperation(this.key
                , this.resourceType
                , this.actionType
                , this.resourceName
        ...
        public Builder copy(AsyncOperation model) {
...
* 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AsyncOperation)) {
            return false;
        }

        AsyncOperation other = (AsyncOperation) o;
