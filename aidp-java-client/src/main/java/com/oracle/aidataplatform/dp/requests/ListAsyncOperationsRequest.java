...
public class ListAsyncOperationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAsyncOperationsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAsyncOperationsRequest o) {
        ...
        /**
         * Build the instance of ListAsyncOperationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAsyncOperationsRequest
         */
        public ListAsyncOperationsRequest build() {
            ListAsyncOperationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAsyncOperationsRequest
         */
        public ListAsyncOperationsRequest buildWithoutInvocationCallback() {
            ListAsyncOperationsRequest request = new ListAsyncOperationsRequest();
            ...
            return request;
            // new ListAsyncOperationsRequest(aiDataPlatformId, resourceType, resourceName, matchResourceName, status, shouldFilterByCallingPrincipal, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAsyncOperationsRequest)) {
            return false;
        }

        ListAsyncOperationsRequest other = (ListAsyncOperationsRequest) o;
