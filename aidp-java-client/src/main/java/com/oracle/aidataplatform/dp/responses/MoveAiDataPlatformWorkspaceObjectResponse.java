...
public class MoveAiDataPlatformWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private MoveAiDataPlatformWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.WorkspaceObjectDetails workspaceObjectDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<MoveAiDataPlatformWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(MoveAiDataPlatformWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public MoveAiDataPlatformWorkspaceObjectResponse build() {
            return new MoveAiDataPlatformWorkspaceObjectResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, workspaceObjectDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MoveAiDataPlatformWorkspaceObjectResponse)) {
            return false;
        }

        MoveAiDataPlatformWorkspaceObjectResponse other = (MoveAiDataPlatformWorkspaceObjectResponse) o;
