...
public class CreateBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateBundleResponse o) {
        ...
        public CreateBundleResponse build() {
            return new CreateBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBundleResponse)) {
            return false;
        }

        CreateBundleResponse other = (CreateBundleResponse) o;
