...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateCustomToolDetails.Builder.class)
...
public final class CreateCustomToolDetails extends CreateToolDetails {
...
public Builder toolConfig(CustomToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateCustomToolDetails build() {
            CreateCustomToolDetails model = new CreateCustomToolDetails(this.displayName
                , this.description
                , this.properties
                , this.toolProvider
                , this.toolTypeName
        ...
        public Builder copy(CreateCustomToolDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateCustomToolDetails(String displayName, String description, java.util.Map<String, Object> properties, String toolProvider, String toolTypeName, java.util.Map<String, Object> inputSchema, CustomToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCustomToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCustomToolDetails)) {
            return false;
        }

        CreateCustomToolDetails other = (CreateCustomToolDetails) o;
