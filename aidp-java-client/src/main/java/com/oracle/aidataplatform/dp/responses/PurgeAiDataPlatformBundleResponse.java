...
public class PurgeAiDataPlatformBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PurgeAiDataPlatformBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PurgeAiDataPlatformBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PurgeAiDataPlatformBundleResponse o) {
         ...
         */
        @Override
        public PurgeAiDataPlatformBundleResponse build() {
            return new PurgeAiDataPlatformBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurgeAiDataPlatformBundleResponse)) {
            return false;
        }

        PurgeAiDataPlatformBundleResponse other = (PurgeAiDataPlatformBundleResponse) o;
