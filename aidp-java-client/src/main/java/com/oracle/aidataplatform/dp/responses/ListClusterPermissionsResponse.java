...
public class ListClusterPermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ListClusterPermissionsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.ClusterPermissionCollection clusterPermissionCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListClusterPermissionsResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ListClusterPermissionsResponse o) {
         ...
         */
        @Override
        public ListClusterPermissionsResponse build() {
            return new ListClusterPermissionsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, clusterPermissionCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListClusterPermissionsResponse)) {
            return false;
        }

        ListClusterPermissionsResponse other = (ListClusterPermissionsResponse) o;
