...
public class GitServiceAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient implements GitServiceAsync {
    /**
...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
         ...
         * @return the client
         */
        public GitServiceAsyncClient build(@jakarta.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            return new GitServiceAsyncClient(this, authenticationDetailsProvider);
        }
    }
