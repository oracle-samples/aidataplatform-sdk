...
public class GetAgentDeploymentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAgentDeploymentRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAgentDeploymentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());agentDeploymentKey(o.getAgentDeploymentKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAgentDeploymentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAgentDeploymentRequest
         */
        public GetAgentDeploymentRequest build() {
            GetAgentDeploymentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAgentDeploymentRequest
         */
        public GetAgentDeploymentRequest buildWithoutInvocationCallback() {
            GetAgentDeploymentRequest request = new GetAgentDeploymentRequest();
            ...
            return request;
            // new GetAgentDeploymentRequest(aiDataPlatformId, workspaceKey, agentKey, agentDeploymentKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAgentDeploymentRequest)) {
            return false;
        }

        GetAgentDeploymentRequest other = (GetAgentDeploymentRequest) o;
