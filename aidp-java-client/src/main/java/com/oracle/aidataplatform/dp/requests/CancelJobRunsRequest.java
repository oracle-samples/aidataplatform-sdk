...
public class CancelJobRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CancelJobRunsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CancelJobRunsRequest o) {
        ...
        /**
         * Build the instance of CancelJobRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelJobRunsRequest
         */
        public CancelJobRunsRequest build() {
            CancelJobRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CancelJobRunsRequest
         */
        public CancelJobRunsRequest buildWithoutInvocationCallback() {
            CancelJobRunsRequest request = new CancelJobRunsRequest();
            ...
            return request;
            // new CancelJobRunsRequest(aiDataPlatformId, workspaceKey, jobKey, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelJobRunsRequest)) {
            return false;
        }

        CancelJobRunsRequest other = (CancelJobRunsRequest) o;
