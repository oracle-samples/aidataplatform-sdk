...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramPromptToolNode.Builder.class)
...
public final class AgentDiagramPromptToolNode extends AgentDiagramNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramPromptToolNode build() {
            AgentDiagramPromptToolNode model = new AgentDiagramPromptToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramPromptToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramPromptToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramPromptToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramPromptToolNode)) {
            return false;
        }

        AgentDiagramPromptToolNode other = (AgentDiagramPromptToolNode) o;
