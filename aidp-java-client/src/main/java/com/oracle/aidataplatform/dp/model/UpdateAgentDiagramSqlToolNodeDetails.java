...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramSqlToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramSqlToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public UpdateAgentDiagramSqlToolNodeDetails build() {
            UpdateAgentDiagramSqlToolNodeDetails model = new UpdateAgentDiagramSqlToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramSqlToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramSqlToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramSqlToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramSqlToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramSqlToolNodeDetails other = (UpdateAgentDiagramSqlToolNodeDetails) o;
