...
* 
    ...
    private CreateSessionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String etag, String opcRequestId, String opcWorkRequestId, com.oracle.aidataplatform.dp.model.Session session) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSessionResponse> {
...
* 
        ...
        public CreateSessionResponse build() {
            return new CreateSessionResponse(__httpStatusCode__, headers, location, etag, opcRequestId, opcWorkRequestId, session);
        }
    }
