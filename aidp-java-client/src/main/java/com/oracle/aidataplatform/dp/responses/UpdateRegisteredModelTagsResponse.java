...
public class UpdateRegisteredModelTagsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code UpdateRegisteredModelTagsResponseDetails} instance.
     */
    ...
    private UpdateRegisteredModelTagsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsResponseDetails updateRegisteredModelTagsResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRegisteredModelTagsResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateRegisteredModelTagsResponse o) {
         ...
         */
        @Override
        public UpdateRegisteredModelTagsResponse build() {
            return new UpdateRegisteredModelTagsResponse(__httpStatusCode__, headers, etag, opcRequestId, updateRegisteredModelTagsResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRegisteredModelTagsResponse)) {
            return false;
        }

        UpdateRegisteredModelTagsResponse other = (UpdateRegisteredModelTagsResponse) o;
