...
public class ModifyContentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ModifyContentDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ModifyContentRequest, com.oracle.aidataplatform.dp.model.ModifyContentDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ModifyContentRequest o) {
        ...
        /**
         * Build the instance of ModifyContentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ModifyContentRequest
         */
        public ModifyContentRequest build() {
            ModifyContentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ModifyContentRequest
         */
        public ModifyContentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ModifyContentRequest(aiDataPlatformId, workspaceKey, contentPath, modifyContentDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModifyContentRequest)) {
            return false;
        }

        ModifyContentRequest other = (ModifyContentRequest) o;
