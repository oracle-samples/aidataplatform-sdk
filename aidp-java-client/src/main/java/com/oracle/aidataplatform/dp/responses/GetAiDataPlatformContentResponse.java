...
public class GetAiDataPlatformContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private GetAiDataPlatformContentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, java.util.Date lastModified, com.oracle.aidataplatform.dp.model.Content content) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetAiDataPlatformContentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(GetAiDataPlatformContentResponse o) {
         ...
         */
        @Override
        public GetAiDataPlatformContentResponse build() {
            return new GetAiDataPlatformContentResponse(__httpStatusCode__, headers, etag, opcRequestId, lastModified, content);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformContentResponse)) {
            return false;
        }

        GetAiDataPlatformContentResponse other = (GetAiDataPlatformContentResponse) o;
