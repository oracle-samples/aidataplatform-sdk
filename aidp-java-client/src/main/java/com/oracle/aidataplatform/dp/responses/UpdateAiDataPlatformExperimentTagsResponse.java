...
public class UpdateAiDataPlatformExperimentTagsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private UpdateAiDataPlatformExperimentTagsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.UpdateExperimentTagsResponseDetails updateExperimentTagsResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateAiDataPlatformExperimentTagsResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateAiDataPlatformExperimentTagsResponse o) {
         ...
         */
        @Override
        public UpdateAiDataPlatformExperimentTagsResponse build() {
            return new UpdateAiDataPlatformExperimentTagsResponse(__httpStatusCode__, headers, etag, opcRequestId, updateExperimentTagsResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformExperimentTagsResponse)) {
            return false;
        }

        UpdateAiDataPlatformExperimentTagsResponse other = (UpdateAiDataPlatformExperimentTagsResponse) o;
