...
public class AuditAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient implements AuditAsync {
    /**
     * Service instance for Audit.
     */
    public static final com.oracle.bmc.Service SERVICE = com.oracle.bmc.Services.serviceBuilder().serviceName("AUDIT").serviceEndpointPrefix("datahub-dp").serviceEndpointTemplate("https://datalake.{region}.oci.{secondLevelDomain}").build();

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(AuditAsyncClient.class);
     ...
     */
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, AuditAsyncClient> {
...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
         ...
         * @return the client
         */
        public AuditAsyncClient build(@jakarta.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
...
return clientCall(request, ManageAiDataPlatformAuditLogsResponse::builder)
        ...
        .basePath("/20260430")
        .appendPathParam("aiDataPlatforms").appendPathParam(request.getAiDataPlatformId()).appendPathParam("actions").appendPathParam("manageAuditLogs")
...
return clientCall(request, SearchAiDataPlatformAuditLogsResponse::builder)
        ...
        .basePath("/20260430")
        .appendPathParam("aiDataPlatforms").appendPathParam(request.getAiDataPlatformId()).appendPathParam("actions").appendPathParam("searchAuditLogs")
...
.callAsync(handler);
     ...
     */
    @Deprecated
    public AuditAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider) {
        this(
            builder(),
            authenticationDetailsProvider
        );
     ...
     */
    @Deprecated
    public AuditAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration) {
        this(
            builder()
     ...
     */
    @Deprecated
    public AuditAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration, com.oracle.bmc.http.ClientConfigurator clientConfigurator) {
        this(
            builder()
                .configuration(configuration)
