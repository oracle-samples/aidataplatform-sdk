...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramPromptToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramPromptToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public UpdateAgentDiagramPromptToolNodeDetails build() {
            UpdateAgentDiagramPromptToolNodeDetails model = new UpdateAgentDiagramPromptToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramPromptToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramPromptToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramPromptToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramPromptToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramPromptToolNodeDetails other = (UpdateAgentDiagramPromptToolNodeDetails) o;
