...
public class UpdateRegisteredModelRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateRegisteredModelDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateRegisteredModelRequest, com.oracle.aidataplatform.dp.model.UpdateRegisteredModelDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateRegisteredModelRequest o) {
        ...
        /**
         * Build the instance of UpdateRegisteredModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateRegisteredModelRequest
         */
        public UpdateRegisteredModelRequest build() {
            UpdateRegisteredModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateRegisteredModelRequest
         */
        public UpdateRegisteredModelRequest buildWithoutInvocationCallback() {
            UpdateRegisteredModelRequest request = new UpdateRegisteredModelRequest();
            ...
            return request;
            // new UpdateRegisteredModelRequest(aiDataPlatformId, updateRegisteredModelDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRegisteredModelRequest)) {
            return false;
        }

        UpdateRegisteredModelRequest other = (UpdateRegisteredModelRequest) o;
