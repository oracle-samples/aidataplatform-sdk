...
public class GetComputeConfigurationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetComputeConfigurationRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetComputeConfigurationRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetComputeConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetComputeConfigurationRequest
         */
        public GetComputeConfigurationRequest build() {
            GetComputeConfigurationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetComputeConfigurationRequest
         */
        public GetComputeConfigurationRequest buildWithoutInvocationCallback() {
            GetComputeConfigurationRequest request = new GetComputeConfigurationRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.clusterKey = clusterKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetComputeConfigurationRequest(aiDataPlatformId, workspaceKey, clusterKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetComputeConfigurationRequest)) {
            return false;
        }

        GetComputeConfigurationRequest other = (GetComputeConfigurationRequest) o;
