...
public class MergeAiDataPlatformGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private MergeAiDataPlatformGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<MergeAiDataPlatformGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(MergeAiDataPlatformGitRepositoryResponse o) {
         ...
         */
        @Override
        public MergeAiDataPlatformGitRepositoryResponse build() {
            return new MergeAiDataPlatformGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MergeAiDataPlatformGitRepositoryResponse)) {
            return false;
        }

        MergeAiDataPlatformGitRepositoryResponse other = (MergeAiDataPlatformGitRepositoryResponse) o;
