...
public class PatchAiDataPlatformClusterLibraryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PatchAiDataPlatformClusterLibraryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String aidpAsyncOperationKey, String opcRequestId, com.oracle.aidataplatform.dp.model.ClusterLibraryCollection clusterLibraryCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PatchAiDataPlatformClusterLibraryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PatchAiDataPlatformClusterLibraryResponse o) {
         ...
         */
        @Override
        public PatchAiDataPlatformClusterLibraryResponse build() {
            return new PatchAiDataPlatformClusterLibraryResponse(__httpStatusCode__, headers, etag, aidpAsyncOperationKey, opcRequestId, clusterLibraryCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAiDataPlatformClusterLibraryResponse)) {
            return false;
        }

        PatchAiDataPlatformClusterLibraryResponse other = (PatchAiDataPlatformClusterLibraryResponse) o;
