...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SnowflakeSchema.Builder.class)
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public SnowflakeSchema build() {
            SnowflakeSchema model = new SnowflakeSchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(SnowflakeSchema model) {
...
return this;
    ...
    @Deprecated
    public SnowflakeSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnowflakeSchema)) {
            return false;
        }

        SnowflakeSchema other = (SnowflakeSchema) o;
