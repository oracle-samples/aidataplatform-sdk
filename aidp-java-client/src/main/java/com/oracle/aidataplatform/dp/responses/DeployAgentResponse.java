...
public class DeployAgentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     * URI for the created Agent deployment.
     */
...
* 
    ...
    private DeployAgentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String etag, String aidpAsyncOperationKey, String opcRequestId, com.oracle.aidataplatform.dp.model.AgentDeployment agentDeployment) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeployAgentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeployAgentResponse o) {
         ...
         */
        @Override
        public DeployAgentResponse build() {
            return new DeployAgentResponse(__httpStatusCode__, headers, location, contentLocation, etag, aidpAsyncOperationKey, opcRequestId, agentDeployment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployAgentResponse)) {
            return false;
        }

        DeployAgentResponse other = (DeployAgentResponse) o;
