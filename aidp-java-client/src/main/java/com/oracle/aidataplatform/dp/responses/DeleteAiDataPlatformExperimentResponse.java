...
public class DeleteAiDataPlatformExperimentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code DeleteExperimentResponseDetails} instance.
     */
    ...
    private DeleteAiDataPlatformExperimentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.DeleteExperimentResponseDetails deleteExperimentResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteAiDataPlatformExperimentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeleteAiDataPlatformExperimentResponse o) {
         ...
         */
        @Override
        public DeleteAiDataPlatformExperimentResponse build() {
            return new DeleteAiDataPlatformExperimentResponse(__httpStatusCode__, headers, etag, opcRequestId, deleteExperimentResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformExperimentResponse)) {
            return false;
        }

        DeleteAiDataPlatformExperimentResponse other = (DeleteAiDataPlatformExperimentResponse) o;
