...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramHttpToolNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramHttpToolNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public UpdateAgentDiagramHttpToolNodeDetails build() {
            UpdateAgentDiagramHttpToolNodeDetails model = new UpdateAgentDiagramHttpToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramHttpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAgentDiagramHttpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramHttpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramHttpToolNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramHttpToolNodeDetails other = (UpdateAgentDiagramHttpToolNodeDetails) o;
