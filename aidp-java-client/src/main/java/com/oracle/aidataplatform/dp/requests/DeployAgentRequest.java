...
public class DeployAgentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeployAgentDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.DeployAgentDetails getBody$() {
        return deployAgentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeployAgentRequest, com.oracle.aidataplatform.dp.model.DeployAgentDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder deployAgentDetails(com.oracle.aidataplatform.dp.model.DeployAgentDetails deployAgentDetails) {
            this.deployAgentDetails = deployAgentDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeployAgentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());deployAgentDetails(o.getDeployAgentDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of DeployAgentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeployAgentRequest
         */
        public DeployAgentRequest build() {
            DeployAgentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.DeployAgentDetails body) {
            deployAgentDetails(body);
            return this;
        }
         ...
         * @return instance of DeployAgentRequest
         */
        public DeployAgentRequest buildWithoutInvocationCallback() {
            DeployAgentRequest request = new DeployAgentRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.agentKey = agentKey;
            request.deployAgentDetails = deployAgentDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeployAgentRequest(aiDataPlatformId, workspaceKey, agentKey, deployAgentDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",deployAgentDetails=").append(String.valueOf(this.deployAgentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployAgentRequest)) {
            return false;
        }

        DeployAgentRequest other = (DeployAgentRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.deployAgentDetails, other.deployAgentDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.deployAgentDetails == null ? 43 : this.deployAgentDetails.hashCode());
