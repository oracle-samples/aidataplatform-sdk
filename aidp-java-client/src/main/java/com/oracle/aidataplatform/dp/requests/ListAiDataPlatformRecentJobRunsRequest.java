...
public class ListAiDataPlatformRecentJobRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformRecentJobRunsRequest, java.lang.Void> {
     ...
     */
        ...
        /**
         * The number of records to fetch.
         * @param recordCount the value to set
         * @return this builder instance
         */
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformRecentJobRunsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobKey(o.getJobKey());recordCount(o.getRecordCount());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformRecentJobRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformRecentJobRunsRequest
         */
        public ListAiDataPlatformRecentJobRunsRequest build() {
            ListAiDataPlatformRecentJobRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformRecentJobRunsRequest
         */
        public ListAiDataPlatformRecentJobRunsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformRecentJobRunsRequest request = new ListAiDataPlatformRecentJobRunsRequest();
            ...
            return request;
            // new ListAiDataPlatformRecentJobRunsRequest(aiDataPlatformId, workspaceKey, jobKey, recordCount, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",recordCount=").append(String.valueOf(this.recordCount));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformRecentJobRunsRequest)) {
            return false;
        }

        ListAiDataPlatformRecentJobRunsRequest other = (ListAiDataPlatformRecentJobRunsRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.recordCount, other.recordCount)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.recordCount == null ? 43 : this.recordCount.hashCode());
