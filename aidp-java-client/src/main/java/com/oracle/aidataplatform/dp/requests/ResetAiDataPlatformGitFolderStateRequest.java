...
public class ResetAiDataPlatformGitFolderStateRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails getBody$() {
        return resetGitFolderStateDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ResetAiDataPlatformGitFolderStateRequest, com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder resetGitFolderStateDetails(com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails resetGitFolderStateDetails) {
            this.resetGitFolderStateDetails = resetGitFolderStateDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ResetAiDataPlatformGitFolderStateRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());resetGitFolderStateDetails(o.getResetGitFolderStateDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of ResetAiDataPlatformGitFolderStateRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResetAiDataPlatformGitFolderStateRequest
         */
        public ResetAiDataPlatformGitFolderStateRequest build() {
            ResetAiDataPlatformGitFolderStateRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails body) {
            resetGitFolderStateDetails(body);
            return this;
        }
         ...
         * @return instance of ResetAiDataPlatformGitFolderStateRequest
         */
        public ResetAiDataPlatformGitFolderStateRequest buildWithoutInvocationCallback() {
            ResetAiDataPlatformGitFolderStateRequest request = new ResetAiDataPlatformGitFolderStateRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.resetGitFolderStateDetails = resetGitFolderStateDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new ResetAiDataPlatformGitFolderStateRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, resetGitFolderStateDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",resetGitFolderStateDetails=").append(String.valueOf(this.resetGitFolderStateDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetAiDataPlatformGitFolderStateRequest)) {
            return false;
        }

        ResetAiDataPlatformGitFolderStateRequest other = (ResetAiDataPlatformGitFolderStateRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.resetGitFolderStateDetails, other.resetGitFolderStateDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.resetGitFolderStateDetails == null ? 43 : this.resetGitFolderStateDetails.hashCode());
