...
public class DeleteVolumeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteVolumeRequest, java.lang.Void> {
...
* 
        ...
        /**
         * Build the instance of DeleteVolumeRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteVolumeRequest
         */
        public DeleteVolumeRequest build() {
            DeleteVolumeRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteVolumeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteVolumeRequest(aiDataPlatformId, volumeKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVolumeRequest)) {
            return false;
        }

        DeleteVolumeRequest other = (DeleteVolumeRequest) o;
