...
public class CreateVolumeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateVolumeResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String etag, String opcWorkRequestId, String opcRequestId, com.oracle.aidataplatform.dp.model.Volume volume) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateVolumeResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateVolumeResponse o) {
        ...
        public CreateVolumeResponse build() {
            return new CreateVolumeResponse(__httpStatusCode__, headers, location, contentLocation, etag, opcWorkRequestId, opcRequestId, volume);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeResponse)) {
            return false;
        }

        CreateVolumeResponse other = (CreateVolumeResponse) o;
