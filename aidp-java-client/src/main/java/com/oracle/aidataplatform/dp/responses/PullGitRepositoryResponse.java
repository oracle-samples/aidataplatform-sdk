...
public class PullGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PullGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PullGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PullGitRepositoryResponse o) {
         ...
         */
        @Override
        public PullGitRepositoryResponse build() {
            return new PullGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PullGitRepositoryResponse)) {
            return false;
        }

        PullGitRepositoryResponse other = (PullGitRepositoryResponse) o;
