...
public class ListJobsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListJobsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, String opcPrevPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.JobCollection jobCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListJobsResponse> {
        ...
        public ListJobsResponse build() {
            return new ListJobsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, opcPrevPage, opcTotalItems, jobCollection);
        }
    }
