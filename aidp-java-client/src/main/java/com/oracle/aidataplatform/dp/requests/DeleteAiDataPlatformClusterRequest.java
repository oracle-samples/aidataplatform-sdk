...
public class DeleteAiDataPlatformClusterRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformClusterRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformClusterRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformClusterRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformClusterRequest
         */
        public DeleteAiDataPlatformClusterRequest build() {
            DeleteAiDataPlatformClusterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformClusterRequest
         */
        public DeleteAiDataPlatformClusterRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformClusterRequest request = new DeleteAiDataPlatformClusterRequest();
            ...
            return request;
            // new DeleteAiDataPlatformClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformClusterRequest)) {
            return false;
        }

        DeleteAiDataPlatformClusterRequest other = (DeleteAiDataPlatformClusterRequest) o;
