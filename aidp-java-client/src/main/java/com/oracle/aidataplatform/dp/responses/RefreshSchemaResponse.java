...
public class RefreshSchemaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshSchemaResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshSchemaResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshSchemaResponse o) {
         ...
         */
        @Override
        public RefreshSchemaResponse build() {
            return new RefreshSchemaResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshSchemaResponse)) {
            return false;
        }

        RefreshSchemaResponse other = (RefreshSchemaResponse) o;
