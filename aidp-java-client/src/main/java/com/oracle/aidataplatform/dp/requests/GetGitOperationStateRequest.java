...
public class GetGitOperationStateRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetGitOperationStateRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetGitOperationStateRequest o) {
        ...
        /**
         * Build the instance of GetGitOperationStateRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetGitOperationStateRequest
         */
        public GetGitOperationStateRequest build() {
            GetGitOperationStateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetGitOperationStateRequest
         */
        public GetGitOperationStateRequest buildWithoutInvocationCallback() {
            GetGitOperationStateRequest request = new GetGitOperationStateRequest();
            ...
            return request;
            // new GetGitOperationStateRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, operationName, branchName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGitOperationStateRequest)) {
            return false;
        }

        GetGitOperationStateRequest other = (GetGitOperationStateRequest) o;
