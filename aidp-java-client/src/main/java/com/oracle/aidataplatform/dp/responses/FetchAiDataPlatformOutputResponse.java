...
* 
    ...
    private FetchAiDataPlatformOutputResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.TaskRunOutput taskRunOutput) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<FetchAiDataPlatformOutputResponse> {
