...
public class DeleteJobRunRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteJobRunRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteJobRunRequest o) {
        ...
        /**
         * Build the instance of DeleteJobRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteJobRunRequest
         */
        public DeleteJobRunRequest build() {
            DeleteJobRunRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteJobRunRequest
         */
        public DeleteJobRunRequest buildWithoutInvocationCallback() {
            DeleteJobRunRequest request = new DeleteJobRunRequest();
            ...
            return request;
            // new DeleteJobRunRequest(aiDataPlatformId, workspaceKey, jobRunKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteJobRunRequest)) {
            return false;
        }

        DeleteJobRunRequest other = (DeleteJobRunRequest) o;
