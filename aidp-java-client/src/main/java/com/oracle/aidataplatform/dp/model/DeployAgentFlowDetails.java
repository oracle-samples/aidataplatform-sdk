...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=DeployAgentFlowDetails.Builder.class)

public final class DeployAgentFlowDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "description", "agentFlowComputeKey", "agentFlowKey", "deploymentType", "sessionRetentionConfig", "oAuthConfig"})
    public DeployAgentFlowDetails(String displayName, String description, String agentFlowComputeKey, String agentFlowKey, DeploymentType deploymentType, SessionRetentionConfiguration sessionRetentionConfig, OAuthConfiguration oAuthConfig) {
        super();
...
public Builder oAuthConfig(OAuthConfiguration oAuthConfig) {
    ...
    return this;
        ...
        public DeployAgentFlowDetails build() {
            DeployAgentFlowDetails model = new DeployAgentFlowDetails(this.displayName
                , this.description
        ...
        public Builder copy(DeployAgentFlowDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployAgentFlowDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployAgentFlowDetails)) {
            return false;
        }

        DeployAgentFlowDetails other = (DeployAgentFlowDetails) o;
