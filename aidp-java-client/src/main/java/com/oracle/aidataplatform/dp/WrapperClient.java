...
public class WrapperClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Wrapper {
    /**
...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
         ...
         * @return the client
         */
        public WrapperClient build(@jakarta.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            return new WrapperClient(this, authenticationDetailsProvider);
        }
    }
