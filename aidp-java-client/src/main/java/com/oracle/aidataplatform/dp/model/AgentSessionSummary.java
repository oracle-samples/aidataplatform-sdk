...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentSessionSummary.Builder.class)

public final class AgentSessionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "key", "agentKey", "lifecycleState", "agentComputeKey", "endpointUrl", "timeCreated", "createdBy", "timeStarted", "timeEnded", "duration", "tokens"})
    public AgentSessionSummary(String displayName, String key, String agentKey, DeploymentLifecycleState lifecycleState, String agentComputeKey, String endpointUrl, java.util.Date timeCreated, String createdBy, java.util.Date timeStarted, java.util.Date timeEnded, Float duration, Long tokens) {
        super();
...
public Builder tokens(Long tokens) {
    ...
    return this;
        ...
        public AgentSessionSummary build() {
            AgentSessionSummary model = new AgentSessionSummary(this.displayName
                , this.key
                , this.agentKey
                , this.lifecycleState
        ...
        public Builder copy(AgentSessionSummary model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentSessionSummary)) {
            return false;
        }

        AgentSessionSummary other = (AgentSessionSummary) o;
