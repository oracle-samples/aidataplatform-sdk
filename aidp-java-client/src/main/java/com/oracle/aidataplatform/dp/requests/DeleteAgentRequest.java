...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAgentRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public Builder copy(DeleteAgentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        public DeleteAgentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteAgentRequest(aiDataPlatformId, workspaceKey, agentKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
