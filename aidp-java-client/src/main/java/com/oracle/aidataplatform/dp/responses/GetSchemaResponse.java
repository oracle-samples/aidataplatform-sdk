...
* 
    ...
    private GetSchemaResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.Schema schema) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GetSchemaResponse> {
...
* 
        ...
        public GetSchemaResponse build() {
            return new GetSchemaResponse(__httpStatusCode__, headers, etag, opcRequestId, schema);
        }
    }
