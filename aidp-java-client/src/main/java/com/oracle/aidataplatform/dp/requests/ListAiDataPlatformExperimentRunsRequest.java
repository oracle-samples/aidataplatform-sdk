...
public class ListAiDataPlatformExperimentRunsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ListExperimentRunsDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformExperimentRunsRequest, com.oracle.aidataplatform.dp.model.ListExperimentRunsDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformExperimentRunsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformExperimentRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformExperimentRunsRequest
         */
        public ListAiDataPlatformExperimentRunsRequest build() {
            ListAiDataPlatformExperimentRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformExperimentRunsRequest
         */
        public ListAiDataPlatformExperimentRunsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformExperimentRunsRequest request = new ListAiDataPlatformExperimentRunsRequest();
            ...
            return request;
            // new ListAiDataPlatformExperimentRunsRequest(aiDataPlatformId, workspaceKey, listExperimentRunsDetails, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformExperimentRunsRequest)) {
            return false;
        }

        ListAiDataPlatformExperimentRunsRequest other = (ListAiDataPlatformExperimentRunsRequest) o;
