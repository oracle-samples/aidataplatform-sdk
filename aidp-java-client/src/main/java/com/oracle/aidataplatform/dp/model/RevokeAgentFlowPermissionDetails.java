...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeAgentFlowPermissionDetails.Builder.class)

public final class RevokeAgentFlowPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public RevokeAgentFlowPermissionDetails(PermissionAssignees assignees, java.util.List<AgentFlowPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
...
private java.util.List<AgentFlowPrivilegeForManage> permissions;
...
public Builder permissions(java.util.List<AgentFlowPrivilegeForManage> permissions) {
    this.permissions = permissions;
    return this;
}
            /**
...
public Builder excludeColumns(java.util.List<String> excludeColumns) {
    ...
    return this;
        ...
        public RevokeAgentFlowPermissionDetails build() {
            RevokeAgentFlowPermissionDetails model = new RevokeAgentFlowPermissionDetails(this.assignees
                , this.permissions
                , this.includeColumns
        ...
        public Builder copy(RevokeAgentFlowPermissionDetails model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("permissions")
    private final java.util.List<AgentFlowPrivilegeForManage> permissions;
    ...
    public java.util.List<AgentFlowPrivilegeForManage> getPermissions() {
        return permissions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeAgentFlowPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeAgentFlowPermissionDetails)) {
            return false;
        }

        RevokeAgentFlowPermissionDetails other = (RevokeAgentFlowPermissionDetails) o;
