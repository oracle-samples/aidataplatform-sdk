...
public class ListAiDataPlatformRegisteredModelsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformRegisteredModelsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformRegisteredModelsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformRegisteredModelsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformRegisteredModelsRequest
         */
        public ListAiDataPlatformRegisteredModelsRequest build() {
            ListAiDataPlatformRegisteredModelsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformRegisteredModelsRequest
         */
        public ListAiDataPlatformRegisteredModelsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformRegisteredModelsRequest request = new ListAiDataPlatformRegisteredModelsRequest();
            ...
            return request;
            // new ListAiDataPlatformRegisteredModelsRequest(aiDataPlatformId, filter, maxResults, pageToken, orderBy, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformRegisteredModelsRequest)) {
            return false;
        }

        ListAiDataPlatformRegisteredModelsRequest other = (ListAiDataPlatformRegisteredModelsRequest) o;
