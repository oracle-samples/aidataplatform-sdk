...
public class ListAiDataPlatformTablesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformTablesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformTablesRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformTablesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformTablesRequest
         */
        public ListAiDataPlatformTablesRequest build() {
            ListAiDataPlatformTablesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformTablesRequest
         */
        public ListAiDataPlatformTablesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformTablesRequest request = new ListAiDataPlatformTablesRequest();
            ...
            return request;
            // new ListAiDataPlatformTablesRequest(aiDataPlatformId, catalogKey, schemaKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformTablesRequest)) {
            return false;
        }

        ListAiDataPlatformTablesRequest other = (ListAiDataPlatformTablesRequest) o;
