...
public class CredentialStoreClient extends com.oracle.bmc.http.internal.BaseSyncClient implements CredentialStore {
    /**
...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
         ...
         * @return the client
         */
        public CredentialStoreClient build(@jakarta.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            return new CredentialStoreClient(this, authenticationDetailsProvider);
        }
    }
