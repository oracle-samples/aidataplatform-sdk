...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=Db2Table.Builder.class)
...
public final class Db2Table extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public Db2Table build() {
            Db2Table model = new Db2Table(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(Db2Table model) {
