...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OacTableSummary.Builder.class)
...
public final class OacTableSummary extends TableSummary {
...
public Builder lifecycleState(TableLifecycleState lifecycleState) {
    ...
    return this;
        ...
        public OacTableSummary build() {
            OacTableSummary model = new OacTableSummary(this.key
                , this.displayName
                , this.tableType
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(OacTableSummary model) {
...
return this;
    ...
    @Deprecated
    public OacTableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OacTableSummary)) {
            return false;
        }

        OacTableSummary other = (OacTableSummary) o;
