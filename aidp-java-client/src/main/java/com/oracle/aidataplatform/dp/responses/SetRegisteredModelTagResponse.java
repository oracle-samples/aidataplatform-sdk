...
public class SetRegisteredModelTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SetRegisteredModelTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.SetRegisteredModelTagResponseDetails setRegisteredModelTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SetRegisteredModelTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SetRegisteredModelTagResponse o) {
         ...
         */
        @Override
        public SetRegisteredModelTagResponse build() {
            return new SetRegisteredModelTagResponse(__httpStatusCode__, headers, etag, opcRequestId, setRegisteredModelTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetRegisteredModelTagResponse)) {
            return false;
        }

        SetRegisteredModelTagResponse other = (SetRegisteredModelTagResponse) o;
