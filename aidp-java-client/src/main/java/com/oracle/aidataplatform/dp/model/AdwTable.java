...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AdwTable.Builder.class)
...
public final class AdwTable extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public AdwTable build() {
            AdwTable model = new AdwTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(AdwTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdwTable)) {
            return false;
        }

        AdwTable other = (AdwTable) o;
