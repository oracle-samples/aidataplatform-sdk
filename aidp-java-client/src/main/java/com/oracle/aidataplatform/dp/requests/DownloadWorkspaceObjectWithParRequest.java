...
public class DownloadWorkspaceObjectWithParRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DownloadWorkspaceObjectWithParRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadWorkspaceObjectWithParRequest o) {
        ...
        /**
         * Build the instance of DownloadWorkspaceObjectWithParRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadWorkspaceObjectWithParRequest
         */
        public DownloadWorkspaceObjectWithParRequest build() {
            DownloadWorkspaceObjectWithParRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DownloadWorkspaceObjectWithParRequest
         */
        public DownloadWorkspaceObjectWithParRequest buildWithoutInvocationCallback() {
            DownloadWorkspaceObjectWithParRequest request = new DownloadWorkspaceObjectWithParRequest();
            ...
            return request;
            // new DownloadWorkspaceObjectWithParRequest(aiDataPlatformId, workspaceKey, path, shouldGenerateNewPar, opcRetryToken, opcRequestId, type, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadWorkspaceObjectWithParRequest)) {
            return false;
        }

        DownloadWorkspaceObjectWithParRequest other = (DownloadWorkspaceObjectWithParRequest) o;
