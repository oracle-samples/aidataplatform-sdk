...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SqlServerOnAzureSchema.Builder.class)
...
public final class SqlServerOnAzureSchema extends Schema {
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public SqlServerOnAzureSchema build() {
            SqlServerOnAzureSchema model = new SqlServerOnAzureSchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(SqlServerOnAzureSchema model) {
...
return this;
    ...
    @Deprecated
    public SqlServerOnAzureSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SqlServerOnAzureSchema(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SqlServerOnAzureSchema)) {
            return false;
        }

        SqlServerOnAzureSchema other = (SqlServerOnAzureSchema) o;
