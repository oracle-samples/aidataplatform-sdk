...
public class GetShareRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetShareRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetShareRequest o) {
        ...
        /**
         * Build the instance of GetShareRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetShareRequest
         */
        public GetShareRequest build() {
            GetShareRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetShareRequest
         */
        public GetShareRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetShareRequest(aiDataPlatformId, shareKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetShareRequest)) {
            return false;
        }

        GetShareRequest other = (GetShareRequest) o;
