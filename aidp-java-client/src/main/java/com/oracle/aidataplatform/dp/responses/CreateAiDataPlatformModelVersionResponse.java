...
public class CreateAiDataPlatformModelVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateAiDataPlatformModelVersionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.CreateModelVersionResponseDetails createModelVersionResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAiDataPlatformModelVersionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateAiDataPlatformModelVersionResponse o) {
         ...
         */
        @Override
        public CreateAiDataPlatformModelVersionResponse build() {
            return new CreateAiDataPlatformModelVersionResponse(__httpStatusCode__, headers, etag, opcRequestId, createModelVersionResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformModelVersionResponse)) {
            return false;
        }

        CreateAiDataPlatformModelVersionResponse other = (CreateAiDataPlatformModelVersionResponse) o;
