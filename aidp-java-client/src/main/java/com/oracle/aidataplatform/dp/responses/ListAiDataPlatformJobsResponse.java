...
public class ListAiDataPlatformJobsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAiDataPlatformJobsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, String opcPrevPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.JobCollection jobCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformJobsResponse> {
