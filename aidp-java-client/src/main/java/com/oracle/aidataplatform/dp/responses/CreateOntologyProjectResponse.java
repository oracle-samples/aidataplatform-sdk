...
public class CreateOntologyProjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateOntologyProjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, com.oracle.aidataplatform.dp.model.OntologyProject ontologyProject) {
        super(__httpStatusCode__, headers);
        this.ontologyProject = ontologyProject;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateOntologyProjectResponse> {
         ...
         */
        @Override
        public Builder copy(CreateOntologyProjectResponse o) {
         ...
         */
        @Override
        public CreateOntologyProjectResponse build() {
            return new CreateOntologyProjectResponse(__httpStatusCode__, headers, ontologyProject);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOntologyProjectResponse)) {
            return false;
        }

        CreateOntologyProjectResponse other = (CreateOntologyProjectResponse) o;
