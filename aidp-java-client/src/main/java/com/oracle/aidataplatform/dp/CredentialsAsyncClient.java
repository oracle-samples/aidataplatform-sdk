...
/**
* Async client implementation for Credentials service. <br/>
...
public class CredentialsAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient implements CredentialsAsync {
    /**
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CredentialsAsyncClient.class);

    CredentialsAsyncClient (
     ...
     */
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, CredentialsAsyncClient> {
...
com.oracle.bmc.internal.Alloy.throwDisabledServiceExceptionIfAppropriate(packageName);
         ...
         * @return the client
         */
        public CredentialsAsyncClient build(@jakarta.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            return new CredentialsAsyncClient(this, authenticationDetailsProvider);
        }
    }
...
.callAsync(handler);
     ...
     */
    @Deprecated
    public CredentialsAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider) {
        this(
            builder(),
            authenticationDetailsProvider
        );
     ...
     */
    @Deprecated
    public CredentialsAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration) {
        this(
            builder()
     ...
     */
    @Deprecated
    public CredentialsAsyncClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration, com.oracle.bmc.http.ClientConfigurator clientConfigurator) {
        this(
            builder()
                .configuration(configuration)
