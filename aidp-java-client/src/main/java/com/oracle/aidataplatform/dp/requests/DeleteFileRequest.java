...
public class DeleteFileRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteFileRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteFileRequest o) {
        ...
        /**
         * Build the instance of DeleteFileRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteFileRequest
         */
        public DeleteFileRequest build() {
            DeleteFileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteFileRequest
         */
        public DeleteFileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteFileRequest(aiDataPlatformId, volumeKey, path, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteFileRequest)) {
            return false;
        }
