...
public class CreateAiDataPlatformWorkspaceObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformWorkspaceObjectRequest, java.io.InputStream> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformWorkspaceObjectRequest o) {
        ...
        /**
         * Build the instance of CreateAiDataPlatformWorkspaceObjectRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformWorkspaceObjectRequest
         */
        public CreateAiDataPlatformWorkspaceObjectRequest build() {
            CreateAiDataPlatformWorkspaceObjectRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateAiDataPlatformWorkspaceObjectRequest
         */
        public CreateAiDataPlatformWorkspaceObjectRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformWorkspaceObjectRequest request = new CreateAiDataPlatformWorkspaceObjectRequest();
            ...
            return request;
            // new CreateAiDataPlatformWorkspaceObjectRequest(aiDataPlatformId, workspaceKey, createWorkspaceObjectDetails, path, type, opcRetryToken, opcRequestId, shouldUpdateRecent, isUploadFileBase64Encoded, isOverwrite, objectDescription);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformWorkspaceObjectRequest)) {
            return false;
        }

        CreateAiDataPlatformWorkspaceObjectRequest other = (CreateAiDataPlatformWorkspaceObjectRequest) o;
