...
public class DeleteModelVersionTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private DeleteModelVersionTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.DeleteModelVersionTagResponseDetails deleteModelVersionTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteModelVersionTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeleteModelVersionTagResponse o) {
         ...
         */
        @Override
        public DeleteModelVersionTagResponse build() {
            return new DeleteModelVersionTagResponse(__httpStatusCode__, headers, etag, opcRequestId, deleteModelVersionTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteModelVersionTagResponse)) {
            return false;
        }

        DeleteModelVersionTagResponse other = (DeleteModelVersionTagResponse) o;
