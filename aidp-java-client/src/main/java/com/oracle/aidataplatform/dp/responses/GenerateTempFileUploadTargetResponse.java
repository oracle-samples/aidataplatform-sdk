...
public class GenerateTempFileUploadTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned {@code GenerateTempFileUploadTargetResponseDetails} instance.
     */
    ...
    private GenerateTempFileUploadTargetResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GenerateTempFileUploadTargetResponseDetails generateTempFileUploadTargetResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GenerateTempFileUploadTargetResponse> {
         ...
         */
        @Override
        public Builder copy(GenerateTempFileUploadTargetResponse o) {
         ...
         */
        @Override
        public GenerateTempFileUploadTargetResponse build() {
            return new GenerateTempFileUploadTargetResponse(__httpStatusCode__, headers, opcRequestId, generateTempFileUploadTargetResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateTempFileUploadTargetResponse)) {
            return false;
        }

        GenerateTempFileUploadTargetResponse other = (GenerateTempFileUploadTargetResponse) o;
