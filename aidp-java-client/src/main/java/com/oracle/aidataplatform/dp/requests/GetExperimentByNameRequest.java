...
public class GetExperimentByNameRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetExperimentByNameRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetExperimentByNameRequest o) {
        ...
        /**
         * Build the instance of GetExperimentByNameRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetExperimentByNameRequest
         */
        public GetExperimentByNameRequest build() {
            GetExperimentByNameRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetExperimentByNameRequest
         */
        public GetExperimentByNameRequest buildWithoutInvocationCallback() {
            GetExperimentByNameRequest request = new GetExperimentByNameRequest();
            ...
            return request;
            // new GetExperimentByNameRequest(aiDataPlatformId, workspaceKey, experimentName, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExperimentByNameRequest)) {
            return false;
        }

        GetExperimentByNameRequest other = (GetExperimentByNameRequest) o;
