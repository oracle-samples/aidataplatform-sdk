...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAgentDiagramAgentNodeDetails.Builder.class)
...
public final class UpdateAgentDiagramAgentNodeDetails extends UpdateAgentDiagramNodeDetails {
...
public Builder tools(java.util.List<Tool> tools) {
    ...
    return this;
        ...
        public UpdateAgentDiagramAgentNodeDetails build() {
            UpdateAgentDiagramAgentNodeDetails model = new UpdateAgentDiagramAgentNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(UpdateAgentDiagramAgentNodeDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramAgentNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramAgentNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramAgentNodeDetails other = (UpdateAgentDiagramAgentNodeDetails) o;
