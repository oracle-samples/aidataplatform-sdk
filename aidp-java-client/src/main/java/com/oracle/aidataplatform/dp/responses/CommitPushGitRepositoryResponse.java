...
public class CommitPushGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CommitPushGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CommitPushGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CommitPushGitRepositoryResponse o) {
         ...
         */
        @Override
        public CommitPushGitRepositoryResponse build() {
            return new CommitPushGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommitPushGitRepositoryResponse)) {
            return false;
        }

        CommitPushGitRepositoryResponse other = (CommitPushGitRepositoryResponse) o;
