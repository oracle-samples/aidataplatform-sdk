...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=GoogleBigquerySchema.Builder.class)
...
public final class GoogleBigquerySchema extends Schema {
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public GoogleBigquerySchema build() {
            GoogleBigquerySchema model = new GoogleBigquerySchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(GoogleBigquerySchema model) {
...
return this;
    ...
    @Deprecated
    public GoogleBigquerySchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GoogleBigquerySchema(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleBigquerySchema)) {
            return false;
        }

        GoogleBigquerySchema other = (GoogleBigquerySchema) o;
