...
public class ListAiDataPlatformJobPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformJobPermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformJobPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobKey(o.getJobKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformJobPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformJobPermissionsRequest
         */
        public ListAiDataPlatformJobPermissionsRequest build() {
            ListAiDataPlatformJobPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformJobPermissionsRequest
         */
        public ListAiDataPlatformJobPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformJobPermissionsRequest request = new ListAiDataPlatformJobPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformJobPermissionsRequest(aiDataPlatformId, workspaceKey, jobKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformJobPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformJobPermissionsRequest other = (ListAiDataPlatformJobPermissionsRequest) o;
