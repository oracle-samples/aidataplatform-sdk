...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=GetRegisteredModelResponseDetails.Builder.class)

public final class GetRegisteredModelResponseDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"registeredModel"})
    public GetRegisteredModelResponseDetails(RegisteredModel registeredModel) {
        super();
...
public Builder registeredModel(RegisteredModel registeredModel) {
    ...
    return this;
        ...
        public GetRegisteredModelResponseDetails build() {
            GetRegisteredModelResponseDetails model = new GetRegisteredModelResponseDetails(this.registeredModel);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GetRegisteredModelResponseDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GetRegisteredModelResponseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRegisteredModelResponseDetails)) {
            return false;
        }

        GetRegisteredModelResponseDetails other = (GetRegisteredModelResponseDetails) o;
