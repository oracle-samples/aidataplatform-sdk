...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=TablePermissionSummary.Builder.class)

public final class TablePermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions", "columns", "excludeColumns", "isInherited", "resourceName", "rowFilterType", "rowFilter"})
    public TablePermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<TablePrivilege> granteePermissions, java.util.List<String> columns, java.util.List<String> excludeColumns, Boolean isInherited, String resourceName, RowFilterType rowFilterType, String rowFilter) {
        super();
...
private java.util.List<TablePrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<TablePrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}
            /**
...
public Builder rowFilter(String rowFilter) {
    ...
    return this;
        ...
        public TablePermissionSummary build() {
            TablePermissionSummary model = new TablePermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(TablePermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<TablePrivilege> granteePermissions;
    ...
    public java.util.List<TablePrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TablePermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TablePermissionSummary)) {
            return false;
        }

        TablePermissionSummary other = (TablePermissionSummary) o;
