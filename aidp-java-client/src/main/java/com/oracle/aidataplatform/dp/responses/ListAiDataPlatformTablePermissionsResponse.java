...
public class ListAiDataPlatformTablePermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAiDataPlatformTablePermissionsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.TablePermissionCollection tablePermissionCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformTablePermissionsResponse> {
