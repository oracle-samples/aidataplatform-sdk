...
public class ListAiDataPlatformRecipientPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.SortOrder getSortOrder() {
        ...
        /**
     * The field to sort by. Default order for {@code grantee} is ascending.      
* 
     */
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformRecipientPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformRecipientPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());recipientKey(o.getRecipientKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformRecipientPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformRecipientPermissionsRequest
         */
        public ListAiDataPlatformRecipientPermissionsRequest build() {
            ListAiDataPlatformRecipientPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformRecipientPermissionsRequest
         */
        public ListAiDataPlatformRecipientPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformRecipientPermissionsRequest request = new ListAiDataPlatformRecipientPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformRecipientPermissionsRequest(aiDataPlatformId, recipientKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformRecipientPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformRecipientPermissionsRequest other = (ListAiDataPlatformRecipientPermissionsRequest) o;
