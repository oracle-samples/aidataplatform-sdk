...
public class RefreshAiDataPlatformCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshAiDataPlatformCatalogResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshAiDataPlatformCatalogResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshAiDataPlatformCatalogResponse o) {
         ...
         */
        @Override
        public RefreshAiDataPlatformCatalogResponse build() {
            return new RefreshAiDataPlatformCatalogResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformCatalogResponse)) {
            return false;
        }

        RefreshAiDataPlatformCatalogResponse other = (RefreshAiDataPlatformCatalogResponse) o;
