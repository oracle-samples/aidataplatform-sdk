...
public class GetAgentSessionTraceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAgentSessionTraceRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAgentSessionTraceRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());sessionId(o.getSessionId());traceKey(o.getTraceKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAgentSessionTraceRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAgentSessionTraceRequest
         */
        public GetAgentSessionTraceRequest build() {
            GetAgentSessionTraceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAgentSessionTraceRequest
         */
        public GetAgentSessionTraceRequest buildWithoutInvocationCallback() {
            GetAgentSessionTraceRequest request = new GetAgentSessionTraceRequest();
            ...
            return request;
            // new GetAgentSessionTraceRequest(aiDataPlatformId, workspaceKey, agentKey, sessionId, traceKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAgentSessionTraceRequest)) {
            return false;
        }

        GetAgentSessionTraceRequest other = (GetAgentSessionTraceRequest) o;
