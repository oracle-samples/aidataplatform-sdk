...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=FetchEntityLineageDetails.Builder.class)
...
public final class FetchEntityLineageDetails  {
    ...
    public FetchEntityLineageDetails(String anchorNode, Integer maxDepth, LineageLevel level, LineageDirection direction, NodeFilterObject nodeFilters, PathFilterObject pathFilters, Boolean shouldIncludeEdges) {
        super();
...
public Builder shouldIncludeEdges(Boolean shouldIncludeEdges) {
    ...
    return this;
        ...
        public FetchEntityLineageDetails build() {
            FetchEntityLineageDetails model = new FetchEntityLineageDetails(this.anchorNode
                , this.maxDepth
                , this.level
                , this.direction
                , this.nodeFilters
