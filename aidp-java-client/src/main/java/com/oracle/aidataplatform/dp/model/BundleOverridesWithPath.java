...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=BundleOverridesWithPath.Builder.class)

public final class BundleOverridesWithPath  {
    @Deprecated
    @java.beans.ConstructorProperties({"path", "overrides"})
    public BundleOverridesWithPath(String path, BundleOverrides overrides) {
        super();
        this.path = path;
...
public Builder overrides(BundleOverrides overrides) {
    ...
    return this;
        ...
        public BundleOverridesWithPath build() {
            BundleOverridesWithPath model = new BundleOverridesWithPath(this.path
                , this.overrides);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BundleOverridesWithPath model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BundleOverridesWithPath(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BundleOverridesWithPath)) {
            return false;
        }

        BundleOverridesWithPath other = (BundleOverridesWithPath) o;
