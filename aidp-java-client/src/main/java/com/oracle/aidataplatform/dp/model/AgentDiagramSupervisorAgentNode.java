...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramSupervisorAgentNode.Builder.class)
...
public final class AgentDiagramSupervisorAgentNode extends AgentDiagramNode {
...
public Builder supervisorConfig(java.util.Map<String, String> supervisorConfig) {
    ...
    return this;
        ...
        public AgentDiagramSupervisorAgentNode build() {
            AgentDiagramSupervisorAgentNode model = new AgentDiagramSupervisorAgentNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramSupervisorAgentNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramSupervisorAgentNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, String instructions, LlmConfig llm, java.util.Map<String, Object> modelSettings, MemoryConfiguration memory, java.util.List<Tool> tools, java.util.List<String> toolReferences, java.util.Map<String, String> supervisorConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramSupervisorAgentNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramSupervisorAgentNode)) {
            return false;
        }

        AgentDiagramSupervisorAgentNode other = (AgentDiagramSupervisorAgentNode) o;
