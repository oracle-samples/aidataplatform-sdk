...
public class CancelAiDataPlatformJobRunRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CancelAiDataPlatformJobRunRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CancelAiDataPlatformJobRunRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobRunKey(o.getJobRunKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());opcRetryToken(o.getOpcRetryToken());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CancelAiDataPlatformJobRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelAiDataPlatformJobRunRequest
         */
        public CancelAiDataPlatformJobRunRequest build() {
            CancelAiDataPlatformJobRunRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CancelAiDataPlatformJobRunRequest
         */
        public CancelAiDataPlatformJobRunRequest buildWithoutInvocationCallback() {
            CancelAiDataPlatformJobRunRequest request = new CancelAiDataPlatformJobRunRequest();
            ...
            return request;
            // new CancelAiDataPlatformJobRunRequest(aiDataPlatformId, workspaceKey, jobRunKey, ifMatch, opcRequestId, opcRetryToken, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelAiDataPlatformJobRunRequest)) {
            return false;
        }

        CancelAiDataPlatformJobRunRequest other = (CancelAiDataPlatformJobRunRequest) o;
