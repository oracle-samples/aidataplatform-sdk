...
public class MakeAiDataPlatformDirRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<MakeAiDataPlatformDirRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(MakeAiDataPlatformDirRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());volumeKey(o.getVolumeKey());path(o.getPath());description(o.getDescription());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of MakeAiDataPlatformDirRequest as configured by this builder
         *
         ...
         *
         * @return instance of MakeAiDataPlatformDirRequest
         */
        public MakeAiDataPlatformDirRequest build() {
            MakeAiDataPlatformDirRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of MakeAiDataPlatformDirRequest
         */
        public MakeAiDataPlatformDirRequest buildWithoutInvocationCallback() {
            MakeAiDataPlatformDirRequest request = new MakeAiDataPlatformDirRequest();
            ...
            return request;
            // new MakeAiDataPlatformDirRequest(aiDataPlatformId, volumeKey, path, description, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MakeAiDataPlatformDirRequest)) {
            return false;
        }

        MakeAiDataPlatformDirRequest other = (MakeAiDataPlatformDirRequest) o;
