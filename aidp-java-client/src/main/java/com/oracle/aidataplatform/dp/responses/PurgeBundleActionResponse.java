...
public class PurgeBundleActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PurgeBundleActionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PurgeBundleActionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PurgeBundleActionResponse o) {
         ...
         */
        @Override
        public PurgeBundleActionResponse build() {
            return new PurgeBundleActionResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurgeBundleActionResponse)) {
            return false;
        }

        PurgeBundleActionResponse other = (PurgeBundleActionResponse) o;
