...
public class ResetAiDataPlatformGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ResetAiDataPlatformGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ResetAiDataPlatformGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ResetAiDataPlatformGitRepositoryResponse o) {
         ...
         */
        @Override
        public ResetAiDataPlatformGitRepositoryResponse build() {
            return new ResetAiDataPlatformGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetAiDataPlatformGitRepositoryResponse)) {
            return false;
        }

        ResetAiDataPlatformGitRepositoryResponse other = (ResetAiDataPlatformGitRepositoryResponse) o;
