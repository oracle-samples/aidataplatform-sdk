...
public class PurgeBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private PurgeBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<PurgeBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(PurgeBundleResponse o) {
         ...
         */
        @Override
        public PurgeBundleResponse build() {
            return new PurgeBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurgeBundleResponse)) {
            return false;
        }

        PurgeBundleResponse other = (PurgeBundleResponse) o;
