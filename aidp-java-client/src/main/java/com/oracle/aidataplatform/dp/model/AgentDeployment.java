...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDeployment.Builder.class)

public final class AgentDeployment  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "displayName", "agentKey", "agentComputeKey", "endpointUrl", "description", "deploymentType", "lifecycleState", "deploymentVersion", "timeCreated", "createdBy", "timeUpdated", "updatedBy", "sessionRetentionConfig", "oAuthConfig", "agentCardUrl"})
    public AgentDeployment(String key, String displayName, String agentKey, String agentComputeKey, String endpointUrl, String description, DeploymentType deploymentType, DeploymentLifecycleState lifecycleState, String deploymentVersion, java.util.Date timeCreated, String createdBy, java.util.Date timeUpdated, String updatedBy, SessionRetentionConfiguration sessionRetentionConfig, OAuthConfiguration oAuthConfig, String agentCardUrl) {
        super();
        this.key = key;
...
public Builder agentCardUrl(String agentCardUrl) {
    ...
    return this;
        ...
        public AgentDeployment build() {
            AgentDeployment model = new AgentDeployment(this.key
                , this.displayName
                , this.agentKey
        ...
        public Builder copy(AgentDeployment model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDeployment)) {
            return false;
        }

        AgentDeployment other = (AgentDeployment) o;
