...
public class CreateAiDataPlatformTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateAiDataPlatformTableResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAiDataPlatformTableResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateAiDataPlatformTableResponse o) {
         ...
         */
        @Override
        public CreateAiDataPlatformTableResponse build() {
            return new CreateAiDataPlatformTableResponse(__httpStatusCode__, headers, location, contentLocation, aidpAsyncOperationKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformTableResponse)) {
            return false;
        }

        CreateAiDataPlatformTableResponse other = (CreateAiDataPlatformTableResponse) o;
