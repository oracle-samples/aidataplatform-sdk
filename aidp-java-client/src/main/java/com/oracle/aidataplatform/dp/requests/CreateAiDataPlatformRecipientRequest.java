...
public class CreateAiDataPlatformRecipientRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateRecipientDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateRecipientDetails getBody$() {
        return createRecipientDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformRecipientRequest, com.oracle.aidataplatform.dp.model.CreateRecipientDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createRecipientDetails(com.oracle.aidataplatform.dp.model.CreateRecipientDetails createRecipientDetails) {
            this.createRecipientDetails = createRecipientDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformRecipientRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());createRecipientDetails(o.getCreateRecipientDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CreateAiDataPlatformRecipientRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformRecipientRequest
         */
        public CreateAiDataPlatformRecipientRequest build() {
            CreateAiDataPlatformRecipientRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateRecipientDetails body) {
            createRecipientDetails(body);
            return this;
        }
         ...
         * @return instance of CreateAiDataPlatformRecipientRequest
         */
        public CreateAiDataPlatformRecipientRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformRecipientRequest request = new CreateAiDataPlatformRecipientRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.createRecipientDetails = createRecipientDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new CreateAiDataPlatformRecipientRequest(aiDataPlatformId, createRecipientDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createRecipientDetails=").append(String.valueOf(this.createRecipientDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformRecipientRequest)) {
            return false;
        }

        CreateAiDataPlatformRecipientRequest other = (CreateAiDataPlatformRecipientRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.createRecipientDetails, other.createRecipientDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createRecipientDetails == null ? 43 : this.createRecipientDetails.hashCode());
