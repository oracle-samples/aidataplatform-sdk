...
public class GetModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of GetModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetModelVersionRequest
         */
        public GetModelVersionRequest build() {
            GetModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetModelVersionRequest
         */
        public GetModelVersionRequest buildWithoutInvocationCallback() {
            GetModelVersionRequest request = new GetModelVersionRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetModelVersionRequest)) {
            return false;
        }

        GetModelVersionRequest other = (GetModelVersionRequest) o;
