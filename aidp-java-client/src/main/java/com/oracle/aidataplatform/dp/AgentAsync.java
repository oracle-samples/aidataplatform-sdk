...
public interface AgentAsync extends AutoCloseable {
    ...
    */
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetAgentSessionResponse> getAgentSession(GetAgentSessionRequest request, com.oracle.bmc.responses.AsyncHandler<GetAgentSessionRequest, GetAgentSessionResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ManageAgentPermissionResponse> manageAgentPermission(ManageAgentPermissionRequest request, com.oracle.bmc.responses.AsyncHandler<ManageAgentPermissionRequest, ManageAgentPermissionResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ValidateAgentResponse> validateAgent(ValidateAgentRequest request, com.oracle.bmc.responses.AsyncHandler<ValidateAgentRequest, ValidateAgentResponse> handler);
