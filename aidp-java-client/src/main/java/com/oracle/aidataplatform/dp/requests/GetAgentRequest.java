...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAgentRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public GetAgentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAgentRequest(aiDataPlatformId, workspaceKey, agentKey, opcRequestId, shouldUpdateRecent);
        }
    }
