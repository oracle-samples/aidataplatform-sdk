...
public class DeleteAgentSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAgentSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAgentSessionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());sessionId(o.getSessionId());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of DeleteAgentSessionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAgentSessionRequest
         */
        public DeleteAgentSessionRequest build() {
            DeleteAgentSessionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAgentSessionRequest
         */
        public DeleteAgentSessionRequest buildWithoutInvocationCallback() {
            DeleteAgentSessionRequest request = new DeleteAgentSessionRequest();
            ...
            return request;
            // new DeleteAgentSessionRequest(aiDataPlatformId, workspaceKey, agentKey, sessionId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAgentSessionRequest)) {
            return false;
        }

        DeleteAgentSessionRequest other = (DeleteAgentSessionRequest) o;
