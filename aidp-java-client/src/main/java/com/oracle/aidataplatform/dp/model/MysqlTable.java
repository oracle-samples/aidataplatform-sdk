...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MysqlTable.Builder.class)
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public MysqlTable build() {
            MysqlTable model = new MysqlTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(MysqlTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MysqlTable)) {
            return false;
        }

        MysqlTable other = (MysqlTable) o;
