...
public class GetAiDataPlatformAsyncOperationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformAsyncOperationRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformAsyncOperationRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());asyncOperationKey(o.getAsyncOperationKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAiDataPlatformAsyncOperationRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformAsyncOperationRequest
         */
        public GetAiDataPlatformAsyncOperationRequest build() {
            GetAiDataPlatformAsyncOperationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformAsyncOperationRequest
         */
        public GetAiDataPlatformAsyncOperationRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformAsyncOperationRequest request = new GetAiDataPlatformAsyncOperationRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.asyncOperationKey = asyncOperationKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAiDataPlatformAsyncOperationRequest(aiDataPlatformId, asyncOperationKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformAsyncOperationRequest)) {
            return false;
        }

        GetAiDataPlatformAsyncOperationRequest other = (GetAiDataPlatformAsyncOperationRequest) o;
