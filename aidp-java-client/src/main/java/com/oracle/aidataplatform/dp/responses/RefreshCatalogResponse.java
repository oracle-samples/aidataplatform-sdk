...
public class RefreshCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshCatalogResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshCatalogResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshCatalogResponse o) {
         ...
         */
        @Override
        public RefreshCatalogResponse build() {
            return new RefreshCatalogResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshCatalogResponse)) {
            return false;
        }

        RefreshCatalogResponse other = (RefreshCatalogResponse) o;
