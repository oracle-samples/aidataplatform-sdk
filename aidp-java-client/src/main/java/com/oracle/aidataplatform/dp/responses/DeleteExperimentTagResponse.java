...
public class DeleteExperimentTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private DeleteExperimentTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.DeleteExperimentTagResponseDetails deleteExperimentTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteExperimentTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeleteExperimentTagResponse o) {
         ...
         */
        @Override
        public DeleteExperimentTagResponse build() {
            return new DeleteExperimentTagResponse(__httpStatusCode__, headers, etag, opcRequestId, deleteExperimentTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExperimentTagResponse)) {
            return false;
        }

        DeleteExperimentTagResponse other = (DeleteExperimentTagResponse) o;
