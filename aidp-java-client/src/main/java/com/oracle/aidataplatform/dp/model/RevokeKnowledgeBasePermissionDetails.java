...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeKnowledgeBasePermissionDetails.Builder.class)

public final class RevokeKnowledgeBasePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public RevokeKnowledgeBasePermissionDetails(PermissionAssignees assignees, java.util.List<KnowledgeBasePrivilege> permissions) {
        super();
...
public Builder permissions(java.util.List<KnowledgeBasePrivilege> permissions) {
    ...
    return this;
        ...
        public RevokeKnowledgeBasePermissionDetails build() {
            RevokeKnowledgeBasePermissionDetails model = new RevokeKnowledgeBasePermissionDetails(this.assignees
                , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeKnowledgeBasePermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeKnowledgeBasePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeKnowledgeBasePermissionDetails)) {
            return false;
        }

        RevokeKnowledgeBasePermissionDetails other = (RevokeKnowledgeBasePermissionDetails) o;
