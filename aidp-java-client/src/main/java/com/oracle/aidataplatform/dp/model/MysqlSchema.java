...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MysqlSchema.Builder.class)
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public MysqlSchema build() {
            MysqlSchema model = new MysqlSchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(MysqlSchema model) {
...
return this;
    ...
    @Deprecated
    public MysqlSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MysqlSchema)) {
            return false;
        }

        MysqlSchema other = (MysqlSchema) o;
