...
public class MergeGitRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private MergeGitRepositoryResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<MergeGitRepositoryResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(MergeGitRepositoryResponse o) {
         ...
         */
        @Override
        public MergeGitRepositoryResponse build() {
            return new MergeGitRepositoryResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MergeGitRepositoryResponse)) {
            return false;
        }

        MergeGitRepositoryResponse other = (MergeGitRepositoryResponse) o;
