...
* 
    ...
    private CreateWorkspaceResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String etag, String aidpAsyncOperationKey, String opcRequestId, com.oracle.aidataplatform.dp.model.Workspace workspace) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateWorkspaceResponse> {
...
* 
        ...
        public CreateWorkspaceResponse build() {
            return new CreateWorkspaceResponse(__httpStatusCode__, headers, location, contentLocation, etag, aidpAsyncOperationKey, opcRequestId, workspace);
        }
    }
