...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SqlServerOnAzureTable.Builder.class)
...
public final class SqlServerOnAzureTable extends Table {
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public SqlServerOnAzureTable build() {
            SqlServerOnAzureTable model = new SqlServerOnAzureTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(SqlServerOnAzureTable model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SqlServerOnAzureTable(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SqlServerOnAzureTable)) {
            return false;
        }

        SqlServerOnAzureTable other = (SqlServerOnAzureTable) o;
