...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeWorkspacePermissionDetails.Builder.class)

public final class RevokeWorkspacePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public RevokeWorkspacePermissionDetails(PermissionAssignees assignees, java.util.List<WorkspacePrivilege> permissions) {
        super();
...
public Builder permissions(java.util.List<WorkspacePrivilege> permissions) {
    ...
    return this;
        ...
        public RevokeWorkspacePermissionDetails build() {
            RevokeWorkspacePermissionDetails model = new RevokeWorkspacePermissionDetails(this.assignees
                , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeWorkspacePermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeWorkspacePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeWorkspacePermissionDetails)) {
            return false;
        }

        RevokeWorkspacePermissionDetails other = (RevokeWorkspacePermissionDetails) o;
