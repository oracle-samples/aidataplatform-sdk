...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=PreviewAgentFlowAgentCardDetails.Builder.class)

public final class PreviewAgentFlowAgentCardDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"agentCardConfigDetails"})
    public PreviewAgentFlowAgentCardDetails(AgentCardConfigDetail agentCardConfigDetails) {
        super();
...
public Builder agentCardConfigDetails(AgentCardConfigDetail agentCardConfigDetails) {
    ...
    return this;
        ...
        public PreviewAgentFlowAgentCardDetails build() {
            PreviewAgentFlowAgentCardDetails model = new PreviewAgentFlowAgentCardDetails(this.agentCardConfigDetails);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PreviewAgentFlowAgentCardDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PreviewAgentFlowAgentCardDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PreviewAgentFlowAgentCardDetails)) {
            return false;
        }

        PreviewAgentFlowAgentCardDetails other = (PreviewAgentFlowAgentCardDetails) o;
