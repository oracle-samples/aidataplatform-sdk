...
public class CreateBundleActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateBundleActionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateBundleActionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateBundleActionResponse o) {
         ...
         */
        @Override
        public CreateBundleActionResponse build() {
            return new CreateBundleActionResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBundleActionResponse)) {
            return false;
        }

        CreateBundleActionResponse other = (CreateBundleActionResponse) o;
