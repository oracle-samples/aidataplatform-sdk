...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentFlowDetachment.Builder.class)

public final class AgentFlowDetachment  {
    @Deprecated
    @java.beans.ConstructorProperties({"agentFlowComputeKey", "agentFlowKey"})
    public AgentFlowDetachment(String agentFlowComputeKey, String agentFlowKey) {
        super();
...
public Builder agentFlowKey(String agentFlowKey) {
    ...
    return this;
        ...
        public AgentFlowDetachment build() {
            AgentFlowDetachment model = new AgentFlowDetachment(this.agentFlowComputeKey
                , this.agentFlowKey);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgentFlowDetachment model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentFlowDetachment)) {
            return false;
        }

        AgentFlowDetachment other = (AgentFlowDetachment) o;
