...
public class CreateBundleActionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateBundleDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateBundleActionRequest, com.oracle.aidataplatform.dp.model.CreateBundleDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CreateBundleActionRequest o) {
        ...
        /**
         * Build the instance of CreateBundleActionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateBundleActionRequest
         */
        public CreateBundleActionRequest build() {
            CreateBundleActionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateBundleActionRequest
         */
        public CreateBundleActionRequest buildWithoutInvocationCallback() {
            CreateBundleActionRequest request = new CreateBundleActionRequest();
            ...
            return request;
            // new CreateBundleActionRequest(aiDataPlatformId, workspaceKey, createBundleDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBundleActionRequest)) {
            return false;
        }

        CreateBundleActionRequest other = (CreateBundleActionRequest) o;
