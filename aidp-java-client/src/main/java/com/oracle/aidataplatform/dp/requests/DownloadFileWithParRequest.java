...
public class DownloadFileWithParRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DownloadFileWithParRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadFileWithParRequest o) {
        ...
        /**
         * Build the instance of DownloadFileWithParRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadFileWithParRequest
         */
        public DownloadFileWithParRequest build() {
            DownloadFileWithParRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DownloadFileWithParRequest
         */
        public DownloadFileWithParRequest buildWithoutInvocationCallback() {
            DownloadFileWithParRequest request = new DownloadFileWithParRequest();
            ...
            return request;
            // new DownloadFileWithParRequest(aiDataPlatformId, volumeKey, path, shouldGenerateNewPar, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadFileWithParRequest)) {
            return false;
        }

        DownloadFileWithParRequest other = (DownloadFileWithParRequest) o;
