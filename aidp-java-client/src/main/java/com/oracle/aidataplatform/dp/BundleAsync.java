...
* 
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<FetchBundlePublishStatusActionResponse> fetchBundlePublishStatusAction(FetchBundlePublishStatusActionRequest request, com.oracle.bmc.responses.AsyncHandler<FetchBundlePublishStatusActionRequest, FetchBundlePublishStatusActionResponse> handler);
...
* 
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<PublishBundleActionResponse> publishBundleAction(PublishBundleActionRequest request, com.oracle.bmc.responses.AsyncHandler<PublishBundleActionRequest, PublishBundleActionResponse> handler);
