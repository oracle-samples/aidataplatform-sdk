...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CatalogPermissionSummary.Builder.class)

public final class CatalogPermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions"})
    public CatalogPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<CatalogPrivilege> granteePermissions) {
        super();
...
private java.util.List<CatalogPrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<CatalogPrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}


        public CatalogPermissionSummary build() {
            CatalogPermissionSummary model = new CatalogPermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(CatalogPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<CatalogPrivilege> granteePermissions;
    ...
    public java.util.List<CatalogPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CatalogPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogPermissionSummary)) {
            return false;
        }

        CatalogPermissionSummary other = (CatalogPermissionSummary) o;
