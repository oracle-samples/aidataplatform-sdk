...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateSqlToolDetails.Builder.class)
...
public final class UpdateSqlToolDetails extends UpdateToolDetails {
...
public Builder toolConfig(SqlToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public UpdateSqlToolDetails build() {
            UpdateSqlToolDetails model = new UpdateSqlToolDetails(this.displayName
                , this.description
                , this.properties
                , this.inputSchema
        ...
        public Builder copy(UpdateSqlToolDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateSqlToolDetails(String displayName, String description, java.util.Map<String, Object> properties, java.util.Map<String, Object> inputSchema, SqlToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateSqlToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSqlToolDetails)) {
            return false;
        }

        UpdateSqlToolDetails other = (UpdateSqlToolDetails) o;
