...
public class ListRecentJobRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListRecentJobRunsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListRecentJobRunsRequest o) {
        ...
        /**
         * Build the instance of ListRecentJobRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRecentJobRunsRequest
         */
        public ListRecentJobRunsRequest build() {
            ListRecentJobRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRecentJobRunsRequest
         */
        public ListRecentJobRunsRequest buildWithoutInvocationCallback() {
            ListRecentJobRunsRequest request = new ListRecentJobRunsRequest();
            ...
            return request;
            // new ListRecentJobRunsRequest(aiDataPlatformId, workspaceKey, jobKey, recordCount, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecentJobRunsRequest)) {
            return false;
        }

        ListRecentJobRunsRequest other = (ListRecentJobRunsRequest) o;
