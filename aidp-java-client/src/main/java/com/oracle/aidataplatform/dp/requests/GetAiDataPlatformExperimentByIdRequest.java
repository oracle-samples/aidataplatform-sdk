...
public class GetAiDataPlatformExperimentByIdRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformExperimentByIdRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformExperimentByIdRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());experimentId(o.getExperimentId());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of GetAiDataPlatformExperimentByIdRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformExperimentByIdRequest
         */
        public GetAiDataPlatformExperimentByIdRequest build() {
            GetAiDataPlatformExperimentByIdRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformExperimentByIdRequest
         */
        public GetAiDataPlatformExperimentByIdRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformExperimentByIdRequest request = new GetAiDataPlatformExperimentByIdRequest();
            ...
            return request;
            // new GetAiDataPlatformExperimentByIdRequest(aiDataPlatformId, workspaceKey, experimentId, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformExperimentByIdRequest)) {
            return false;
        }

        GetAiDataPlatformExperimentByIdRequest other = (GetAiDataPlatformExperimentByIdRequest) o;
