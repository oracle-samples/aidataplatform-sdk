...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeAgentPermissionDetails.Builder.class)

public final class RevokeAgentPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public RevokeAgentPermissionDetails(PermissionAssignees assignees, java.util.List<AgentPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
...
public Builder excludeColumns(java.util.List<String> excludeColumns) {
    ...
    return this;
        ...
        public RevokeAgentPermissionDetails build() {
            RevokeAgentPermissionDetails model = new RevokeAgentPermissionDetails(this.assignees
                , this.permissions
                , this.includeColumns
        ...
        public Builder copy(RevokeAgentPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeAgentPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeAgentPermissionDetails)) {
            return false;
        }

        RevokeAgentPermissionDetails other = (RevokeAgentPermissionDetails) o;
