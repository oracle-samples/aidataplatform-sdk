...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentEdge.Builder.class)

public final class AgentEdge  {
    @Deprecated
    ...
    public AgentEdge(String srcNodeId, String destNodeId, String srcNodeOutput, String destNodeInput, String parentNodeId, java.util.List<Point> edgeHandles, java.util.Map<String, Object> edgeProperties, String edgeType, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<ValidationError> validationErrors) {
        super();
...
public Builder validationErrors(java.util.List<ValidationError> validationErrors) {
    ...
    return this;
        ...
        public AgentEdge build() {
            AgentEdge model = new AgentEdge(this.srcNodeId
                , this.destNodeId
                , this.srcNodeOutput
                , this.destNodeInput
                , this.parentNodeId
        ...
        public Builder copy(AgentEdge model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentEdge)) {
            return false;
        }

        AgentEdge other = (AgentEdge) o;
