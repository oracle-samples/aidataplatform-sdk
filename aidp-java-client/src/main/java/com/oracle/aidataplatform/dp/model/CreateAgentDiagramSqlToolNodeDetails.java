...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramSqlToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramSqlToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
public Builder toolConfig(SqlToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateAgentDiagramSqlToolNodeDetails build() {
            CreateAgentDiagramSqlToolNodeDetails model = new CreateAgentDiagramSqlToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramSqlToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramSqlToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, SqlToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramSqlToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramSqlToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramSqlToolNodeDetails other = (CreateAgentDiagramSqlToolNodeDetails) o;
