...
public class ListAiDataPlatformViewPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformViewPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformViewPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());viewKey(o.getViewKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformViewPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformViewPermissionsRequest
         */
        public ListAiDataPlatformViewPermissionsRequest build() {
            ListAiDataPlatformViewPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformViewPermissionsRequest
         */
        public ListAiDataPlatformViewPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformViewPermissionsRequest request = new ListAiDataPlatformViewPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformViewPermissionsRequest(aiDataPlatformId, viewKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformViewPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformViewPermissionsRequest other = (ListAiDataPlatformViewPermissionsRequest) o;
