...
public class ListGitBranchesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListGitBranchesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListGitBranchesRequest o) {
        ...
        /**
         * Build the instance of ListGitBranchesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListGitBranchesRequest
         */
        public ListGitBranchesRequest build() {
            ListGitBranchesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListGitBranchesRequest
         */
        public ListGitBranchesRequest buildWithoutInvocationCallback() {
            ListGitBranchesRequest request = new ListGitBranchesRequest();
            ...
            return request;
            // new ListGitBranchesRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, displayName, displayNameContains, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListGitBranchesRequest)) {
            return false;
        }

        ListGitBranchesRequest other = (ListGitBranchesRequest) o;
