...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignAgentFlowPermissionDetails.Builder.class)

public final class AssignAgentFlowPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public AssignAgentFlowPermissionDetails(PermissionAssignees assignees, java.util.List<AgentFlowPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
...
public Builder excludeColumns(java.util.List<String> excludeColumns) {
    ...
    return this;
        ...
        public AssignAgentFlowPermissionDetails build() {
            AssignAgentFlowPermissionDetails model = new AssignAgentFlowPermissionDetails(this.assignees
                , this.permissions
                , this.includeColumns
        ...
        public Builder copy(AssignAgentFlowPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignAgentFlowPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignAgentFlowPermissionDetails)) {
            return false;
        }

        AssignAgentFlowPermissionDetails other = (AssignAgentFlowPermissionDetails) o;
