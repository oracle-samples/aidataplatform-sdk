...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AiCompute.Builder.class)
...
public final class AiCompute extends Cluster {
...
public Builder replicaConfig(ReplicaConfig replicaConfig) {
    ...
    return this;
        ...
        public AiCompute build() {
            AiCompute model = new AiCompute(this.key
                , this.displayName
                , this.description
                , this.type
                , this.timeCreated
        ...
        public Builder copy(AiCompute model) {
