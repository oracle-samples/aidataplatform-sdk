...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramSqlToolNode.Builder.class)
...
public final class AgentDiagramSqlToolNode extends AgentDiagramNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramSqlToolNode build() {
            AgentDiagramSqlToolNode model = new AgentDiagramSqlToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramSqlToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramSqlToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramSqlToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramSqlToolNode)) {
            return false;
        }

        AgentDiagramSqlToolNode other = (AgentDiagramSqlToolNode) o;
