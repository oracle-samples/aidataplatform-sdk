...
public class SyncAiDataPlatformBundleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SyncAiDataPlatformBundleResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SyncAiDataPlatformBundleResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SyncAiDataPlatformBundleResponse o) {
         ...
         */
        @Override
        public SyncAiDataPlatformBundleResponse build() {
            return new SyncAiDataPlatformBundleResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SyncAiDataPlatformBundleResponse)) {
            return false;
        }

        SyncAiDataPlatformBundleResponse other = (SyncAiDataPlatformBundleResponse) o;
