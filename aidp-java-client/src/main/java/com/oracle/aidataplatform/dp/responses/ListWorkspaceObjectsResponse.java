...
public class ListWorkspaceObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned {@code WorkspaceObjectCollection} instance.
     */
    ...
    private ListWorkspaceObjectsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.WorkspaceObjectCollection workspaceObjectCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListWorkspaceObjectsResponse> {
         ...
         */
        @Override
        public Builder copy(ListWorkspaceObjectsResponse o) {
         ...
         */
        @Override
        public ListWorkspaceObjectsResponse build() {
            return new ListWorkspaceObjectsResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, workspaceObjectCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkspaceObjectsResponse)) {
            return false;
        }

        ListWorkspaceObjectsResponse other = (ListWorkspaceObjectsResponse) o;
