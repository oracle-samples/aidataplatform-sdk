...
public class CreateBundleRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateBundleDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateBundleRequest, com.oracle.aidataplatform.dp.model.CreateBundleDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CreateBundleRequest o) {
        ...
        /**
         * Build the instance of CreateBundleRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateBundleRequest
         */
        public CreateBundleRequest build() {
            CreateBundleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateBundleRequest
         */
        public CreateBundleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateBundleRequest(aiDataPlatformId, workspaceKey, createBundleDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBundleRequest)) {
            return false;
        }

        CreateBundleRequest other = (CreateBundleRequest) o;
