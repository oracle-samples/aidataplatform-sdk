...
public class CreateAiDataPlatformWorkspaceModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateModelVersionDetails getBody$() {
        return createModelVersionDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformWorkspaceModelVersionRequest, com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createModelVersionDetails(com.oracle.aidataplatform.dp.model.CreateModelVersionDetails createModelVersionDetails) {
            this.createModelVersionDetails = createModelVersionDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformWorkspaceModelVersionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createModelVersionDetails(o.getCreateModelVersionDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of CreateAiDataPlatformWorkspaceModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformWorkspaceModelVersionRequest
         */
        public CreateAiDataPlatformWorkspaceModelVersionRequest build() {
            CreateAiDataPlatformWorkspaceModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateModelVersionDetails body) {
            createModelVersionDetails(body);
            return this;
        }
         ...
         * @return instance of CreateAiDataPlatformWorkspaceModelVersionRequest
         */
        public CreateAiDataPlatformWorkspaceModelVersionRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformWorkspaceModelVersionRequest request = new CreateAiDataPlatformWorkspaceModelVersionRequest();
            ...
            return request;
            // new CreateAiDataPlatformWorkspaceModelVersionRequest(aiDataPlatformId, workspaceKey, createModelVersionDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformWorkspaceModelVersionRequest)) {
            return false;
        }

        CreateAiDataPlatformWorkspaceModelVersionRequest other = (CreateAiDataPlatformWorkspaceModelVersionRequest) o;
