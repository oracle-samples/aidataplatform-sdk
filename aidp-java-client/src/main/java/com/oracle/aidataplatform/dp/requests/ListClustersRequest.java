...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListClustersRequest, java.lang.Void> {
...
* 
        ...
        public ListClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListClustersRequest(aiDataPlatformId, workspaceKey, state, displayName, displayNameContains, type, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
