...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramRagToolNode.Builder.class)
...
public final class AgentDiagramRagToolNode extends AgentDiagramNode {
...
public Builder inputSchema(RagToolInputSchema inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramRagToolNode build() {
            AgentDiagramRagToolNode model = new AgentDiagramRagToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramRagToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramRagToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, RagToolInputSchema inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramRagToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramRagToolNode)) {
            return false;
        }

        AgentDiagramRagToolNode other = (AgentDiagramRagToolNode) o;
