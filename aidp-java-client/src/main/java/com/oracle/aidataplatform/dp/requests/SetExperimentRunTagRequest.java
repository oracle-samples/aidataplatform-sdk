...
public class SetExperimentRunTagRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<SetExperimentRunTagRequest, com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(SetExperimentRunTagRequest o) {
        ...
        /**
         * Build the instance of SetExperimentRunTagRequest as configured by this builder
         *
         ...
         *
         * @return instance of SetExperimentRunTagRequest
         */
        public SetExperimentRunTagRequest build() {
            SetExperimentRunTagRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SetExperimentRunTagRequest
         */
        public SetExperimentRunTagRequest buildWithoutInvocationCallback() {
            SetExperimentRunTagRequest request = new SetExperimentRunTagRequest();
            ...
            return request;
            // new SetExperimentRunTagRequest(aiDataPlatformId, workspaceKey, setExperimentRunTagDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetExperimentRunTagRequest)) {
            return false;
        }

        SetExperimentRunTagRequest other = (SetExperimentRunTagRequest) o;
