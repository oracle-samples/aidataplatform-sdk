...
public class UpdateViewRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateViewDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateViewRequest, com.oracle.aidataplatform.dp.model.UpdateViewDetails> {
...
* 
        ...
        public UpdateViewRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateViewRequest(aiDataPlatformId, viewKey, updateViewDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
