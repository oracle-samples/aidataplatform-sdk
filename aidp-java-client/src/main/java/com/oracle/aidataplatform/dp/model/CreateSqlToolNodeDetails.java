...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateSqlToolNodeDetails.Builder.class)
...
public final class CreateSqlToolNodeDetails extends CreateAgentFlowNodeDetails {
...
public Builder toolConfig(SqlToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateSqlToolNodeDetails build() {
            CreateSqlToolNodeDetails model = new CreateSqlToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateSqlToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateSqlToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, SqlToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSqlToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSqlToolNodeDetails)) {
            return false;
        }

        CreateSqlToolNodeDetails other = (CreateSqlToolNodeDetails) o;
