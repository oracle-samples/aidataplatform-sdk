...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExadataSchema.Builder.class)
...
public final class ExadataSchema extends Schema {
...
public Builder details(java.util.Map<String, String> details) {
    ...
    return this;
        ...
        public ExadataSchema build() {
            ExadataSchema model = new ExadataSchema(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(ExadataSchema model) {
...
return this;
    ...
    @Deprecated
    public ExadataSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataSchema)) {
            return false;
        }

        ExadataSchema other = (ExadataSchema) o;
