...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramCustomToolNode.Builder.class)
...
public final class AgentDiagramCustomToolNode extends AgentDiagramNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramCustomToolNode build() {
            AgentDiagramCustomToolNode model = new AgentDiagramCustomToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramCustomToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramCustomToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramCustomToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramCustomToolNode)) {
            return false;
        }

        AgentDiagramCustomToolNode other = (AgentDiagramCustomToolNode) o;
