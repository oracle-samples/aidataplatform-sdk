...
public class CreateTableRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateTableDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateTableRequest, com.oracle.aidataplatform.dp.model.CreateTableDetails> {
...
* 
        ...
        public CreateTableRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateTableRequest(aiDataPlatformId, createTableDetails, shouldUpdateRecent, opcRetryToken, opcRequestId);
        }
    }
