...
public class DeleteAiDataPlatformTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformTableRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformTableRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());displayName(o.getDisplayName());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformTableRequest
         */
        public DeleteAiDataPlatformTableRequest build() {
            DeleteAiDataPlatformTableRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformTableRequest
         */
        public DeleteAiDataPlatformTableRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformTableRequest request = new DeleteAiDataPlatformTableRequest();
            ...
            return request;
            // new DeleteAiDataPlatformTableRequest(aiDataPlatformId, tableKey, displayName, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformTableRequest)) {
            return false;
        }

        DeleteAiDataPlatformTableRequest other = (DeleteAiDataPlatformTableRequest) o;
