...
public class RefreshAiDataPlatformTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshAiDataPlatformTableResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshAiDataPlatformTableResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshAiDataPlatformTableResponse o) {
         ...
         */
        @Override
        public RefreshAiDataPlatformTableResponse build() {
            return new RefreshAiDataPlatformTableResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformTableResponse)) {
            return false;
        }

        RefreshAiDataPlatformTableResponse other = (RefreshAiDataPlatformTableResponse) o;
