...
@com.fasterxml.jackson.annotation.JsonTypeInfo(use=com.fasterxml.jackson.annotation.JsonTypeInfo.Id.NAME, include=com.fasterxml.jackson.annotation.JsonTypeInfo.As.PROPERTY, property="type", defaultImpl=UpdateAgentDiagramNodeDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramSqlToolNodeDetails.class, name = "SQL_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramHttpToolNodeDetails.class, name = "HTTP_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramMcpToolNodeDetails.class, name = "MCP_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramPromptToolNodeDetails.class, name = "PROMPT_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramCustomToolNodeDetails.class, name = "CUSTOM_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramAgentNodeDetails.class, name = "AGENT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = UpdateAgentDiagramRagToolNodeDetails.class, name = "RAG_TOOL")
})

public class UpdateAgentDiagramNodeDetails  {
    @Deprecated
    ...
    protected UpdateAgentDiagramNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAgentDiagramNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDiagramNodeDetails)) {
            return false;
        }

        UpdateAgentDiagramNodeDetails other = (UpdateAgentDiagramNodeDetails) o;
