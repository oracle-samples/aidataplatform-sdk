...
public class UpdateAiDataPlatformClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private UpdateAiDataPlatformClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateAiDataPlatformClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateAiDataPlatformClusterResponse o) {
         ...
         */
        @Override
        public UpdateAiDataPlatformClusterResponse build() {
            return new UpdateAiDataPlatformClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformClusterResponse)) {
            return false;
        }

        UpdateAiDataPlatformClusterResponse other = (UpdateAiDataPlatformClusterResponse) o;
