...
public class GetAiDataPlatformRecipientRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformRecipientRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformRecipientRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());recipientKey(o.getRecipientKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformRecipientRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformRecipientRequest
         */
        public GetAiDataPlatformRecipientRequest build() {
            GetAiDataPlatformRecipientRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformRecipientRequest
         */
        public GetAiDataPlatformRecipientRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformRecipientRequest request = new GetAiDataPlatformRecipientRequest();
            ...
            return request;
            // new GetAiDataPlatformRecipientRequest(aiDataPlatformId, recipientKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformRecipientRequest)) {
            return false;
        }

        GetAiDataPlatformRecipientRequest other = (GetAiDataPlatformRecipientRequest) o;
