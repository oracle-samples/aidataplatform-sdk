...
* 
    ...
    private SummarizeMetricsDataResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.SummarizeMetricsResponse summarizeMetricsResponse) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SummarizeMetricsDataResponse> {
...
* 
        ...
        public SummarizeMetricsDataResponse build() {
            return new SummarizeMetricsDataResponse(__httpStatusCode__, headers, etag, opcRequestId, summarizeMetricsResponse);
        }
    }
