...
public class DeployBundleActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private DeployBundleActionResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<DeployBundleActionResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(DeployBundleActionResponse o) {
         ...
         */
        @Override
        public DeployBundleActionResponse build() {
            return new DeployBundleActionResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployBundleActionResponse)) {
            return false;
        }

        DeployBundleActionResponse other = (DeployBundleActionResponse) o;
