...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=KnowledgeBasePermissionSummary.Builder.class)

public final class KnowledgeBasePermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions", "isInherited", "resourceName"})
    public KnowledgeBasePermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<AllKnowledgeBasePrivilege> granteePermissions, Boolean isInherited, String resourceName) {
        super();
...
private java.util.List<AllKnowledgeBasePrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<AllKnowledgeBasePrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}
            /**
...
public Builder resourceName(String resourceName) {
    ...
    return this;
        ...
        public KnowledgeBasePermissionSummary build() {
            KnowledgeBasePermissionSummary model = new KnowledgeBasePermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(KnowledgeBasePermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<AllKnowledgeBasePrivilege> granteePermissions;
    ...
    public java.util.List<AllKnowledgeBasePrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KnowledgeBasePermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KnowledgeBasePermissionSummary)) {
            return false;
        }

        KnowledgeBasePermissionSummary other = (KnowledgeBasePermissionSummary) o;
