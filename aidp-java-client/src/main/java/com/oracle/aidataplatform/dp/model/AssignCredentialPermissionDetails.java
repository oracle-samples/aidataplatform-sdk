...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignCredentialPermissionDetails.Builder.class)

public final class AssignCredentialPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public AssignCredentialPermissionDetails(PermissionAssignees assignees, java.util.List<CredentialPrivilege> permissions) {
        super();
...
public Builder permissions(java.util.List<CredentialPrivilege> permissions) {
    ...
    return this;
        ...
        public AssignCredentialPermissionDetails build() {
            AssignCredentialPermissionDetails model = new AssignCredentialPermissionDetails(this.assignees
                , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssignCredentialPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignCredentialPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignCredentialPermissionDetails)) {
            return false;
        }

        AssignCredentialPermissionDetails other = (AssignCredentialPermissionDetails) o;
