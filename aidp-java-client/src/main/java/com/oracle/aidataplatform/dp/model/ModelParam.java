...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ModelParam.Builder.class)
...
public Builder value(String value) {
    ...
    return this;
        ...
        public ModelParam build() {
            ModelParam model = new ModelParam(this.name
                , this.value);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ModelParam model) {
