...
public class RestartAiDataPlatformClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RestartAiDataPlatformClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RestartAiDataPlatformClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RestartAiDataPlatformClusterResponse o) {
         ...
         */
        @Override
        public RestartAiDataPlatformClusterResponse build() {
            return new RestartAiDataPlatformClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartAiDataPlatformClusterResponse)) {
            return false;
        }

        RestartAiDataPlatformClusterResponse other = (RestartAiDataPlatformClusterResponse) o;
