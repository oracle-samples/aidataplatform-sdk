...
public class ListAiDataPlatformWorkspaceObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAiDataPlatformWorkspaceObjectsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.WorkspaceObjectCollection workspaceObjectCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformWorkspaceObjectsResponse> {
