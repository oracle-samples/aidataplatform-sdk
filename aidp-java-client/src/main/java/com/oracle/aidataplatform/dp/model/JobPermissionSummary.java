...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=JobPermissionSummary.Builder.class)

public final class JobPermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions"})
    public JobPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<JobPrivilege> granteePermissions) {
        super();
...
private java.util.List<JobPrivilege> granteePermissions;
...
public Builder granteePermissions(java.util.List<JobPrivilege> granteePermissions) {
    this.granteePermissions = granteePermissions;
    return this;
}


        public JobPermissionSummary build() {
            JobPermissionSummary model = new JobPermissionSummary(this.grantee
                , this.granteeName
                , this.granteeType
        ...
        public Builder copy(JobPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<JobPrivilege> granteePermissions;
    ...
    public java.util.List<JobPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("JobPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobPermissionSummary)) {
            return false;
        }

        JobPermissionSummary other = (JobPermissionSummary) o;
