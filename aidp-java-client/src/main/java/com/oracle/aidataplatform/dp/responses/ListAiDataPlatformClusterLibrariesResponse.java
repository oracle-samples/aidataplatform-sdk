...
public class ListAiDataPlatformClusterLibrariesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    /**
     * The returned {@code ClusterLibraryCollection} instance.
     */
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "headers", "opcRequestId", "opcNextPage", "opcPrevPage", "opcTotalItems", "clusterLibraryCollection"})
    private ListAiDataPlatformClusterLibrariesResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String opcNextPage, String opcPrevPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.ClusterLibraryCollection clusterLibraryCollection) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ListAiDataPlatformClusterLibrariesResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ListAiDataPlatformClusterLibrariesResponse o) {
         ...
         */
        @Override
        public ListAiDataPlatformClusterLibrariesResponse build() {
            return new ListAiDataPlatformClusterLibrariesResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, opcPrevPage, opcTotalItems, clusterLibraryCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformClusterLibrariesResponse)) {
            return false;
        }

        ListAiDataPlatformClusterLibrariesResponse other = (ListAiDataPlatformClusterLibrariesResponse) o;
