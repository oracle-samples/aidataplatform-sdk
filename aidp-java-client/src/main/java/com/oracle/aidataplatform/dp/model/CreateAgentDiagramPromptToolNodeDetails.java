...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramPromptToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramPromptToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
private PromptToolConfiguration toolConfig;



public Builder toolConfig(PromptToolConfiguration toolConfig) {
    this.toolConfig = toolConfig;
    return this;
}


        public CreateAgentDiagramPromptToolNodeDetails build() {
            CreateAgentDiagramPromptToolNodeDetails model = new CreateAgentDiagramPromptToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramPromptToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramPromptToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, PromptToolConfiguration toolConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("toolConfig")
    private final PromptToolConfiguration toolConfig;

    
    public PromptToolConfiguration getToolConfig() {
        return toolConfig;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramPromptToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramPromptToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramPromptToolNodeDetails other = (CreateAgentDiagramPromptToolNodeDetails) o;
