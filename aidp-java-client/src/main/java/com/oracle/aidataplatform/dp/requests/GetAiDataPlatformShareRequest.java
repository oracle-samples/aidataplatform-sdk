...
public class GetAiDataPlatformShareRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformShareRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformShareRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());shareKey(o.getShareKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformShareRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformShareRequest
         */
        public GetAiDataPlatformShareRequest build() {
            GetAiDataPlatformShareRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformShareRequest
         */
        public GetAiDataPlatformShareRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformShareRequest request = new GetAiDataPlatformShareRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.shareKey = shareKey;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new GetAiDataPlatformShareRequest(aiDataPlatformId, shareKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformShareRequest)) {
            return false;
        }

        GetAiDataPlatformShareRequest other = (GetAiDataPlatformShareRequest) o;
