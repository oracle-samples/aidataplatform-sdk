...
public class RefreshTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshTableResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshTableResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshTableResponse o) {
         ...
         */
        @Override
        public RefreshTableResponse build() {
            return new RefreshTableResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshTableResponse)) {
            return false;
        }

        RefreshTableResponse other = (RefreshTableResponse) o;
