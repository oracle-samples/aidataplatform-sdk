...
public class StartClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private StartClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<StartClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(StartClusterResponse o) {
        ...
        public StartClusterResponse build() {
            return new StartClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartClusterResponse)) {
            return false;
        }

        StartClusterResponse other = (StartClusterResponse) o;
