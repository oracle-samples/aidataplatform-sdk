...
public class GenerateAiDataPlatformTempFileUploadTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GenerateAiDataPlatformTempFileUploadTargetResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GenerateTempFileUploadTargetResponseDetails generateTempFileUploadTargetResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<GenerateAiDataPlatformTempFileUploadTargetResponse> {
