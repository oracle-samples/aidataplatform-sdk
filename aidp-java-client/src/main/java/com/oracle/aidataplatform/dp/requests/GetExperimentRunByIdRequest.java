...
public class GetExperimentRunByIdRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of GetExperimentRunByIdRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetExperimentRunByIdRequest
         */
        public GetExperimentRunByIdRequest build() {
            GetExperimentRunByIdRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetExperimentRunByIdRequest
         */
        public GetExperimentRunByIdRequest buildWithoutInvocationCallback() {
            GetExperimentRunByIdRequest request = new GetExperimentRunByIdRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExperimentRunByIdRequest)) {
            return false;
        }

        GetExperimentRunByIdRequest other = (GetExperimentRunByIdRequest) o;
