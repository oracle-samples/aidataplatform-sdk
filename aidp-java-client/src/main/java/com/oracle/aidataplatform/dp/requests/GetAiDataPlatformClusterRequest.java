...
public class GetAiDataPlatformClusterRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformClusterRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformClusterRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformClusterRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformClusterRequest
         */
        public GetAiDataPlatformClusterRequest build() {
            GetAiDataPlatformClusterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformClusterRequest
         */
        public GetAiDataPlatformClusterRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformClusterRequest request = new GetAiDataPlatformClusterRequest();
            ...
            return request;
            // new GetAiDataPlatformClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformClusterRequest)) {
            return false;
        }

        GetAiDataPlatformClusterRequest other = (GetAiDataPlatformClusterRequest) o;
