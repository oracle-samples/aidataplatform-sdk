...
public class HeadAiDataPlatformWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private HeadAiDataPlatformWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String objectKey, String path, String type, java.util.Date timeUpdated, String fileMetadata, String compositeEtag) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<HeadAiDataPlatformWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(HeadAiDataPlatformWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public HeadAiDataPlatformWorkspaceObjectResponse build() {
            return new HeadAiDataPlatformWorkspaceObjectResponse(__httpStatusCode__, headers, opcRequestId, objectKey, path, type, timeUpdated, fileMetadata, compositeEtag);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadAiDataPlatformWorkspaceObjectResponse)) {
            return false;
        }

        HeadAiDataPlatformWorkspaceObjectResponse other = (HeadAiDataPlatformWorkspaceObjectResponse) o;
