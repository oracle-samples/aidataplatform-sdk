...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SnowflakeTable.Builder.class)
...
public Builder lifecycleStateDetails(String lifecycleStateDetails) {
    ...
    return this;
        ...
        public SnowflakeTable build() {
            SnowflakeTable model = new SnowflakeTable(this.key
                , this.displayName
                , this.catalogKey
                , this.schemaKey
                , this.location
        ...
        public Builder copy(SnowflakeTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnowflakeTable)) {
            return false;
        }

        SnowflakeTable other = (SnowflakeTable) o;
