...
public class CheckoutAiDataPlatformBranchRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CheckoutBranchDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.CheckoutBranchDetails checkoutBranchDetails;
     ...
     * Details for the new branch.
     */
    public com.oracle.aidataplatform.dp.model.CheckoutBranchDetails getCheckoutBranchDetails() {
        return checkoutBranchDetails;
    }
        /**
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CheckoutBranchDetails getBody$() {
        return checkoutBranchDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CheckoutAiDataPlatformBranchRequest, com.oracle.aidataplatform.dp.model.CheckoutBranchDetails> {
     ...
     * Details for the new branch.
     */
        private com.oracle.aidataplatform.dp.model.CheckoutBranchDetails checkoutBranchDetails = null;

        /**
         * Details for the new branch.
         * @param checkoutBranchDetails the value to set
         * @return this builder instance
         */
        public Builder checkoutBranchDetails(com.oracle.aidataplatform.dp.model.CheckoutBranchDetails checkoutBranchDetails) {
            this.checkoutBranchDetails = checkoutBranchDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CheckoutAiDataPlatformBranchRequest o) {
        ...
        /**
         * Build the instance of CheckoutAiDataPlatformBranchRequest as configured by this builder
         *
         ...
         *
         * @return instance of CheckoutAiDataPlatformBranchRequest
         */
        public CheckoutAiDataPlatformBranchRequest build() {
            CheckoutAiDataPlatformBranchRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CheckoutBranchDetails body) {
            checkoutBranchDetails(body);
            return this;
        }
         ...
         * @return instance of CheckoutAiDataPlatformBranchRequest
         */
        public CheckoutAiDataPlatformBranchRequest buildWithoutInvocationCallback() {
            CheckoutAiDataPlatformBranchRequest request = new CheckoutAiDataPlatformBranchRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.checkoutBranchDetails = checkoutBranchDetails;
            ...
            return request;
            // new CheckoutAiDataPlatformBranchRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, checkoutBranchDetails, opcRetryToken, opcRequestId, shouldUpdateRecent, ifMatch, dhUserPrincipal);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",checkoutBranchDetails=").append(String.valueOf(this.checkoutBranchDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckoutAiDataPlatformBranchRequest)) {
            return false;
        }

        CheckoutAiDataPlatformBranchRequest other = (CheckoutAiDataPlatformBranchRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.checkoutBranchDetails, other.checkoutBranchDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.checkoutBranchDetails == null ? 43 : this.checkoutBranchDetails.hashCode());
