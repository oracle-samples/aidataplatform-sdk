...
public class ListAiDataPlatformTablePermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformTablePermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformTablePermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformTablePermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformTablePermissionsRequest
         */
        public ListAiDataPlatformTablePermissionsRequest build() {
            ListAiDataPlatformTablePermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformTablePermissionsRequest
         */
        public ListAiDataPlatformTablePermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformTablePermissionsRequest request = new ListAiDataPlatformTablePermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformTablePermissionsRequest(aiDataPlatformId, tableKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformTablePermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformTablePermissionsRequest other = (ListAiDataPlatformTablePermissionsRequest) o;
