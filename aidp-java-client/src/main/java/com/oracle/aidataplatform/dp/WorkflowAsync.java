...
public interface WorkflowAsync extends AutoCloseable {
    ...
    */
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListTaskRunRetriesResponse> listTaskRunRetries(ListTaskRunRetriesRequest request, com.oracle.bmc.responses.AsyncHandler<ListTaskRunRetriesRequest, ListTaskRunRetriesResponse> handler);
