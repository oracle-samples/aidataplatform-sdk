...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetClusterRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public GetClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, opcRequestId, shouldUpdateRecent);
        }
    }
