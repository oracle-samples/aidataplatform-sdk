...
public class FetchEntityLineageRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails fetchEntityLineageDetails;
     ...
     * The information needed to obtain desired lineage.
     */
    public com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails getFetchEntityLineageDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails getBody$() {
        return fetchEntityLineageDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<FetchEntityLineageRequest, com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails> {
     ...
     * The information needed to obtain desired lineage.
     */
        private com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails fetchEntityLineageDetails = null;
         ...
         * @return this builder instance
         */
        public Builder fetchEntityLineageDetails(com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails fetchEntityLineageDetails) {
...
* 
        ...
        public Builder copy(FetchEntityLineageRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());fetchEntityLineageDetails(o.getFetchEntityLineageDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());limit(o.getLimit());page(o.getPage());
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.FetchEntityLineageDetails body) {
        ...
        public FetchEntityLineageRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new FetchEntityLineageRequest(aiDataPlatformId, fetchEntityLineageDetails, opcRetryToken, opcRequestId, ifMatch, limit, page);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",fetchEntityLineageDetails=").append(String.valueOf(this.fetchEntityLineageDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.fetchEntityLineageDetails, other.fetchEntityLineageDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.fetchEntityLineageDetails == null ? 43 : this.fetchEntityLineageDetails.hashCode());
