...
public class UpdateAgentDeploymentMetadataRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentMetadataDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentMetadataDetails getBody$() {
        return updateAgentDeploymentMetadataDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAgentDeploymentMetadataRequest, com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentMetadataDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder updateAgentDeploymentMetadataDetails(com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentMetadataDetails updateAgentDeploymentMetadataDetails) {
            this.updateAgentDeploymentMetadataDetails = updateAgentDeploymentMetadataDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAgentDeploymentMetadataRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());updateAgentDeploymentMetadataDetails(o.getUpdateAgentDeploymentMetadataDetails());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of UpdateAgentDeploymentMetadataRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAgentDeploymentMetadataRequest
         */
        public UpdateAgentDeploymentMetadataRequest build() {
            UpdateAgentDeploymentMetadataRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateAgentDeploymentMetadataDetails body) {
            updateAgentDeploymentMetadataDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateAgentDeploymentMetadataRequest
         */
        public UpdateAgentDeploymentMetadataRequest buildWithoutInvocationCallback() {
            UpdateAgentDeploymentMetadataRequest request = new UpdateAgentDeploymentMetadataRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.agentKey = agentKey;
            request.updateAgentDeploymentMetadataDetails = updateAgentDeploymentMetadataDetails;
            request.shouldUpdateRecent = shouldUpdateRecent;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateAgentDeploymentMetadataRequest(aiDataPlatformId, workspaceKey, agentKey, updateAgentDeploymentMetadataDetails, shouldUpdateRecent, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateAgentDeploymentMetadataDetails=").append(String.valueOf(this.updateAgentDeploymentMetadataDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentDeploymentMetadataRequest)) {
            return false;
        }

        UpdateAgentDeploymentMetadataRequest other = (UpdateAgentDeploymentMetadataRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.updateAgentDeploymentMetadataDetails, other.updateAgentDeploymentMetadataDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateAgentDeploymentMetadataDetails == null ? 43 : this.updateAgentDeploymentMetadataDetails.hashCode());
