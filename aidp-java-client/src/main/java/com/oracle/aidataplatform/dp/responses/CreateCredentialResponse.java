...
public class CreateCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateCredentialResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId) {
        super(__httpStatusCode__, headers);
        this.opcRequestId = opcRequestId;

    }

    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCredentialResponse> {
        ...
        public CreateCredentialResponse build() {
            return new CreateCredentialResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
