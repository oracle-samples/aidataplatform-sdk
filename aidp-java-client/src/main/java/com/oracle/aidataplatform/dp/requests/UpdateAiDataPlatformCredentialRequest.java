...
public class UpdateAiDataPlatformCredentialRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateDataLakeCredentialDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateDataLakeCredentialDetails getBody$() {
        return updateDataLakeCredentialDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformCredentialRequest, com.oracle.aidataplatform.dp.model.UpdateDataLakeCredentialDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder updateDataLakeCredentialDetails(com.oracle.aidataplatform.dp.model.UpdateDataLakeCredentialDetails updateDataLakeCredentialDetails) {
            this.updateDataLakeCredentialDetails = updateDataLakeCredentialDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformCredentialRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());credentialKey(o.getCredentialKey());updateDataLakeCredentialDetails(o.getUpdateDataLakeCredentialDetails());shouldUpdateRecent(o.getShouldUpdateRecent());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of UpdateAiDataPlatformCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformCredentialRequest
         */
        public UpdateAiDataPlatformCredentialRequest build() {
            UpdateAiDataPlatformCredentialRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateDataLakeCredentialDetails body) {
            updateDataLakeCredentialDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateAiDataPlatformCredentialRequest
         */
        public UpdateAiDataPlatformCredentialRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformCredentialRequest request = new UpdateAiDataPlatformCredentialRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.credentialKey = credentialKey;
            request.updateDataLakeCredentialDetails = updateDataLakeCredentialDetails;
            request.shouldUpdateRecent = shouldUpdateRecent;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateAiDataPlatformCredentialRequest(aiDataPlatformId, credentialKey, updateDataLakeCredentialDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateDataLakeCredentialDetails=").append(String.valueOf(this.updateDataLakeCredentialDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformCredentialRequest)) {
            return false;
        }

        UpdateAiDataPlatformCredentialRequest other = (UpdateAiDataPlatformCredentialRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.credentialKey, other.credentialKey)
            && java.util.Objects.equals(this.updateDataLakeCredentialDetails, other.updateDataLakeCredentialDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateDataLakeCredentialDetails == null ? 43 : this.updateDataLakeCredentialDetails.hashCode());
