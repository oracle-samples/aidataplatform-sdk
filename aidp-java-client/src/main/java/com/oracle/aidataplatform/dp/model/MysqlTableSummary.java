...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MysqlTableSummary.Builder.class)
...
public final class MysqlTableSummary extends TableSummary {
...
public Builder lifecycleState(TableLifecycleState lifecycleState) {
    ...
    return this;
        ...
        public MysqlTableSummary build() {
            MysqlTableSummary model = new MysqlTableSummary(this.key
                , this.displayName
                , this.tableType
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(MysqlTableSummary model) {
...
return this;
    ...
    @Deprecated
    public MysqlTableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MysqlTableSummary)) {
            return false;
        }

        MysqlTableSummary other = (MysqlTableSummary) o;
