...
public class ValidateAgentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ValidateAgentRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ValidateAgentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ValidateAgentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ValidateAgentRequest
         */
        public ValidateAgentRequest build() {
            ValidateAgentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ValidateAgentRequest
         */
        public ValidateAgentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ValidateAgentRequest(aiDataPlatformId, workspaceKey, agentKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateAgentRequest)) {
            return false;
        }

        ValidateAgentRequest other = (ValidateAgentRequest) o;
