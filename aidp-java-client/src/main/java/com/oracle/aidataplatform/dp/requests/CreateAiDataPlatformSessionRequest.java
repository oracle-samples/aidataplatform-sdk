...
public class CreateAiDataPlatformSessionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateSessionDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.CreateSessionDetails createSessionDetails;
     ...
     * Details to create a new session.
     */
    public com.oracle.aidataplatform.dp.model.CreateSessionDetails getCreateSessionDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateSessionDetails getBody$() {
        return createSessionDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformSessionRequest, com.oracle.aidataplatform.dp.model.CreateSessionDetails> {
     ...
     * Details to create a new session.
     */
        private com.oracle.aidataplatform.dp.model.CreateSessionDetails createSessionDetails = null;
         ...
         * @return this builder instance
         */
        public Builder createSessionDetails(com.oracle.aidataplatform.dp.model.CreateSessionDetails createSessionDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformSessionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createSessionDetails(o.getCreateSessionDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());datalakeTenantId(o.getDatalakeTenantId());
        ...
        /**
         * Build the instance of CreateAiDataPlatformSessionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformSessionRequest
         */
        public CreateAiDataPlatformSessionRequest build() {
            CreateAiDataPlatformSessionRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateSessionDetails body) {
         ...
         * @return instance of CreateAiDataPlatformSessionRequest
         */
        public CreateAiDataPlatformSessionRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformSessionRequest request = new CreateAiDataPlatformSessionRequest();
            ...
            return request;
            // new CreateAiDataPlatformSessionRequest(aiDataPlatformId, workspaceKey, createSessionDetails, opcRetryToken, opcRequestId, datalakeTenantId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformSessionRequest)) {
            return false;
        }

        CreateAiDataPlatformSessionRequest other = (CreateAiDataPlatformSessionRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createSessionDetails == null ? 43 : this.createSessionDetails.hashCode());
