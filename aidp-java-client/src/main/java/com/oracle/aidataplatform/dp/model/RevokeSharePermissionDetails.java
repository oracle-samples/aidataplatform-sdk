...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeSharePermissionDetails.Builder.class)

public final class RevokeSharePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public RevokeSharePermissionDetails(PermissionAssignees assignees, java.util.List<SharePrivilege> permissions) {
        super();
...
public Builder permissions(java.util.List<SharePrivilege> permissions) {
    ...
    return this;
        ...
        public RevokeSharePermissionDetails build() {
            RevokeSharePermissionDetails model = new RevokeSharePermissionDetails(this.assignees
                , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeSharePermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeSharePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeSharePermissionDetails)) {
            return false;
        }

        RevokeSharePermissionDetails other = (RevokeSharePermissionDetails) o;
