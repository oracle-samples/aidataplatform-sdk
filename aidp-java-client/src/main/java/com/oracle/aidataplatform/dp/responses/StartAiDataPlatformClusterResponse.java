...
public class StartAiDataPlatformClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private StartAiDataPlatformClusterResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<StartAiDataPlatformClusterResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(StartAiDataPlatformClusterResponse o) {
         ...
         */
        @Override
        public StartAiDataPlatformClusterResponse build() {
            return new StartAiDataPlatformClusterResponse(__httpStatusCode__, headers, aidpAsyncOperationKey, opcRequestId, etag, cluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartAiDataPlatformClusterResponse)) {
            return false;
        }

        StartAiDataPlatformClusterResponse other = (StartAiDataPlatformClusterResponse) o;
