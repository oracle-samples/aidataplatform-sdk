...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExportContentsDetails.Builder.class)

public final class ExportContentsDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"format"})
    public ExportContentsDetails(Format format) {
        super();
        this.format = format;
    }
...
public Builder format(Format format) {
    ...
    return this;
        ...
        public ExportContentsDetails build() {
            ExportContentsDetails model = new ExportContentsDetails(this.format);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExportContentsDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExportContentsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportContentsDetails)) {
            return false;
        }

        ExportContentsDetails other = (ExportContentsDetails) o;
