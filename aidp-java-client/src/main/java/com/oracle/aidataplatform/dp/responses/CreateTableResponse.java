...
public class CreateTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateTableResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTableResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateTableResponse o) {
        ...
        public CreateTableResponse build() {
            return new CreateTableResponse(__httpStatusCode__, headers, location, contentLocation, aidpAsyncOperationKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTableResponse)) {
            return false;
        }

        CreateTableResponse other = (CreateTableResponse) o;
