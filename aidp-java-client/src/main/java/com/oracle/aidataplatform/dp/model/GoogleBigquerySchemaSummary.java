...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=GoogleBigquerySchemaSummary.Builder.class)
...
public final class GoogleBigquerySchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public GoogleBigquerySchemaSummary build() {
            GoogleBigquerySchemaSummary model = new GoogleBigquerySchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(GoogleBigquerySchemaSummary model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GoogleBigquerySchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleBigquerySchemaSummary)) {
            return false;
        }

        GoogleBigquerySchemaSummary other = (GoogleBigquerySchemaSummary) o;
