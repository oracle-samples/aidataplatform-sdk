...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExperimentTag.Builder.class)
...
public Builder value(String value) {
    ...
    return this;
        ...
        public ExperimentTag build() {
            ExperimentTag model = new ExperimentTag(this.key
                , this.value);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExperimentTag model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExperimentTag)) {
            return false;
        }

        ExperimentTag other = (ExperimentTag) o;
