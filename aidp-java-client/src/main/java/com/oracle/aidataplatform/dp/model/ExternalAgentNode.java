...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExternalAgentNode.Builder.class)
...
public final class ExternalAgentNode extends AgentFlowNode {
...
@com.fasterxml.jackson.annotation.JsonProperty("externalAgentConfig")
private java.util.Map<String, String> externalAgentConfig;

        /**
         * Extra configuration for the external agent node.
         * @param externalAgentConfig the value to set
         * @return this builder
         **/
        

public Builder externalAgentConfig(java.util.Map<String, String> externalAgentConfig) {
    this.externalAgentConfig = externalAgentConfig;
    return this;
}


        public ExternalAgentNode build() {
            ExternalAgentNode model = new ExternalAgentNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
                ...
                , this.instructions
                , this.externalAgentConfig);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalAgentNode model) {
    ...
    this.externalAgentConfig(model.getExternalAgentConfig());
return this;
        }
    }
    ...
    @Deprecated
    public ExternalAgentNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, String instructions, java.util.Map<String, String> externalAgentConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("externalAgentConfig")
    private final java.util.Map<String, String> externalAgentConfig;
    ...
    public java.util.Map<String, String> getExternalAgentConfig() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalAgentNode(");
        sb.append("super=").append(super.toString(includeByteArrayContents));
        sb.append(", instructions=").append(String.valueOf(this.instructions));
        sb.append(", externalAgentConfig=").append(String.valueOf(this.externalAgentConfig));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalAgentNode)) {
            return false;
        }

        ExternalAgentNode other = (ExternalAgentNode) o;
        return java.util.Objects.equals(this.instructions, other.instructions) &&
            java.util.Objects.equals(this.externalAgentConfig, other.externalAgentConfig) &&
            super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.externalAgentConfig == null ? 43 : this.externalAgentConfig.hashCode());
        return result;
    }
