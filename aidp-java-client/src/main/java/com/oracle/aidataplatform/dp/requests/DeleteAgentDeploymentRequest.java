...
public class DeleteAgentDeploymentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAgentDeploymentRequest, java.lang.Void> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder agentDeploymentKey(String agentDeploymentKey) {
            this.agentDeploymentKey = agentDeploymentKey;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAgentDeploymentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());agentKey(o.getAgentKey());agentDeploymentKey(o.getAgentDeploymentKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of DeleteAgentDeploymentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAgentDeploymentRequest
         */
        public DeleteAgentDeploymentRequest build() {
            DeleteAgentDeploymentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAgentDeploymentRequest
         */
        public DeleteAgentDeploymentRequest buildWithoutInvocationCallback() {
            DeleteAgentDeploymentRequest request = new DeleteAgentDeploymentRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.agentKey = agentKey;
            request.agentDeploymentKey = agentDeploymentKey;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteAgentDeploymentRequest(aiDataPlatformId, workspaceKey, agentKey, agentDeploymentKey, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
            ...
            .agentKey(agentKey)
            .agentDeploymentKey(agentDeploymentKey)
            .ifMatch(ifMatch)
    ...
    public String toString() {
        ...
        sb.append(",agentDeploymentKey=").append(String.valueOf(this.agentDeploymentKey));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAgentDeploymentRequest)) {
            return false;
        }

        DeleteAgentDeploymentRequest other = (DeleteAgentDeploymentRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.agentDeploymentKey, other.agentDeploymentKey)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.agentDeploymentKey == null ? 43 : this.agentDeploymentKey.hashCode());
