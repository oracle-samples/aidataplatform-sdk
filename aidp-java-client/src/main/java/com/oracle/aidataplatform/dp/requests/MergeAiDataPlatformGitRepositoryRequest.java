...
public class MergeAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitMergeDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.GitMergeDetails getBody$() {
        return gitMergeDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<MergeAiDataPlatformGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitMergeDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder gitMergeDetails(com.oracle.aidataplatform.dp.model.GitMergeDetails gitMergeDetails) {
            this.gitMergeDetails = gitMergeDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(MergeAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());gitMergeDetails(o.getGitMergeDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of MergeAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of MergeAiDataPlatformGitRepositoryRequest
         */
        public MergeAiDataPlatformGitRepositoryRequest build() {
            MergeAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.GitMergeDetails body) {
            gitMergeDetails(body);
            return this;
        }
         ...
         * @return instance of MergeAiDataPlatformGitRepositoryRequest
         */
        public MergeAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            MergeAiDataPlatformGitRepositoryRequest request = new MergeAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.gitMergeDetails = gitMergeDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new MergeAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitMergeDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",gitMergeDetails=").append(String.valueOf(this.gitMergeDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MergeAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        MergeAiDataPlatformGitRepositoryRequest other = (MergeAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.gitMergeDetails, other.gitMergeDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.gitMergeDetails == null ? 43 : this.gitMergeDetails.hashCode());
