...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramMcpToolNode.Builder.class)
...
public final class AgentDiagramMcpToolNode extends AgentDiagramNode {
...
public Builder inputSchema(java.util.Map<String, Object> inputSchema) {
    ...
    return this;
        ...
        public AgentDiagramMcpToolNode build() {
            AgentDiagramMcpToolNode model = new AgentDiagramMcpToolNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramMcpToolNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramMcpToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramMcpToolNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramMcpToolNode)) {
            return false;
        }

        AgentDiagramMcpToolNode other = (AgentDiagramMcpToolNode) o;
