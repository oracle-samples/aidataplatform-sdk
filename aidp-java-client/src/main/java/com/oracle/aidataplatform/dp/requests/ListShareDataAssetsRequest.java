...
public class ListShareDataAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListShareDataAssetsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListShareDataAssetsRequest o) {
        ...
        /**
         * Build the instance of ListShareDataAssetsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListShareDataAssetsRequest
         */
        public ListShareDataAssetsRequest build() {
            ListShareDataAssetsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListShareDataAssetsRequest
         */
        public ListShareDataAssetsRequest buildWithoutInvocationCallback() {
            ListShareDataAssetsRequest request = new ListShareDataAssetsRequest();
            ...
            return request;
            // new ListShareDataAssetsRequest(aiDataPlatformId, shareKey, displayName, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListShareDataAssetsRequest)) {
            return false;
        }

        ListShareDataAssetsRequest other = (ListShareDataAssetsRequest) o;
