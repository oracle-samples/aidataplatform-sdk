...
public class ListAiDataPlatformFilesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformFilesRequest, java.lang.Void> {
     ...
     */
        ...
        /**
         * A boolean which decides if nested files should be in the list files in volume response.
         * @param isRecursive the value to set
         * @return this builder instance
         */
     ...
     * Comma separated keys to have in list response.
     */
        private String metadataKeys = null;
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformFilesRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());volumeKey(o.getVolumeKey());path(o.getPath());isRecursive(o.getIsRecursive());displayName(o.getDisplayName());metadataKeys(o.getMetadataKeys());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformFilesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformFilesRequest
         */
        public ListAiDataPlatformFilesRequest build() {
            ListAiDataPlatformFilesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformFilesRequest
         */
        public ListAiDataPlatformFilesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformFilesRequest request = new ListAiDataPlatformFilesRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.volumeKey = volumeKey;
            request.path = path;
            request.isRecursive = isRecursive;
            request.displayName = displayName;
            request.metadataKeys = metadataKeys;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new ListAiDataPlatformFilesRequest(aiDataPlatformId, volumeKey, path, isRecursive, displayName, metadataKeys, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",isRecursive=").append(String.valueOf(this.isRecursive));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformFilesRequest)) {
            return false;
        }

        ListAiDataPlatformFilesRequest other = (ListAiDataPlatformFilesRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.volumeKey, other.volumeKey)
            && java.util.Objects.equals(this.path, other.path)
            && java.util.Objects.equals(this.isRecursive, other.isRecursive)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.isRecursive == null ? 43 : this.isRecursive.hashCode());
