...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListTaskRunsRequest, java.lang.Void> {
...
* 
        ...
        public ListTaskRunsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTaskRunsRequest(aiDataPlatformId, workspaceKey, jobRunKey, displayName, status, parentJobRunKey, rootJobRunKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
