...
public class SetAiDataPlatformModelVersionTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private SetAiDataPlatformModelVersionTagResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.SetModelVersionTagResponseDetails setModelVersionTagResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<SetAiDataPlatformModelVersionTagResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(SetAiDataPlatformModelVersionTagResponse o) {
         ...
         */
        @Override
        public SetAiDataPlatformModelVersionTagResponse build() {
            return new SetAiDataPlatformModelVersionTagResponse(__httpStatusCode__, headers, etag, opcRequestId, setModelVersionTagResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetAiDataPlatformModelVersionTagResponse)) {
            return false;
        }

        SetAiDataPlatformModelVersionTagResponse other = (SetAiDataPlatformModelVersionTagResponse) o;
