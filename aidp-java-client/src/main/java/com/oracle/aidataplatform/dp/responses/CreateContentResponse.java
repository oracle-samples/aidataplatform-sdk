...
public class CreateContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateContentResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String etag, String opcWorkRequestId, String opcRequestId, com.oracle.aidataplatform.dp.model.Content content) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateContentResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateContentResponse o) {
        ...
        public CreateContentResponse build() {
            return new CreateContentResponse(__httpStatusCode__, headers, location, etag, opcWorkRequestId, opcRequestId, content);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContentResponse)) {
            return false;
        }

        CreateContentResponse other = (CreateContentResponse) o;
