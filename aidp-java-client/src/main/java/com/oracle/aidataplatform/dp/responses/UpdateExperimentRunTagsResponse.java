...
public class UpdateExperimentRunTagsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private UpdateExperimentRunTagsResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.UpdateExperimentRunTagsResponseDetails updateExperimentRunTagsResponseDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateExperimentRunTagsResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(UpdateExperimentRunTagsResponse o) {
         ...
         */
        @Override
        public UpdateExperimentRunTagsResponse build() {
            return new UpdateExperimentRunTagsResponse(__httpStatusCode__, headers, etag, opcRequestId, updateExperimentRunTagsResponseDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExperimentRunTagsResponse)) {
            return false;
        }

        UpdateExperimentRunTagsResponse other = (UpdateExperimentRunTagsResponse) o;
