...
public class UpdateAiDataPlatformClusterRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateClusterDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.UpdateClusterDetails updateClusterDetails;
     ...
     * The information to be updated.
     */
    public com.oracle.aidataplatform.dp.model.UpdateClusterDetails getUpdateClusterDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateClusterDetails getBody$() {
        return updateClusterDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformClusterRequest, com.oracle.aidataplatform.dp.model.UpdateClusterDetails> {
     ...
     * The information to be updated.
     */
        private com.oracle.aidataplatform.dp.model.UpdateClusterDetails updateClusterDetails = null;
         ...
         * @return this builder instance
         */
        public Builder updateClusterDetails(com.oracle.aidataplatform.dp.model.UpdateClusterDetails updateClusterDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformClusterRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());clusterKey(o.getClusterKey());updateClusterDetails(o.getUpdateClusterDetails());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of UpdateAiDataPlatformClusterRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformClusterRequest
         */
        public UpdateAiDataPlatformClusterRequest build() {
            UpdateAiDataPlatformClusterRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateClusterDetails body) {
         ...
         * @return instance of UpdateAiDataPlatformClusterRequest
         */
        public UpdateAiDataPlatformClusterRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformClusterRequest request = new UpdateAiDataPlatformClusterRequest();
            ...
            return request;
            // new UpdateAiDataPlatformClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, updateClusterDetails, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformClusterRequest)) {
            return false;
        }

        UpdateAiDataPlatformClusterRequest other = (UpdateAiDataPlatformClusterRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateClusterDetails == null ? 43 : this.updateClusterDetails.hashCode());
