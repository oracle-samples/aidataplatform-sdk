...
public class ResetAiDataPlatformGitFolderStateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private ResetAiDataPlatformGitFolderStateResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<ResetAiDataPlatformGitFolderStateResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(ResetAiDataPlatformGitFolderStateResponse o) {
         ...
         */
        @Override
        public ResetAiDataPlatformGitFolderStateResponse build() {
            return new ResetAiDataPlatformGitFolderStateResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetAiDataPlatformGitFolderStateResponse)) {
            return false;
        }

        ResetAiDataPlatformGitFolderStateResponse other = (ResetAiDataPlatformGitFolderStateResponse) o;
