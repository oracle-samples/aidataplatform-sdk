...
public class UpdateJobRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateJobDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateJobRequest, com.oracle.aidataplatform.dp.model.UpdateJobDetails> {
...
* 
     ...
     */
        ...
        public UpdateJobRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateJobRequest(aiDataPlatformId, workspaceKey, jobKey, updateJobDetails, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
