...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentEdgeDetails.Builder.class)

public final class CreateAgentEdgeDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"srcNodeId", "destNodeId", "srcNodeOutput", "destNodeInput", "parentNodeId", "edgeHandles", "edgeType"})
    public CreateAgentEdgeDetails(String srcNodeId, String destNodeId, String srcNodeOutput, String destNodeInput, String parentNodeId, java.util.List<Point> edgeHandles, String edgeType) {
        super();
...
public Builder edgeType(String edgeType) {
    ...
    return this;
        ...
        public CreateAgentEdgeDetails build() {
            CreateAgentEdgeDetails model = new CreateAgentEdgeDetails(this.srcNodeId
                , this.destNodeId
                , this.srcNodeOutput
                , this.destNodeInput
                , this.parentNodeId
        ...
        public Builder copy(CreateAgentEdgeDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentEdgeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentEdgeDetails)) {
            return false;
        }

        CreateAgentEdgeDetails other = (CreateAgentEdgeDetails) o;
