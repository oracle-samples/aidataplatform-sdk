...
public class UpdateExperimentRunRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateExperimentRunDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateExperimentRunRequest, com.oracle.aidataplatform.dp.model.UpdateExperimentRunDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateExperimentRunRequest o) {
        ...
        /**
         * Build the instance of UpdateExperimentRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateExperimentRunRequest
         */
        public UpdateExperimentRunRequest build() {
            UpdateExperimentRunRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateExperimentRunRequest
         */
        public UpdateExperimentRunRequest buildWithoutInvocationCallback() {
            UpdateExperimentRunRequest request = new UpdateExperimentRunRequest();
            ...
            return request;
            // new UpdateExperimentRunRequest(aiDataPlatformId, workspaceKey, updateExperimentRunDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExperimentRunRequest)) {
            return false;
        }

        UpdateExperimentRunRequest other = (UpdateExperimentRunRequest) o;
