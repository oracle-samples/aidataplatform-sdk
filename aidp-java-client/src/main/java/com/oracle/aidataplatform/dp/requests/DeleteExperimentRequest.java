...
* 
        ...
        public Builder copy(DeleteExperimentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());deleteExperimentDetails(o.getDeleteExperimentDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        public DeleteExperimentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteExperimentRequest(aiDataPlatformId, workspaceKey, deleteExperimentDetails, opcRetryToken, opcRequestId);
        }
    }
