...
public class DeleteExperimentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeleteExperimentDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteExperimentRequest, com.oracle.aidataplatform.dp.model.DeleteExperimentDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteExperimentRequest o) {
        ...
        /**
         * Build the instance of DeleteExperimentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteExperimentRequest
         */
        public DeleteExperimentRequest build() {
            DeleteExperimentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteExperimentRequest
         */
        public DeleteExperimentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteExperimentRequest(aiDataPlatformId, workspaceKey, deleteExperimentDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExperimentRequest)) {
            return false;
        }

        DeleteExperimentRequest other = (DeleteExperimentRequest) o;
