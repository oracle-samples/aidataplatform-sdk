...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateAgentDiagramCustomToolNodeDetails.Builder.class)
...
public final class CreateAgentDiagramCustomToolNodeDetails extends CreateAgentDiagramNodeDetails {
...
public Builder toolConfig(CustomToolConfiguration toolConfig) {
    ...
    return this;
        ...
        public CreateAgentDiagramCustomToolNodeDetails build() {
            CreateAgentDiagramCustomToolNodeDetails model = new CreateAgentDiagramCustomToolNodeDetails(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(CreateAgentDiagramCustomToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateAgentDiagramCustomToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, CustomToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentDiagramCustomToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentDiagramCustomToolNodeDetails)) {
            return false;
        }

        CreateAgentDiagramCustomToolNodeDetails other = (CreateAgentDiagramCustomToolNodeDetails) o;
