...
public class RefreshTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshTableRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshTableRequest o) {
        ...
        /**
         * Build the instance of RefreshTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshTableRequest
         */
        public RefreshTableRequest build() {
            RefreshTableRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshTableRequest
         */
        public RefreshTableRequest buildWithoutInvocationCallback() {
            RefreshTableRequest request = new RefreshTableRequest();
            ...
            return request;
            // new RefreshTableRequest(aiDataPlatformId, tableKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshTableRequest)) {
            return false;
        }

        RefreshTableRequest other = (RefreshTableRequest) o;
