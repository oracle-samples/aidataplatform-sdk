...
public class CreateSchemaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CreateSchemaResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String aidpAsyncOperationKey, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSchemaResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CreateSchemaResponse o) {
        ...
        public CreateSchemaResponse build() {
            return new CreateSchemaResponse(__httpStatusCode__, headers, location, contentLocation, aidpAsyncOperationKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSchemaResponse)) {
            return false;
        }

        CreateSchemaResponse other = (CreateSchemaResponse) o;
