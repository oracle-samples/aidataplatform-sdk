...
public class CancelAiDataPlatformJobRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CancelAiDataPlatformJobRunsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CancelAiDataPlatformJobRunsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobKey(o.getJobKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());opcRetryToken(o.getOpcRetryToken());
        ...
        /**
         * Build the instance of CancelAiDataPlatformJobRunsRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelAiDataPlatformJobRunsRequest
         */
        public CancelAiDataPlatformJobRunsRequest build() {
            CancelAiDataPlatformJobRunsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CancelAiDataPlatformJobRunsRequest
         */
        public CancelAiDataPlatformJobRunsRequest buildWithoutInvocationCallback() {
            CancelAiDataPlatformJobRunsRequest request = new CancelAiDataPlatformJobRunsRequest();
            ...
            return request;
            // new CancelAiDataPlatformJobRunsRequest(aiDataPlatformId, workspaceKey, jobKey, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelAiDataPlatformJobRunsRequest)) {
            return false;
        }

        CancelAiDataPlatformJobRunsRequest other = (CancelAiDataPlatformJobRunsRequest) o;
