...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentDiagramGuardrailNode.Builder.class)
...
public final class AgentDiagramGuardrailNode extends AgentDiagramNode {
...
public Builder extraGuardrailsConfig(java.util.Map<String, String> extraGuardrailsConfig) {
    ...
    return this;
        ...
        public AgentDiagramGuardrailNode build() {
            AgentDiagramGuardrailNode model = new AgentDiagramGuardrailNode(this.nodeType
                , this.name
                , this.description
                , this.positionX
                , this.positionY
        ...
        public Builder copy(AgentDiagramGuardrailNode model) {
...
return this;
    ...
    @Deprecated
    public AgentDiagramGuardrailNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, String guardrailsConfigKey, java.util.Map<String, String> extraGuardrailsConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AgentDiagramGuardrailNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentDiagramGuardrailNode)) {
            return false;
        }

        AgentDiagramGuardrailNode other = (AgentDiagramGuardrailNode) o;
