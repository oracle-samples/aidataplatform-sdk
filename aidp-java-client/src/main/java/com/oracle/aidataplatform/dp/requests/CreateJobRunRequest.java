...
public class CreateJobRunRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateJobRunDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateJobRunRequest, com.oracle.aidataplatform.dp.model.CreateJobRunDetails> {
...
* 
     ...
     */
        ...
        public CreateJobRunRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateJobRunRequest(aiDataPlatformId, workspaceKey, createJobRunDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
