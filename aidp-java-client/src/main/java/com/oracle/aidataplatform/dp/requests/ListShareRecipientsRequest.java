...
public class ListShareRecipientsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListShareRecipientsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListShareRecipientsRequest o) {
        ...
        /**
         * Build the instance of ListShareRecipientsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListShareRecipientsRequest
         */
        public ListShareRecipientsRequest build() {
            ListShareRecipientsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListShareRecipientsRequest
         */
        public ListShareRecipientsRequest buildWithoutInvocationCallback() {
            ListShareRecipientsRequest request = new ListShareRecipientsRequest();
            ...
            return request;
            // new ListShareRecipientsRequest(aiDataPlatformId, shareKey, displayName, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListShareRecipientsRequest)) {
            return false;
        }

        ListShareRecipientsRequest other = (ListShareRecipientsRequest) o;
