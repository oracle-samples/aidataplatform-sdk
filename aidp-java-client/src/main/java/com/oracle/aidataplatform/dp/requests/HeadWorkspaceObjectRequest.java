...
public class HeadWorkspaceObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<HeadWorkspaceObjectRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(HeadWorkspaceObjectRequest o) {
        ...
        /**
         * Build the instance of HeadWorkspaceObjectRequest as configured by this builder
         *
         ...
         *
         * @return instance of HeadWorkspaceObjectRequest
         */
        public HeadWorkspaceObjectRequest build() {
            HeadWorkspaceObjectRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of HeadWorkspaceObjectRequest
         */
        public HeadWorkspaceObjectRequest buildWithoutInvocationCallback() {
            HeadWorkspaceObjectRequest request = new HeadWorkspaceObjectRequest();
            ...
            return request;
            // new HeadWorkspaceObjectRequest(aiDataPlatformId, workspaceKey, objectPath, shouldIncludeMetadata, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadWorkspaceObjectRequest)) {
            return false;
        }

        HeadWorkspaceObjectRequest other = (HeadWorkspaceObjectRequest) o;
