...
public final class Workspace  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "displayName", "description", "type", "timeCreated", "timeUpdated", "lifecycleState", "lifecycleDetails", "systemTags", "createdBy", "createdByName", "updatedBy", "updatedByName", "defaultCatalogKey", "isPrivateNetworkEnabled", "networkConfigurationDetails", "logGroupId", "aicUserSchemaName"})
    public Workspace(String key, String displayName, String description, Type type, java.util.Date timeCreated, java.util.Date timeUpdated, LifecycleState lifecycleState, String lifecycleDetails, java.util.Map<String, java.util.Map<String, Object>> systemTags, String createdBy, String createdByName, String updatedBy, String updatedByName, String defaultCatalogKey, Boolean isPrivateNetworkEnabled, WorkspaceNetworkConfigurationDetails networkConfigurationDetails, String logGroupId, String aicUserSchemaName) {
        super();
        this.key = key;
...
public Builder aicUserSchemaName(String aicUserSchemaName) {
    ...
    return this;
        ...
        public Workspace build() {
            Workspace model = new Workspace(this.key
                , this.displayName
                , this.description
                , this.type
                , this.timeCreated
                ...
                , this.networkConfigurationDetails
                , this.logGroupId
