...
public class GetAiDataPlatformRegisteredModelRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformRegisteredModelRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformRegisteredModelRequest o) {
        ...
        /**
         * Build the instance of GetAiDataPlatformRegisteredModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformRegisteredModelRequest
         */
        public GetAiDataPlatformRegisteredModelRequest build() {
            GetAiDataPlatformRegisteredModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformRegisteredModelRequest
         */
        public GetAiDataPlatformRegisteredModelRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformRegisteredModelRequest request = new GetAiDataPlatformRegisteredModelRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.name = name;
            request.opcRequestId = opcRequestId;
            request.dhUserPrincipal = dhUserPrincipal;
            return request;
            // new GetAiDataPlatformRegisteredModelRequest(aiDataPlatformId, name, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformRegisteredModelRequest)) {
            return false;
        }

        GetAiDataPlatformRegisteredModelRequest other = (GetAiDataPlatformRegisteredModelRequest) o;
