...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateAiComputeDetails.Builder.class)
...
public final class UpdateAiComputeDetails extends UpdateClusterDetails {
...
public Builder replicaConfig(ReplicaConfig replicaConfig) {
    ...
    return this;
        ...
        public UpdateAiComputeDetails build() {
            UpdateAiComputeDetails model = new UpdateAiComputeDetails(this.displayName
                , this.description
                , this.driverConfig
                , this.nodeType
        ...
        public Builder copy(UpdateAiComputeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateAiComputeDetails(String displayName, String description, DriverConfig driverConfig, String nodeType, ReplicaConfig replicaConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAiComputeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiComputeDetails)) {
            return false;
        }

        UpdateAiComputeDetails other = (UpdateAiComputeDetails) o;
