...
public class MakeDirResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private MakeDirResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String location, String contentLocation, String opcRequestId) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<MakeDirResponse> {
