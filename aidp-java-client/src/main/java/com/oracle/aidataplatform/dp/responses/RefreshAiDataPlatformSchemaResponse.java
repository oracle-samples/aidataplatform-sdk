...
public class RefreshAiDataPlatformSchemaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private RefreshAiDataPlatformSchemaResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcRequestId, String aidpAsyncOperationKey) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshAiDataPlatformSchemaResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(RefreshAiDataPlatformSchemaResponse o) {
         ...
         */
        @Override
        public RefreshAiDataPlatformSchemaResponse build() {
            return new RefreshAiDataPlatformSchemaResponse(__httpStatusCode__, headers, opcRequestId, aidpAsyncOperationKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformSchemaResponse)) {
            return false;
        }

        RefreshAiDataPlatformSchemaResponse other = (RefreshAiDataPlatformSchemaResponse) o;
