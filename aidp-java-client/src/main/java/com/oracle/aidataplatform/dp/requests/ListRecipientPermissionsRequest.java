...
public class ListRecipientPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListRecipientPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListRecipientPermissionsRequest o) {
        ...
        /**
         * Build the instance of ListRecipientPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRecipientPermissionsRequest
         */
        public ListRecipientPermissionsRequest build() {
            ListRecipientPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRecipientPermissionsRequest
         */
        public ListRecipientPermissionsRequest buildWithoutInvocationCallback() {
            ListRecipientPermissionsRequest request = new ListRecipientPermissionsRequest();
            ...
            return request;
            // new ListRecipientPermissionsRequest(aiDataPlatformId, recipientKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecipientPermissionsRequest)) {
            return false;
        }

        ListRecipientPermissionsRequest other = (ListRecipientPermissionsRequest) o;
