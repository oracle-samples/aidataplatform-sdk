...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AlhSchemaSummary.Builder.class)
...
public final class AlhSchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public AlhSchemaSummary build() {
            AlhSchemaSummary model = new AlhSchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(AlhSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public AlhSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlhSchemaSummary)) {
            return false;
        }

        AlhSchemaSummary other = (AlhSchemaSummary) o;
