...
public class MoveWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private MoveWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.WorkspaceObjectDetails workspaceObjectDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<MoveWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(MoveWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public MoveWorkspaceObjectResponse build() {
            return new MoveWorkspaceObjectResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, workspaceObjectDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MoveWorkspaceObjectResponse)) {
            return false;
        }

        MoveWorkspaceObjectResponse other = (MoveWorkspaceObjectResponse) o;
