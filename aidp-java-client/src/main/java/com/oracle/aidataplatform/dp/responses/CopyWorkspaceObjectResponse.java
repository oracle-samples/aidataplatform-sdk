...
public class CopyWorkspaceObjectResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
...
* 
    ...
    private CopyWorkspaceObjectResponse(int __httpStatusCode__,  java.util.Map<String, java.util.List<String>> headers, String opcWorkRequestId, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.WorkspaceObjectDetails workspaceObjectDetails) {
    ...
    public static class Builder implements com.oracle.bmc.responses.BmcResponse.Builder<CopyWorkspaceObjectResponse> {
...
* 
         ...
         */
        @Override
        public Builder copy(CopyWorkspaceObjectResponse o) {
         ...
         */
        @Override
        public CopyWorkspaceObjectResponse build() {
            return new CopyWorkspaceObjectResponse(__httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, workspaceObjectDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyWorkspaceObjectResponse)) {
            return false;
        }

        CopyWorkspaceObjectResponse other = (CopyWorkspaceObjectResponse) o;
