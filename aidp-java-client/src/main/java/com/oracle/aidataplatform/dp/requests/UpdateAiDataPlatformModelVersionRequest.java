...
public class UpdateAiDataPlatformModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateModelVersionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformModelVersionRequest, com.oracle.aidataplatform.dp.model.UpdateModelVersionDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformModelVersionRequest o) {
        ...
        /**
         * Build the instance of UpdateAiDataPlatformModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformModelVersionRequest
         */
        public UpdateAiDataPlatformModelVersionRequest build() {
            UpdateAiDataPlatformModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateAiDataPlatformModelVersionRequest
         */
        public UpdateAiDataPlatformModelVersionRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformModelVersionRequest request = new UpdateAiDataPlatformModelVersionRequest();
            ...
            return request;
            // new UpdateAiDataPlatformModelVersionRequest(aiDataPlatformId, updateModelVersionDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformModelVersionRequest)) {
            return false;
        }

        UpdateAiDataPlatformModelVersionRequest other = (UpdateAiDataPlatformModelVersionRequest) o;
