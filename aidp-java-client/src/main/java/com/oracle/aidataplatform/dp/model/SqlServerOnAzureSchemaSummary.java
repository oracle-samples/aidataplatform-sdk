...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SqlServerOnAzureSchemaSummary.Builder.class)
...
public final class SqlServerOnAzureSchemaSummary extends SchemaSummary {
...
public Builder timeLastRefresh(java.util.Date timeLastRefresh) {
    ...
    return this;
        ...
        public SqlServerOnAzureSchemaSummary build() {
            SqlServerOnAzureSchemaSummary model = new SqlServerOnAzureSchemaSummary(this.key
                , this.displayName
                , this.description
                , this.timeCreated
                , this.timeUpdated
        ...
        public Builder copy(SqlServerOnAzureSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public SqlServerOnAzureSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SqlServerOnAzureSchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SqlServerOnAzureSchemaSummary)) {
            return false;
        }

        SqlServerOnAzureSchemaSummary other = (SqlServerOnAzureSchemaSummary) o;
