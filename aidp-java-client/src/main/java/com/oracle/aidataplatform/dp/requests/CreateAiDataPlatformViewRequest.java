...
public class CreateAiDataPlatformViewRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateViewDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.CreateViewDetails createViewDetails;
     ...
     * Details for the new view.
     */
    public com.oracle.aidataplatform.dp.model.CreateViewDetails getCreateViewDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateViewDetails getBody$() {
        return createViewDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformViewRequest, com.oracle.aidataplatform.dp.model.CreateViewDetails> {
     ...
     * Details for the new view.
     */
        private com.oracle.aidataplatform.dp.model.CreateViewDetails createViewDetails = null;
         ...
         * @return this builder instance
         */
        public Builder createViewDetails(com.oracle.aidataplatform.dp.model.CreateViewDetails createViewDetails) {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformViewRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());createViewDetails(o.getCreateViewDetails());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of CreateAiDataPlatformViewRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformViewRequest
         */
        public CreateAiDataPlatformViewRequest build() {
            CreateAiDataPlatformViewRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateViewDetails body) {
         ...
         * @return instance of CreateAiDataPlatformViewRequest
         */
        public CreateAiDataPlatformViewRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformViewRequest request = new CreateAiDataPlatformViewRequest();
            ...
            return request;
            // new CreateAiDataPlatformViewRequest(aiDataPlatformId, createViewDetails, shouldUpdateRecent, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformViewRequest)) {
            return false;
        }

        CreateAiDataPlatformViewRequest other = (CreateAiDataPlatformViewRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createViewDetails == null ? 43 : this.createViewDetails.hashCode());
