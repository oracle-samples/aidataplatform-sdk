...
class RoleClient(object):
    ...
    def add_ai_data_platform_member_to_role(self, ai_data_platform_id, role_key, add_member_to_role_details, **kwargs):
        ...
        :param str role_key: (required)
            The unique key of the Role.

        :param oci.aidataplatform_dp.models.AddMemberToRoleDetails add_member_to_role_details: (required)
        ...
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles/{roleKey}/actions/addMember"
        method = "POST"
    ...
    def create_ai_data_platform_role(self, ai_data_platform_id, create_role_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.CreateRoleDetails create_role_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.Role`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles"
        method = "POST"
    ...
    def delete_ai_data_platform_role(self, ai_data_platform_id, role_key, **kwargs):
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles/{roleKey}"
        method = "DELETE"
    ...
    def get_ai_data_platform_role(self, ai_data_platform_id, role_key, **kwargs):
        ...
        :param str role_scope: (optional)
            The scope of roles to be returned. Defaults to USER.

            Allowed values are: "USER", "ADMIN", "MEMBER_OF"
        ...
        if 'role_scope' in kwargs:
            role_scope_allowed_values = ["USER", "ADMIN", "MEMBER_OF"]
            if kwargs['role_scope'] not in role_scope_allowed_values:
                raise ValueError(
                    "Invalid value for `role_scope`, must be one of {0}".format(role_scope_allowed_values)
                )

        query_params = {
            "roleScope": kwargs.get("role_scope", missing)
        }
    ...
    def list_ai_data_platform_role_permissions(self, ai_data_platform_id, role_key, **kwargs):
        ...
        :param str permission_scope: (optional)
            The scope of role permissions to be returned. Defaults to ALL

            Allowed values are: "DIRECT", "INHERITED", "ALL"
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.RolePermissionCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles/{roleKey}/permissions"
        method = "GET"
        ...
        if 'permission_scope' in kwargs:
            permission_scope_allowed_values = ["DIRECT", "INHERITED", "ALL"]
            if kwargs['permission_scope'] not in permission_scope_allowed_values:
                raise ValueError(
                    "Invalid value for `permission_scope`, must be one of {0}".format(permission_scope_allowed_values)
                )
        ...
        query_params = {
            "permissionScope": kwargs.get("permission_scope", missing),
    ...
    def list_ai_data_platform_roles(self, ai_data_platform_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.RoleCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles"
        method = "GET"
    ...
    def remove_ai_data_platform_member_from_role(self, ai_data_platform_id, role_key, remove_member_from_role_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.RemoveMemberFromRoleDetails remove_member_from_role_details: (required)
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/roles/{roleKey}/actions/removeMember"
        method = "POST"
    ...
    def update_ai_data_platform_role(self, ai_data_platform_id, role_key, update_role_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.UpdateRoleDetails update_role_details: (required)
