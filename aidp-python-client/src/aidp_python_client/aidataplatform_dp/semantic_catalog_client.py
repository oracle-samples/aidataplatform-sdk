...
class SemanticCatalogClient(object):
    ...
    def export_lineage(self, ai_data_platform_id, export_lineage_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.ExportLineageDetails export_lineage_details: (required)
        ...
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/actions/exportLineage"
        method = "POST"
        ...
        if extra_kwargs:
            raise ValueError(
                "export_lineage got unknown kwargs: {!r}".format(extra_kwargs))
    ...
    def fetch_entity_lineage(self, ai_data_platform_id, fetch_entity_lineage_details, **kwargs):
        """
        ...
        :param oci.aidataplatform_dp.models.FetchEntityLineageDetails fetch_entity_lineage_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.EntityLineage`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/actions/fetchLineage"
        method = "POST"
