...
class AsyncOperationsClient(object):
    """
    ...
    def get_ai_data_platform_async_operation(self, ai_data_platform_id, async_operation_key, **kwargs):
        ...
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/asyncOperations/{asyncOperationKey}"
        method = "GET"
    ...
    def list_ai_data_platform_async_operations(self, ai_data_platform_id, **kwargs):
        ...
        :param bool match_resource_name: (optional)
        ...
        :param bool should_filter_by_calling_principal: (optional)
        ...
        :param str sort_by: (optional)
            The field to sort by. You can provide only one sort order. Default order for `timeStarted` is descending.
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.AsyncOperationCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/asyncOperations"
        method = "GET"
        ...
        expected_kwargs = [
            ...
            "match_resource_name",
            "status",
            "should_filter_by_calling_principal",
            "limit",
            "page",
            "sort_order",
            "sort_by",
        ...
        query_params = {
            ...
            "matchResourceName": kwargs.get("match_resource_name", missing),
            "status": kwargs.get("status", missing),
            "shouldFilterByCallingPrincipal": kwargs.get("should_filter_by_calling_principal", missing),
        ...
        if retry_strategy:
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="AsyncOperationCollection")
        else:
            return self.base_client.call_api(
                resource_path=resource_path,
                method=method,
