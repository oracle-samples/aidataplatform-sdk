...
class AuditClient(object):
    ...
    def manage_audit_logs(self, ai_data_platform_id, manage_audit_logs_details, **kwargs):
        ...
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/actions/manageAuditLogs"
        method = "POST"
    ...
    def search_audit_logs(self, ai_data_platform_id, search_audit_logs_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.SearchAuditLogsDetails search_audit_logs_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.AuditLogSearchResultCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/actions/searchAuditLogs"
        method = "POST"
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                body=search_audit_logs_details,
                response_type="AuditLogSearchResultCollection")
        else:
            return self.base_client.call_api(
                resource_path=resource_path,
                method=method,
