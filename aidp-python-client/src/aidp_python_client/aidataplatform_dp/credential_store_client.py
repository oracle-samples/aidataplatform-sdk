...
class CredentialStoreClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("credential_store", config, signer, aidataplatform_dp_type_mapping, **base_client_init_kwargs)
    ...
    def create_ai_data_platform_credential(self, ai_data_platform_id, create_data_lake_credential_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.CreateDataLakeCredentialDetails create_data_lake_credential_details: (required)
            Creates a new Credential object. When the internal flag is enabled, callers must supply a `namespace` value of `default` or `user_settings` in the payload.
        ...
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/credentials"
        method = "POST"
    ...
    def delete_ai_data_platform_credential(self, ai_data_platform_id, credential_key, **kwargs):
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/credentials/{credentialKey}"
        method = "DELETE"
    ...
    def get_ai_data_platform_credential(self, ai_data_platform_id, credential_key, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.Credential`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/credentials/{credentialKey}"
        method = "GET"
    ...
    def list_ai_data_platform_credentials(self, ai_data_platform_id, **kwargs):
        ...
        :param str credential_type: (optional)
            The type of the Credential

            Allowed values are: "SECRET_TOKEN", "VAULT_REFERENCE", "SERVICE_ACCOUNT"
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.CredentialCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/credentials"
        method = "GET"
        ...
        if 'credential_type' in kwargs:
            credential_type_allowed_values = ["SECRET_TOKEN", "VAULT_REFERENCE", "SERVICE_ACCOUNT"]
            if kwargs['credential_type'] not in credential_type_allowed_values:
                raise ValueError(
                    "Invalid value for `credential_type`, must be one of {0}".format(credential_type_allowed_values)
                )
        ...
        query_params = {
            ...
            "credentialType": kwargs.get("credential_type", missing)
        }
    ...
    def update_ai_data_platform_credential(self, ai_data_platform_id, credential_key, update_data_lake_credential_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.UpdateDataLakeCredentialDetails update_data_lake_credential_details: (required)
        ...
        if retry_strategy:
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_data_lake_credential_details)
        else:
            return self.base_client.call_api(
                resource_path=resource_path,
                method=method,
