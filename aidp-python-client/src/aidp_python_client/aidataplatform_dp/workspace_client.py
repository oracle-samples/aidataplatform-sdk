...
class WorkspaceClient(object):
    ...
    def create_git_folder(self, ai_data_platform_id, workspace_key, create_git_folder_details, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.GitFolder`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces/{workspaceKey}/gitFolders"
        method = "POST"
    ...
    def create_workspace(self, ai_data_platform_id, create_workspace_details, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.Workspace`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces"
        method = "POST"
    ...
    def delete_workspace(self, ai_data_platform_id, workspace_key, **kwargs):
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces/{workspaceKey}"
        method = "DELETE"
        ...
        header_params = {
            ...
            "if-match": kwargs.get("if_match", missing),
            "opc-request-id": kwargs.get("opc_request_id", missing),
            "time-data-lake-deletion": kwargs.get("time_data_lake_deletion", missing)
        }
        header_params = {k: v for (k, v) in six.iteritems(header_params) if v is not missing and v is not None}
    ...
    def list_create_workspace_permissions(self, ai_data_platform_id, **kwargs):
        ...
        :param str sort_by: (optional)
            The field to sort by. You can provide only one sort order. Default order for `granteeName`
            is ascending.

            Allowed values are: "granteeName"
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.CreateWorkspacePermissionCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/createWorkspacePermissions"
        method = "GET"
        ...
        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["granteeName"]
    ...
    def list_workspace_permissions(self, ai_data_platform_id, workspace_key, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.WorkspacePermissionCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces/{workspaceKey}/permissions"
        method = "GET"
    ...
    def list_workspaces(self, ai_data_platform_id, **kwargs):
        ...
        :param str type: (optional)
            ...
            Allowed values are: "DEFAULT", "USER"
        ...
        :param bool is_private_network_enabled: (optional)
            A flag to filter the workspaces which are private network enabled or disabled
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.WorkspaceCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces"
        method = "GET"
        ...
        if 'type' in kwargs:
            type_allowed_values = ["DEFAULT", "USER"]
        ...
        query_params = {
            ...
            "sortOrder": kwargs.get("sort_order", missing),
            "sortBy": kwargs.get("sort_by", missing),
            "isPrivateNetworkEnabled": kwargs.get("is_private_network_enabled", missing)
        }
        query_params = {k: v for (k, v) in six.iteritems(query_params) if v is not missing and v is not None}
    ...
    def manage_create_workspace_permission(self, ai_data_platform_id, manage_create_workspace_permission_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.ManageCreateWorkspacePermissionDetails manage_create_workspace_permission_details: (required)
            The information to be updated.
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/actions/manageCreateWorkspacePermission"
        method = "POST"
    ...
    def manage_workspace_permission(self, ai_data_platform_id, workspace_key, manage_workspace_permission_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.ManageWorkspacePermissionDetails manage_workspace_permission_details: (required)
            The information to be updated.
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces/{workspaceKey}/actions/managePermission"
        method = "POST"
    ...
    def update_workspace_async_operation_status(self, ai_data_platform_id, workspace_key, async_operation_key, update_workspace_async_operation_status_details, **kwargs):
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/workspaces/{workspaceKey}/asyncOperations/{asyncOperationKey}/status"
        method = "PUT"
        ...
        if retry_strategy:
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_workspace_async_operation_status_details,
                response_type="Workspace")
        else:
            return self.base_client.call_api(
                resource_path=resource_path,
