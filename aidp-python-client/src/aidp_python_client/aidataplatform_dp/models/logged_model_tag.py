...
class LoggedModelTag(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new LoggedModelTag object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param key:
            The value to assign to the key property of this LoggedModelTag.
        :type key: str

        :param value:
            The value to assign to the value property of this LoggedModelTag.
        :type value: str
