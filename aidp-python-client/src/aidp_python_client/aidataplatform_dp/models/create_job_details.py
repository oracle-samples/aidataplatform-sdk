...
class CreateJobDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param run_as:
            The value to assign to the run_as property of this CreateJobDetails.
        :type run_as: str
        ...
        :param schedule:
            The value to assign to the schedule property of this CreateJobDetails.
        :type schedule: oci.aidataplatform_dp.models.Schedule

        :param continuous:
            The value to assign to the continuous property of this CreateJobDetails.
        :type continuous: oci.aidataplatform_dp.models.Continuous

        :param max_concurrent_runs:
            The value to assign to the max_concurrent_runs property of this CreateJobDetails.
        :type max_concurrent_runs: int

        :param git_config:
            The value to assign to the git_config property of this CreateJobDetails.
        :type git_config: oci.aidataplatform_dp.models.GitConfig

        :param queue:
            The value to assign to the queue property of this CreateJobDetails.
        :type queue: oci.aidataplatform_dp.models.Queue

        :param job_clusters:
            The value to assign to the job_clusters property of this CreateJobDetails.
        :type job_clusters: list[oci.aidataplatform_dp.models.JobCluster]

        :param path:
            The value to assign to the path property of this CreateJobDetails.
        :type path: str

        :param tasks:
            The value to assign to the tasks property of this CreateJobDetails.
        :type tasks: list[oci.aidataplatform_dp.models.Task]

        :param parameters:
            The value to assign to the parameters property of this CreateJobDetails.
    ...
    def run_as(self):
        """
        Gets the run_as of this CreateJobDetails.
        This points to the user or service account executing the job.


        :return: The run_as of this CreateJobDetails.
        :rtype: str
        """
        return self._run_as
    ...
    def run_as(self, run_as):
        """
        Sets the run_as of this CreateJobDetails.
        This points to the user or service account executing the job.


        :param run_as: The run_as of this CreateJobDetails.
        :type: str
        """
        self._run_as = run_as
    ...
    def schedule(self):
        """
        Gets the schedule of this CreateJobDetails.

        :return: The schedule of this CreateJobDetails.
    ...
    def schedule(self, schedule):
        """
        Sets the schedule of this CreateJobDetails.

        :param schedule: The schedule of this CreateJobDetails.
    ...
    def continuous(self):
        """
        Gets the continuous of this CreateJobDetails.

        :return: The continuous of this CreateJobDetails.
    ...
    def continuous(self, continuous):
        """
        Sets the continuous of this CreateJobDetails.

        :param continuous: The continuous of this CreateJobDetails.
    ...
    def max_concurrent_runs(self, max_concurrent_runs):
        """
        Sets the max_concurrent_runs of this CreateJobDetails.
        Indicates the number of executions for the same job that can be run concurrently. The maximum value cannot exceed 1000.


        :param max_concurrent_runs: The max_concurrent_runs of this CreateJobDetails.
        :type: int
        """
    ...
    def git_config(self):
        """
        Gets the git_config of this CreateJobDetails.

        :return: The git_config of this CreateJobDetails.
    ...
    def git_config(self, git_config):
        """
        Sets the git_config of this CreateJobDetails.

        :param git_config: The git_config of this CreateJobDetails.
    ...
    def queue(self):
        """
        Gets the queue of this CreateJobDetails.

        :return: The queue of this CreateJobDetails.
    ...
    def queue(self, queue):
        """
        Sets the queue of this CreateJobDetails.

        :param queue: The queue of this CreateJobDetails.
    ...
    def job_clusters(self):
        """
        Gets the job_clusters of this CreateJobDetails.
        List of job cluster configurations.


        :return: The job_clusters of this CreateJobDetails.
    ...
    def job_clusters(self, job_clusters):
        """
        Sets the job_clusters of this CreateJobDetails.
        List of job cluster configurations.


        :param job_clusters: The job_clusters of this CreateJobDetails.
    ...
    def path(self):
        """
        Gets the path of this CreateJobDetails.
        The path to store the job definition in.


        :return: The path of this CreateJobDetails.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this CreateJobDetails.
        The path to store the job definition in.


        :param path: The path of this CreateJobDetails.
        :type: str
        """
        self._path = path
    ...
    def tasks(self):
        """
        Gets the tasks of this CreateJobDetails.
        List of tasks in a job.


        :return: The tasks of this CreateJobDetails.
    ...
    def tasks(self, tasks):
        """
        Sets the tasks of this CreateJobDetails.
        List of tasks in a job.


        :param tasks: The tasks of this CreateJobDetails.
    ...
    def parameters(self):
        """
        Gets the parameters of this CreateJobDetails.
        An optional list of parameters.


        :return: The parameters of this CreateJobDetails.
    ...
    def parameters(self, parameters):
        """
        Sets the parameters of this CreateJobDetails.
        An optional list of parameters.


        :param parameters: The parameters of this CreateJobDetails.
