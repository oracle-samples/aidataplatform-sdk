...
class UpdateVolumeDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param description:
            The value to assign to the description property of this UpdateVolumeDetails.
    ...
    def description(self):
        """
        Gets the description of this UpdateVolumeDetails.
        Short description of the volume


        :return: The description of this UpdateVolumeDetails.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this UpdateVolumeDetails.
        Short description of the volume


        :param description: The description of this UpdateVolumeDetails.
        :type: str
        """
