...
class Dependency(object):
    ...
    #: A constant which can be used with the type property of a Dependency.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Dependency object with values from keyword arguments. This class has the following subclasses and if you are using this class as input
        to a service operations then you should favor using a subclass over the base class:

        * :class:`~oci.aidataplatform_dp.models.ComputeDependency`
        * :class:`~oci.aidataplatform_dp.models.FileDependency`
        * :class:`~oci.aidataplatform_dp.models.JobDependency`
    ...
    def type(self):
        """
        **[Required]** Gets the type of this Dependency.
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["FILE", "COMPUTE", "JOB"]
