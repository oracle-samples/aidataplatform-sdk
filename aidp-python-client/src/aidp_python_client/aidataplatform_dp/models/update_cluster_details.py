...
class UpdateClusterDetails(object):
    ...
    def __init__(self, **kwargs):
        ...
        * :class:`~oci.aidataplatform_dp.models.UpdateSparkClusterDetails`
        ...
        :param description:
            The value to assign to the description property of this UpdateClusterDetails.
        :type description: str

        :param driver_config:
            The value to assign to the driver_config property of this UpdateClusterDetails.
        :type driver_config: oci.aidataplatform_dp.models.DriverConfig

        :param node_type:
            The value to assign to the node_type property of this UpdateClusterDetails.
        :type node_type: str
    ...
    def description(self):
        """
        Gets the description of this UpdateClusterDetails.
        Cluster description.


        :return: The description of this UpdateClusterDetails.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this UpdateClusterDetails.
        Cluster description.


        :param description: The description of this UpdateClusterDetails.
        :type: str
        """
    ...
    def driver_config(self):
        """
        Gets the driver_config of this UpdateClusterDetails.

        :return: The driver_config of this UpdateClusterDetails.
    ...
    def driver_config(self, driver_config):
        """
        Sets the driver_config of this UpdateClusterDetails.

        :param driver_config: The driver_config of this UpdateClusterDetails.
    ...
    def node_type(self):
        """
        Gets the node_type of this UpdateClusterDetails.
        Cluster node type encodes the node shape and associated resources.


        :return: The node_type of this UpdateClusterDetails.
        :rtype: str
        """
    ...
    def node_type(self, node_type):
        """
        Sets the node_type of this UpdateClusterDetails.
        Cluster node type encodes the node shape and associated resources.


        :param node_type: The node_type of this UpdateClusterDetails.
        :type: str
        """
