...
class Feature(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Feature object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param feature_name:
            The value to assign to the feature_name property of this Feature.
        :type feature_name: str

        :param value:
            The value to assign to the value property of this Feature.
        :type value: str
    ...
    def feature_name(self):
        """
        **[Required]** Gets the feature_name of this Feature.
    ...
    def value(self):
        """
        **[Required]** Gets the value of this Feature.
