...
class AiCompute(Cluster):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AiCompute object with values from keyword arguments. The default value of the :py:attr:`~oci.aidataplatform_dp.models.AiCompute.source_api` attribute
        of this class is ``AI_COMPUTE`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param key:
            The value to assign to the key property of this AiCompute.
        :type key: str

        :param display_name:
            The value to assign to the display_name property of this AiCompute.
        :type display_name: str

        :param description:
            The value to assign to the description property of this AiCompute.
        :type description: str

        :param source_api:
            The value to assign to the source_api property of this AiCompute.
            Allowed values for this property are: "CLUSTER_API", "DEFAULT_CLUSTER_API", "AI_COMPUTE"
        :type source_api: str

        :param type:
            The value to assign to the type property of this AiCompute.
            Allowed values for this property are: "USER", "AI_COMPUTE"
        :type type: str

        :param time_created:
            The value to assign to the time_created property of this AiCompute.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this AiCompute.
        :type time_updated: datetime

        :param state:
            The value to assign to the state property of this AiCompute.
        ...
        :param state_details:
            The value to assign to the state_details property of this AiCompute.
        :type state_details: str

        :param node_type:
            The value to assign to the node_type property of this AiCompute.
        :type node_type: str

        :param driver_config:
            The value to assign to the driver_config property of this AiCompute.
        :type driver_config: oci.aidataplatform_dp.models.DriverConfig

        :param active_cluster_resources:
            The value to assign to the active_cluster_resources property of this AiCompute.
        :type active_cluster_resources: oci.aidataplatform_dp.models.ActiveClusterResources

        :param created_by:
            The value to assign to the created_by property of this AiCompute.
        :type created_by: str

        :param created_by_name:
            The value to assign to the created_by_name property of this AiCompute.
        :type created_by_name: str

        :param updated_by:
            The value to assign to the updated_by property of this AiCompute.
        :type updated_by: str

        :param updated_by_name:
            The value to assign to the updated_by_name property of this AiCompute.
        :type updated_by_name: str

        :param stopped_by:
            The value to assign to the stopped_by property of this AiCompute.
        :type stopped_by: str

        :param stopped_by_name:
            The value to assign to the stopped_by_name property of this AiCompute.
    ...
    def replica_config(self):
        """
        Gets the replica_config of this AiCompute.

        :return: The replica_config of this AiCompute.
    ...
    def replica_config(self, replica_config):
        """
        Sets the replica_config of this AiCompute.

        :param replica_config: The replica_config of this AiCompute.
