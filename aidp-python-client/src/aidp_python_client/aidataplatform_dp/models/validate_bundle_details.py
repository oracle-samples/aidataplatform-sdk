...
class ValidateBundleDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ValidateBundleDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param path:
            The value to assign to the path property of this ValidateBundleDetails.
        :type path: str
