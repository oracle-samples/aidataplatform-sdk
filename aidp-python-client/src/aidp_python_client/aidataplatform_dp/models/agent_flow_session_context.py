...
class AgentFlowSessionContext(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AgentFlowSessionContext object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param retention_config:
            The value to assign to the retention_config property of this AgentFlowSessionContext.
    ...
    def retention_config(self):
        """
        Gets the retention_config of this AgentFlowSessionContext.

        :return: The retention_config of this AgentFlowSessionContext.
    ...
    def retention_config(self, retention_config):
        """
        Sets the retention_config of this AgentFlowSessionContext.

        :param retention_config: The retention_config of this AgentFlowSessionContext.
