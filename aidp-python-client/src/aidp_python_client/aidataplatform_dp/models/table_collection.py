...
class TableCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.aidataplatform_dp.models.TableSummary]
    ...
    def items(self):
        """
        **[Required]** Gets the items of this TableCollection.
        List of tables.


        :return: The items of this TableCollection.
        :rtype: list[oci.aidataplatform_dp.models.TableSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.aidataplatform_dp.models.TableSummary]
        """
        self._items = items
