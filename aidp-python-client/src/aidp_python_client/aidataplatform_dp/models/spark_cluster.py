...
class SparkCluster(Cluster):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SparkCluster object with values from keyword arguments. The default value of the :py:attr:`~oci.aidataplatform_dp.models.SparkCluster.source_api` attribute
        of this class is ``CLUSTER_API`` and it should not be changed.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param key:
            The value to assign to the key property of this SparkCluster.
        :type key: str

        :param display_name:
            The value to assign to the display_name property of this SparkCluster.
        :type display_name: str

        :param description:
            The value to assign to the description property of this SparkCluster.
        ...
        :param time_created:
            The value to assign to the time_created property of this SparkCluster.
        :type time_created: datetime

        :param time_updated:
            The value to assign to the time_updated property of this SparkCluster.
        :type time_updated: datetime

        :param state:
            The value to assign to the state property of this SparkCluster.
        ...
        :param state_details:
            The value to assign to the state_details property of this SparkCluster.
        :type state_details: str

        :param node_type:
            The value to assign to the node_type property of this SparkCluster.
        :type node_type: str

        :param driver_config:
            The value to assign to the driver_config property of this SparkCluster.
        :type driver_config: oci.aidataplatform_dp.models.DriverConfig

        :param active_cluster_resources:
            The value to assign to the active_cluster_resources property of this SparkCluster.
        :type active_cluster_resources: oci.aidataplatform_dp.models.ActiveClusterResources

        :param created_by:
            The value to assign to the created_by property of this SparkCluster.
        :type created_by: str

        :param created_by_name:
            The value to assign to the created_by_name property of this SparkCluster.
        :type created_by_name: str

        :param updated_by:
            The value to assign to the updated_by property of this SparkCluster.
        :type updated_by: str

        :param updated_by_name:
            The value to assign to the updated_by_name property of this SparkCluster.
        :type updated_by_name: str

        :param stopped_by:
            The value to assign to the stopped_by property of this SparkCluster.
        :type stopped_by: str

        :param stopped_by_name:
            The value to assign to the stopped_by_name property of this SparkCluster.
        :type stopped_by_name: str

        :param worker_config:
            The value to assign to the worker_config property of this SparkCluster.
        :type worker_config: oci.aidataplatform_dp.models.WorkerConfig

        :param cluster_runtime_config:
            The value to assign to the cluster_runtime_config property of this SparkCluster.
        :type cluster_runtime_config: oci.aidataplatform_dp.models.ClusterRuntimeConfig

        :param logging_config:
            The value to assign to the logging_config property of this SparkCluster.
        :type logging_config: oci.aidataplatform_dp.models.LoggingConfig

        :param auto_termination_minutes:
            The value to assign to the auto_termination_minutes property of this SparkCluster.
        :type auto_termination_minutes: int

        :param attached_notebooks:
            The value to assign to the attached_notebooks property of this SparkCluster.
        ...
        :param log_id:
            The value to assign to the log_id property of this SparkCluster.
        :type log_id: str

        :param log_group_id:
            The value to assign to the log_group_id property of this SparkCluster.
        :type log_group_id: str

        :param subscription:
            The value to assign to the subscription property of this SparkCluster.
        ...
        self._source_api = 'CLUSTER_API'

    @property
    def worker_config(self):
        """
        Gets the worker_config of this SparkCluster.

        :return: The worker_config of this SparkCluster.
    ...
    def worker_config(self, worker_config):
        """
        Sets the worker_config of this SparkCluster.

        :param worker_config: The worker_config of this SparkCluster.
    ...
    def cluster_runtime_config(self):
        """
        Gets the cluster_runtime_config of this SparkCluster.

        :return: The cluster_runtime_config of this SparkCluster.
    ...
    def cluster_runtime_config(self, cluster_runtime_config):
        """
        Sets the cluster_runtime_config of this SparkCluster.

        :param cluster_runtime_config: The cluster_runtime_config of this SparkCluster.
    ...
    def logging_config(self):
        """
        Gets the logging_config of this SparkCluster.

        :return: The logging_config of this SparkCluster.
    ...
    def logging_config(self, logging_config):
        """
        Sets the logging_config of this SparkCluster.

        :param logging_config: The logging_config of this SparkCluster.
    ...
    def auto_termination_minutes(self):
        """
        Gets the auto_termination_minutes of this SparkCluster.
        Optional timeout value in minutes used to automatically stop idle compute clusters.


        :return: The auto_termination_minutes of this SparkCluster.
        :rtype: int
        """
    ...
    def auto_termination_minutes(self, auto_termination_minutes):
        """
        Sets the auto_termination_minutes of this SparkCluster.
        Optional timeout value in minutes used to automatically stop idle compute clusters.


        :param auto_termination_minutes: The auto_termination_minutes of this SparkCluster.
        :type: int
        """
    ...
    def attached_notebooks(self):
        """
        Gets the attached_notebooks of this SparkCluster.
        List of notebooks attached to a specific cluster.


        :return: The attached_notebooks of this SparkCluster.
        :rtype: list[str]
        """
    ...
    def attached_notebooks(self, attached_notebooks):
        """
        Sets the attached_notebooks of this SparkCluster.
        List of notebooks attached to a specific cluster.


        :param attached_notebooks: The attached_notebooks of this SparkCluster.
        :type: list[str]
        """
    ...
    def attached_sessions(self):
        """
        Gets the attached_sessions of this SparkCluster.
        List of sessions attached to a specific cluster.


        :return: The attached_sessions of this SparkCluster.
    ...
    def attached_sessions(self, attached_sessions):
        """
        Sets the attached_sessions of this SparkCluster.
        List of sessions attached to a specific cluster.


        :param attached_sessions: The attached_sessions of this SparkCluster.
    ...
    def jdbc_endpoint_url(self):
        """
        Gets the jdbc_endpoint_url of this SparkCluster.
        Spark JDBC URL.


        :return: The jdbc_endpoint_url of this SparkCluster.
        :rtype: str
        """
    ...
    def jdbc_endpoint_url(self, jdbc_endpoint_url):
        """
        Sets the jdbc_endpoint_url of this SparkCluster.
        Spark JDBC URL.


        :param jdbc_endpoint_url: The jdbc_endpoint_url of this SparkCluster.
        :type: str
        """
    ...
    def log_id(self):
        """
        Gets the log_id of this SparkCluster.
        ...
        :return: The log_id of this SparkCluster.
        :rtype: str
        """
        return self._log_id
    ...
    def log_id(self, log_id):
        """
        Sets the log_id of this SparkCluster.
        The OCID of the log where cluster logs are published and retrieved. This logId is always created within the logGroupId returned in the response payload.


        :param log_id: The log_id of this SparkCluster.
        :type: str
        """
        self._log_id = log_id
    ...
    def log_group_id(self):
        """
        Gets the log_group_id of this SparkCluster.
        ...
        :return: The log_group_id of this SparkCluster.
        :rtype: str
        """
    ...
    def log_group_id(self, log_group_id):
        """
        Sets the log_group_id of this SparkCluster.
        The unique OCID that identifies a specific log group within OCI Logging.
        This log group is exclusively associated with the AI Data Platform Workbench instance and is created in the same compartment within the customer\u2019s tenancy as the AI Data Platform Workbench instance.


        :param log_group_id: The log_group_id of this SparkCluster.
        :type: str
        """
    ...
    def subscription(self):
        """
        Gets the subscription of this SparkCluster.

        :return: The subscription of this SparkCluster.
    ...
    def subscription(self, subscription):
        """
        Sets the subscription of this SparkCluster.

        :param subscription: The subscription of this SparkCluster.
