...
class EntityLineage(object):
    ...
    def __init__(self, **kwargs):
        ...
        :param nodes:
            The value to assign to the nodes property of this EntityLineage.
        :type nodes: list[oci.aidataplatform_dp.models.LineageObject]

        :param links:
            The value to assign to the links property of this EntityLineage.
    ...
    def nodes(self):
        """
        **[Required]** Gets the nodes of this EntityLineage.
        Set of links that are involved in the lineage.


        :return: The nodes of this EntityLineage.
    ...
    def nodes(self, nodes):
        """
        Sets the nodes of this EntityLineage.
        Set of links that are involved in the lineage.


        :param nodes: The nodes of this EntityLineage.
    ...
    def links(self):
        """
        **[Required]** Gets the links of this EntityLineage.
        Set of links between the objects in the 'objects' set.


        :return: The links of this EntityLineage.
    ...
    def links(self, links):
        """
        Sets the links of this EntityLineage.
        Set of links between the objects in the 'objects' set.


        :param links: The links of this EntityLineage.
