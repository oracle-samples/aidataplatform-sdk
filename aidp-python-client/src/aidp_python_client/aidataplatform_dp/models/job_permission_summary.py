...
class JobPermissionSummary(object):
    """
    Information about a job permission.
    """

    #: A constant which can be used with the grantee_type property of a JobPermissionSummary.
    ...
    #: A constant which can be used with the grantee_permissions property of a JobPermissionSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new JobPermissionSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param grantee:
            The value to assign to the grantee property of this JobPermissionSummary.
        :type grantee: str

        :param grantee_name:
            The value to assign to the grantee_name property of this JobPermissionSummary.
        :type grantee_name: str

        :param grantee_type:
            The value to assign to the grantee_type property of this JobPermissionSummary.
        ...
        :param grantee_permissions:
            The value to assign to the grantee_permissions property of this JobPermissionSummary.
    ...
    def grantee(self):
        """
        **[Required]** Gets the grantee of this JobPermissionSummary.
        The OCID of user/group and name in case of role.


        :return: The grantee of this JobPermissionSummary.
        :rtype: str
        """
    ...
    def grantee(self, grantee):
        """
        Sets the grantee of this JobPermissionSummary.
        The OCID of user/group and name in case of role.


        :param grantee: The grantee of this JobPermissionSummary.
        :type: str
        """
    ...
    def grantee_name(self):
        """
        Gets the grantee_name of this JobPermissionSummary.
        The simplified name of the grantee.


        :return: The grantee_name of this JobPermissionSummary.
        :rtype: str
        """
    ...
    def grantee_name(self, grantee_name):
        """
        Sets the grantee_name of this JobPermissionSummary.
        The simplified name of the grantee.


        :param grantee_name: The grantee_name of this JobPermissionSummary.
        :type: str
        """
    ...
    def grantee_type(self):
        """
        **[Required]** Gets the grantee_type of this JobPermissionSummary.
        The type of grantee.
        ...
        :return: The grantee_type of this JobPermissionSummary.
        :rtype: str
        """
    ...
    def grantee_type(self, grantee_type):
        """
        Sets the grantee_type of this JobPermissionSummary.
        The type of grantee.


        :param grantee_type: The grantee_type of this JobPermissionSummary.
        :type: str
        """
    ...
    def grantee_permissions(self):
        """
        **[Required]** Gets the grantee_permissions of this JobPermissionSummary.
        ...
        :return: The grantee_permissions of this JobPermissionSummary.
        :rtype: list[str]
        """
    ...
    def grantee_permissions(self, grantee_permissions):
        """
        Sets the grantee_permissions of this JobPermissionSummary.
        The selected permissions for a Job.


        :param grantee_permissions: The grantee_permissions of this JobPermissionSummary.
        :type: list[str]
        """
