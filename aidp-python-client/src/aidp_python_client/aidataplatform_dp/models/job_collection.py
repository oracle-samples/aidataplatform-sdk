...
class JobCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.aidataplatform_dp.models.JobSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this JobCollection.
        ...
        :rtype: list[oci.aidataplatform_dp.models.JobSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.aidataplatform_dp.models.JobSummary]
        """
        self._items = items
