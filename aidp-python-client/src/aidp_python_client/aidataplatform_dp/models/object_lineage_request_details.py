...
class ObjectLineageRequestDetails(object):
    ...
    #: A constant which can be used with the level property of a ObjectLineageRequestDetails.
    ...
    def __init__(self, **kwargs):
        ...
        :param anchor_node:
            The value to assign to the anchor_node property of this ObjectLineageRequestDetails.
        :type anchor_node: str

        :param max_depth:
            The value to assign to the max_depth property of this ObjectLineageRequestDetails.
        :type max_depth: int
        ...
        :param node_filters:
            The value to assign to the node_filters property of this ObjectLineageRequestDetails.
        :type node_filters: oci.aidataplatform_dp.models.NodeFilterObject

        :param path_filters:
            The value to assign to the path_filters property of this ObjectLineageRequestDetails.
        :type path_filters: oci.aidataplatform_dp.models.PathFilterObject

        :param should_include_edges:
            The value to assign to the should_include_edges property of this ObjectLineageRequestDetails.
    ...
    def anchor_node(self):
        """
        **[Required]** Gets the anchor_node of this ObjectLineageRequestDetails.
        Root entity node from with the lineage is to be fetched.


        :return: The anchor_node of this ObjectLineageRequestDetails.
        :rtype: str
        """
    ...
    def anchor_node(self, anchor_node):
        """
        Sets the anchor_node of this ObjectLineageRequestDetails.
        Root entity node from with the lineage is to be fetched.


        :param anchor_node: The anchor_node of this ObjectLineageRequestDetails.
        :type: str
        """
    ...
    def max_depth(self):
        """
        **[Required]** Gets the max_depth of this ObjectLineageRequestDetails.
        Maximum depth to traverse in lineage graph. Depth is measured as number of links from anchor node to matching nodes.


        :return: The max_depth of this ObjectLineageRequestDetails.
        :rtype: int
        """
    ...
    def max_depth(self, max_depth):
        """
        Sets the max_depth of this ObjectLineageRequestDetails.
        Maximum depth to traverse in lineage graph. Depth is measured as number of links from anchor node to matching nodes.


        :param max_depth: The max_depth of this ObjectLineageRequestDetails.
        :type: int
        """
    ...
    def level(self):
        """
        **[Required]** Gets the level of this ObjectLineageRequestDetails.
    ...
    def direction(self):
        """
        **[Required]** Gets the direction of this ObjectLineageRequestDetails.
    ...
    def node_filters(self):
        """
        Gets the node_filters of this ObjectLineageRequestDetails.

        :return: The node_filters of this ObjectLineageRequestDetails.
    ...
    def node_filters(self, node_filters):
        """
        Sets the node_filters of this ObjectLineageRequestDetails.

        :param node_filters: The node_filters of this ObjectLineageRequestDetails.
    ...
    def path_filters(self):
        """
        Gets the path_filters of this ObjectLineageRequestDetails.

        :return: The path_filters of this ObjectLineageRequestDetails.
    ...
    def path_filters(self, path_filters):
        """
        Sets the path_filters of this ObjectLineageRequestDetails.

        :param path_filters: The path_filters of this ObjectLineageRequestDetails.
    ...
    def should_include_edges(self):
        """
        Gets the should_include_edges of this ObjectLineageRequestDetails.
        Controls if the edges will be returned with vertices.


        :return: The should_include_edges of this ObjectLineageRequestDetails.
        :rtype: bool
        """
    ...
    def should_include_edges(self, should_include_edges):
        """
        Sets the should_include_edges of this ObjectLineageRequestDetails.
        Controls if the edges will be returned with vertices.


        :param should_include_edges: The should_include_edges of this ObjectLineageRequestDetails.
        :type: bool
        """
