...
class RoleCollection(object):
    ...
    def __init__(self, **kwargs):
        ...
        :type items: list[oci.aidataplatform_dp.models.RoleSummary]
    ...
    def items(self):
        ...
        **[Required]** Gets the items of this RoleCollection.
        ...
        :rtype: list[oci.aidataplatform_dp.models.RoleSummary]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :type: list[oci.aidataplatform_dp.models.RoleSummary]
        """
        self._items = items
