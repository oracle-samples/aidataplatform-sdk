...
class SchemaPermissionSummary(object):
    """
    Information about a schema permission.
    """

    #: A constant which can be used with the grantee_type property of a SchemaPermissionSummary.
    ...
    GRANTEE_PERMISSIONS_CREATE_VIEW = "CREATE_VIEW"

    #: A constant which can be used with the grantee_permissions property of a SchemaPermissionSummary.
    #: This constant has a value of "CREATE_VOLUME"
    GRANTEE_PERMISSIONS_CREATE_VOLUME = "CREATE_VOLUME"

    #: A constant which can be used with the grantee_permissions property of a SchemaPermissionSummary.
    #: This constant has a value of "CREATE_TABLE"
    GRANTEE_PERMISSIONS_CREATE_TABLE = "CREATE_TABLE"
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new SchemaPermissionSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param grantee:
            The value to assign to the grantee property of this SchemaPermissionSummary.
        :type grantee: str

        :param grantee_name:
            The value to assign to the grantee_name property of this SchemaPermissionSummary.
        :type grantee_name: str

        :param grantee_type:
            The value to assign to the grantee_type property of this SchemaPermissionSummary.
        ...
        :param is_inherited:
            The value to assign to the is_inherited property of this SchemaPermissionSummary.
        :type is_inherited: bool

        :param resource_name:
            The value to assign to the resource_name property of this SchemaPermissionSummary.
    ...
    def grantee(self):
        """
        **[Required]** Gets the grantee of this SchemaPermissionSummary.
        OCID of user/group and name in case of role.


        :return: The grantee of this SchemaPermissionSummary.
        :rtype: str
        """
    ...
    def grantee(self, grantee):
        """
        Sets the grantee of this SchemaPermissionSummary.
        OCID of user/group and name in case of role.


        :param grantee: The grantee of this SchemaPermissionSummary.
        :type: str
        """
    ...
    def grantee_name(self):
        """
        Gets the grantee_name of this SchemaPermissionSummary.
        Simplified name of the grantee.


        :return: The grantee_name of this SchemaPermissionSummary.
        :rtype: str
        """
    ...
    def grantee_name(self, grantee_name):
        """
        Sets the grantee_name of this SchemaPermissionSummary.
        Simplified name of the grantee.


        :param grantee_name: The grantee_name of this SchemaPermissionSummary.
        :type: str
        """
    ...
    def grantee_type(self):
        """
        **[Required]** Gets the grantee_type of this SchemaPermissionSummary.
        Type of grantee.
        ...
        :return: The grantee_type of this SchemaPermissionSummary.
        :rtype: str
        """
    ...
    def grantee_type(self, grantee_type):
        """
        Sets the grantee_type of this SchemaPermissionSummary.
        Type of grantee.


        :param grantee_type: The grantee_type of this SchemaPermissionSummary.
        :type: str
        """
    ...
    def grantee_permissions(self):
        ...
        **[Required]** Gets the grantee_permissions of this SchemaPermissionSummary.
        ...
        :return: The grantee_permissions of this SchemaPermissionSummary.
        :rtype: list[str]
        """
    ...
    def grantee_permissions(self, grantee_permissions):
        """
        Sets the grantee_permissions of this SchemaPermissionSummary.
        Selected permissions for a schema.
    ...
    def is_inherited(self):
        """
        Gets the is_inherited of this SchemaPermissionSummary.
        Permission listed is inherited or not from object higher up in hierarchy.


        :return: The is_inherited of this SchemaPermissionSummary.
        :rtype: bool
        """
    ...
    def is_inherited(self, is_inherited):
        """
        Sets the is_inherited of this SchemaPermissionSummary.
        Permission listed is inherited or not from object higher up in hierarchy.


        :param is_inherited: The is_inherited of this SchemaPermissionSummary.
        :type: bool
        """
    ...
    def resource_name(self):
        """
        Gets the resource_name of this SchemaPermissionSummary.
        ...
        :return: The resource_name of this SchemaPermissionSummary.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """
        Sets the resource_name of this SchemaPermissionSummary.
        Name of the object to which this permission belongs. This would be the name of schema if permission is not inherited or name of object higher up in hierarchy if permission is inherited.


        :param resource_name: The resource_name of this SchemaPermissionSummary.
        :type: str
        """
