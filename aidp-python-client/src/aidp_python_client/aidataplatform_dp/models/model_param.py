...
class ModelParam(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ModelParam object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param name:
            The value to assign to the name property of this ModelParam.
        :type name: str

        :param value:
            The value to assign to the value property of this ModelParam.
        :type value: str
