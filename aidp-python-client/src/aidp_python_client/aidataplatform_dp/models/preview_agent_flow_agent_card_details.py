...
class PreviewAgentFlowAgentCardDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new PreviewAgentFlowAgentCardDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param agent_card_config_details:
            The value to assign to the agent_card_config_details property of this PreviewAgentFlowAgentCardDetails.
    ...
    def agent_card_config_details(self):
        """
        **[Required]** Gets the agent_card_config_details of this PreviewAgentFlowAgentCardDetails.

        :return: The agent_card_config_details of this PreviewAgentFlowAgentCardDetails.
    ...
    def agent_card_config_details(self, agent_card_config_details):
        """
        Sets the agent_card_config_details of this PreviewAgentFlowAgentCardDetails.

        :param agent_card_config_details: The agent_card_config_details of this PreviewAgentFlowAgentCardDetails.
