...
class GitMergeDetails(object):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new GitMergeDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param git_folder_path:
            The value to assign to the git_folder_path property of this GitMergeDetails.
        :type git_folder_path: str

        :param branch_name:
            The value to assign to the branch_name property of this GitMergeDetails.
        :type branch_name: str

        :param remote_branch_name:
            The value to assign to the remote_branch_name property of this GitMergeDetails.
        :type remote_branch_name: str

        :param commit_id:
            The value to assign to the commit_id property of this GitMergeDetails.
        :type commit_id: str
    ...
    def remote_branch_name(self):
        """
        **[Required]** Gets the remote_branch_name of this GitMergeDetails.
        Remote branch name, if you want to merge a different branch.


        :return: The remote_branch_name of this GitMergeDetails.
        :rtype: str
        """
    ...
    def remote_branch_name(self, remote_branch_name):
        """
        Sets the remote_branch_name of this GitMergeDetails.
        Remote branch name, if you want to merge a different branch.


        :param remote_branch_name: The remote_branch_name of this GitMergeDetails.
        :type: str
        """
