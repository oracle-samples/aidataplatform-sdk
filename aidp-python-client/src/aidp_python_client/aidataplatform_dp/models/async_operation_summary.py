...
class AsyncOperationSummary(object):
    """
    Summary information about an Async Operation.
    """

    #: A constant which can be used with the resource_type property of a AsyncOperationSummary.
    ...
    #: A constant which can be used with the action_type property of a AsyncOperationSummary.
    #: This constant has a value of "UNKNOWN"
    ...
    #: A constant which can be used with the action_type property of a AsyncOperationSummary.
    #: This constant has a value of "DEPLOY_AGENT_FLOW"
    ACTION_TYPE_DEPLOY_AGENT_FLOW = "DEPLOY_AGENT_FLOW"
    ...
    #: A constant which can be used with the status property of a AsyncOperationSummary.
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AsyncOperationSummary object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param key:
            The value to assign to the key property of this AsyncOperationSummary.
        :type key: str

        :param resource_type:
            The value to assign to the resource_type property of this AsyncOperationSummary.
            Allowed values for this property are: "UNKNOWN", "CATALOG", "SCHEMA", "TABLE", "VIEW", "VOLUME", "VOLUME_FILE", "WORKSPACE", "WORKSPACE_OBJECT", "CLUSTER", "AI_COMPUTE", "KNOWLEDGE_BASE", "KNOWLEDGE_BASE_JOB", "KNOWLEDGE_BASE_JOB_RUN", "AGENT_FLOW", "GIT_OPERATION", "BUNDLE_OPERATION", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type resource_type: str

        :param action_type:
            The value to assign to the action_type property of this AsyncOperationSummary.
            Allowed values for this property are: "UNKNOWN", "CREATE_CATALOG", "UPDATE_CATALOG", "DELETE_CATALOG", "TEST_CONNECTION_CATALOG", "CREATE_USER_SCHEMA_IN_CATALOG", "CREATE_SCHEMA", "DELETE_SCHEMA", "CREATE_TABLE", "UPDATE_TABLE", "DELETE_TABLE", "CREATE_VOLUME", "DELETE_VOLUME", "COPY_VOLUME_FILE", "MOVE_VOLUME_FILE", "DELETE_VOLUME_FILE", "DELETE_VOLUME_FOLDER", "CREATE_WORKSPACE", "UPDATE_WORKSPACE", "DELETE_WORKSPACE", "CREATE_CLUSTER", "UPDATE_CLUSTER", "START_CLUSTER", "STOP_CLUSTER", "RESTART_CLUSTER", "PATCH_CLUSTER_LIBRARIES", "DELETE_CLUSTER", "MANAGE_EXTRACTED_ENTITIES", "REFRESH_ENTITY", "DOWNLOAD_CLUSTER_LOG", "MIGRATE_EXTERNAL_CATALOG", "UPDATE_KNOWLEDGE_BASE", "DELETE_KNOWLEDGE_BASE", "CREATE_KNOWLEDGE_BASE", "DELETE_KNOWLEDGE_BASE_JOB", "CREATE_KNOWLEDGE_BASE_JOB", "CREATE_KNOWLEDGE_BASE_JOB_RUN", "DEPLOY_AGENT_FLOW", "CREATE_GIT_FOLDER", "UPDATE_GIT_REPOSITORY", "CREATE_BUNDLE", "BUNDLE_DEPLOY", "BUNDLE_PURGE", "BUNDLE_SYNC", "MARK_AS_BUNDLE", "GIT_COMMIT_PUSH", "GIT_CREATE_BRANCH", "GIT_CHECKOUT_BRANCH", "GIT_OPERATION_PULL", "GIT_OPERATION_MERGE", "GIT_OPERATION_REBASE", "GIT_OPERATION_RESET", "GIT_OPERATION_RESET_STATE", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type action_type: str

        :param resource_name:
            The value to assign to the resource_name property of this AsyncOperationSummary.
        :type resource_name: str

        :param created_by:
            The value to assign to the created_by property of this AsyncOperationSummary.
        :type created_by: str

        :param created_by_name:
            The value to assign to the created_by_name property of this AsyncOperationSummary.
        :type created_by_name: str

        :param time_started:
            The value to assign to the time_started property of this AsyncOperationSummary.
        :type time_started: datetime

        :param time_finished:
            The value to assign to the time_finished property of this AsyncOperationSummary.
        :type time_finished: datetime

        :param status:
            The value to assign to the status property of this AsyncOperationSummary.
            Allowed values for this property are: "IN_PROGRESS", "SUCCEEDED", "FAILED", "CANCELED", 'UNKNOWN_ENUM_VALUE'.
            Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.
        :type status: str

        :param resource_display_name:
            The value to assign to the resource_display_name property of this AsyncOperationSummary.
    ...
    def key(self):
        """
        **[Required]** Gets the key of this AsyncOperationSummary.
        The unique key that identifies an async operation


        :return: The key of this AsyncOperationSummary.
        :rtype: str
        """
        return self._key
    ...
    def key(self, key):
        """
        Sets the key of this AsyncOperationSummary.
        The unique key that identifies an async operation


        :param key: The key of this AsyncOperationSummary.
        :type: str
        """
        self._key = key
    ...
    def resource_type(self):
        """
        **[Required]** Gets the resource_type of this AsyncOperationSummary.
        ...
        :return: The resource_type of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """
        Sets the resource_type of this AsyncOperationSummary.
        The resource type of the async operation.


        :param resource_type: The resource_type of this AsyncOperationSummary.
        :type: str
        """
        allowed_values = ["UNKNOWN", "CATALOG", "SCHEMA", "TABLE", "VIEW", "VOLUME", "VOLUME_FILE", "WORKSPACE", "WORKSPACE_OBJECT", "CLUSTER", "AI_COMPUTE", "KNOWLEDGE_BASE", "KNOWLEDGE_BASE_JOB", "KNOWLEDGE_BASE_JOB_RUN", "AGENT_FLOW", "GIT_OPERATION", "BUNDLE_OPERATION"]
    ...
    def action_type(self):
        """
        **[Required]** Gets the action_type of this AsyncOperationSummary.
        ...
        :return: The action_type of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def action_type(self, action_type):
        """
        Sets the action_type of this AsyncOperationSummary.
        The action type of the async operation.


        :param action_type: The action_type of this AsyncOperationSummary.
        :type: str
        """
        allowed_values = ["UNKNOWN", "CREATE_CATALOG", "UPDATE_CATALOG", "DELETE_CATALOG", "TEST_CONNECTION_CATALOG", "CREATE_USER_SCHEMA_IN_CATALOG", "CREATE_SCHEMA", "DELETE_SCHEMA", "CREATE_TABLE", "UPDATE_TABLE", "DELETE_TABLE", "CREATE_VOLUME", "DELETE_VOLUME", "COPY_VOLUME_FILE", "MOVE_VOLUME_FILE", "DELETE_VOLUME_FILE", "DELETE_VOLUME_FOLDER", "CREATE_WORKSPACE", "UPDATE_WORKSPACE", "DELETE_WORKSPACE", "CREATE_CLUSTER", "UPDATE_CLUSTER", "START_CLUSTER", "STOP_CLUSTER", "RESTART_CLUSTER", "PATCH_CLUSTER_LIBRARIES", "DELETE_CLUSTER", "MANAGE_EXTRACTED_ENTITIES", "REFRESH_ENTITY", "DOWNLOAD_CLUSTER_LOG", "MIGRATE_EXTERNAL_CATALOG", "UPDATE_KNOWLEDGE_BASE", "DELETE_KNOWLEDGE_BASE", "CREATE_KNOWLEDGE_BASE", "DELETE_KNOWLEDGE_BASE_JOB", "CREATE_KNOWLEDGE_BASE_JOB", "CREATE_KNOWLEDGE_BASE_JOB_RUN", "DEPLOY_AGENT_FLOW", "CREATE_GIT_FOLDER", "UPDATE_GIT_REPOSITORY", "CREATE_BUNDLE", "BUNDLE_DEPLOY", "BUNDLE_PURGE", "BUNDLE_SYNC", "MARK_AS_BUNDLE", "GIT_COMMIT_PUSH", "GIT_CREATE_BRANCH", "GIT_CHECKOUT_BRANCH", "GIT_OPERATION_PULL", "GIT_OPERATION_MERGE", "GIT_OPERATION_REBASE", "GIT_OPERATION_RESET", "GIT_OPERATION_RESET_STATE"]
    ...
    def resource_name(self):
        """
        **[Required]** Gets the resource_name of this AsyncOperationSummary.
        ...
        :return: The resource_name of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """
        Sets the resource_name of this AsyncOperationSummary.
        The fully qualified name of the Data Lake resource. Example: For table, it is
        <catalog_name>.<schema_name>.<table_name>. For Cluster, it is <workspace_key>.<cluster_key>


        :param resource_name: The resource_name of this AsyncOperationSummary.
        :type: str
        """
    ...
    def created_by(self):
        """
        **[Required]** Gets the created_by of this AsyncOperationSummary.
        The principal Id who started the async operation


        :return: The created_by of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def created_by(self, created_by):
        """
        Sets the created_by of this AsyncOperationSummary.
        The principal Id who started the async operation


        :param created_by: The created_by of this AsyncOperationSummary.
        :type: str
        """
    ...
    def created_by_name(self):
        """
        Gets the created_by_name of this AsyncOperationSummary.
        The principal name who started the async operation


        :return: The created_by_name of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def created_by_name(self, created_by_name):
        """
        Sets the created_by_name of this AsyncOperationSummary.
        The principal name who started the async operation


        :param created_by_name: The created_by_name of this AsyncOperationSummary.
        :type: str
        """
    ...
    def time_started(self):
        """
        Gets the time_started of this AsyncOperationSummary.
        ...
        :return: The time_started of this AsyncOperationSummary.
        :rtype: datetime
        """
    ...
    def time_started(self, time_started):
        """
        Sets the time_started of this AsyncOperationSummary.
        The date and time the Async operation was started, in the format defined by `RFC 3339`__.
        Example: `2016-08-25T21:10:29.600Z`
        ...
        :param time_started: The time_started of this AsyncOperationSummary.
        :type: datetime
        """
    ...
    def time_finished(self):
        """
        Gets the time_finished of this AsyncOperationSummary.
        ...
        :return: The time_finished of this AsyncOperationSummary.
        :rtype: datetime
        """
    ...
    def time_finished(self, time_finished):
        """
        Sets the time_finished of this AsyncOperationSummary.
        The date and time the Async operation finished, in the format defined by `RFC 3339`__.
        Example: `2016-08-25T21:10:29.600Z`
        ...
        :param time_finished: The time_finished of this AsyncOperationSummary.
        :type: datetime
        """
    ...
    def status(self):
        """
        **[Required]** Gets the status of this AsyncOperationSummary.
        ...
        :return: The status of this AsyncOperationSummary.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this AsyncOperationSummary.
        The state of the Table.


        :param status: The status of this AsyncOperationSummary.
        :type: str
        """
    ...
    def resource_display_name(self):
        """
        Gets the resource_display_name of this AsyncOperationSummary.
        ...
        :return: The resource_display_name of this AsyncOperationSummary.
        :rtype: str
        """
    ...
    def resource_display_name(self, resource_display_name):
        """
        Sets the resource_display_name of this AsyncOperationSummary.
        The display name of the Data Lake resource. Example: For catalog/table/schema, it is same as resourceName
        But for workspace/cluster it is workspace and cluster displayName field.


        :param resource_display_name: The resource_display_name of this AsyncOperationSummary.
        :type: str
        """
