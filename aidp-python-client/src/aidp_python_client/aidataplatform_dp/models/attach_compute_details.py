...
class AttachComputeDetails(object):
    """
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AttachComputeDetails object with values from keyword arguments.
        The following keyword arguments are supported (corresponding to the getters/setters of this class):

        :param agent_flow_compute_key:
            The value to assign to the agent_flow_compute_key property of this AttachComputeDetails.
    ...
    def agent_flow_compute_key(self):
        """
        **[Required]** Gets the agent_flow_compute_key of this AttachComputeDetails.
        The key of the Agent Flow Compute associated with this Agent Flow


        :return: The agent_flow_compute_key of this AttachComputeDetails.
        :rtype: str
        """
    ...
    def agent_flow_compute_key(self, agent_flow_compute_key):
        """
        Sets the agent_flow_compute_key of this AttachComputeDetails.
        The key of the Agent Flow Compute associated with this Agent Flow


        :param agent_flow_compute_key: The agent_flow_compute_key of this AttachComputeDetails.
        :type: str
        """
