...
class UserSettingClient(object):
    """
    ...
    def create_user_setting(self, ai_data_platform_id, create_user_setting_details, **kwargs):
        ...
        :param oci.aidataplatform_dp.models.CreateUserSettingDetails create_user_setting_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.UserSetting`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/userSettings"
        method = "POST"
    ...
    def delete_user_setting(self, ai_data_platform_id, setting_key, **kwargs):
        ...
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/userSettings/{settingKey}"
        method = "DELETE"
    ...
    def list_user_settings(self, ai_data_platform_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.aidataplatform_dp.models.UserSettingCollection`
        :rtype: :class:`~oci.response.Response`
        """
        resource_path = "/aiDataPlatforms/{aiDataPlatformId}/userSettings"
        method = "GET"
        ...
        if 'setting_type' in kwargs:
            setting_type_allowed_values = ["IAM_USER_CREDENTIAL", "GIT_ACCOUNT"]
            if kwargs['setting_type'] not in setting_type_allowed_values:
                raise ValueError(
                    "Invalid value for `setting_type`, must be one of {0}".format(setting_type_allowed_values)
                )
        ...
        query_params = {
            "settingType": kwargs.get("setting_type", missing),
    ...
    def update_user_setting(self, ai_data_platform_id, setting_key, update_user_setting_details, **kwargs):
        ...
        if retry_strategy:
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_user_setting_details,
                response_type="UserSetting")
        else:
            return self.base_client.call_api(
                resource_path=resource_path,
