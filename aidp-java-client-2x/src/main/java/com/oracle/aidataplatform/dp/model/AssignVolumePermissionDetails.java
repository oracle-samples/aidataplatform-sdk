...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignVolumePermissionDetails.Builder.class)

public final class AssignVolumePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public AssignVolumePermissionDetails(PermissionAssignees assignees, java.util.List<VolumePrivilege> permissions) {
        super();
     ...
     **/
        ...
        private java.util.List<VolumePrivilege> permissions;
        ...
        public Builder permissions(java.util.List<VolumePrivilege> permissions) {
        this.permissions = permissions;
        return this;
        }


        public AssignVolumePermissionDetails build() {
            AssignVolumePermissionDetails model = new AssignVolumePermissionDetails(this.assignees
                    , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssignVolumePermissionDetails model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("permissions")
    private final java.util.List<VolumePrivilege> permissions;
    ...
    public java.util.List<VolumePrivilege> getPermissions() {
        return permissions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignVolumePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignVolumePermissionDetails)) {
            return false;
        }

        AssignVolumePermissionDetails other = (AssignVolumePermissionDetails) o;
