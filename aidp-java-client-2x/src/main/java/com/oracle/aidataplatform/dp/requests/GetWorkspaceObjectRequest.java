...
public class GetWorkspaceObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetWorkspaceObjectRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetWorkspaceObjectRequest o) {
        ...
        /**
         * Build the instance of GetWorkspaceObjectRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetWorkspaceObjectRequest
         */
        public GetWorkspaceObjectRequest build() {
            GetWorkspaceObjectRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetWorkspaceObjectRequest
         */
        public GetWorkspaceObjectRequest buildWithoutInvocationCallback() {
            GetWorkspaceObjectRequest request = new GetWorkspaceObjectRequest();
            ...
            return request;
            // new GetWorkspaceObjectRequest(aiDataPlatformId, workspaceKey, objectPath, shouldIncludeMetadata, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWorkspaceObjectRequest)) {
            return false;
        }

        GetWorkspaceObjectRequest other = (GetWorkspaceObjectRequest) o;
