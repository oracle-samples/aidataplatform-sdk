...
* 
    ...
    private HeadAiDataPlatformWorkspaceObjectResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String objectKey, String path, String type, java.util.Date timeUpdated, String fileMetadata, String compositeEtag) {
