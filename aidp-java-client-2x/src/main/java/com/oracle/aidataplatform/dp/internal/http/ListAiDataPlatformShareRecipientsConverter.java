...
public class ListAiDataPlatformShareRecipientsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListAiDataPlatformShareRecipientsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListAiDataPlatformShareRecipientsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListAiDataPlatformShareRecipientsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListAiDataPlatformShareRecipientsRequest request) {
        ...
        .path("/20260430")
            .path("aiDataPlatforms").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getAiDataPlatformId())).path("shares").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getShareKey())).path("recipients");
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListAiDataPlatformShareRecipientsResponse responseWrapper = builder.build();
