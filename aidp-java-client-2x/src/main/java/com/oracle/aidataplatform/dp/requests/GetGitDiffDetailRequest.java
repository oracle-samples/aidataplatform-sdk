...
public class GetGitDiffDetailRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetGitDiffDetailRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetGitDiffDetailRequest o) {
        ...
        /**
         * Build the instance of GetGitDiffDetailRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetGitDiffDetailRequest
         */
        public GetGitDiffDetailRequest build() {
            GetGitDiffDetailRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetGitDiffDetailRequest
         */
        public GetGitDiffDetailRequest buildWithoutInvocationCallback() {
            GetGitDiffDetailRequest request = new GetGitDiffDetailRequest();
            ...
            return request;
            // new GetGitDiffDetailRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitFolderPath, branchName, gitFilePath, contextLines, maxPatchBytes, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGitDiffDetailRequest)) {
            return false;
        }

        GetGitDiffDetailRequest other = (GetGitDiffDetailRequest) o;
