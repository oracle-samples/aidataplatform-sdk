...
public class GetGitOperationStateConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GetGitOperationStateConverter.class);

    public static com.oracle.aidataplatform.dp.requests.GetGitOperationStateRequest interceptRequest(com.oracle.aidataplatform.dp.requests.GetGitOperationStateRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.GetGitOperationStateRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse");
        ...
        com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse.Builder builder = com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.GetGitOperationStateResponse responseWrapper = builder.build();
