...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=DownloadClusterLogsDetails.Builder.class)

public final class DownloadClusterLogsDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"timeBegin", "timeEnd", "logContentTypeContains", "clientContext", "subjectContains", "logLevel", "opcRequestId", "thread", "executionContextId", "logStreamTypeContains", "eventType"})
    public DownloadClusterLogsDetails(java.util.Date timeBegin, java.util.Date timeEnd, String logContentTypeContains, String clientContext, String subjectContains, String logLevel, String opcRequestId, String thread, String executionContextId, String logStreamTypeContains, String eventType) {
        super();
...
* 
     **/
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("clientContext")
        private String clientContext;

                /**
         * UI-generated identifier to correlate the async job.
* 
         * @param clientContext the value to set
         * @return this builder
         **/
...
* 
        ...
        public DownloadClusterLogsDetails build() {
            DownloadClusterLogsDetails model = new DownloadClusterLogsDetails(this.timeBegin
                    , this.timeEnd
...
* 
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DownloadClusterLogsDetails(");
        ...
        sb.append(", clientContext=").append(String.valueOf(this.clientContext));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadClusterLogsDetails)) {
            return false;
        }

        DownloadClusterLogsDetails other = (DownloadClusterLogsDetails) o;
        return java.util.Objects.equals(this.timeBegin, other.timeBegin) &&
            ...
            java.util.Objects.equals(this.clientContext, other.clientContext) &&
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.clientContext == null ? 43 : this.clientContext.hashCode());
