...
public class CommitPushAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CommitPushDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CommitPushDetails getBody$() {
        return commitPushDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CommitPushAiDataPlatformGitRepositoryRequest, com.oracle.aidataplatform.dp.model.CommitPushDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder commitPushDetails(com.oracle.aidataplatform.dp.model.CommitPushDetails commitPushDetails) {
            this.commitPushDetails = commitPushDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CommitPushAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());commitPushDetails(o.getCommitPushDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of CommitPushAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of CommitPushAiDataPlatformGitRepositoryRequest
         */
        public CommitPushAiDataPlatformGitRepositoryRequest build() {
            CommitPushAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CommitPushDetails body) {
            commitPushDetails(body);
            return this;
        }
         ...
         * @return instance of CommitPushAiDataPlatformGitRepositoryRequest
         */
        public CommitPushAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            CommitPushAiDataPlatformGitRepositoryRequest request = new CommitPushAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.commitPushDetails = commitPushDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            request.ifMatch = ifMatch;
            return request;
            // new CommitPushAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, commitPushDetails, opcRetryToken, opcRequestId, shouldUpdateRecent, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",commitPushDetails=").append(String.valueOf(this.commitPushDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommitPushAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        CommitPushAiDataPlatformGitRepositoryRequest other = (CommitPushAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.commitPushDetails, other.commitPushDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.commitPushDetails == null ? 43 : this.commitPushDetails.hashCode());
