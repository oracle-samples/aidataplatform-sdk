...
public class GetGitOperationStateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetGitOperationStateResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GitOperationState gitOperationState) {
