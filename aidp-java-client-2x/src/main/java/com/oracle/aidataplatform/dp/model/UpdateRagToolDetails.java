...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateRagToolDetails.Builder.class)
...
public final class UpdateRagToolDetails extends UpdateToolDetails {
    ...
    public static class Builder {
        ...
        public UpdateRagToolDetails build() {
            UpdateRagToolDetails model = new UpdateRagToolDetails(this.displayName
                    , this.description
                    , this.properties
                    , this.inputSchema
        ...
        public Builder copy(UpdateRagToolDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateRagToolDetails(String displayName, String description, java.util.Map<String, Object> properties, RagToolInputSchema inputSchema, RagToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateRagToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRagToolDetails)) {
            return false;
        }

        UpdateRagToolDetails other = (UpdateRagToolDetails) o;
