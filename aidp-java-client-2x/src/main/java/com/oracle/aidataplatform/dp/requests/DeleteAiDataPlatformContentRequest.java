...
public class DeleteAiDataPlatformContentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformContentRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformContentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());contentPath(o.getContentPath());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformContentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformContentRequest
         */
        public DeleteAiDataPlatformContentRequest build() {
            DeleteAiDataPlatformContentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformContentRequest
         */
        public DeleteAiDataPlatformContentRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformContentRequest request = new DeleteAiDataPlatformContentRequest();
            ...
            return request;
            // new DeleteAiDataPlatformContentRequest(aiDataPlatformId, workspaceKey, contentPath, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformContentRequest)) {
            return false;
        }

        DeleteAiDataPlatformContentRequest other = (DeleteAiDataPlatformContentRequest) o;
