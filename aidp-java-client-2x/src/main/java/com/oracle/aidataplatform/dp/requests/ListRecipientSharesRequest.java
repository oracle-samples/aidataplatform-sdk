...
public class ListRecipientSharesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListRecipientSharesRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListRecipientSharesRequest o) {
        ...
        /**
         * Build the instance of ListRecipientSharesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRecipientSharesRequest
         */
        public ListRecipientSharesRequest build() {
            ListRecipientSharesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRecipientSharesRequest
         */
        public ListRecipientSharesRequest buildWithoutInvocationCallback() {
            ListRecipientSharesRequest request = new ListRecipientSharesRequest();
            ...
            return request;
            // new ListRecipientSharesRequest(aiDataPlatformId, recipientKey, displayName, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecipientSharesRequest)) {
            return false;
        }

        ListRecipientSharesRequest other = (ListRecipientSharesRequest) o;
