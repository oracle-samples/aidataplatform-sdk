...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=KafkaTopicSchemaSummary.Builder.class)
...
public final class KafkaTopicSchemaSummary extends SchemaSummary {
     ...
     **/
        ...
        public KafkaTopicSchemaSummary build() {
            KafkaTopicSchemaSummary model = new KafkaTopicSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
                    ...
                    , this.timeLastRefresh
                    , this.partitions
                    , this.replicationFactor);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KafkaTopicSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public KafkaTopicSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh, String partitions, String replicationFactor) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KafkaTopicSchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KafkaTopicSchemaSummary)) {
            return false;
        }

        KafkaTopicSchemaSummary other = (KafkaTopicSchemaSummary) o;
