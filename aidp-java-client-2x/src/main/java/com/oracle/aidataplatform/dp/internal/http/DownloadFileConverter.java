...
public class DownloadFileConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DownloadFileConverter.class);

    public static com.oracle.aidataplatform.dp.requests.DownloadFileRequest interceptRequest(com.oracle.aidataplatform.dp.requests.DownloadFileRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.DownloadFileRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadFileResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadFileResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadFileResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadFileResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.DownloadFileResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.DownloadFileResponse");
        ...
        com.oracle.aidataplatform.dp.responses.DownloadFileResponse.Builder builder = com.oracle.aidataplatform.dp.responses.DownloadFileResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.DownloadFileResponse responseWrapper = builder.build();
