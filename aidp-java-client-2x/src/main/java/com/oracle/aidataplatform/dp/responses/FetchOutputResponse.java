...
* 
    ...
    private FetchOutputResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.TaskRunOutput taskRunOutput) {
