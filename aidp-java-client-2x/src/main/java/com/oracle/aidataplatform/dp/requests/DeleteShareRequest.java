...
public class DeleteShareRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteShareRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteShareRequest o) {
        ...
        /**
         * Build the instance of DeleteShareRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteShareRequest
         */
        public DeleteShareRequest build() {
            DeleteShareRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteShareRequest
         */
        public DeleteShareRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteShareRequest(aiDataPlatformId, shareKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteShareRequest)) {
            return false;
        }

        DeleteShareRequest other = (DeleteShareRequest) o;
