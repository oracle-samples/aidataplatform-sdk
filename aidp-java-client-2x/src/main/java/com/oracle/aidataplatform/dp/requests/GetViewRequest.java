...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetViewRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public GetViewRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetViewRequest(aiDataPlatformId, viewKey, opcRequestId, shouldUpdateRecent);
        }
    }
