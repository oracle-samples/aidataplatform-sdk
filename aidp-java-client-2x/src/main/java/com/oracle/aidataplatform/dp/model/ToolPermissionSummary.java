...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ToolPermissionSummary.Builder.class)

public final class ToolPermissionSummary  {
    @Deprecated
    ...
    public ToolPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<ToolPrivilege> granteePermissions, java.util.List<String> columns, java.util.List<String> excludeColumns, Boolean isInherited, String resourceName) {
        super();
     ...
     **/
        ...
        private java.util.List<ToolPrivilege> granteePermissions;
        ...
        public Builder granteePermissions(java.util.List<ToolPrivilege> granteePermissions) {
        this.granteePermissions = granteePermissions;
        return this;
        }
            /**
     ...
     **/
        ...
        public ToolPermissionSummary build() {
            ToolPermissionSummary model = new ToolPermissionSummary(this.grantee
                    , this.granteeName
                    , this.granteeType
        ...
        public Builder copy(ToolPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<ToolPrivilege> granteePermissions;
    ...
    public java.util.List<ToolPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ToolPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ToolPermissionSummary)) {
            return false;
        }

        ToolPermissionSummary other = (ToolPermissionSummary) o;
