...
public class GitServiceClient implements GitService {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, GitServiceClient> {
         ...
         * @return the client
         */
        public GitServiceClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            if (authenticationDetailsProvider == null) {
                throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
            }
            return new GitServiceClient(authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
    ...
    public CheckoutAiDataPlatformBranchResponse checkoutAiDataPlatformBranch(CheckoutAiDataPlatformBranchRequest request) {
        LOG.trace("Called checkoutAiDataPlatformBranch");
            ...
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "CheckoutAiDataPlatformBranch", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getCheckoutBranchDetails(), retriedRequest);
    ...
    public CommitPushAiDataPlatformGitRepositoryResponse commitPushAiDataPlatformGitRepository(CommitPushAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called commitPushAiDataPlatformGitRepository");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "CommitPushAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getCommitPushDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public CreateAiDataPlatformGitBranchResponse createAiDataPlatformGitBranch(CreateAiDataPlatformGitBranchRequest request) {
        LOG.trace("Called createAiDataPlatformGitBranch");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "CreateAiDataPlatformGitBranch", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getCreateGitBranchDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public GetAiDataPlatformGitDiffDetailResponse getAiDataPlatformGitDiffDetail(GetAiDataPlatformGitDiffDetailRequest request) {
        LOG.trace("Called getAiDataPlatformGitDiffDetail");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "GetAiDataPlatformGitDiffDetail", ib.getRequestUri().toString(), "");
    ...
    public GetAiDataPlatformGitOperationStateResponse getAiDataPlatformGitOperationState(GetAiDataPlatformGitOperationStateRequest request) {
        LOG.trace("Called getAiDataPlatformGitOperationState");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "GetAiDataPlatformGitOperationState", ib.getRequestUri().toString(), "");
    ...
    public GetAiDataPlatformGitRepositoryResponse getAiDataPlatformGitRepository(GetAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called getAiDataPlatformGitRepository");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "GetAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
    ...
    public ListAiDataPlatformGitBranchesResponse listAiDataPlatformGitBranches(ListAiDataPlatformGitBranchesRequest request) {
        LOG.trace("Called listAiDataPlatformGitBranches");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "ListAiDataPlatformGitBranches", ib.getRequestUri().toString(), "");
    ...
    public ListAiDataPlatformGitDiffsResponse listAiDataPlatformGitDiffs(ListAiDataPlatformGitDiffsRequest request) {
        LOG.trace("Called listAiDataPlatformGitDiffs");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "ListAiDataPlatformGitDiffs", ib.getRequestUri().toString(), "");
    ...
    public MergeAiDataPlatformGitRepositoryResponse mergeAiDataPlatformGitRepository(MergeAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called mergeAiDataPlatformGitRepository");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "MergeAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getGitMergeDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public PullAiDataPlatformGitRepositoryResponse pullAiDataPlatformGitRepository(PullAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called pullAiDataPlatformGitRepository");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "PullAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getGitPullDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public RebaseAiDataPlatformGitRepositoryResponse rebaseAiDataPlatformGitRepository(RebaseAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called rebaseAiDataPlatformGitRepository");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "RebaseAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getGitRebaseDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public ResetAiDataPlatformGitFolderStateResponse resetAiDataPlatformGitFolderState(ResetAiDataPlatformGitFolderStateRequest request) {
        LOG.trace("Called resetAiDataPlatformGitFolderState");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "ResetAiDataPlatformGitFolderState", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getResetGitFolderStateDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public ResetAiDataPlatformGitRepositoryResponse resetAiDataPlatformGitRepository(ResetAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called resetAiDataPlatformGitRepository");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "ResetAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getGitResetDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public ResolveAiDataPlatformGitConflictsResponse resolveAiDataPlatformGitConflicts(ResolveAiDataPlatformGitConflictsRequest request) {
        LOG.trace("Called resolveAiDataPlatformGitConflicts");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "ResolveAiDataPlatformGitConflicts", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getConflictResolveDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
    ...
    public UpdateAiDataPlatformGitRepositoryResponse updateAiDataPlatformGitRepository(UpdateAiDataPlatformGitRepositoryRequest request) {
        LOG.trace("Called updateAiDataPlatformGitRepository");
            ...
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier = com.oracle.bmc.retrier.Retriers.createPreferredRetrier(interceptedRequest.getRetryConfiguration(), retryConfiguration, true);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("GitService", "UpdateAiDataPlatformGitRepository", ib.getRequestUri().toString(), "");
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.put(ib, retriedRequest.getUpdateGitRepositoryDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
