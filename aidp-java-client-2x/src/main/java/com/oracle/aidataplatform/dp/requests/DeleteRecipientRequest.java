...
public class DeleteRecipientRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteRecipientRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteRecipientRequest o) {
        ...
        /**
         * Build the instance of DeleteRecipientRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteRecipientRequest
         */
        public DeleteRecipientRequest build() {
            DeleteRecipientRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteRecipientRequest
         */
        public DeleteRecipientRequest buildWithoutInvocationCallback() {
            DeleteRecipientRequest request = new DeleteRecipientRequest();
            ...
            return request;
            // new DeleteRecipientRequest(aiDataPlatformId, recipientKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRecipientRequest)) {
            return false;
        }

        DeleteRecipientRequest other = (DeleteRecipientRequest) o;
