...
public class DeleteTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteTableRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of DeleteTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteTableRequest
         */
        public DeleteTableRequest build() {
            DeleteTableRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteTableRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteTableRequest(aiDataPlatformId, tableKey, displayName, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTableRequest)) {
            return false;
        }

        DeleteTableRequest other = (DeleteTableRequest) o;
