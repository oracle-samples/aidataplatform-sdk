...
public class DownloadAiDataPlatformClusterLogsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DownloadClusterLogsDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DownloadAiDataPlatformClusterLogsRequest, com.oracle.aidataplatform.dp.model.DownloadClusterLogsDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadAiDataPlatformClusterLogsRequest o) {
        ...
        /**
         * Build the instance of DownloadAiDataPlatformClusterLogsRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadAiDataPlatformClusterLogsRequest
         */
        public DownloadAiDataPlatformClusterLogsRequest build() {
            DownloadAiDataPlatformClusterLogsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DownloadAiDataPlatformClusterLogsRequest
         */
        public DownloadAiDataPlatformClusterLogsRequest buildWithoutInvocationCallback() {
            DownloadAiDataPlatformClusterLogsRequest request = new DownloadAiDataPlatformClusterLogsRequest();
            ...
            return request;
            // new DownloadAiDataPlatformClusterLogsRequest(aiDataPlatformId, workspaceKey, clusterKey, downloadClusterLogsDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadAiDataPlatformClusterLogsRequest)) {
            return false;
        }

        DownloadAiDataPlatformClusterLogsRequest other = (DownloadAiDataPlatformClusterLogsRequest) o;
