...
public final class CreateJobDetails  {
    ...
    public CreateJobDetails(String runAs, String name, String description, Schedule schedule, Continuous continuous, Integer maxConcurrentRuns, GitConfig gitConfig, Queue queue, java.util.List<JobCluster> jobClusters, String path, java.util.List<Task> tasks, java.util.List<Parameter> parameters, Integer timeoutSeconds) {
        super();
        this.runAs = runAs;
        this.name = name;
     ...
     **/
        ...
        public CreateJobDetails build() {
            CreateJobDetails model = new CreateJobDetails(this.runAs
                    , this.name
                    , this.description
                    , this.schedule
                    , this.continuous
