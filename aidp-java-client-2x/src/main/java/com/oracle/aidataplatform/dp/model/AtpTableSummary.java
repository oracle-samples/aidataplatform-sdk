...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AtpTableSummary.Builder.class)
...
public final class AtpTableSummary extends TableSummary {
    ...
    public static class Builder {
        ...
        public AtpTableSummary build() {
            AtpTableSummary model = new AtpTableSummary(this.key
                    , this.displayName
                    , this.tableType
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(AtpTableSummary model) {
...
return this;
    ...
    @Deprecated
    public AtpTableSummary(String key, String displayName, TableType tableType, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, TableLifecycleState lifecycleState) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AtpTableSummary)) {
            return false;
        }

        AtpTableSummary other = (AtpTableSummary) o;
