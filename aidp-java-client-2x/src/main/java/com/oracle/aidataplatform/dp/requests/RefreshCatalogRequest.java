...
public class RefreshCatalogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshCatalogRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshCatalogRequest o) {
        ...
        /**
         * Build the instance of RefreshCatalogRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshCatalogRequest
         */
        public RefreshCatalogRequest build() {
            RefreshCatalogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshCatalogRequest
         */
        public RefreshCatalogRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RefreshCatalogRequest(aiDataPlatformId, catalogKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshCatalogRequest)) {
            return false;
        }

        RefreshCatalogRequest other = (RefreshCatalogRequest) o;
