...
public class ListAiDataPlatformGitBranchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListAiDataPlatformGitBranchesResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.GitBranchCollection gitBranchCollection) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformGitBranchesResponse)) {
            return false;
        }

        ListAiDataPlatformGitBranchesResponse other = (ListAiDataPlatformGitBranchesResponse) o;
