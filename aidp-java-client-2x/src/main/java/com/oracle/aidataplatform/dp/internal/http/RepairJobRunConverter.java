...
public class RepairJobRunConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(RepairJobRunConverter.class);

    public static com.oracle.aidataplatform.dp.requests.RepairJobRunRequest interceptRequest(com.oracle.aidataplatform.dp.requests.RepairJobRunRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.RepairJobRunRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RepairJobRunResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RepairJobRunResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RepairJobRunResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RepairJobRunResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.RepairJobRunResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.RepairJobRunResponse");
        ...
        com.oracle.aidataplatform.dp.responses.RepairJobRunResponse.Builder builder = com.oracle.aidataplatform.dp.responses.RepairJobRunResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.RepairJobRunResponse responseWrapper = builder.build();
