...
public class MakeDirRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<MakeDirRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(MakeDirRequest o) {
        ...
        /**
         * Build the instance of MakeDirRequest as configured by this builder
         *
         ...
         *
         * @return instance of MakeDirRequest
         */
        public MakeDirRequest build() {
            MakeDirRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of MakeDirRequest
         */
        public MakeDirRequest buildWithoutInvocationCallback() {
            MakeDirRequest request = new MakeDirRequest();
            ...
            return request;
            // new MakeDirRequest(aiDataPlatformId, volumeKey, path, description, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        MakeDirRequest other = (MakeDirRequest) o;
