...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=StartNode.Builder.class)
...
public final class StartNode extends AgentFlowNode {
     ...
     **/
        ...
        public StartNode build() {
            StartNode model = new StartNode(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(StartNode model) {
...
return this;
    ...
    @Deprecated
    public StartNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, String> startNodeConfig) {
