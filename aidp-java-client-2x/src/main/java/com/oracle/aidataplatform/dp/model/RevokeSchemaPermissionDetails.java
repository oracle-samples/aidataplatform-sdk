...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeSchemaPermissionDetails.Builder.class)

public final class RevokeSchemaPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public RevokeSchemaPermissionDetails(PermissionAssignees assignees, java.util.List<SchemaPrivilegeForManage> permissions) {
        super();
     ...
     **/
        ...
        public RevokeSchemaPermissionDetails build() {
            RevokeSchemaPermissionDetails model = new RevokeSchemaPermissionDetails(this.assignees
                    , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeSchemaPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeSchemaPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeSchemaPermissionDetails)) {
            return false;
        }

        RevokeSchemaPermissionDetails other = (RevokeSchemaPermissionDetails) o;
