...
public class UpdateAiDataPlatformWorkspaceObjectConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateAiDataPlatformWorkspaceObjectConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformWorkspaceObjectRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformWorkspaceObjectRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformWorkspaceObjectRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getObjectPath(), "objectPath must not be blank");        Validate.notNull(request.getUpdateWorkspaceObjectDetails(), "updateWorkspaceObjectDetails is required");                                
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformWorkspaceObjectResponse responseWrapper = builder.build();
