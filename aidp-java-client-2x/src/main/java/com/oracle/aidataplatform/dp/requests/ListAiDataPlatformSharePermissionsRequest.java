...
public class ListAiDataPlatformSharePermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.SortOrder getSortOrder() {
        ...
        /**
     * The field to sort by. You can provide only one sort order. Default order for {@code grantee}
* is ascending. Default order for {@code granteeType} is ascending.
* 
     */
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformSharePermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformSharePermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());shareKey(o.getShareKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformSharePermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformSharePermissionsRequest
         */
        public ListAiDataPlatformSharePermissionsRequest build() {
            ListAiDataPlatformSharePermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformSharePermissionsRequest
         */
        public ListAiDataPlatformSharePermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformSharePermissionsRequest request = new ListAiDataPlatformSharePermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformSharePermissionsRequest(aiDataPlatformId, shareKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformSharePermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformSharePermissionsRequest other = (ListAiDataPlatformSharePermissionsRequest) o;
