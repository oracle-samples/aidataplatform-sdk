...
public class ListAiDataPlatformClusterLibrariesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformClusterLibrariesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformClusterLibrariesRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformClusterLibrariesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformClusterLibrariesRequest
         */
        public ListAiDataPlatformClusterLibrariesRequest build() {
            ListAiDataPlatformClusterLibrariesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformClusterLibrariesRequest
         */
        public ListAiDataPlatformClusterLibrariesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformClusterLibrariesRequest request = new ListAiDataPlatformClusterLibrariesRequest();
            ...
            return request;
            // new ListAiDataPlatformClusterLibrariesRequest(aiDataPlatformId, workspaceKey, clusterKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformClusterLibrariesRequest)) {
            return false;
        }

        ListAiDataPlatformClusterLibrariesRequest other = (ListAiDataPlatformClusterLibrariesRequest) o;
