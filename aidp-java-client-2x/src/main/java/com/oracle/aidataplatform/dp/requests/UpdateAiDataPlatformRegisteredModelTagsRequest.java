...
public class UpdateAiDataPlatformRegisteredModelTagsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsDetails getBody$() {
        return updateRegisteredModelTagsDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformRegisteredModelTagsRequest, com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder updateRegisteredModelTagsDetails(com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsDetails updateRegisteredModelTagsDetails) {
            this.updateRegisteredModelTagsDetails = updateRegisteredModelTagsDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformRegisteredModelTagsRequest o) {
        ...
        /**
         * Build the instance of UpdateAiDataPlatformRegisteredModelTagsRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformRegisteredModelTagsRequest
         */
        public UpdateAiDataPlatformRegisteredModelTagsRequest build() {
            UpdateAiDataPlatformRegisteredModelTagsRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateRegisteredModelTagsDetails body) {
            updateRegisteredModelTagsDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateAiDataPlatformRegisteredModelTagsRequest
         */
        public UpdateAiDataPlatformRegisteredModelTagsRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformRegisteredModelTagsRequest request = new UpdateAiDataPlatformRegisteredModelTagsRequest();
            ...
            return request;
            // new UpdateAiDataPlatformRegisteredModelTagsRequest(aiDataPlatformId, updateRegisteredModelTagsDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformRegisteredModelTagsRequest)) {
            return false;
        }

        UpdateAiDataPlatformRegisteredModelTagsRequest other = (UpdateAiDataPlatformRegisteredModelTagsRequest) o;
