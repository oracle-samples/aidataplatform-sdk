...
public class ExportContentsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ExportContentsDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ExportContentsRequest, com.oracle.aidataplatform.dp.model.ExportContentsDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ExportContentsRequest o) {
        ...
        /**
         * Build the instance of ExportContentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ExportContentsRequest
         */
        public ExportContentsRequest build() {
            ExportContentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ExportContentsRequest
         */
        public ExportContentsRequest buildWithoutInvocationCallback() {
            ExportContentsRequest request = new ExportContentsRequest();
            ...
            return request;
            // new ExportContentsRequest(aiDataPlatformId, workspaceKey, contentPath, exportContentsDetails, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportContentsRequest)) {
            return false;
        }

        ExportContentsRequest other = (ExportContentsRequest) o;
