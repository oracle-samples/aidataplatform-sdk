...
public class StartClusterConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(StartClusterConverter.class);

    public static com.oracle.aidataplatform.dp.requests.StartClusterRequest interceptRequest(com.oracle.aidataplatform.dp.requests.StartClusterRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.StartClusterRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.StartClusterResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.StartClusterResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.StartClusterResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.StartClusterResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.StartClusterResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.StartClusterResponse");
        ...
        com.oracle.aidataplatform.dp.responses.StartClusterResponse.Builder builder = com.oracle.aidataplatform.dp.responses.StartClusterResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.StartClusterResponse responseWrapper = builder.build();
