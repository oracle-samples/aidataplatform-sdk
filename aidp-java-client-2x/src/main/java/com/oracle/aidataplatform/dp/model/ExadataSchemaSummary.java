...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExadataSchemaSummary.Builder.class)
...
public final class ExadataSchemaSummary extends SchemaSummary {
    ...
    public static class Builder {
        ...
        public ExadataSchemaSummary build() {
            ExadataSchemaSummary model = new ExadataSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(ExadataSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public ExadataSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadataSchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataSchemaSummary)) {
            return false;
        }

        ExadataSchemaSummary other = (ExadataSchemaSummary) o;
