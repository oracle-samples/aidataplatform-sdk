...
public class UpdateAiDataPlatformJobRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateJobDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.UpdateJobDetails updateJobDetails;
     ...
     * The information to be updated.
     */
    public com.oracle.aidataplatform.dp.model.UpdateJobDetails getUpdateJobDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateJobDetails getBody$() {
        return updateJobDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformJobRequest, com.oracle.aidataplatform.dp.model.UpdateJobDetails> {
     ...
     * The information to be updated.
     */
        private com.oracle.aidataplatform.dp.model.UpdateJobDetails updateJobDetails = null;
         ...
         * @return this builder instance
         */
        public Builder updateJobDetails(com.oracle.aidataplatform.dp.model.UpdateJobDetails updateJobDetails) {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformJobRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobKey(o.getJobKey());updateJobDetails(o.getUpdateJobDetails());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of UpdateAiDataPlatformJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformJobRequest
         */
        public UpdateAiDataPlatformJobRequest build() {
            UpdateAiDataPlatformJobRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateJobDetails body) {
         ...
         * @return instance of UpdateAiDataPlatformJobRequest
         */
        public UpdateAiDataPlatformJobRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformJobRequest request = new UpdateAiDataPlatformJobRequest();
            ...
            return request;
            // new UpdateAiDataPlatformJobRequest(aiDataPlatformId, workspaceKey, jobKey, updateJobDetails, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformJobRequest)) {
            return false;
        }

        UpdateAiDataPlatformJobRequest other = (UpdateAiDataPlatformJobRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateJobDetails == null ? 43 : this.updateJobDetails.hashCode());
