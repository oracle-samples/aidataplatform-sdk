...
public class ListRecipientsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListRecipientsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListRecipientsRequest o) {
        ...
        /**
         * Build the instance of ListRecipientsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRecipientsRequest
         */
        public ListRecipientsRequest build() {
            ListRecipientsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRecipientsRequest
         */
        public ListRecipientsRequest buildWithoutInvocationCallback() {
            ListRecipientsRequest request = new ListRecipientsRequest();
            ...
            return request;
            // new ListRecipientsRequest(aiDataPlatformId, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecipientsRequest)) {
            return false;
        }

        ListRecipientsRequest other = (ListRecipientsRequest) o;
