...
public class GetContentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetContentRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetContentRequest o) {
        ...
        /**
         * Build the instance of GetContentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetContentRequest
         */
        public GetContentRequest build() {
            GetContentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetContentRequest
         */
        public GetContentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetContentRequest(aiDataPlatformId, workspaceKey, contentPath, opcRequestId, type, format, content, hash, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetContentRequest)) {
            return false;
        }

        GetContentRequest other = (GetContentRequest) o;
