...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=MasterCatalog.Builder.class)
...
public final class MasterCatalog  {
    ...
    public MasterCatalog(String key, String displayName, String description, MasterCatalogLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy) {
        super();
        this.key = key;
...
* 
        ...
        public MasterCatalog build() {
            MasterCatalog model = new MasterCatalog(this.key
                    , this.displayName
                    , this.description
                    , this.lifecycleState
        ...
        public Builder copy(MasterCatalog model) {
...
* 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MasterCatalog)) {
            return false;
        }

        MasterCatalog other = (MasterCatalog) o;
