...
public class ListWorkspacesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListWorkspacesRequest, java.lang.Void> {
...
* 
        ...
        public ListWorkspacesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWorkspacesRequest(aiDataPlatformId, lifecycleState, displayName, displayNameContains, type, limit, page, sortOrder, sortBy, isPrivateNetworkEnabled, opcRequestId);
        }
    }
