...
public class PerformInferSchemaWithPreviewRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PerformInferSchemaWithPreviewRequest, com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PerformInferSchemaWithPreviewRequest o) {
        ...
        /**
         * Build the instance of PerformInferSchemaWithPreviewRequest as configured by this builder
         *
         ...
         *
         * @return instance of PerformInferSchemaWithPreviewRequest
         */
        public PerformInferSchemaWithPreviewRequest build() {
            PerformInferSchemaWithPreviewRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PerformInferSchemaWithPreviewRequest
         */
        public PerformInferSchemaWithPreviewRequest buildWithoutInvocationCallback() {
            PerformInferSchemaWithPreviewRequest request = new PerformInferSchemaWithPreviewRequest();
            ...
            return request;
            // new PerformInferSchemaWithPreviewRequest(aiDataPlatformId, schemaKey, performInferSchemaDetails, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PerformInferSchemaWithPreviewRequest)) {
            return false;
        }

        PerformInferSchemaWithPreviewRequest other = (PerformInferSchemaWithPreviewRequest) o;
