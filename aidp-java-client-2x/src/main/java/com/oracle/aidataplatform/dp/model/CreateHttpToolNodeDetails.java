...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateHttpToolNodeDetails.Builder.class)
...
public final class CreateHttpToolNodeDetails extends CreateAgentFlowNodeDetails {
     ...
     **/
        ...
        public CreateHttpToolNodeDetails build() {
            CreateHttpToolNodeDetails model = new CreateHttpToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(CreateHttpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateHttpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, HttpToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateHttpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateHttpToolNodeDetails)) {
            return false;
        }

        CreateHttpToolNodeDetails other = (CreateHttpToolNodeDetails) o;
