...
public class GetAiDataPlatformJobRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformJobRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformJobRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobKey(o.getJobKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformJobRequest
         */
        public GetAiDataPlatformJobRequest build() {
            GetAiDataPlatformJobRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformJobRequest
         */
        public GetAiDataPlatformJobRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformJobRequest request = new GetAiDataPlatformJobRequest();
            ...
            return request;
            // new GetAiDataPlatformJobRequest(aiDataPlatformId, workspaceKey, jobKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformJobRequest)) {
            return false;
        }

        GetAiDataPlatformJobRequest other = (GetAiDataPlatformJobRequest) o;
