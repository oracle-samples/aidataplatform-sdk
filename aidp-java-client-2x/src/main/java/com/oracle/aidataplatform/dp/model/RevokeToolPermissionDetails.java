...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeToolPermissionDetails.Builder.class)

public final class RevokeToolPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public RevokeToolPermissionDetails(PermissionAssignees assignees, java.util.List<ToolPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
     ...
     **/
        ...
        private java.util.List<ToolPrivilegeForManage> permissions;
        ...
        public Builder permissions(java.util.List<ToolPrivilegeForManage> permissions) {
        this.permissions = permissions;
        return this;
        }
            /**
     ...
     **/
        ...
        public RevokeToolPermissionDetails build() {
            RevokeToolPermissionDetails model = new RevokeToolPermissionDetails(this.assignees
                    , this.permissions
                    , this.includeColumns
        ...
        public Builder copy(RevokeToolPermissionDetails model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("permissions")
    private final java.util.List<ToolPrivilegeForManage> permissions;
    ...
    public java.util.List<ToolPrivilegeForManage> getPermissions() {
        return permissions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeToolPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeToolPermissionDetails)) {
            return false;
        }

        RevokeToolPermissionDetails other = (RevokeToolPermissionDetails) o;
