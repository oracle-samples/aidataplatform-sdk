...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreatePromptToolNodeDetails.Builder.class)
...
public final class CreatePromptToolNodeDetails extends CreateAgentFlowNodeDetails {
     ...
     **/
        ...
        public CreatePromptToolNodeDetails build() {
            CreatePromptToolNodeDetails model = new CreatePromptToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(CreatePromptToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreatePromptToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, PromptToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreatePromptToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePromptToolNodeDetails)) {
            return false;
        }

        CreatePromptToolNodeDetails other = (CreatePromptToolNodeDetails) o;
