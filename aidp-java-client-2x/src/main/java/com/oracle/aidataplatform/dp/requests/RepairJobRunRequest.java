...
public class RepairJobRunRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.RepairJobRunDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RepairJobRunRequest, com.oracle.aidataplatform.dp.model.RepairJobRunDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RepairJobRunRequest o) {
        ...
        /**
         * Build the instance of RepairJobRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of RepairJobRunRequest
         */
        public RepairJobRunRequest build() {
            RepairJobRunRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RepairJobRunRequest
         */
        public RepairJobRunRequest buildWithoutInvocationCallback() {
            RepairJobRunRequest request = new RepairJobRunRequest();
            ...
            return request;
            // new RepairJobRunRequest(aiDataPlatformId, workspaceKey, jobRunKey, repairJobRunDetails, opcRetryToken, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RepairJobRunRequest)) {
            return false;
        }

        RepairJobRunRequest other = (RepairJobRunRequest) o;
