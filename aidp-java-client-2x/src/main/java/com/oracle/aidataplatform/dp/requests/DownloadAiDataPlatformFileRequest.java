...
public class DownloadAiDataPlatformFileRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DownloadAiDataPlatformFileRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadAiDataPlatformFileRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());volumeKey(o.getVolumeKey());path(o.getPath());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DownloadAiDataPlatformFileRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadAiDataPlatformFileRequest
         */
        public DownloadAiDataPlatformFileRequest build() {
            DownloadAiDataPlatformFileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DownloadAiDataPlatformFileRequest
         */
        public DownloadAiDataPlatformFileRequest buildWithoutInvocationCallback() {
            DownloadAiDataPlatformFileRequest request = new DownloadAiDataPlatformFileRequest();
            ...
            return request;
            // new DownloadAiDataPlatformFileRequest(aiDataPlatformId, volumeKey, path, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadAiDataPlatformFileRequest)) {
            return false;
        }

        DownloadAiDataPlatformFileRequest other = (DownloadAiDataPlatformFileRequest) o;
