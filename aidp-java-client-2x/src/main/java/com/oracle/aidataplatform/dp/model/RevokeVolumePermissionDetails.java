...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeVolumePermissionDetails.Builder.class)

public final class RevokeVolumePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public RevokeVolumePermissionDetails(PermissionAssignees assignees, java.util.List<VolumePrivilege> permissions) {
        super();
     ...
     **/
        ...
        public RevokeVolumePermissionDetails build() {
            RevokeVolumePermissionDetails model = new RevokeVolumePermissionDetails(this.assignees
                    , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeVolumePermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeVolumePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeVolumePermissionDetails)) {
            return false;
        }

        RevokeVolumePermissionDetails other = (RevokeVolumePermissionDetails) o;
