...
public class RefreshSchemaRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshSchemaRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshSchemaRequest o) {
        ...
        /**
         * Build the instance of RefreshSchemaRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshSchemaRequest
         */
        public RefreshSchemaRequest build() {
            RefreshSchemaRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshSchemaRequest
         */
        public RefreshSchemaRequest buildWithoutInvocationCallback() {
            RefreshSchemaRequest request = new RefreshSchemaRequest();
            ...
            return request;
            // new RefreshSchemaRequest(aiDataPlatformId, schemaKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshSchemaRequest)) {
            return false;
        }

        RefreshSchemaRequest other = (RefreshSchemaRequest) o;
