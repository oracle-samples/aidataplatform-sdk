...
public class ListAiDataPlatformClustersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.Cluster.State state;
     ...
     * A filter to return only resources that match the given lifecycle state. The state value is case-insensitive.
     */
    public com.oracle.aidataplatform.dp.model.Cluster.State getState() {
        return state;
    }
        /**
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformClustersRequest, java.lang.Void> {
     ...
     * A filter to return only resources that match the given lifecycle state. The state value is case-insensitive.
     */
        private com.oracle.aidataplatform.dp.model.Cluster.State state = null;
         ...
         * @return this builder instance
         */
        public Builder state(com.oracle.aidataplatform.dp.model.Cluster.State state) {
            this.state = state;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformClustersRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());state(o.getState());displayName(o.getDisplayName());displayNameContains(o.getDisplayNameContains());type(o.getType());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformClustersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformClustersRequest
         */
        public ListAiDataPlatformClustersRequest build() {
            ListAiDataPlatformClustersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformClustersRequest
         */
        public ListAiDataPlatformClustersRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformClustersRequest request = new ListAiDataPlatformClustersRequest();
            ...
            return request;
            // new ListAiDataPlatformClustersRequest(aiDataPlatformId, workspaceKey, state, displayName, displayNameContains, type, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformClustersRequest)) {
            return false;
        }

        ListAiDataPlatformClustersRequest other = (ListAiDataPlatformClustersRequest) o;
