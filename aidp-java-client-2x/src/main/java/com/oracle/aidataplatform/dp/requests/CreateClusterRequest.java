...
public class CreateClusterRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateClusterDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateClusterRequest, com.oracle.aidataplatform.dp.model.CreateClusterDetails> {
...
* 
     ...
     */
        ...
        public CreateClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateClusterRequest(aiDataPlatformId, workspaceKey, createClusterDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
