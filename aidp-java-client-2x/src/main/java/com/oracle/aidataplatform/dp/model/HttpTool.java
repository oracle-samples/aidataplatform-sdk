...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=HttpTool.Builder.class)
...
public final class HttpTool extends Tool {
     ...
     **/
        ...
        public HttpTool build() {
            HttpTool model = new HttpTool(this.key
                    , this.displayName
                    , this.workspaceKey
                    , this.description
                    , this.isReference
        ...
        public Builder copy(HttpTool model) {
...
return this;
    ...
    @Deprecated
    public HttpTool(String key, String displayName, String workspaceKey, String description, Boolean isReference, Float positionX, Float positionY, java.util.Map<String, Object> properties, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, Object> inputSchema, HttpToolConfiguration toolConfig) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HttpTool)) {
            return false;
        }

        HttpTool other = (HttpTool) o;
