...
public class CommitPushGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CommitPushDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CommitPushGitRepositoryRequest, com.oracle.aidataplatform.dp.model.CommitPushDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(CommitPushGitRepositoryRequest o) {
        ...
        /**
         * Build the instance of CommitPushGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of CommitPushGitRepositoryRequest
         */
        public CommitPushGitRepositoryRequest build() {
            CommitPushGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CommitPushGitRepositoryRequest
         */
        public CommitPushGitRepositoryRequest buildWithoutInvocationCallback() {
            CommitPushGitRepositoryRequest request = new CommitPushGitRepositoryRequest();
            ...
            return request;
            // new CommitPushGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, commitPushDetails, opcRetryToken, opcRequestId, shouldUpdateRecent, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CommitPushGitRepositoryRequest)) {
            return false;
        }

        CommitPushGitRepositoryRequest other = (CommitPushGitRepositoryRequest) o;
