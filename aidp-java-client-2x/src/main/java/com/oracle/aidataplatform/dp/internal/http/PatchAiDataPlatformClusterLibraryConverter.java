...
public class PatchAiDataPlatformClusterLibraryConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(PatchAiDataPlatformClusterLibraryConverter.class);

    public static com.oracle.aidataplatform.dp.requests.PatchAiDataPlatformClusterLibraryRequest interceptRequest(com.oracle.aidataplatform.dp.requests.PatchAiDataPlatformClusterLibraryRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.PatchAiDataPlatformClusterLibraryRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getClusterKey(), "clusterKey must not be blank");        Validate.notNull(request.getPatchClusterLibraryDetails(), "patchClusterLibraryDetails is required");                
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse");
        ...
        com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse.Builder builder = com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.PatchAiDataPlatformClusterLibraryResponse responseWrapper = builder.build();
