...
public class GetCatalogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetCatalogRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         *
         * @return instance of GetCatalogRequest
         */
        public GetCatalogRequest build() {
            GetCatalogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetCatalogRequest
         */
        public GetCatalogRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCatalogRequest)) {
            return false;
        }

        GetCatalogRequest other = (GetCatalogRequest) o;
