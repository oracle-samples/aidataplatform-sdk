...
public class ListRegisteredModelsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListRegisteredModelsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListRegisteredModelsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListRegisteredModelsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListRegisteredModelsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListRegisteredModelsResponse responseWrapper = builder.build();
