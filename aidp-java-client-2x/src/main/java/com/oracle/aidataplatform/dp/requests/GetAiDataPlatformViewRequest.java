...
public class GetAiDataPlatformViewRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformViewRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformViewRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());viewKey(o.getViewKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformViewRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformViewRequest
         */
        public GetAiDataPlatformViewRequest build() {
            GetAiDataPlatformViewRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformViewRequest
         */
        public GetAiDataPlatformViewRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformViewRequest request = new GetAiDataPlatformViewRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.viewKey = viewKey;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new GetAiDataPlatformViewRequest(aiDataPlatformId, viewKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformViewRequest)) {
            return false;
        }

        GetAiDataPlatformViewRequest other = (GetAiDataPlatformViewRequest) o;
