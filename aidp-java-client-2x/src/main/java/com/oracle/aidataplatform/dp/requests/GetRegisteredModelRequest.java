...
public class GetRegisteredModelRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of GetRegisteredModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetRegisteredModelRequest
         */
        public GetRegisteredModelRequest build() {
            GetRegisteredModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetRegisteredModelRequest
         */
        public GetRegisteredModelRequest buildWithoutInvocationCallback() {
            GetRegisteredModelRequest request = new GetRegisteredModelRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRegisteredModelRequest)) {
            return false;
        }

        GetRegisteredModelRequest other = (GetRegisteredModelRequest) o;
