...
public class CreateAiDataPlatformExperimentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateExperimentDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateExperimentDetails getBody$() {
        return createExperimentDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformExperimentRequest, com.oracle.aidataplatform.dp.model.CreateExperimentDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createExperimentDetails(com.oracle.aidataplatform.dp.model.CreateExperimentDetails createExperimentDetails) {
            this.createExperimentDetails = createExperimentDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformExperimentRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());createExperimentDetails(o.getCreateExperimentDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of CreateAiDataPlatformExperimentRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformExperimentRequest
         */
        public CreateAiDataPlatformExperimentRequest build() {
            CreateAiDataPlatformExperimentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateExperimentDetails body) {
            createExperimentDetails(body);
            return this;
        }
         ...
         * @return instance of CreateAiDataPlatformExperimentRequest
         */
        public CreateAiDataPlatformExperimentRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformExperimentRequest request = new CreateAiDataPlatformExperimentRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.createExperimentDetails = createExperimentDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.dhUserPrincipal = dhUserPrincipal;
            return request;
            // new CreateAiDataPlatformExperimentRequest(aiDataPlatformId, workspaceKey, createExperimentDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createExperimentDetails=").append(String.valueOf(this.createExperimentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformExperimentRequest)) {
            return false;
        }

        CreateAiDataPlatformExperimentRequest other = (CreateAiDataPlatformExperimentRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.workspaceKey, other.workspaceKey)
            && java.util.Objects.equals(this.createExperimentDetails, other.createExperimentDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createExperimentDetails == null ? 43 : this.createExperimentDetails.hashCode());
