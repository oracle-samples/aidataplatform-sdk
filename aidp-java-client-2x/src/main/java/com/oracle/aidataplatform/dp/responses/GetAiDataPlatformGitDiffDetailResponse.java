...
public class GetAiDataPlatformGitDiffDetailResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetAiDataPlatformGitDiffDetailResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.GitDiffDetail gitDiffDetail) {
