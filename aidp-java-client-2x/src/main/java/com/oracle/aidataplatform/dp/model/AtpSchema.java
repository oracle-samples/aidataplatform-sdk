...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AtpSchema.Builder.class)
...
public final class AtpSchema extends Schema {
    ...
    public static class Builder {
        ...
        public AtpSchema build() {
            AtpSchema model = new AtpSchema(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(AtpSchema model) {
...
return this;
    ...
    @Deprecated
    public AtpSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AtpSchema)) {
            return false;
        }

        AtpSchema other = (AtpSchema) o;
