...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateHttpToolNodeDetails.Builder.class)
...
public final class UpdateHttpToolNodeDetails extends UpdateAgentFlowNodeDetails {
     ...
     **/
        ...
        public UpdateHttpToolNodeDetails build() {
            UpdateHttpToolNodeDetails model = new UpdateHttpToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(UpdateHttpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateHttpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateHttpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateHttpToolNodeDetails)) {
            return false;
        }

        UpdateHttpToolNodeDetails other = (UpdateHttpToolNodeDetails) o;
