...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=HumanInTheLoopNode.Builder.class)
...
public final class HumanInTheLoopNode extends AgentFlowNode {
     ...
     **/
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("humanInTheLoopConfig")
        private java.util.Map<String, String> humanInTheLoopConfig;

                /**
         * Extra configuration for the human in the loop node.
         * @param humanInTheLoopConfig the value to set
         * @return this builder
         **/
        

        public Builder humanInTheLoopConfig(java.util.Map<String, String> humanInTheLoopConfig) {
        this.humanInTheLoopConfig = humanInTheLoopConfig;
        return this;
        }


        public HumanInTheLoopNode build() {
            HumanInTheLoopNode model = new HumanInTheLoopNode(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
                    ...
                    , this.humanInTheLoopConfig);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HumanInTheLoopNode model) {
    ...
    this.humanInTheLoopConfig(model.getHumanInTheLoopConfig());
return this;
        }
    }
    ...
    @Deprecated
    public HumanInTheLoopNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, java.util.Map<String, String> humanInTheLoopConfig) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("humanInTheLoopConfig")
    private final java.util.Map<String, String> humanInTheLoopConfig;
    ...
    public java.util.Map<String, String> getHumanInTheLoopConfig() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HumanInTheLoopNode(");
        sb.append("super=").append(super.toString(includeByteArrayContents));
        sb.append(", humanInTheLoopConfig=").append(String.valueOf(this.humanInTheLoopConfig));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HumanInTheLoopNode)) {
            return false;
        }

        HumanInTheLoopNode other = (HumanInTheLoopNode) o;
        return java.util.Objects.equals(this.humanInTheLoopConfig, other.humanInTheLoopConfig) &&
            super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.humanInTheLoopConfig == null ? 43 : this.humanInTheLoopConfig.hashCode());
        return result;
    }
