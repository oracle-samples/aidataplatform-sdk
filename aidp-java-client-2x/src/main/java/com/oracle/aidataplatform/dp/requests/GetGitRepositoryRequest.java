...
public class GetGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetGitRepositoryRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetGitRepositoryRequest o) {
        ...
        /**
         * Build the instance of GetGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetGitRepositoryRequest
         */
        public GetGitRepositoryRequest build() {
            GetGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetGitRepositoryRequest
         */
        public GetGitRepositoryRequest buildWithoutInvocationCallback() {
            GetGitRepositoryRequest request = new GetGitRepositoryRequest();
            ...
            return request;
            // new GetGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, shouldIncludeCredentialKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGitRepositoryRequest)) {
            return false;
        }

        GetGitRepositoryRequest other = (GetGitRepositoryRequest) o;
