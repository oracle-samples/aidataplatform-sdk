...
public class HeadAiDataPlatformWorkspaceObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<HeadAiDataPlatformWorkspaceObjectRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(HeadAiDataPlatformWorkspaceObjectRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());objectPath(o.getObjectPath());shouldIncludeMetadata(o.getShouldIncludeMetadata());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of HeadAiDataPlatformWorkspaceObjectRequest as configured by this builder
         *
         ...
         *
         * @return instance of HeadAiDataPlatformWorkspaceObjectRequest
         */
        public HeadAiDataPlatformWorkspaceObjectRequest build() {
            HeadAiDataPlatformWorkspaceObjectRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of HeadAiDataPlatformWorkspaceObjectRequest
         */
        public HeadAiDataPlatformWorkspaceObjectRequest buildWithoutInvocationCallback() {
            HeadAiDataPlatformWorkspaceObjectRequest request = new HeadAiDataPlatformWorkspaceObjectRequest();
            ...
            return request;
            // new HeadAiDataPlatformWorkspaceObjectRequest(aiDataPlatformId, workspaceKey, objectPath, shouldIncludeMetadata, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadAiDataPlatformWorkspaceObjectRequest)) {
            return false;
        }

        HeadAiDataPlatformWorkspaceObjectRequest other = (HeadAiDataPlatformWorkspaceObjectRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.shouldIncludeMetadata, other.shouldIncludeMetadata)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.shouldIncludeMetadata == null ? 43 : this.shouldIncludeMetadata.hashCode());
