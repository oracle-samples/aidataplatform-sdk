...
public class BundleClient implements Bundle {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, BundleClient> {
         ...
         * @return the client
         */
        public BundleClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            if (authenticationDetailsProvider == null) {
                throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
            }
            return new BundleClient(authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getCreateBundleDetails(), retriedRequest);
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getDeployBundleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getFetchBundleDeploymentStatusDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getPurgeBundleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getSyncBundleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
