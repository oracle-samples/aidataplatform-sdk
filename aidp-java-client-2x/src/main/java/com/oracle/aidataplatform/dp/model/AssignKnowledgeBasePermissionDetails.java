...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignKnowledgeBasePermissionDetails.Builder.class)

public final class AssignKnowledgeBasePermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public AssignKnowledgeBasePermissionDetails(PermissionAssignees assignees, java.util.List<KnowledgeBasePrivilege> permissions) {
        super();
     ...
     **/
        ...
        private java.util.List<KnowledgeBasePrivilege> permissions;
        ...
        public Builder permissions(java.util.List<KnowledgeBasePrivilege> permissions) {
        this.permissions = permissions;
        return this;
        }


        public AssignKnowledgeBasePermissionDetails build() {
            AssignKnowledgeBasePermissionDetails model = new AssignKnowledgeBasePermissionDetails(this.assignees
                    , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssignKnowledgeBasePermissionDetails model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("permissions")
    private final java.util.List<KnowledgeBasePrivilege> permissions;
    ...
    public java.util.List<KnowledgeBasePrivilege> getPermissions() {
        return permissions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignKnowledgeBasePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignKnowledgeBasePermissionDetails)) {
            return false;
        }

        AssignKnowledgeBasePermissionDetails other = (AssignKnowledgeBasePermissionDetails) o;
