...
public class GitClient implements Git {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, GitClient> {
         ...
         * @return the client
         */
        public GitClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            if (authenticationDetailsProvider == null) {
                throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
            }
            return new GitClient(authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
