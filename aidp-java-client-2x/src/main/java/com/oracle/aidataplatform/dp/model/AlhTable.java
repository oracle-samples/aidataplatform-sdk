...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AlhTable.Builder.class)
...
public final class AlhTable extends Table {
    ...
    public static class Builder {
        ...
        public AlhTable build() {
            AlhTable model = new AlhTable(this.key
                    , this.displayName
                    , this.catalogKey
                    , this.schemaKey
                    , this.location
        ...
        public Builder copy(AlhTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlhTable)) {
            return false;
        }

        AlhTable other = (AlhTable) o;
