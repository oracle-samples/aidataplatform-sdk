...
public class ListViewPermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * The returned ViewPermissionCollection instance.
     */
    ...
    private ListViewPermissionsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.ViewPermissionCollection viewPermissionCollection) {
