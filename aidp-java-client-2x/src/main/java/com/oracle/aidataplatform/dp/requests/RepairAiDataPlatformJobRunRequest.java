...
public class RepairAiDataPlatformJobRunRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.RepairJobRunDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.RepairJobRunDetails repairJobRunDetails;
     ...
     * Details of the job run to be repaired.
     */
    public com.oracle.aidataplatform.dp.model.RepairJobRunDetails getRepairJobRunDetails() {
        return repairJobRunDetails;
    }
        /**
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.RepairJobRunDetails getBody$() {
        return repairJobRunDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RepairAiDataPlatformJobRunRequest, com.oracle.aidataplatform.dp.model.RepairJobRunDetails> {
     ...
     * Details of the job run to be repaired.
     */
        private com.oracle.aidataplatform.dp.model.RepairJobRunDetails repairJobRunDetails = null;

        /**
         * Details of the job run to be repaired.
         * @param repairJobRunDetails the value to set
         * @return this builder instance
         */
        public Builder repairJobRunDetails(com.oracle.aidataplatform.dp.model.RepairJobRunDetails repairJobRunDetails) {
            this.repairJobRunDetails = repairJobRunDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RepairAiDataPlatformJobRunRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());jobRunKey(o.getJobRunKey());repairJobRunDetails(o.getRepairJobRunDetails());opcRetryToken(o.getOpcRetryToken());shouldUpdateRecent(o.getShouldUpdateRecent());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of RepairAiDataPlatformJobRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of RepairAiDataPlatformJobRunRequest
         */
        public RepairAiDataPlatformJobRunRequest build() {
            RepairAiDataPlatformJobRunRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.RepairJobRunDetails body) {
            repairJobRunDetails(body);
            return this;
        }
         ...
         * @return instance of RepairAiDataPlatformJobRunRequest
         */
        public RepairAiDataPlatformJobRunRequest buildWithoutInvocationCallback() {
            RepairAiDataPlatformJobRunRequest request = new RepairAiDataPlatformJobRunRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.jobRunKey = jobRunKey;
            request.repairJobRunDetails = repairJobRunDetails;
            request.opcRetryToken = opcRetryToken;
            request.shouldUpdateRecent = shouldUpdateRecent;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new RepairAiDataPlatformJobRunRequest(aiDataPlatformId, workspaceKey, jobRunKey, repairJobRunDetails, opcRetryToken, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",repairJobRunDetails=").append(String.valueOf(this.repairJobRunDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RepairAiDataPlatformJobRunRequest)) {
            return false;
        }

        RepairAiDataPlatformJobRunRequest other = (RepairAiDataPlatformJobRunRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.repairJobRunDetails, other.repairJobRunDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.repairJobRunDetails == null ? 43 : this.repairJobRunDetails.hashCode());
