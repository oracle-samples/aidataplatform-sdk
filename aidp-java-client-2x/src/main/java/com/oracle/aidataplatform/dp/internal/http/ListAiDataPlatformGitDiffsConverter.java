...
public class ListAiDataPlatformGitDiffsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListAiDataPlatformGitDiffsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListAiDataPlatformGitDiffsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListAiDataPlatformGitDiffsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListAiDataPlatformGitDiffsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListAiDataPlatformGitDiffsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
