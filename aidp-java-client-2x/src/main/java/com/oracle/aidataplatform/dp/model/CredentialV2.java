...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CredentialV2.Builder.class)

public final class CredentialV2  {
    @Deprecated
    ...
    public CredentialV2(String key, String displayName, CredentialType type, CredentialDetails credentialDetails, String credentialDescription, CredentialV2LifeCycleState lifecycleState, String lifecycleStateDetails, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy) {
        super();
        this.key = key;
     ...
     **/
        ...
        public CredentialV2 build() {
            CredentialV2 model = new CredentialV2(this.key
                    , this.displayName
                    , this.type
        ...
        public Builder copy(CredentialV2 model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialV2)) {
            return false;
        }

        CredentialV2 other = (CredentialV2) o;
