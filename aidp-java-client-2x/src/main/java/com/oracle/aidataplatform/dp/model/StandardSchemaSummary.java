...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=StandardSchemaSummary.Builder.class)
...
public final class StandardSchemaSummary extends SchemaSummary {
    ...
    public static class Builder {
        ...
        public StandardSchemaSummary build() {
            StandardSchemaSummary model = new StandardSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(StandardSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public StandardSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StandardSchemaSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StandardSchemaSummary)) {
            return false;
        }

        StandardSchemaSummary other = (StandardSchemaSummary) o;
