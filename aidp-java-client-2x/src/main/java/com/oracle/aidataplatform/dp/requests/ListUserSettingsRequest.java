...
public class ListUserSettingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListUserSettingsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListUserSettingsRequest o) {
        ...
        /**
         * Build the instance of ListUserSettingsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListUserSettingsRequest
         */
        public ListUserSettingsRequest build() {
            ListUserSettingsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUserSettingsRequest
         */
        public ListUserSettingsRequest buildWithoutInvocationCallback() {
            ListUserSettingsRequest request = new ListUserSettingsRequest();
            ...
            return request;
            // new ListUserSettingsRequest(aiDataPlatformId, settingType, isDefault, limit, page, sortOrder, sortBy, displayName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUserSettingsRequest)) {
            return false;
        }

        ListUserSettingsRequest other = (ListUserSettingsRequest) o;
