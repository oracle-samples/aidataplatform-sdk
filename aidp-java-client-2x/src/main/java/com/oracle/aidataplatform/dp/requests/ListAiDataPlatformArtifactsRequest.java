...
public class ListAiDataPlatformArtifactsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformArtifactsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformArtifactsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformArtifactsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformArtifactsRequest
         */
        public ListAiDataPlatformArtifactsRequest build() {
            ListAiDataPlatformArtifactsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformArtifactsRequest
         */
        public ListAiDataPlatformArtifactsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformArtifactsRequest request = new ListAiDataPlatformArtifactsRequest();
            ...
            return request;
            // new ListAiDataPlatformArtifactsRequest(aiDataPlatformId, workspaceKey, runId, path, pageToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformArtifactsRequest)) {
            return false;
        }

        ListAiDataPlatformArtifactsRequest other = (ListAiDataPlatformArtifactsRequest) o;
