...
public class CopyWorkspaceObjectConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CopyWorkspaceObjectConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CopyWorkspaceObjectRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CopyWorkspaceObjectRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CopyWorkspaceObjectRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CopyWorkspaceObjectResponse responseWrapper = builder.build();
