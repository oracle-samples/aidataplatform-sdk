...
public class UpdateGitRepositoryConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateGitRepositoryConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateGitRepositoryRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateGitRepositoryRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateGitRepositoryRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateGitRepositoryResponse responseWrapper = builder.build();
