...
public class ListCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListCredentialsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListCredentialsRequest o) {
        ...
        /**
         * Build the instance of ListCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCredentialsRequest
         */
        public ListCredentialsRequest build() {
            ListCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCredentialsRequest
         */
        public ListCredentialsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCredentialsRequest(aiDataPlatformId, displayName, displayNameContains, lifecycleState, limit, page, sortOrder, sortBy, credentialType, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCredentialsRequest)) {
            return false;
        }
