...
return this;
    ...
    @Deprecated
    public WorkspaceFileClusterLibrarySummary(java.util.Date timeCreated, java.util.Date timeUpdated, String stateMessage, Status status, String name, String path) {
