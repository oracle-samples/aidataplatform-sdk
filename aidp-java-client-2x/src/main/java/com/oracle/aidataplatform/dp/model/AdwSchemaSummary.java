...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AdwSchemaSummary.Builder.class)
...
public final class AdwSchemaSummary extends SchemaSummary {
    ...
    public static class Builder {
        ...
        public AdwSchemaSummary build() {
            AdwSchemaSummary model = new AdwSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(AdwSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public AdwSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdwSchemaSummary)) {
            return false;
        }

        AdwSchemaSummary other = (AdwSchemaSummary) o;
