...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=KnowledgeBaseJobRunSummary.Builder.class)

public final class KnowledgeBaseJobRunSummary  {
    @Deprecated
     ...
     **/
        ...
        public KnowledgeBaseJobRunSummary build() {
            KnowledgeBaseJobRunSummary model = new KnowledgeBaseJobRunSummary(this.key
        ...
        public Builder copy(KnowledgeBaseJobRunSummary model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KnowledgeBaseJobRunSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KnowledgeBaseJobRunSummary)) {
            return false;
        }

        KnowledgeBaseJobRunSummary other = (KnowledgeBaseJobRunSummary) o;
