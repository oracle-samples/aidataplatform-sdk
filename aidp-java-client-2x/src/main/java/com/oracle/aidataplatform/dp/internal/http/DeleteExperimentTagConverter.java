...
public class DeleteExperimentTagConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DeleteExperimentTagConverter.class);

    public static com.oracle.aidataplatform.dp.requests.DeleteExperimentTagRequest interceptRequest(com.oracle.aidataplatform.dp.requests.DeleteExperimentTagRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.DeleteExperimentTagRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse");
        ...
        com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse.Builder builder = com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.DeleteExperimentTagResponse responseWrapper = builder.build();
