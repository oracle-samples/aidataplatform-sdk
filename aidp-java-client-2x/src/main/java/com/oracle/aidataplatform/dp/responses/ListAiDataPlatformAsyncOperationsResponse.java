...
public class ListAiDataPlatformAsyncOperationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * The returned AsyncOperationCollection instance.
     */
    ...
    private ListAiDataPlatformAsyncOperationsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.AsyncOperationCollection asyncOperationCollection) {
