...
public class ListFilesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListFilesRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListFilesRequest o) {
        ...
        /**
         * Build the instance of ListFilesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListFilesRequest
         */
        public ListFilesRequest build() {
            ListFilesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListFilesRequest
         */
        public ListFilesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFilesRequest(aiDataPlatformId, volumeKey, path, isRecursive, displayName, metadataKeys, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListFilesRequest)) {
            return false;
        }
