...
public class GetGitDiffDetailConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GetGitDiffDetailConverter.class);

    public static com.oracle.aidataplatform.dp.requests.GetGitDiffDetailRequest interceptRequest(com.oracle.aidataplatform.dp.requests.GetGitDiffDetailRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.GetGitDiffDetailRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse");
        ...
        com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse.Builder builder = com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.GetGitDiffDetailResponse responseWrapper = builder.build();
