...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=NoAuth.Builder.class)
...
public final class NoAuth extends Auth {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {


        public NoAuth build() {
            NoAuth model = new NoAuth();            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NoAuth model) {
            return this;
        }
    }
