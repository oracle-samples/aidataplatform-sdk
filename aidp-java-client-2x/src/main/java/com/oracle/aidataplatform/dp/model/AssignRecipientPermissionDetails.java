...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AssignRecipientPermissionDetails.Builder.class)

public final class AssignRecipientPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions"})
    public AssignRecipientPermissionDetails(PermissionAssignees assignees, java.util.List<RecipientPrivilege> permissions) {
        super();
     ...
     **/
        ...
        public AssignRecipientPermissionDetails build() {
            AssignRecipientPermissionDetails model = new AssignRecipientPermissionDetails(this.assignees
                    , this.permissions);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssignRecipientPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssignRecipientPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssignRecipientPermissionDetails)) {
            return false;
        }

        AssignRecipientPermissionDetails other = (AssignRecipientPermissionDetails) o;
