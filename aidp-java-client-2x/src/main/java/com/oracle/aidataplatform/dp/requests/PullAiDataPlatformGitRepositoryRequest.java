...
public class PullAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitPullDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.GitPullDetails getBody$() {
        return gitPullDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PullAiDataPlatformGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitPullDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder gitPullDetails(com.oracle.aidataplatform.dp.model.GitPullDetails gitPullDetails) {
            this.gitPullDetails = gitPullDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PullAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());gitPullDetails(o.getGitPullDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of PullAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of PullAiDataPlatformGitRepositoryRequest
         */
        public PullAiDataPlatformGitRepositoryRequest build() {
            PullAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.GitPullDetails body) {
            gitPullDetails(body);
            return this;
        }
         ...
         * @return instance of PullAiDataPlatformGitRepositoryRequest
         */
        public PullAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            PullAiDataPlatformGitRepositoryRequest request = new PullAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.gitPullDetails = gitPullDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new PullAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitPullDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",gitPullDetails=").append(String.valueOf(this.gitPullDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PullAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        PullAiDataPlatformGitRepositoryRequest other = (PullAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.gitPullDetails, other.gitPullDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.gitPullDetails == null ? 43 : this.gitPullDetails.hashCode());
