...
public class GetAsyncOperationConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GetAsyncOperationConverter.class);

    public static com.oracle.aidataplatform.dp.requests.GetAsyncOperationRequest interceptRequest(com.oracle.aidataplatform.dp.requests.GetAsyncOperationRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.GetAsyncOperationRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse");
        ...
        com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse.Builder builder = com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.GetAsyncOperationResponse responseWrapper = builder.build();
