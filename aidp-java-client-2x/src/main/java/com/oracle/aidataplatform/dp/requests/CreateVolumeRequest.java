...
public class CreateVolumeRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateVolumeDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateVolumeRequest, com.oracle.aidataplatform.dp.model.CreateVolumeDetails> {
...
* 
     ...
     */
         ...
         *
         * @return instance of CreateVolumeRequest
         */
        public CreateVolumeRequest build() {
            CreateVolumeRequest request = buildWithoutInvocationCallback();
        ...
        public CreateVolumeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateVolumeRequest(aiDataPlatformId, createVolumeDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeRequest)) {
            return false;
        }

        CreateVolumeRequest other = (CreateVolumeRequest) o;
