...
public class SetAiDataPlatformExperimentRunTagRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails getBody$() {
        return setExperimentRunTagDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<SetAiDataPlatformExperimentRunTagRequest, com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder setExperimentRunTagDetails(com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails setExperimentRunTagDetails) {
            this.setExperimentRunTagDetails = setExperimentRunTagDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(SetAiDataPlatformExperimentRunTagRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());setExperimentRunTagDetails(o.getSetExperimentRunTagDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of SetAiDataPlatformExperimentRunTagRequest as configured by this builder
         *
         ...
         *
         * @return instance of SetAiDataPlatformExperimentRunTagRequest
         */
        public SetAiDataPlatformExperimentRunTagRequest build() {
            SetAiDataPlatformExperimentRunTagRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.SetExperimentRunTagDetails body) {
            setExperimentRunTagDetails(body);
            return this;
        }
         ...
         * @return instance of SetAiDataPlatformExperimentRunTagRequest
         */
        public SetAiDataPlatformExperimentRunTagRequest buildWithoutInvocationCallback() {
            SetAiDataPlatformExperimentRunTagRequest request = new SetAiDataPlatformExperimentRunTagRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.setExperimentRunTagDetails = setExperimentRunTagDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.dhUserPrincipal = dhUserPrincipal;
            return request;
            // new SetAiDataPlatformExperimentRunTagRequest(aiDataPlatformId, workspaceKey, setExperimentRunTagDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",setExperimentRunTagDetails=").append(String.valueOf(this.setExperimentRunTagDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetAiDataPlatformExperimentRunTagRequest)) {
            return false;
        }

        SetAiDataPlatformExperimentRunTagRequest other = (SetAiDataPlatformExperimentRunTagRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.workspaceKey, other.workspaceKey)
            && java.util.Objects.equals(this.setExperimentRunTagDetails, other.setExperimentRunTagDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.setExperimentRunTagDetails == null ? 43 : this.setExperimentRunTagDetails.hashCode());
