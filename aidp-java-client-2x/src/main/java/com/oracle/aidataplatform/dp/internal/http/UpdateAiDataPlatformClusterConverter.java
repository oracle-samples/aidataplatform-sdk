...
public class UpdateAiDataPlatformClusterConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateAiDataPlatformClusterConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformClusterRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformClusterRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateAiDataPlatformClusterRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getClusterKey(), "clusterKey must not be blank");        Validate.notNull(request.getUpdateClusterDetails(), "updateClusterDetails is required");                        

        com.oracle.bmc.http.internal.WrappedWebTarget target = client.getBaseTarget()
        .path("/20260430")
            .path("aiDataPlatforms").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getAiDataPlatformId())).path("workspaces").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getWorkspaceKey())).path("clusters").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getClusterKey()));
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateAiDataPlatformClusterResponse responseWrapper = builder.build();
