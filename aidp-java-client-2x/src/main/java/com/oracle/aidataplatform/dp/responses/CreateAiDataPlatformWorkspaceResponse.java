...
* 
    ...
    private CreateAiDataPlatformWorkspaceResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String location, String contentLocation, String etag, String aidpAsyncOperationKey, String opcRequestId, com.oracle.aidataplatform.dp.model.Workspace workspace) {
