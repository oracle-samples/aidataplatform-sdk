...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OacSchemaSummary.Builder.class)
...
public final class OacSchemaSummary extends SchemaSummary {
    ...
    public static class Builder {
        ...
        public OacSchemaSummary build() {
            OacSchemaSummary model = new OacSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(OacSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public OacSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OacSchemaSummary)) {
            return false;
        }

        OacSchemaSummary other = (OacSchemaSummary) o;
