...
public class GetAiDataPlatformExperimentByNameRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformExperimentByNameRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformExperimentByNameRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());experimentName(o.getExperimentName());opcRequestId(o.getOpcRequestId());dhUserPrincipal(o.getDhUserPrincipal());
        ...
        /**
         * Build the instance of GetAiDataPlatformExperimentByNameRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformExperimentByNameRequest
         */
        public GetAiDataPlatformExperimentByNameRequest build() {
            GetAiDataPlatformExperimentByNameRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformExperimentByNameRequest
         */
        public GetAiDataPlatformExperimentByNameRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformExperimentByNameRequest request = new GetAiDataPlatformExperimentByNameRequest();
            ...
            return request;
            // new GetAiDataPlatformExperimentByNameRequest(aiDataPlatformId, workspaceKey, experimentName, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",experimentName=").append(String.valueOf(this.experimentName));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformExperimentByNameRequest)) {
            return false;
        }

        GetAiDataPlatformExperimentByNameRequest other = (GetAiDataPlatformExperimentByNameRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.workspaceKey, other.workspaceKey)
            && java.util.Objects.equals(this.experimentName, other.experimentName)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.experimentName == null ? 43 : this.experimentName.hashCode());
