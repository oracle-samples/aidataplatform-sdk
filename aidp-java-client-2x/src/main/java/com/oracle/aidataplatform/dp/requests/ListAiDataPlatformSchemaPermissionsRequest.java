...
public class ListAiDataPlatformSchemaPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformSchemaPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformSchemaPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());schemaKey(o.getSchemaKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformSchemaPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformSchemaPermissionsRequest
         */
        public ListAiDataPlatformSchemaPermissionsRequest build() {
            ListAiDataPlatformSchemaPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformSchemaPermissionsRequest
         */
        public ListAiDataPlatformSchemaPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformSchemaPermissionsRequest request = new ListAiDataPlatformSchemaPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformSchemaPermissionsRequest(aiDataPlatformId, schemaKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformSchemaPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformSchemaPermissionsRequest other = (ListAiDataPlatformSchemaPermissionsRequest) o;
