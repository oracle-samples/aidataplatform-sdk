...
public class ListRecentJobRunsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListRecentJobRunsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListRecentJobRunsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListRecentJobRunsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListRecentJobRunsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListRecentJobRunsResponse responseWrapper = builder.build();
