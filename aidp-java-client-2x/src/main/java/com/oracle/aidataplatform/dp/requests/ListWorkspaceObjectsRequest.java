...
public class ListWorkspaceObjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListWorkspaceObjectsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListWorkspaceObjectsRequest o) {
        ...
        /**
         * Build the instance of ListWorkspaceObjectsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWorkspaceObjectsRequest
         */
        public ListWorkspaceObjectsRequest build() {
            ListWorkspaceObjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWorkspaceObjectsRequest
         */
        public ListWorkspaceObjectsRequest buildWithoutInvocationCallback() {
            ListWorkspaceObjectsRequest request = new ListWorkspaceObjectsRequest();
            ...
            return request;
            // new ListWorkspaceObjectsRequest(aiDataPlatformId, workspaceKey, path, type, displayName, limit, metadataKeys, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkspaceObjectsRequest)) {
            return false;
        }

        ListWorkspaceObjectsRequest other = (ListWorkspaceObjectsRequest) o;
