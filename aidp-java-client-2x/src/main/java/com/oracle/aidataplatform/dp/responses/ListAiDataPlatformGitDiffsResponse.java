...
public class ListAiDataPlatformGitDiffsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListAiDataPlatformGitDiffsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.GitDiffSummaryCollection gitDiffSummaryCollection) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformGitDiffsResponse)) {
            return false;
        }

        ListAiDataPlatformGitDiffsResponse other = (ListAiDataPlatformGitDiffsResponse) o;
