...
public class ListAiDataPlatformRolesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAiDataPlatformRolesResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.RoleCollection roleCollection) {
