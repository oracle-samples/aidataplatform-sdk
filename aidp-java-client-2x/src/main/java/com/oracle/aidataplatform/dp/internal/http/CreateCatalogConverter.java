...
public class CreateCatalogConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CreateCatalogConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CreateCatalogRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CreateCatalogRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CreateCatalogRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateCatalogResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateCatalogResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateCatalogResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateCatalogResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CreateCatalogResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CreateCatalogResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CreateCatalogResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CreateCatalogResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CreateCatalogResponse responseWrapper = builder.build();
