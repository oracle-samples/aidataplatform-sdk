...
public class CreateWorkspaceObjectConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CreateWorkspaceObjectConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CreateWorkspaceObjectRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CreateWorkspaceObjectRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CreateWorkspaceObjectRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CreateWorkspaceObjectResponse responseWrapper = builder.build();
