...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AdminSettingSummary.Builder.class)

public final class AdminSettingSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "name", "type", "isDefault", "timeCreated", "timeUpdated", "properties"})
    public AdminSettingSummary(String key, String name, SettingType type, Boolean isDefault, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.Map<String, Object> properties) {
        super();
        this.key = key;
        this.name = name;
        this.type = type;
     ...
     **/
        ...
        public AdminSettingSummary build() {
            AdminSettingSummary model = new AdminSettingSummary(this.key
                    , this.name
                    , this.type
                    , this.isDefault
                    , this.timeCreated
        ...
        public Builder copy(AdminSettingSummary model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminSettingSummary)) {
            return false;
        }

        AdminSettingSummary other = (AdminSettingSummary) o;
