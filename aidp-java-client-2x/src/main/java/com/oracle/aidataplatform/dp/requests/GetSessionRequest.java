...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return instance of GetSessionRequest
         */
        public GetSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSessionRequest(aiDataPlatformId, workspaceKey, sessionId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSessionRequest)) {
            return false;
        }
