...
public class ListArtifactsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListArtifactsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListArtifactsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListArtifactsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListArtifactsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListArtifactsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListArtifactsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListArtifactsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListArtifactsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListArtifactsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListArtifactsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListArtifactsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListArtifactsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListArtifactsResponse responseWrapper = builder.build();
