...
public class DeleteAiDataPlatformShareRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformShareRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformShareRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());shareKey(o.getShareKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformShareRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformShareRequest
         */
        public DeleteAiDataPlatformShareRequest build() {
            DeleteAiDataPlatformShareRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformShareRequest
         */
        public DeleteAiDataPlatformShareRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformShareRequest request = new DeleteAiDataPlatformShareRequest();
            ...
            return request;
            // new DeleteAiDataPlatformShareRequest(aiDataPlatformId, shareKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformShareRequest)) {
            return false;
        }

        DeleteAiDataPlatformShareRequest other = (DeleteAiDataPlatformShareRequest) o;
