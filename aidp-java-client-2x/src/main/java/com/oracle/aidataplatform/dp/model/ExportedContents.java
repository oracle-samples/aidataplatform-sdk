...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=ExportedContents.Builder.class)

public final class ExportedContents  {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "path", "content", "format"})
    public ExportedContents(String name, String path, Object content, Format format) {
        super();
        this.name = name;
        this.path = path;
...
* 
        ...
        public ExportedContents build() {
            ExportedContents model = new ExportedContents(this.name
                    , this.path
                    , this.content
        ...
        public Builder copy(ExportedContents model) {
...
* 
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportedContents)) {
            return false;
        }

        ExportedContents other = (ExportedContents) o;
