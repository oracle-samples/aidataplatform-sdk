...
public class DownloadClusterLogsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DownloadClusterLogsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.DownloadClusterLogsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.DownloadClusterLogsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.DownloadClusterLogsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.DownloadClusterLogsResponse responseWrapper = builder.build();
