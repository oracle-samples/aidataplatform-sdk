...
public class ListGitBranchesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * The returned GitBranchCollection instance.
     */
    ...
    private ListGitBranchesResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.GitBranchCollection gitBranchCollection) {
