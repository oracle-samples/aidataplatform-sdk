...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OracleSchema.Builder.class)
...
public final class OracleSchema extends Schema {
    ...
    public static class Builder {
        ...
        public OracleSchema build() {
            OracleSchema model = new OracleSchema(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(OracleSchema model) {
...
return this;
    ...
    @Deprecated
    public OracleSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleSchema)) {
            return false;
        }

        OracleSchema other = (OracleSchema) o;
