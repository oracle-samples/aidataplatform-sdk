...
* 
    ...
    private DeleteWorkspaceResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String aidpAsyncOperationKey, String opcRequestId) {
