...
public class ListAiDataPlatformViewsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformViewsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformViewsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformViewsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformViewsRequest
         */
        public ListAiDataPlatformViewsRequest build() {
            ListAiDataPlatformViewsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformViewsRequest
         */
        public ListAiDataPlatformViewsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformViewsRequest request = new ListAiDataPlatformViewsRequest();
            ...
            return request;
            // new ListAiDataPlatformViewsRequest(aiDataPlatformId, catalogKey, schemaKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformViewsRequest)) {
            return false;
        }

        ListAiDataPlatformViewsRequest other = (ListAiDataPlatformViewsRequest) o;
