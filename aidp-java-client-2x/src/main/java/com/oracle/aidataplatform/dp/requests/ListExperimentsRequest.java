...
public class ListExperimentsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ListExperimentsDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListExperimentsRequest, com.oracle.aidataplatform.dp.model.ListExperimentsDetails> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of ListExperimentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListExperimentsRequest
         */
        public ListExperimentsRequest build() {
            ListExperimentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExperimentsRequest
         */
        public ListExperimentsRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExperimentsRequest)) {
            return false;
        }

        ListExperimentsRequest other = (ListExperimentsRequest) o;
