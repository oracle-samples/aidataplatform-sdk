...
public class GetTaskRunConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GetTaskRunConverter.class);

    public static com.oracle.aidataplatform.dp.requests.GetTaskRunRequest interceptRequest(com.oracle.aidataplatform.dp.requests.GetTaskRunRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.GetTaskRunRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetTaskRunResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetTaskRunResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetTaskRunResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetTaskRunResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.GetTaskRunResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.GetTaskRunResponse");
        ...
        com.oracle.aidataplatform.dp.responses.GetTaskRunResponse.Builder builder = com.oracle.aidataplatform.dp.responses.GetTaskRunResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.GetTaskRunResponse responseWrapper = builder.build();
