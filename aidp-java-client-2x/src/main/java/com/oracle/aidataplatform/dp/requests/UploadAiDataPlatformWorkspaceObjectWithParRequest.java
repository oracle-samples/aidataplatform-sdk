...
public class UploadAiDataPlatformWorkspaceObjectWithParRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UploadFileWithParDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UploadAiDataPlatformWorkspaceObjectWithParRequest, com.oracle.aidataplatform.dp.model.UploadFileWithParDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UploadAiDataPlatformWorkspaceObjectWithParRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());uploadFileWithParDetails(o.getUploadFileWithParDetails());path(o.getPath());isOverwrite(o.getIsOverwrite());shouldGenerateNewPar(o.getShouldGenerateNewPar());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());type(o.getType());objectDescription(o.getObjectDescription());
        ...
        /**
         * Build the instance of UploadAiDataPlatformWorkspaceObjectWithParRequest as configured by this builder
         *
         ...
         *
         * @return instance of UploadAiDataPlatformWorkspaceObjectWithParRequest
         */
        public UploadAiDataPlatformWorkspaceObjectWithParRequest build() {
            UploadAiDataPlatformWorkspaceObjectWithParRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UploadAiDataPlatformWorkspaceObjectWithParRequest
         */
        public UploadAiDataPlatformWorkspaceObjectWithParRequest buildWithoutInvocationCallback() {
            UploadAiDataPlatformWorkspaceObjectWithParRequest request = new UploadAiDataPlatformWorkspaceObjectWithParRequest();
            ...
            return request;
            // new UploadAiDataPlatformWorkspaceObjectWithParRequest(aiDataPlatformId, workspaceKey, uploadFileWithParDetails, path, isOverwrite, shouldGenerateNewPar, shouldUpdateRecent, opcRetryToken, opcRequestId, type, objectDescription);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadAiDataPlatformWorkspaceObjectWithParRequest)) {
            return false;
        }

        UploadAiDataPlatformWorkspaceObjectWithParRequest other = (UploadAiDataPlatformWorkspaceObjectWithParRequest) o;
