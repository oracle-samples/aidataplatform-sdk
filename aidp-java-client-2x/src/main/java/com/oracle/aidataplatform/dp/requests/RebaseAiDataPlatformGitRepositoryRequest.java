...
public class RebaseAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitRebaseDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.GitRebaseDetails getBody$() {
        return gitRebaseDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RebaseAiDataPlatformGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitRebaseDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder gitRebaseDetails(com.oracle.aidataplatform.dp.model.GitRebaseDetails gitRebaseDetails) {
            this.gitRebaseDetails = gitRebaseDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(RebaseAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());gitRebaseDetails(o.getGitRebaseDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of RebaseAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of RebaseAiDataPlatformGitRepositoryRequest
         */
        public RebaseAiDataPlatformGitRepositoryRequest build() {
            RebaseAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.GitRebaseDetails body) {
            gitRebaseDetails(body);
            return this;
        }
         ...
         * @return instance of RebaseAiDataPlatformGitRepositoryRequest
         */
        public RebaseAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            RebaseAiDataPlatformGitRepositoryRequest request = new RebaseAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.gitRebaseDetails = gitRebaseDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new RebaseAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitRebaseDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",gitRebaseDetails=").append(String.valueOf(this.gitRebaseDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebaseAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        RebaseAiDataPlatformGitRepositoryRequest other = (RebaseAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.gitRebaseDetails, other.gitRebaseDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.gitRebaseDetails == null ? 43 : this.gitRebaseDetails.hashCode());
