...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=StandardSchema.Builder.class)
...
public final class StandardSchema extends Schema {
    ...
    public static class Builder {
        ...
        public StandardSchema build() {
            StandardSchema model = new StandardSchema(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(StandardSchema model) {
...
return this;
    ...
    @Deprecated
    public StandardSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StandardSchema)) {
            return false;
        }

        StandardSchema other = (StandardSchema) o;
