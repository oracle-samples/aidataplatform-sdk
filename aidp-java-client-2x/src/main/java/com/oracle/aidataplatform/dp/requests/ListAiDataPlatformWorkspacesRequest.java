...
public class ListAiDataPlatformWorkspacesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     */
    private com.oracle.aidataplatform.dp.model.Workspace.LifecycleState lifecycleState;
...
* 
     */
    public com.oracle.aidataplatform.dp.model.Workspace.LifecycleState getLifecycleState() {
     ...
     */
    private com.oracle.aidataplatform.dp.model.Workspace.Type type;
     ...
     * When no value is provided, all workspaces are returned. Otherwise, workspace of selected value is returned.
     */
    public com.oracle.aidataplatform.dp.model.Workspace.Type getType() {
        return type;
    }
        /**
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformWorkspacesRequest, java.lang.Void> {
...
* 
     */
        private com.oracle.aidataplatform.dp.model.Workspace.LifecycleState lifecycleState = null;
...
* 
         ...
         * @return this builder instance
         */
        public Builder lifecycleState(com.oracle.aidataplatform.dp.model.Workspace.LifecycleState lifecycleState) {
     ...
     * When no value is provided, all workspaces are returned. Otherwise, workspace of selected value is returned.
     */
        private com.oracle.aidataplatform.dp.model.Workspace.Type type = null;
         ...
         * @return this builder instance
         */
        public Builder type(com.oracle.aidataplatform.dp.model.Workspace.Type type) {
            this.type = type;
            return this;
        }
...
* 
     ...
     * A flag to filter the workspaces which are private network enabled or disabled
     */
        private Boolean isPrivateNetworkEnabled = null;
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformWorkspacesRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());lifecycleState(o.getLifecycleState());displayName(o.getDisplayName());displayNameContains(o.getDisplayNameContains());type(o.getType());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());isPrivateNetworkEnabled(o.getIsPrivateNetworkEnabled());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of ListAiDataPlatformWorkspacesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformWorkspacesRequest
         */
        public ListAiDataPlatformWorkspacesRequest build() {
            ListAiDataPlatformWorkspacesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformWorkspacesRequest
         */
        public ListAiDataPlatformWorkspacesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformWorkspacesRequest request = new ListAiDataPlatformWorkspacesRequest();
            ...
            request.isPrivateNetworkEnabled = isPrivateNetworkEnabled;
            request.opcRequestId = opcRequestId;
            return request;
            // new ListAiDataPlatformWorkspacesRequest(aiDataPlatformId, lifecycleState, displayName, displayNameContains, type, limit, page, sortOrder, sortBy, isPrivateNetworkEnabled, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformWorkspacesRequest)) {
            return false;
        }

        ListAiDataPlatformWorkspacesRequest other = (ListAiDataPlatformWorkspacesRequest) o;
