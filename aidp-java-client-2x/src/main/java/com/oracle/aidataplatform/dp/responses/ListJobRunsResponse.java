...
public class ListJobRunsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListJobRunsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.JobRunCollection jobRunCollection) {
