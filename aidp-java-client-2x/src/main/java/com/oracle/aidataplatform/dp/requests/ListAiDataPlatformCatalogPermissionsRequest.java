...
public class ListAiDataPlatformCatalogPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformCatalogPermissionsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformCatalogPermissionsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());catalogKey(o.getCatalogKey());limit(o.getLimit());page(o.getPage());sortOrder(o.getSortOrder());sortBy(o.getSortBy());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of ListAiDataPlatformCatalogPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformCatalogPermissionsRequest
         */
        public ListAiDataPlatformCatalogPermissionsRequest build() {
            ListAiDataPlatformCatalogPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformCatalogPermissionsRequest
         */
        public ListAiDataPlatformCatalogPermissionsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformCatalogPermissionsRequest request = new ListAiDataPlatformCatalogPermissionsRequest();
            ...
            return request;
            // new ListAiDataPlatformCatalogPermissionsRequest(aiDataPlatformId, catalogKey, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformCatalogPermissionsRequest)) {
            return false;
        }

        ListAiDataPlatformCatalogPermissionsRequest other = (ListAiDataPlatformCatalogPermissionsRequest) o;
