...
public class LogExperimentRunMetricRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.LogExperimentRunMetricDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<LogExperimentRunMetricRequest, com.oracle.aidataplatform.dp.model.LogExperimentRunMetricDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(LogExperimentRunMetricRequest o) {
        ...
        /**
         * Build the instance of LogExperimentRunMetricRequest as configured by this builder
         *
         ...
         *
         * @return instance of LogExperimentRunMetricRequest
         */
        public LogExperimentRunMetricRequest build() {
            LogExperimentRunMetricRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of LogExperimentRunMetricRequest
         */
        public LogExperimentRunMetricRequest buildWithoutInvocationCallback() {
            LogExperimentRunMetricRequest request = new LogExperimentRunMetricRequest();
            ...
            return request;
            // new LogExperimentRunMetricRequest(aiDataPlatformId, workspaceKey, logExperimentRunMetricDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogExperimentRunMetricRequest)) {
            return false;
        }

        LogExperimentRunMetricRequest other = (LogExperimentRunMetricRequest) o;
