...
@com.fasterxml.jackson.annotation.JsonTypeInfo(use=com.fasterxml.jackson.annotation.JsonTypeInfo.Id.NAME, include=com.fasterxml.jackson.annotation.JsonTypeInfo.As.PROPERTY, property="type", defaultImpl=CreateAgentFlowNodeDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateCustomToolNodeDetails.class, name = "CUSTOM_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateMcpToolNodeDetails.class, name = "MCP_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreatePromptToolNodeDetails.class, name = "PROMPT_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateHttpToolNodeDetails.class, name = "HTTP_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateAgentNodeDetails.class, name = "AGENT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateRagToolNodeDetails.class, name = "RAG_TOOL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = CreateSqlToolNodeDetails.class, name = "SQL_TOOL")
})

public class CreateAgentFlowNodeDetails  {
    @Deprecated
    ...
    protected CreateAgentFlowNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAgentFlowNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentFlowNodeDetails)) {
            return false;
        }

        CreateAgentFlowNodeDetails other = (CreateAgentFlowNodeDetails) o;
