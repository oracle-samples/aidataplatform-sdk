...
public class UpdateRegisteredModelTagsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateRegisteredModelTagsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateRegisteredModelTagsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateRegisteredModelTagsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateRegisteredModelTagsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateRegisteredModelTagsResponse responseWrapper = builder.build();
