...
public class RefreshAiDataPlatformCatalogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshAiDataPlatformCatalogRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshAiDataPlatformCatalogRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());catalogKey(o.getCatalogKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());
        ...
        /**
         * Build the instance of RefreshAiDataPlatformCatalogRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshAiDataPlatformCatalogRequest
         */
        public RefreshAiDataPlatformCatalogRequest build() {
            RefreshAiDataPlatformCatalogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshAiDataPlatformCatalogRequest
         */
        public RefreshAiDataPlatformCatalogRequest buildWithoutInvocationCallback() {
            RefreshAiDataPlatformCatalogRequest request = new RefreshAiDataPlatformCatalogRequest();
            ...
            return request;
            // new RefreshAiDataPlatformCatalogRequest(aiDataPlatformId, catalogKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformCatalogRequest)) {
            return false;
        }

        RefreshAiDataPlatformCatalogRequest other = (RefreshAiDataPlatformCatalogRequest) o;
