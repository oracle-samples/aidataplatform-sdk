...
public class HeadWorkspaceObjectConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(HeadWorkspaceObjectConverter.class);

    public static com.oracle.aidataplatform.dp.requests.HeadWorkspaceObjectRequest interceptRequest(com.oracle.aidataplatform.dp.requests.HeadWorkspaceObjectRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.HeadWorkspaceObjectRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse");
        ...
        com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse.Builder builder = com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.HeadWorkspaceObjectResponse responseWrapper = builder.build();
