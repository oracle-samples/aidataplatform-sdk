...
public class CreateAiDataPlatformContentConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CreateAiDataPlatformContentConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformContentRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformContentRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformContentRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getContentPath(), "contentPath must not be blank");        Validate.notNull(request.getCreateContentDetails(), "createContentDetails is required");                                
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformContentResponse responseWrapper = builder.build();
