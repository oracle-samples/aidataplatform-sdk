...
public class ListAiDataPlatformCatalogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAiDataPlatformCatalogsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.CatalogCollection catalogCollection) {
