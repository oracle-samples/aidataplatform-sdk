...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RecipientPermissionSummary.Builder.class)

public final class RecipientPermissionSummary  {
    @Deprecated
    @java.beans.ConstructorProperties({"grantee", "granteeName", "granteeType", "granteePermissions"})
    public RecipientPermissionSummary(String grantee, String granteeName, GranteeType granteeType, java.util.List<RecipientPrivilege> granteePermissions) {
        super();
     ...
     **/
        ...
        private java.util.List<RecipientPrivilege> granteePermissions;
        ...
        public Builder granteePermissions(java.util.List<RecipientPrivilege> granteePermissions) {
        this.granteePermissions = granteePermissions;
        return this;
        }


        public RecipientPermissionSummary build() {
            RecipientPermissionSummary model = new RecipientPermissionSummary(this.grantee
                    , this.granteeName
                    , this.granteeType
        ...
        public Builder copy(RecipientPermissionSummary model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("granteePermissions")
    private final java.util.List<RecipientPrivilege> granteePermissions;
    ...
    public java.util.List<RecipientPrivilege> getGranteePermissions() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RecipientPermissionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecipientPermissionSummary)) {
            return false;
        }

        RecipientPermissionSummary other = (RecipientPermissionSummary) o;
