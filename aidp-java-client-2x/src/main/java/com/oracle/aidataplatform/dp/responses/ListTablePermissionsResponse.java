...
public class ListTablePermissionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListTablePermissionsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.TablePermissionCollection tablePermissionCollection) {
