...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetJobRequest, java.lang.Void> {
...
* 
     ...
     */
        ...
        public GetJobRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetJobRequest(aiDataPlatformId, workspaceKey, jobKey, opcRequestId, shouldUpdateRecent);
        }
    }
