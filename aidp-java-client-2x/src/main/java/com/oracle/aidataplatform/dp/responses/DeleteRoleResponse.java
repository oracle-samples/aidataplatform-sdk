...
public class DeleteRoleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteRoleResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId) {
    ...
    public static class Builder {
        ...
        public DeleteRoleResponse build() {
            return new DeleteRoleResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
