...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=PromptTool.Builder.class)
...
public final class PromptTool extends Tool {
     ...
     **/
        ...
        public PromptTool build() {
            PromptTool model = new PromptTool(this.key
                    , this.displayName
                    , this.workspaceKey
                    , this.description
                    , this.isReference
        ...
        public Builder copy(PromptTool model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PromptTool)) {
            return false;
        }

        PromptTool other = (PromptTool) o;
