...
public class CreateExperimentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateExperimentDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateExperimentRequest, com.oracle.aidataplatform.dp.model.CreateExperimentDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateExperimentRequest o) {
        ...
        /**
         * Build the instance of CreateExperimentRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateExperimentRequest
         */
        public CreateExperimentRequest build() {
            CreateExperimentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateExperimentRequest
         */
        public CreateExperimentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateExperimentRequest(aiDataPlatformId, workspaceKey, createExperimentDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExperimentRequest)) {
            return false;
        }

        CreateExperimentRequest other = (CreateExperimentRequest) o;
