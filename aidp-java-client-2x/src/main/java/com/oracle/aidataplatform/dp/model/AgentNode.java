...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AgentNode.Builder.class)
...
public final class AgentNode extends AgentFlowNode {
     ...
     **/
        ...
        public AgentNode build() {
            AgentNode model = new AgentNode(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(AgentNode model) {
