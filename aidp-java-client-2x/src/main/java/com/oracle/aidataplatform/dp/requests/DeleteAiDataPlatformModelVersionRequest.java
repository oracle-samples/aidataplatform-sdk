...
public class DeleteAiDataPlatformModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails deleteModelVersionDetails;
     ...
     * Details of the ModelVersion.
     */
    public com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails getDeleteModelVersionDetails() {
        return deleteModelVersionDetails;
    }
        /**
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails getBody$() {
        return deleteModelVersionDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformModelVersionRequest, com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails> {
     ...
     * Details of the ModelVersion.
     */
        private com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails deleteModelVersionDetails = null;

        /**
         * Details of the ModelVersion.
         * @param deleteModelVersionDetails the value to set
         * @return this builder instance
         */
        public Builder deleteModelVersionDetails(com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails deleteModelVersionDetails) {
            this.deleteModelVersionDetails = deleteModelVersionDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformModelVersionRequest o) {
        ...
        /**
         * Build the instance of DeleteAiDataPlatformModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformModelVersionRequest
         */
        public DeleteAiDataPlatformModelVersionRequest build() {
            DeleteAiDataPlatformModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.DeleteModelVersionDetails body) {
            deleteModelVersionDetails(body);
            return this;
        }
         ...
         * @return instance of DeleteAiDataPlatformModelVersionRequest
         */
        public DeleteAiDataPlatformModelVersionRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformModelVersionRequest request = new DeleteAiDataPlatformModelVersionRequest();
            ...
            return request;
            // new DeleteAiDataPlatformModelVersionRequest(aiDataPlatformId, deleteModelVersionDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformModelVersionRequest)) {
            return false;
        }

        DeleteAiDataPlatformModelVersionRequest other = (DeleteAiDataPlatformModelVersionRequest) o;
