...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateSqlToolNodeDetails.Builder.class)
...
public final class UpdateSqlToolNodeDetails extends UpdateAgentFlowNodeDetails {
     ...
     **/
        ...
        public UpdateSqlToolNodeDetails build() {
            UpdateSqlToolNodeDetails model = new UpdateSqlToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(UpdateSqlToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateSqlToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, java.util.Map<String, Object> inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateSqlToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSqlToolNodeDetails)) {
            return false;
        }

        UpdateSqlToolNodeDetails other = (UpdateSqlToolNodeDetails) o;
