...
public class ModifyAiDataPlatformContentConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ModifyAiDataPlatformContentConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ModifyAiDataPlatformContentRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ModifyAiDataPlatformContentRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ModifyAiDataPlatformContentRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getContentPath(), "contentPath must not be blank");        Validate.notNull(request.getModifyContentDetails(), "modifyContentDetails is required");                        
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ModifyAiDataPlatformContentResponse responseWrapper = builder.build();
