...
public class ListAiDataPlatformVolumesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformVolumesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformVolumesRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformVolumesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformVolumesRequest
         */
        public ListAiDataPlatformVolumesRequest build() {
            ListAiDataPlatformVolumesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformVolumesRequest
         */
        public ListAiDataPlatformVolumesRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformVolumesRequest request = new ListAiDataPlatformVolumesRequest();
            ...
            return request;
            // new ListAiDataPlatformVolumesRequest(aiDataPlatformId, catalogKey, schemaKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformVolumesRequest)) {
            return false;
        }

        ListAiDataPlatformVolumesRequest other = (ListAiDataPlatformVolumesRequest) o;
