...
public class UploadWorkspaceObjectWithParConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UploadWorkspaceObjectWithParConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UploadWorkspaceObjectWithParRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UploadWorkspaceObjectWithParRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UploadWorkspaceObjectWithParRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UploadWorkspaceObjectWithParResponse responseWrapper = builder.build();
