...
public class ManageJobPermissionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ManageJobPermissionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ManageJobPermissionRequest, com.oracle.aidataplatform.dp.model.ManageJobPermissionDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ManageJobPermissionRequest o) {
        ...
        /**
         * Build the instance of ManageJobPermissionRequest as configured by this builder
         *
         ...
         *
         * @return instance of ManageJobPermissionRequest
         */
        public ManageJobPermissionRequest build() {
            ManageJobPermissionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ManageJobPermissionRequest
         */
        public ManageJobPermissionRequest buildWithoutInvocationCallback() {
            ManageJobPermissionRequest request = new ManageJobPermissionRequest();
            ...
            return request;
            // new ManageJobPermissionRequest(aiDataPlatformId, workspaceKey, jobKey, manageJobPermissionDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManageJobPermissionRequest)) {
            return false;
        }

        ManageJobPermissionRequest other = (ManageJobPermissionRequest) o;
