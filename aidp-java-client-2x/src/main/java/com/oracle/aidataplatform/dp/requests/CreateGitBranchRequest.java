...
public class CreateGitBranchRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateGitBranchDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateGitBranchRequest, com.oracle.aidataplatform.dp.model.CreateGitBranchDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateGitBranchRequest o) {
        ...
        /**
         * Build the instance of CreateGitBranchRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateGitBranchRequest
         */
        public CreateGitBranchRequest build() {
            CreateGitBranchRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateGitBranchRequest
         */
        public CreateGitBranchRequest buildWithoutInvocationCallback() {
            CreateGitBranchRequest request = new CreateGitBranchRequest();
            ...
            return request;
            // new CreateGitBranchRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, createGitBranchDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGitBranchRequest)) {
            return false;
        }

        CreateGitBranchRequest other = (CreateGitBranchRequest) o;
