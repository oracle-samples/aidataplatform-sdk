...
public class UploadAiDataPlatformFileWithParConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UploadAiDataPlatformFileWithParConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UploadAiDataPlatformFileWithParRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UploadAiDataPlatformFileWithParRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformFileWithParResponse responseWrapper = builder.build();
