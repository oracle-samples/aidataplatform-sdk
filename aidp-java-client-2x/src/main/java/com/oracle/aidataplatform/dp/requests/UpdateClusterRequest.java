...
public class UpdateClusterRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateClusterDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateClusterRequest, com.oracle.aidataplatform.dp.model.UpdateClusterDetails> {
...
* 
     ...
     */
        ...
        public UpdateClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateClusterRequest(aiDataPlatformId, workspaceKey, clusterKey, updateClusterDetails, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
