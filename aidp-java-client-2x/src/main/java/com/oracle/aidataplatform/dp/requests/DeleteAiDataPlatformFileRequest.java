...
public class DeleteAiDataPlatformFileRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformFileRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformFileRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());volumeKey(o.getVolumeKey());path(o.getPath());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformFileRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformFileRequest
         */
        public DeleteAiDataPlatformFileRequest build() {
            DeleteAiDataPlatformFileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformFileRequest
         */
        public DeleteAiDataPlatformFileRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformFileRequest request = new DeleteAiDataPlatformFileRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.volumeKey = volumeKey;
            request.path = path;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteAiDataPlatformFileRequest(aiDataPlatformId, volumeKey, path, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformFileRequest)) {
            return false;
        }

        DeleteAiDataPlatformFileRequest other = (DeleteAiDataPlatformFileRequest) o;
