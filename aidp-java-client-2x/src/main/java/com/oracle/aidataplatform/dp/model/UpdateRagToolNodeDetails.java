...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateRagToolNodeDetails.Builder.class)
...
public final class UpdateRagToolNodeDetails extends UpdateAgentFlowNodeDetails {
    ...
    public static class Builder {
        ...
        public UpdateRagToolNodeDetails build() {
            UpdateRagToolNodeDetails model = new UpdateRagToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(UpdateRagToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateRagToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, RagToolInputSchema inputSchema) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateRagToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRagToolNodeDetails)) {
            return false;
        }

        UpdateRagToolNodeDetails other = (UpdateRagToolNodeDetails) o;
