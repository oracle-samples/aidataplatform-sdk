...
public class CreateViewRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateViewDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateViewRequest, com.oracle.aidataplatform.dp.model.CreateViewDetails> {
...
* 
        ...
        public CreateViewRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateViewRequest(aiDataPlatformId, createViewDetails, shouldUpdateRecent, opcRetryToken, opcRequestId);
        }
    }
