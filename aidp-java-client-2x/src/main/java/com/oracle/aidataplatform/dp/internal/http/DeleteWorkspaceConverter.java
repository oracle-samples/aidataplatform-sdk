...
public class DeleteWorkspaceConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DeleteWorkspaceConverter.class);

    public static com.oracle.aidataplatform.dp.requests.DeleteWorkspaceRequest interceptRequest(com.oracle.aidataplatform.dp.requests.DeleteWorkspaceRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.DeleteWorkspaceRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse");
        ...
        com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse.Builder builder = com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.DeleteWorkspaceResponse responseWrapper = builder.build();
