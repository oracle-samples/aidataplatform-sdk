...
public class ListWorkspaceObjectPermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListWorkspaceObjectPermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListWorkspaceObjectPermissionsRequest o) {
        ...
        /**
         * Build the instance of ListWorkspaceObjectPermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWorkspaceObjectPermissionsRequest
         */
        public ListWorkspaceObjectPermissionsRequest build() {
            ListWorkspaceObjectPermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWorkspaceObjectPermissionsRequest
         */
        public ListWorkspaceObjectPermissionsRequest buildWithoutInvocationCallback() {
            ListWorkspaceObjectPermissionsRequest request = new ListWorkspaceObjectPermissionsRequest();
            ...
            return request;
            // new ListWorkspaceObjectPermissionsRequest(aiDataPlatformId, workspaceKey, objectKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkspaceObjectPermissionsRequest)) {
            return false;
        }

        ListWorkspaceObjectPermissionsRequest other = (ListWorkspaceObjectPermissionsRequest) o;
