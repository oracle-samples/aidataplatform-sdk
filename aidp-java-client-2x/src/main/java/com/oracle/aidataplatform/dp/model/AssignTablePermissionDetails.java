...
public final class AssignTablePermissionDetails  {
    ...
    public AssignTablePermissionDetails(PermissionAssignees assignees, java.util.List<TablePrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
