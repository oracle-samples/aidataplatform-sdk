...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=SearchResultsCollection.Builder.class)

public final class SearchResultsCollection  {
    @Deprecated
    @java.beans.ConstructorProperties({"count", "query", "items", "aggregations"})
    public SearchResultsCollection(Integer count, String query, java.util.List<ObjectSearchSummary> items, java.util.Map<String, java.util.List<SearchObjectType>> aggregations) {
        super();
        this.count = count;
        this.query = query;
        this.items = items;
     ...
     **/
        ...
        private java.util.List<ObjectSearchSummary> items;
        ...
        public Builder items(java.util.List<ObjectSearchSummary> items) {
        this.items = items;
        return this;
        }
            /**
     ...
     **/
        ...
        public SearchResultsCollection build() {
            SearchResultsCollection model = new SearchResultsCollection(this.count
                    , this.query
                    , this.items
        ...
        public Builder copy(SearchResultsCollection model) {
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<ObjectSearchSummary> items;
    ...
    public java.util.List<ObjectSearchSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SearchResultsCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchResultsCollection)) {
            return false;
        }

        SearchResultsCollection other = (SearchResultsCollection) o;
