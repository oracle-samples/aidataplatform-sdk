...
public class UserSettingAsyncClient implements UserSettingAsync {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, UserSettingAsyncClient> {
         ...
         * @return the client
         */
    public UserSettingAsyncClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
        if (authenticationDetailsProvider == null) {
            throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
        }
        return new UserSettingAsyncClient(authenticationDetailsProvider,
                configuration,
                clientConfigurator,
