...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateSparkClusterDetails.Builder.class)
...
public final class UpdateSparkClusterDetails extends UpdateClusterDetails {
     ...
     **/
        ...
        public UpdateSparkClusterDetails build() {
            UpdateSparkClusterDetails model = new UpdateSparkClusterDetails(this.displayName
                    , this.description
                    , this.driverConfig
                    , this.nodeType
                    , this.workerConfig
        ...
        public Builder copy(UpdateSparkClusterDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateSparkClusterDetails(String displayName, String description, DriverConfig driverConfig, String nodeType, WorkerConfig workerConfig, ClusterRuntimeConfig clusterRuntimeConfig, LoggingConfig loggingConfig, Integer autoTerminationMinutes, SubscriptionDetails subscription) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateSparkClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSparkClusterDetails)) {
            return false;
        }

        UpdateSparkClusterDetails other = (UpdateSparkClusterDetails) o;
