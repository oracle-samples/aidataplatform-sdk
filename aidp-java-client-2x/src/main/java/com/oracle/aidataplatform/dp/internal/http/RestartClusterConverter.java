...
public class RestartClusterConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(RestartClusterConverter.class);

    public static com.oracle.aidataplatform.dp.requests.RestartClusterRequest interceptRequest(com.oracle.aidataplatform.dp.requests.RestartClusterRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.RestartClusterRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RestartClusterResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RestartClusterResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RestartClusterResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.RestartClusterResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.RestartClusterResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.RestartClusterResponse");
        ...
        com.oracle.aidataplatform.dp.responses.RestartClusterResponse.Builder builder = com.oracle.aidataplatform.dp.responses.RestartClusterResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.RestartClusterResponse responseWrapper = builder.build();
