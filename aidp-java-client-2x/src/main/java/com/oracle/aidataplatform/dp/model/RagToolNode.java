...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RagToolNode.Builder.class)
...
public final class RagToolNode extends AgentFlowNode {
    ...
    public static class Builder {
        ...
        public RagToolNode build() {
            RagToolNode model = new RagToolNode(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(RagToolNode model) {
...
return this;
    ...
    @Deprecated
    public RagToolNode(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String key, java.util.Date timeCreated, java.util.Date timeUpdated, java.util.List<NodeInput> inputs, java.util.List<NodeOutput> outputs, java.util.List<ValidationError> validationErrors, RagToolInputSchema inputSchema) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RagToolNode)) {
            return false;
        }

        RagToolNode other = (RagToolNode) o;
