...
public class BundleAsyncClient implements BundleAsync {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, BundleAsyncClient> {
         ...
         * @return the client
         */
    public BundleAsyncClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
        if (authenticationDetailsProvider == null) {
            throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
        }
        return new BundleAsyncClient(authenticationDetailsProvider,
                configuration,
                clientConfigurator,
