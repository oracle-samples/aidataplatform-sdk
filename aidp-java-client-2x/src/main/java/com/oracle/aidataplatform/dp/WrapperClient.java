...
public class WrapperClient implements Wrapper {
    /**
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(WrapperClient.class);
     ...
     */
    public WrapperClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider) {
     ...
     */
    public WrapperClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration) {
     ...
     */
    public WrapperClient(com.oracle.bmc.auth.BasicAuthenticationDetailsProvider authenticationDetailsProvider, com.oracle.bmc.ClientConfiguration configuration, com.oracle.bmc.http.ClientConfigurator clientConfigurator) {
    ...
    */
     ...
     */
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, WrapperClient> {
         ...
         * @return the client
         */
        public WrapperClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            if (authenticationDetailsProvider == null) {
                throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
            }
            return new WrapperClient(authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
    ...
    public DownloadAiDataPlatformClusterLogsResponse downloadAiDataPlatformClusterLogs(DownloadAiDataPlatformClusterLogsRequest request) {
        LOG.trace("Called downloadAiDataPlatformClusterLogs");
            ...
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("Wrapper", "DownloadAiDataPlatformClusterLogs", ib.getRequestUri().toString(), "");
    ...
    public SearchAiDataPlatformClusterLogsResponse searchAiDataPlatformClusterLogs(SearchAiDataPlatformClusterLogsRequest request) {
        LOG.trace("Called searchAiDataPlatformClusterLogs");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("Wrapper", "SearchAiDataPlatformClusterLogs", ib.getRequestUri().toString(), "");
    ...
    public SummarizeAiDataPlatformMetricsDataResponse summarizeAiDataPlatformMetricsData(SummarizeAiDataPlatformMetricsDataRequest request) {
        LOG.trace("Called summarizeAiDataPlatformMetricsData");
            ...
            com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails = new com.oracle.bmc.ServiceDetails("Wrapper", "SummarizeAiDataPlatformMetricsData", ib.getRequestUri().toString(), "");
