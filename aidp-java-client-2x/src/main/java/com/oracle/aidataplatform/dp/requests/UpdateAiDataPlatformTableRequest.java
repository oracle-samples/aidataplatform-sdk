...
public class UpdateAiDataPlatformTableRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateTableDetails> {
     ...
     */
    private com.oracle.aidataplatform.dp.model.UpdateTableDetails updateTableDetails;
     ...
     * The information to be updated.
     */
    public com.oracle.aidataplatform.dp.model.UpdateTableDetails getUpdateTableDetails() {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.UpdateTableDetails getBody$() {
        return updateTableDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateAiDataPlatformTableRequest, com.oracle.aidataplatform.dp.model.UpdateTableDetails> {
     ...
     * The information to be updated.
     */
        private com.oracle.aidataplatform.dp.model.UpdateTableDetails updateTableDetails = null;
         ...
         * @return this builder instance
         */
        public Builder updateTableDetails(com.oracle.aidataplatform.dp.model.UpdateTableDetails updateTableDetails) {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateAiDataPlatformTableRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());updateTableDetails(o.getUpdateTableDetails());shouldUpdateRecent(o.getShouldUpdateRecent());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of UpdateAiDataPlatformTableRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateAiDataPlatformTableRequest
         */
        public UpdateAiDataPlatformTableRequest build() {
            UpdateAiDataPlatformTableRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.UpdateTableDetails body) {
         ...
         * @return instance of UpdateAiDataPlatformTableRequest
         */
        public UpdateAiDataPlatformTableRequest buildWithoutInvocationCallback() {
            UpdateAiDataPlatformTableRequest request = new UpdateAiDataPlatformTableRequest();
            ...
            return request;
            // new UpdateAiDataPlatformTableRequest(aiDataPlatformId, tableKey, updateTableDetails, shouldUpdateRecent, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAiDataPlatformTableRequest)) {
            return false;
        }

        UpdateAiDataPlatformTableRequest other = (UpdateAiDataPlatformTableRequest) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.updateTableDetails == null ? 43 : this.updateTableDetails.hashCode());
