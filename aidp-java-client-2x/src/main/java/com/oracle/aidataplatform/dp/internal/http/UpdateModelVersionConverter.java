...
public class UpdateModelVersionConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateModelVersionConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateModelVersionRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateModelVersionRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateModelVersionRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateModelVersionResponse responseWrapper = builder.build();
