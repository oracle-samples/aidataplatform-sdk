...
public class UpdateDirRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateDirDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateDirRequest, com.oracle.aidataplatform.dp.model.UpdateDirDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateDirRequest o) {
        ...
        /**
         * Build the instance of UpdateDirRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateDirRequest
         */
        public UpdateDirRequest build() {
            UpdateDirRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateDirRequest
         */
        public UpdateDirRequest buildWithoutInvocationCallback() {
            UpdateDirRequest request = new UpdateDirRequest();
            ...
            return request;
            // new UpdateDirRequest(aiDataPlatformId, volumeKey, updateDirDetails, path, opcRetryToken, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDirRequest)) {
            return false;
        }

        UpdateDirRequest other = (UpdateDirRequest) o;
