...
public class PatchClusterLibraryConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(PatchClusterLibraryConverter.class);

    public static com.oracle.aidataplatform.dp.requests.PatchClusterLibraryRequest interceptRequest(com.oracle.aidataplatform.dp.requests.PatchClusterLibraryRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.PatchClusterLibraryRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse");
        ...
        com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse.Builder builder = com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.PatchClusterLibraryResponse responseWrapper = builder.build();
