...
public class ListAiDataPlatformCatalogsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformCatalogsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformCatalogsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformCatalogsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformCatalogsRequest
         */
        public ListAiDataPlatformCatalogsRequest build() {
            ListAiDataPlatformCatalogsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformCatalogsRequest
         */
        public ListAiDataPlatformCatalogsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformCatalogsRequest request = new ListAiDataPlatformCatalogsRequest();
            ...
            return request;
            // new ListAiDataPlatformCatalogsRequest(aiDataPlatformId, displayName, catalogState, catalogType, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformCatalogsRequest)) {
            return false;
        }

        ListAiDataPlatformCatalogsRequest other = (ListAiDataPlatformCatalogsRequest) o;
