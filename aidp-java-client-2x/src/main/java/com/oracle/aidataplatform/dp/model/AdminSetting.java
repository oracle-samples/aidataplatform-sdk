...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AdminSetting.Builder.class)

public final class AdminSetting  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "name", "isDefault", "data"})
    public AdminSetting(String key, String name, Boolean isDefault, SettingData data) {
        super();
        this.key = key;
        this.name = name;
     ...
     **/
        ...
        public AdminSetting build() {
            AdminSetting model = new AdminSetting(this.key
                    , this.name
                    , this.isDefault
        ...
        public Builder copy(AdminSetting model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminSetting)) {
            return false;
        }

        AdminSetting other = (AdminSetting) o;
