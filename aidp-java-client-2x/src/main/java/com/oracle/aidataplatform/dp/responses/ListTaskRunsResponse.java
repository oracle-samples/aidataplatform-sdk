...
public class ListTaskRunsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListTaskRunsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.TaskRunCollection taskRunCollection) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTaskRunsResponse)) {
            return false;
        }

        ListTaskRunsResponse other = (ListTaskRunsResponse) o;
