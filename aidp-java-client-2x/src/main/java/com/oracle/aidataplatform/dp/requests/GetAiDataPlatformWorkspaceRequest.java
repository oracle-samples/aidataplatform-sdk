...
public class GetAiDataPlatformWorkspaceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformWorkspaceRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformWorkspaceRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAiDataPlatformWorkspaceRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformWorkspaceRequest
         */
        public GetAiDataPlatformWorkspaceRequest build() {
            GetAiDataPlatformWorkspaceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformWorkspaceRequest
         */
        public GetAiDataPlatformWorkspaceRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformWorkspaceRequest request = new GetAiDataPlatformWorkspaceRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAiDataPlatformWorkspaceRequest(aiDataPlatformId, workspaceKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformWorkspaceRequest)) {
            return false;
        }

        GetAiDataPlatformWorkspaceRequest other = (GetAiDataPlatformWorkspaceRequest) o;
