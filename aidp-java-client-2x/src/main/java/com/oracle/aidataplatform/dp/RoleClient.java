...
public class RoleClient implements Role {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, RoleClient> {
         ...
         * @return the client
         */
        public RoleClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
            if (authenticationDetailsProvider == null) {
                throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
            }
            return new RoleClient(authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getAddMemberToRoleDetails(), retriedRequest);
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getCreateRoleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.post(ib, retriedRequest.getRemoveMemberFromRoleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
            ...
            return retrier.execute(
                    ...
                    retryRequest -> {
                        ...
                        return tokenRefreshRetrier.execute(
                                retryRequest,
                                retriedRequest -> { 
                                    javax.ws.rs.core.Response response = client.put(ib, retriedRequest.getUpdateRoleDetails(), retriedRequest);
                                    return transformer.apply(response);
                                });
                    });
    }
