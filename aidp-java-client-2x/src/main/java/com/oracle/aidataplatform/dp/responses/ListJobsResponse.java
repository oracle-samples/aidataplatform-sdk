...
public class ListJobsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListJobsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, String opcPrevPage, Integer opcTotalItems, com.oracle.aidataplatform.dp.model.JobCollection jobCollection) {
