...
public class PerformInferSchemaRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PerformInferSchemaRequest, com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PerformInferSchemaRequest o) {
        ...
        /**
         * Build the instance of PerformInferSchemaRequest as configured by this builder
         *
         ...
         *
         * @return instance of PerformInferSchemaRequest
         */
        public PerformInferSchemaRequest build() {
            PerformInferSchemaRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PerformInferSchemaRequest
         */
        public PerformInferSchemaRequest buildWithoutInvocationCallback() {
            PerformInferSchemaRequest request = new PerformInferSchemaRequest();
            ...
            return request;
            // new PerformInferSchemaRequest(aiDataPlatformId, schemaKey, performInferSchemaDetails, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PerformInferSchemaRequest)) {
            return false;
        }

        PerformInferSchemaRequest other = (PerformInferSchemaRequest) o;
