...
public class CancelAiDataPlatformJobRunConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CancelAiDataPlatformJobRunConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CancelAiDataPlatformJobRunRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CancelAiDataPlatformJobRunRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CancelAiDataPlatformJobRunRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notBlank(request.getJobRunKey(), "jobRunKey must not be blank");                                

        com.oracle.bmc.http.internal.WrappedWebTarget target = client.getBaseTarget()
        .path("/20260430")
            .path("aiDataPlatforms").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getAiDataPlatformId())).path("workspaces").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getWorkspaceKey())).path("jobRuns").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getJobRunKey())).path("actions").path("cancel");
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CancelAiDataPlatformJobRunResponse responseWrapper = builder.build();
