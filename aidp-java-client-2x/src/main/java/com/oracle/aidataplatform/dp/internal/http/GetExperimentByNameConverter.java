...
public class GetExperimentByNameConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GetExperimentByNameConverter.class);

    public static com.oracle.aidataplatform.dp.requests.GetExperimentByNameRequest interceptRequest(com.oracle.aidataplatform.dp.requests.GetExperimentByNameRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.GetExperimentByNameRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse");
        ...
        com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse.Builder builder = com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.GetExperimentByNameResponse responseWrapper = builder.build();
