...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=KnowledgeBaseJob.Builder.class)

public final class KnowledgeBaseJob  {
    @Deprecated
    @java.beans.ConstructorProperties({"key", "workflowJobKey", "displayName", "description", "knowledgeBaseKey", "catalogKey", "schemaKey", "type", "goal", "sources", "sourceKey", "schedule", "timeCreated", "timeUpdated", "createdBy", "updatedBy", "lifecycleState", "lifecycleStateDetails"})
    public KnowledgeBaseJob(String key, String workflowJobKey, String displayName, String description, String knowledgeBaseKey, String catalogKey, String schemaKey, KnowledgeBaseJobType type, KnowledgeBaseJobGoalType goal, String sources, String sourceKey, String schedule, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, KnowledgeBaseJobLifecycleState lifecycleState, String lifecycleStateDetails) {
        super();
        this.key = key;
     ...
     **/
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("workflowJobKey")
        private String workflowJobKey;

                /**
         * The Unique identifier for this KnowledgeBase Job resource's mapped WF job
         * @param workflowJobKey the value to set
         * @return this builder
         **/
        

        public Builder workflowJobKey(String workflowJobKey) {
        this.workflowJobKey = workflowJobKey;
        return this;
        }
            /**
     ...
     **/
        ...
        public KnowledgeBaseJob build() {
            KnowledgeBaseJob model = new KnowledgeBaseJob(this.key
                    , this.workflowJobKey
                    , this.displayName
                    , this.description
        ...
        public Builder copy(KnowledgeBaseJob model) {
                this.key(model.getKey());
    this.workflowJobKey(model.getWorkflowJobKey());
...
return this;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("workflowJobKey")
    private final String workflowJobKey;
    ...
    public String getWorkflowJobKey() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KnowledgeBaseJob(");
        sb.append("key=").append(String.valueOf(this.key));
        sb.append(", workflowJobKey=").append(String.valueOf(this.workflowJobKey));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KnowledgeBaseJob)) {
            return false;
        }

        KnowledgeBaseJob other = (KnowledgeBaseJob) o;
        return java.util.Objects.equals(this.key, other.key) &&
            java.util.Objects.equals(this.workflowJobKey, other.workflowJobKey) &&
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.workflowJobKey == null ? 43 : this.workflowJobKey.hashCode());
