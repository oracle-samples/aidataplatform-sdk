...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateSqlToolDetails.Builder.class)
...
public final class CreateSqlToolDetails extends CreateToolDetails {
     ...
     **/
        ...
        public CreateSqlToolDetails build() {
            CreateSqlToolDetails model = new CreateSqlToolDetails(this.displayName
                    , this.description
                    , this.properties
                    , this.inputSchema
        ...
        public Builder copy(CreateSqlToolDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateSqlToolDetails(String displayName, String description, java.util.Map<String, Object> properties, java.util.Map<String, Object> inputSchema, SqlToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSqlToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSqlToolDetails)) {
            return false;
        }

        CreateSqlToolDetails other = (CreateSqlToolDetails) o;
