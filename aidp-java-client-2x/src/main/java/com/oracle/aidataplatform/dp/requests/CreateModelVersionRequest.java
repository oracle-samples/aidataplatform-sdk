...
public class CreateModelVersionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateModelVersionRequest, com.oracle.aidataplatform.dp.model.CreateModelVersionDetails> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of CreateModelVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateModelVersionRequest
         */
        public CreateModelVersionRequest build() {
            CreateModelVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateModelVersionRequest
         */
        public CreateModelVersionRequest buildWithoutInvocationCallback() {
            CreateModelVersionRequest request = new CreateModelVersionRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateModelVersionRequest)) {
            return false;
        }

        CreateModelVersionRequest other = (CreateModelVersionRequest) o;
