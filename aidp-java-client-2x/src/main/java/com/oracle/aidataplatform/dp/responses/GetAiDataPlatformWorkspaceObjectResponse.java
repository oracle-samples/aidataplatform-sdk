...
* 
    ...
    private GetAiDataPlatformWorkspaceObjectResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String etag, String opcRequestId, String objectKey, String path, String type, java.util.Date timeUpdated, java.io.InputStream inputStream) {
