...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=AtpTable.Builder.class)
...
public final class AtpTable extends Table {
    ...
    public static class Builder {
        ...
        public AtpTable build() {
            AtpTable model = new AtpTable(this.key
                    , this.displayName
                    , this.catalogKey
                    , this.schemaKey
                    , this.location
        ...
        public Builder copy(AtpTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AtpTable)) {
            return false;
        }

        AtpTable other = (AtpTable) o;
