...
public class LogExperimentRunModelRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.LogExperimentRunModelDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<LogExperimentRunModelRequest, com.oracle.aidataplatform.dp.model.LogExperimentRunModelDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(LogExperimentRunModelRequest o) {
        ...
        /**
         * Build the instance of LogExperimentRunModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of LogExperimentRunModelRequest
         */
        public LogExperimentRunModelRequest build() {
            LogExperimentRunModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of LogExperimentRunModelRequest
         */
        public LogExperimentRunModelRequest buildWithoutInvocationCallback() {
            LogExperimentRunModelRequest request = new LogExperimentRunModelRequest();
            ...
            return request;
            // new LogExperimentRunModelRequest(aiDataPlatformId, workspaceKey, logExperimentRunModelDetails, opcRetryToken, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogExperimentRunModelRequest)) {
            return false;
        }

        LogExperimentRunModelRequest other = (LogExperimentRunModelRequest) o;
