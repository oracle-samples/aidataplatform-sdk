...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=TestSqlToolDetails.Builder.class)
...
public final class TestSqlToolDetails extends TestToolDetails {
    ...
    public static class Builder {
        ...
        private SqlToolConfiguration config;

        

        public Builder config(SqlToolConfiguration config) {
        this.config = config;
        return this;
        }
        ...
        public TestSqlToolDetails build() {
            TestSqlToolDetails model = new TestSqlToolDetails(this.agentFlowId
                    , this.config
                    , this.paramValues);            return model;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TestSqlToolDetails model) {
...
return this;
    ...
    @Deprecated
    public TestSqlToolDetails(String agentFlowId, SqlToolConfiguration config, TestToolParamValues paramValues) {
        super(agentFlowId);
        this.config = config;
        this.paramValues = paramValues;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("config")
    private final SqlToolConfiguration config;

    
    public SqlToolConfiguration getConfig() {
        return config;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestSqlToolDetails)) {
            return false;
        }

        TestSqlToolDetails other = (TestSqlToolDetails) o;
