...
public class CreateJobRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateJobDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateJobRequest, com.oracle.aidataplatform.dp.model.CreateJobDetails> {
...
* 
     ...
     */
        ...
        public CreateJobRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateJobRequest(aiDataPlatformId, workspaceKey, createJobDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
