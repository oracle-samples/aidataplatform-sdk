...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdatePromptToolDetails.Builder.class)
...
public final class UpdatePromptToolDetails extends UpdateToolDetails {
     ...
     **/
        ...
        public UpdatePromptToolDetails build() {
            UpdatePromptToolDetails model = new UpdatePromptToolDetails(this.displayName
                    , this.description
                    , this.properties
                    , this.inputSchema
        ...
        public Builder copy(UpdatePromptToolDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdatePromptToolDetails(String displayName, String description, java.util.Map<String, Object> properties, java.util.Map<String, Object> inputSchema, PromptToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePromptToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePromptToolDetails)) {
            return false;
        }

        UpdatePromptToolDetails other = (UpdatePromptToolDetails) o;
