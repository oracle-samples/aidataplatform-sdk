...
* 
    ...
    private GetAiDataPlatformUserSettingResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String etag, String opcRequestId, com.oracle.aidataplatform.dp.model.UserSetting userSetting) {
