...
public class RefreshAiDataPlatformSchemaRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RefreshAiDataPlatformSchemaRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshAiDataPlatformSchemaRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());schemaKey(o.getSchemaKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());opcRetryToken(o.getOpcRetryToken());
        ...
        /**
         * Build the instance of RefreshAiDataPlatformSchemaRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshAiDataPlatformSchemaRequest
         */
        public RefreshAiDataPlatformSchemaRequest build() {
            RefreshAiDataPlatformSchemaRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshAiDataPlatformSchemaRequest
         */
        public RefreshAiDataPlatformSchemaRequest buildWithoutInvocationCallback() {
            RefreshAiDataPlatformSchemaRequest request = new RefreshAiDataPlatformSchemaRequest();
            ...
            return request;
            // new RefreshAiDataPlatformSchemaRequest(aiDataPlatformId, schemaKey, ifMatch, opcRequestId, shouldUpdateRecent, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshAiDataPlatformSchemaRequest)) {
            return false;
        }

        RefreshAiDataPlatformSchemaRequest other = (RefreshAiDataPlatformSchemaRequest) o;
