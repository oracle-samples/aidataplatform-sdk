...
public class ListAsyncOperationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAsyncOperationsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.AsyncOperationCollection asyncOperationCollection) {
