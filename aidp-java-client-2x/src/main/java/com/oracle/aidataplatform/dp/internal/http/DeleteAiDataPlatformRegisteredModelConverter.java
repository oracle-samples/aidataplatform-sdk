...
public class DeleteAiDataPlatformRegisteredModelConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DeleteAiDataPlatformRegisteredModelConverter.class);

    public static com.oracle.aidataplatform.dp.requests.DeleteAiDataPlatformRegisteredModelRequest interceptRequest(com.oracle.aidataplatform.dp.requests.DeleteAiDataPlatformRegisteredModelRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.DeleteAiDataPlatformRegisteredModelRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse");
        ...
        com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse.Builder builder = com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.DeleteAiDataPlatformRegisteredModelResponse responseWrapper = builder.build();
