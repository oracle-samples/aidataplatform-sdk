...
public class DeleteAiDataPlatformDirRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformDirRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformDirRequest o) {
        ...
        /**
         * Build the instance of DeleteAiDataPlatformDirRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformDirRequest
         */
        public DeleteAiDataPlatformDirRequest build() {
            DeleteAiDataPlatformDirRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformDirRequest
         */
        public DeleteAiDataPlatformDirRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformDirRequest request = new DeleteAiDataPlatformDirRequest();
            ...
            return request;
            // new DeleteAiDataPlatformDirRequest(aiDataPlatformId, volumeKey, path, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformDirRequest)) {
            return false;
        }

        DeleteAiDataPlatformDirRequest other = (DeleteAiDataPlatformDirRequest) o;
