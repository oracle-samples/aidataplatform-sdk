...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=UpdateNlToSqlToolDetails.Builder.class)
...
public final class UpdateNlToSqlToolDetails extends UpdateToolDetails {
    ...
    public static class Builder {
        ...
        public UpdateNlToSqlToolDetails build() {
            UpdateNlToSqlToolDetails model = new UpdateNlToSqlToolDetails(this.displayName
                    , this.description
                    , this.properties
                    , this.inputSchema
        ...
        public Builder copy(UpdateNlToSqlToolDetails model) {
...
return this;
    ...
    @Deprecated
    public UpdateNlToSqlToolDetails(String displayName, String description, java.util.Map<String, Object> properties, NlToSqlToolInputSchema inputSchema, NlToSqlToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateNlToSqlToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNlToSqlToolDetails)) {
            return false;
        }

        UpdateNlToSqlToolDetails other = (UpdateNlToSqlToolDetails) o;
