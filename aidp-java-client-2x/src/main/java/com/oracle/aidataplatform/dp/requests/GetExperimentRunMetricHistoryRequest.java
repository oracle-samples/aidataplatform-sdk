...
public class GetExperimentRunMetricHistoryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
     ...
     */
        ...
        /**
         * Build the instance of GetExperimentRunMetricHistoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetExperimentRunMetricHistoryRequest
         */
        public GetExperimentRunMetricHistoryRequest build() {
            GetExperimentRunMetricHistoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetExperimentRunMetricHistoryRequest
         */
        public GetExperimentRunMetricHistoryRequest buildWithoutInvocationCallback() {
            GetExperimentRunMetricHistoryRequest request = new GetExperimentRunMetricHistoryRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExperimentRunMetricHistoryRequest)) {
            return false;
        }

        GetExperimentRunMetricHistoryRequest other = (GetExperimentRunMetricHistoryRequest) o;
