...
public class AsyncOperationsAsyncClient implements AsyncOperationsAsync {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, AsyncOperationsAsyncClient> {
         ...
         * @return the client
         */
    public AsyncOperationsAsyncClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
        if (authenticationDetailsProvider == null) {
            throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
        }
        return new AsyncOperationsAsyncClient(authenticationDetailsProvider,
                configuration,
                clientConfigurator,
