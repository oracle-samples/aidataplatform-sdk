...
public class ResetGitFolderStateRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ResetGitFolderStateRequest, com.oracle.aidataplatform.dp.model.ResetGitFolderStateDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ResetGitFolderStateRequest o) {
        ...
        /**
         * Build the instance of ResetGitFolderStateRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResetGitFolderStateRequest
         */
        public ResetGitFolderStateRequest build() {
            ResetGitFolderStateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ResetGitFolderStateRequest
         */
        public ResetGitFolderStateRequest buildWithoutInvocationCallback() {
            ResetGitFolderStateRequest request = new ResetGitFolderStateRequest();
            ...
            return request;
            // new ResetGitFolderStateRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, resetGitFolderStateDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetGitFolderStateRequest)) {
            return false;
        }

        ResetGitFolderStateRequest other = (ResetGitFolderStateRequest) o;
