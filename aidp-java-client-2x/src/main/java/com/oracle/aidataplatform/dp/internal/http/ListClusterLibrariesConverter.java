...
public class ListClusterLibrariesConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListClusterLibrariesConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListClusterLibrariesRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListClusterLibrariesRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListClusterLibrariesRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListClusterLibrariesResponse responseWrapper = builder.build();
