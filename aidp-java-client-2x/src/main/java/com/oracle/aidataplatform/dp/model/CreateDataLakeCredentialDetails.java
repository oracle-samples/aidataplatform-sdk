...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateDataLakeCredentialDetails.Builder.class)

public final class CreateDataLakeCredentialDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "credentialDescription", "type", "credentialDetails"})
    public CreateDataLakeCredentialDetails(String displayName, String credentialDescription, CredentialType type, CredentialDetails credentialDetails) {
        super();
     ...
     **/
        ...
        public CreateDataLakeCredentialDetails build() {
            CreateDataLakeCredentialDetails model = new CreateDataLakeCredentialDetails(this.displayName
        ...
        public Builder copy(CreateDataLakeCredentialDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataLakeCredentialDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataLakeCredentialDetails)) {
            return false;
        }

        CreateDataLakeCredentialDetails other = (CreateDataLakeCredentialDetails) o;
