...
public class GetAiDataPlatformSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformSessionRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());sessionId(o.getSessionId());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAiDataPlatformSessionRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformSessionRequest
         */
        public GetAiDataPlatformSessionRequest build() {
            GetAiDataPlatformSessionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformSessionRequest
         */
        public GetAiDataPlatformSessionRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformSessionRequest request = new GetAiDataPlatformSessionRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.sessionId = sessionId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAiDataPlatformSessionRequest(aiDataPlatformId, workspaceKey, sessionId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformSessionRequest)) {
            return false;
        }

        GetAiDataPlatformSessionRequest other = (GetAiDataPlatformSessionRequest) o;
