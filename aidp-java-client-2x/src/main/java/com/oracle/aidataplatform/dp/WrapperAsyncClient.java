...
public class WrapperAsyncClient implements WrapperAsync {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, WrapperAsyncClient> {
         ...
         * @return the client
         */
    public WrapperAsyncClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
        if (authenticationDetailsProvider == null) {
            throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
        }
        return new WrapperAsyncClient(authenticationDetailsProvider,
                configuration,
                clientConfigurator,
