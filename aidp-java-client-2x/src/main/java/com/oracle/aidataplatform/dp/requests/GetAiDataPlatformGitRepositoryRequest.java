...
public class GetAiDataPlatformGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformGitRepositoryRequest, java.lang.Void> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder shouldIncludeCredentialKey(Boolean shouldIncludeCredentialKey) {
            this.shouldIncludeCredentialKey = shouldIncludeCredentialKey;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformGitRepositoryRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());shouldIncludeCredentialKey(o.getShouldIncludeCredentialKey());opcRequestId(o.getOpcRequestId());
        ...
        /**
         * Build the instance of GetAiDataPlatformGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformGitRepositoryRequest
         */
        public GetAiDataPlatformGitRepositoryRequest build() {
            GetAiDataPlatformGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformGitRepositoryRequest
         */
        public GetAiDataPlatformGitRepositoryRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformGitRepositoryRequest request = new GetAiDataPlatformGitRepositoryRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.shouldIncludeCredentialKey = shouldIncludeCredentialKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAiDataPlatformGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, shouldIncludeCredentialKey, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
            ...
            .shouldIncludeCredentialKey(shouldIncludeCredentialKey)
    ...
    public String toString() {
        ...
        sb.append(",shouldIncludeCredentialKey=").append(String.valueOf(this.shouldIncludeCredentialKey));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformGitRepositoryRequest)) {
            return false;
        }

        GetAiDataPlatformGitRepositoryRequest other = (GetAiDataPlatformGitRepositoryRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.shouldIncludeCredentialKey, other.shouldIncludeCredentialKey)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.shouldIncludeCredentialKey == null ? 43 : this.shouldIncludeCredentialKey.hashCode());
