...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OracleTable.Builder.class)
...
public final class OracleTable extends Table {
    ...
    public static class Builder {
        ...
        public OracleTable build() {
            OracleTable model = new OracleTable(this.key
                    , this.displayName
                    , this.catalogKey
                    , this.schemaKey
                    , this.location
        ...
        public Builder copy(OracleTable model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleTable)) {
            return false;
        }

        OracleTable other = (OracleTable) o;
