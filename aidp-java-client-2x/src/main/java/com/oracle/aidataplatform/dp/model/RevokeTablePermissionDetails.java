...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeTablePermissionDetails.Builder.class)
...
public final class RevokeTablePermissionDetails  {
     ...
     **/
        ...
        public Builder copy(RevokeTablePermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeTablePermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeTablePermissionDetails)) {
            return false;
        }

        RevokeTablePermissionDetails other = (RevokeTablePermissionDetails) o;
