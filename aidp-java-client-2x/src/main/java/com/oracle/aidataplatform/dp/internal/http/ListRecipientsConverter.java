...
public class ListRecipientsConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ListRecipientsConverter.class);

    public static com.oracle.aidataplatform.dp.requests.ListRecipientsRequest interceptRequest(com.oracle.aidataplatform.dp.requests.ListRecipientsRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.ListRecipientsRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecipientsResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecipientsResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecipientsResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.ListRecipientsResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.ListRecipientsResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.ListRecipientsResponse");
        ...
        com.oracle.aidataplatform.dp.responses.ListRecipientsResponse.Builder builder = com.oracle.aidataplatform.dp.responses.ListRecipientsResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.ListRecipientsResponse responseWrapper = builder.build();
