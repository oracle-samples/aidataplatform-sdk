...
public class RebaseGitRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.GitRebaseDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RebaseGitRepositoryRequest, com.oracle.aidataplatform.dp.model.GitRebaseDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(RebaseGitRepositoryRequest o) {
        ...
        /**
         * Build the instance of RebaseGitRepositoryRequest as configured by this builder
         *
         ...
         *
         * @return instance of RebaseGitRepositoryRequest
         */
        public RebaseGitRepositoryRequest build() {
            RebaseGitRepositoryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RebaseGitRepositoryRequest
         */
        public RebaseGitRepositoryRequest buildWithoutInvocationCallback() {
            RebaseGitRepositoryRequest request = new RebaseGitRepositoryRequest();
            ...
            return request;
            // new RebaseGitRepositoryRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, gitRebaseDetails, opcRetryToken, opcRequestId, ifMatch, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebaseGitRepositoryRequest)) {
            return false;
        }

        RebaseGitRepositoryRequest other = (RebaseGitRepositoryRequest) o;
