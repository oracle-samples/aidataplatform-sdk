...
public class ListAiDataPlatformShareDataAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformShareDataAssetsRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformShareDataAssetsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformShareDataAssetsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformShareDataAssetsRequest
         */
        public ListAiDataPlatformShareDataAssetsRequest build() {
            ListAiDataPlatformShareDataAssetsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformShareDataAssetsRequest
         */
        public ListAiDataPlatformShareDataAssetsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformShareDataAssetsRequest request = new ListAiDataPlatformShareDataAssetsRequest();
            ...
            return request;
            // new ListAiDataPlatformShareDataAssetsRequest(aiDataPlatformId, shareKey, displayName, limit, page, sortOrder, sortBy, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformShareDataAssetsRequest)) {
            return false;
        }

        ListAiDataPlatformShareDataAssetsRequest other = (ListAiDataPlatformShareDataAssetsRequest) o;
