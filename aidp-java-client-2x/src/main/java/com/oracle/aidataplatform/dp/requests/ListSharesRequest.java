...
public class ListSharesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListSharesRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListSharesRequest o) {
        ...
        /**
         * Build the instance of ListSharesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSharesRequest
         */
        public ListSharesRequest build() {
            ListSharesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListSharesRequest
         */
        public ListSharesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSharesRequest(aiDataPlatformId, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSharesRequest)) {
            return false;
        }

        ListSharesRequest other = (ListSharesRequest) o;
