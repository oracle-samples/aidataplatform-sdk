...
public class CancelJobRunConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CancelJobRunConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CancelJobRunRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CancelJobRunRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CancelJobRunRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelJobRunResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelJobRunResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelJobRunResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CancelJobRunResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CancelJobRunResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CancelJobRunResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CancelJobRunResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CancelJobRunResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CancelJobRunResponse responseWrapper = builder.build();
