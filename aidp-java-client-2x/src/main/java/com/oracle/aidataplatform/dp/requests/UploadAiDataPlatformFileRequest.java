...
public class UploadAiDataPlatformFileRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UploadAiDataPlatformFileRequest, java.io.InputStream> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UploadAiDataPlatformFileRequest o) {
        ...
        /**
         * Build the instance of UploadAiDataPlatformFileRequest as configured by this builder
         *
         ...
         *
         * @return instance of UploadAiDataPlatformFileRequest
         */
        public UploadAiDataPlatformFileRequest build() {
            UploadAiDataPlatformFileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UploadAiDataPlatformFileRequest
         */
        public UploadAiDataPlatformFileRequest buildWithoutInvocationCallback() {
            UploadAiDataPlatformFileRequest request = new UploadAiDataPlatformFileRequest();
            ...
            return request;
            // new UploadAiDataPlatformFileRequest(aiDataPlatformId, volumeKey, uploadFileDetails, path, isOverwrite, shouldUpdateRecent, isUploadFileBase64Encoded, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadAiDataPlatformFileRequest)) {
            return false;
        }

        UploadAiDataPlatformFileRequest other = (UploadAiDataPlatformFileRequest) o;
