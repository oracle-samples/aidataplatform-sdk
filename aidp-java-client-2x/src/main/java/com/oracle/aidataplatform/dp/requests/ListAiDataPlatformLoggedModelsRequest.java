...
public class ListAiDataPlatformLoggedModelsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ListLoggedModelsDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListAiDataPlatformLoggedModelsRequest, com.oracle.aidataplatform.dp.model.ListLoggedModelsDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAiDataPlatformLoggedModelsRequest o) {
        ...
        /**
         * Build the instance of ListAiDataPlatformLoggedModelsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAiDataPlatformLoggedModelsRequest
         */
        public ListAiDataPlatformLoggedModelsRequest build() {
            ListAiDataPlatformLoggedModelsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAiDataPlatformLoggedModelsRequest
         */
        public ListAiDataPlatformLoggedModelsRequest buildWithoutInvocationCallback() {
            ListAiDataPlatformLoggedModelsRequest request = new ListAiDataPlatformLoggedModelsRequest();
            ...
            return request;
            // new ListAiDataPlatformLoggedModelsRequest(aiDataPlatformId, workspaceKey, listLoggedModelsDetails, opcRequestId, dhUserPrincipal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAiDataPlatformLoggedModelsRequest)) {
            return false;
        }

        ListAiDataPlatformLoggedModelsRequest other = (ListAiDataPlatformLoggedModelsRequest) o;
