...
public class GetAiDataPlatformCredentialRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<GetAiDataPlatformCredentialRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(GetAiDataPlatformCredentialRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());credentialKey(o.getCredentialKey());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of GetAiDataPlatformCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAiDataPlatformCredentialRequest
         */
        public GetAiDataPlatformCredentialRequest build() {
            GetAiDataPlatformCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAiDataPlatformCredentialRequest
         */
        public GetAiDataPlatformCredentialRequest buildWithoutInvocationCallback() {
            GetAiDataPlatformCredentialRequest request = new GetAiDataPlatformCredentialRequest();
            ...
            return request;
            // new GetAiDataPlatformCredentialRequest(aiDataPlatformId, credentialKey, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformCredentialRequest)) {
            return false;
        }

        GetAiDataPlatformCredentialRequest other = (GetAiDataPlatformCredentialRequest) o;
