...
public class ListRolesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListRolesResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.RoleCollection roleCollection) {
    ...
    public static class Builder {
        ...
        public ListRolesResponse build() {
            return new ListRolesResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, roleCollection);
        }
    }
