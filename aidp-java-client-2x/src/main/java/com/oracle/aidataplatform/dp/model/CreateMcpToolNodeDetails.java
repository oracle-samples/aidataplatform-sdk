...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreateMcpToolNodeDetails.Builder.class)
...
public final class CreateMcpToolNodeDetails extends CreateAgentFlowNodeDetails {
     ...
     **/
        ...
        public CreateMcpToolNodeDetails build() {
            CreateMcpToolNodeDetails model = new CreateMcpToolNodeDetails(this.nodeType
                    , this.name
                    , this.description
                    , this.positionX
                    , this.positionY
        ...
        public Builder copy(CreateMcpToolNodeDetails model) {
...
return this;
    ...
    @Deprecated
    public CreateMcpToolNodeDetails(String nodeType, String name, String description, Float positionX, Float positionY, Boolean isExpanded, String parentNodeId, String srcNodeId, java.util.Map<String, Object> configuration, String nodeTypeId, String toolKey, java.util.Map<String, Object> inputSchema, McpToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMcpToolNodeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMcpToolNodeDetails)) {
            return false;
        }

        CreateMcpToolNodeDetails other = (CreateMcpToolNodeDetails) o;
