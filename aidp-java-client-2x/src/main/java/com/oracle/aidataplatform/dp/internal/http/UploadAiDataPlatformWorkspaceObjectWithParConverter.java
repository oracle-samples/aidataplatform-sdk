...
public class UploadAiDataPlatformWorkspaceObjectWithParConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UploadAiDataPlatformWorkspaceObjectWithParConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UploadAiDataPlatformWorkspaceObjectWithParRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UploadAiDataPlatformWorkspaceObjectWithParRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UploadAiDataPlatformWorkspaceObjectWithParRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getAiDataPlatformId(), "aiDataPlatformId must not be blank");        Validate.notBlank(request.getWorkspaceKey(), "workspaceKey must not be blank");        Validate.notNull(request.getUploadFileWithParDetails(), "uploadFileWithParDetails is required");        Validate.notNull(request.getPath(), "path is required");                                                

        com.oracle.bmc.http.internal.WrappedWebTarget target = client.getBaseTarget()
        .path("/20260430")
            .path("aiDataPlatforms").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getAiDataPlatformId())).path("workspaces").path(com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(request.getWorkspaceKey())).path("actions").path("uploadFileMeta");
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UploadAiDataPlatformWorkspaceObjectWithParResponse responseWrapper = builder.build();
