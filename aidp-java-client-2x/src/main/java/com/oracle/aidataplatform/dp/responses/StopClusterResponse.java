...
* 
    ...
    private StopClusterResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String aidpAsyncOperationKey, String opcRequestId, String etag, com.oracle.aidataplatform.dp.model.Cluster cluster) {
