...
public class CreateRecipientRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateRecipientDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateRecipientRequest, com.oracle.aidataplatform.dp.model.CreateRecipientDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateRecipientRequest o) {
        ...
        /**
         * Build the instance of CreateRecipientRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateRecipientRequest
         */
        public CreateRecipientRequest build() {
            CreateRecipientRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateRecipientRequest
         */
        public CreateRecipientRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateRecipientRequest(aiDataPlatformId, createRecipientDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRecipientRequest)) {
            return false;
        }

        CreateRecipientRequest other = (CreateRecipientRequest) o;
