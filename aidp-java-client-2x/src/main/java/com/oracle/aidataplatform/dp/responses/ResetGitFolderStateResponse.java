...
* 
    ...
    private ResetGitFolderStateResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String aidpAsyncOperationKey) {
