...
public class RetrieveParRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RetrieveParRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(RetrieveParRequest o) {
        ...
        /**
         * Build the instance of RetrieveParRequest as configured by this builder
         *
         ...
         *
         * @return instance of RetrieveParRequest
         */
        public RetrieveParRequest build() {
            RetrieveParRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RetrieveParRequest
         */
        public RetrieveParRequest buildWithoutInvocationCallback() {
            RetrieveParRequest request = new RetrieveParRequest();
            ...
            return request;
            // new RetrieveParRequest(aiDataPlatformId, tableKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetrieveParRequest)) {
            return false;
        }

        RetrieveParRequest other = (RetrieveParRequest) o;
