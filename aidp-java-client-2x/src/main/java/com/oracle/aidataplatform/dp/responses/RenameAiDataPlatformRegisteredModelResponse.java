...
public class RenameAiDataPlatformRegisteredModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RenameAiDataPlatformRegisteredModelResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, com.oracle.aidataplatform.dp.model.RenameRegisteredModelResponseDetails renameRegisteredModelResponseDetails) {
