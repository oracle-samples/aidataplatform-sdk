...
public class CreateContentRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateContentDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateContentRequest, com.oracle.aidataplatform.dp.model.CreateContentDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateContentRequest o) {
        ...
        /**
         * Build the instance of CreateContentRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateContentRequest
         */
        public CreateContentRequest build() {
            CreateContentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateContentRequest
         */
        public CreateContentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateContentRequest(aiDataPlatformId, workspaceKey, contentPath, createContentDetails, opcRetryToken, opcRequestId, shouldUpdateRecent, datalakeTenantId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContentRequest)) {
            return false;
        }

        CreateContentRequest other = (CreateContentRequest) o;
