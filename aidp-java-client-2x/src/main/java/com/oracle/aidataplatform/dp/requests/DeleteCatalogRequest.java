...
public class DeleteCatalogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteCatalogRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteCatalogRequest o) {
        ...
        /**
         * Build the instance of DeleteCatalogRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteCatalogRequest
         */
        public DeleteCatalogRequest build() {
            DeleteCatalogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteCatalogRequest
         */
        public DeleteCatalogRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteCatalogRequest(aiDataPlatformId, catalogKey, isForced, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCatalogRequest)) {
            return false;
        }

        DeleteCatalogRequest other = (DeleteCatalogRequest) o;
