...
public class UpdateWorkspaceAsyncOperationStatusRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.UpdateWorkspaceAsyncOperationStatusDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<UpdateWorkspaceAsyncOperationStatusRequest, com.oracle.aidataplatform.dp.model.UpdateWorkspaceAsyncOperationStatusDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateWorkspaceAsyncOperationStatusRequest o) {
        ...
        /**
         * Build the instance of UpdateWorkspaceAsyncOperationStatusRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateWorkspaceAsyncOperationStatusRequest
         */
        public UpdateWorkspaceAsyncOperationStatusRequest build() {
            UpdateWorkspaceAsyncOperationStatusRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateWorkspaceAsyncOperationStatusRequest
         */
        public UpdateWorkspaceAsyncOperationStatusRequest buildWithoutInvocationCallback() {
            UpdateWorkspaceAsyncOperationStatusRequest request = new UpdateWorkspaceAsyncOperationStatusRequest();
            ...
            return request;
            // new UpdateWorkspaceAsyncOperationStatusRequest(aiDataPlatformId, workspaceKey, asyncOperationKey, updateWorkspaceAsyncOperationStatusDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWorkspaceAsyncOperationStatusRequest)) {
            return false;
        }

        UpdateWorkspaceAsyncOperationStatusRequest other = (UpdateWorkspaceAsyncOperationStatusRequest) o;
