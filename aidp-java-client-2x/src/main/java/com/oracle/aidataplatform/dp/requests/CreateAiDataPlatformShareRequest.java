...
public class CreateAiDataPlatformShareRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.CreateShareDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.CreateShareDetails getBody$() {
        return createShareDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<CreateAiDataPlatformShareRequest, com.oracle.aidataplatform.dp.model.CreateShareDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder createShareDetails(com.oracle.aidataplatform.dp.model.CreateShareDetails createShareDetails) {
            this.createShareDetails = createShareDetails;
            return this;
        }
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiDataPlatformShareRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());createShareDetails(o.getCreateShareDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of CreateAiDataPlatformShareRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateAiDataPlatformShareRequest
         */
        public CreateAiDataPlatformShareRequest build() {
            CreateAiDataPlatformShareRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.CreateShareDetails body) {
            createShareDetails(body);
            return this;
        }
         ...
         * @return instance of CreateAiDataPlatformShareRequest
         */
        public CreateAiDataPlatformShareRequest buildWithoutInvocationCallback() {
            CreateAiDataPlatformShareRequest request = new CreateAiDataPlatformShareRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.createShareDetails = createShareDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.shouldUpdateRecent = shouldUpdateRecent;
            return request;
            // new CreateAiDataPlatformShareRequest(aiDataPlatformId, createShareDetails, opcRetryToken, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createShareDetails=").append(String.valueOf(this.createShareDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAiDataPlatformShareRequest)) {
            return false;
        }

        CreateAiDataPlatformShareRequest other = (CreateAiDataPlatformShareRequest) o;
        return super.equals(o)
            && java.util.Objects.equals(this.aiDataPlatformId, other.aiDataPlatformId)
            && java.util.Objects.equals(this.createShareDetails, other.createShareDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.createShareDetails == null ? 43 : this.createShareDetails.hashCode());
