...
public class ListWorkspacePermissionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ListWorkspacePermissionsRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ListWorkspacePermissionsRequest o) {
        ...
        /**
         * Build the instance of ListWorkspacePermissionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWorkspacePermissionsRequest
         */
        public ListWorkspacePermissionsRequest build() {
            ListWorkspacePermissionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWorkspacePermissionsRequest
         */
        public ListWorkspacePermissionsRequest buildWithoutInvocationCallback() {
            ListWorkspacePermissionsRequest request = new ListWorkspacePermissionsRequest();
            ...
            return request;
            // new ListWorkspacePermissionsRequest(aiDataPlatformId, workspaceKey, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkspacePermissionsRequest)) {
            return false;
        }

        ListWorkspacePermissionsRequest other = (ListWorkspacePermissionsRequest) o;
