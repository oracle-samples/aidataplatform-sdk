...
public class PerformAiDataPlatformInferSchemaWithPreviewRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<PerformAiDataPlatformInferSchemaWithPreviewRequest, com.oracle.aidataplatform.dp.model.PerformInferSchemaDetails> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(PerformAiDataPlatformInferSchemaWithPreviewRequest o) {
        ...
        /**
         * Build the instance of PerformAiDataPlatformInferSchemaWithPreviewRequest as configured by this builder
         *
         ...
         *
         * @return instance of PerformAiDataPlatformInferSchemaWithPreviewRequest
         */
        public PerformAiDataPlatformInferSchemaWithPreviewRequest build() {
            PerformAiDataPlatformInferSchemaWithPreviewRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PerformAiDataPlatformInferSchemaWithPreviewRequest
         */
        public PerformAiDataPlatformInferSchemaWithPreviewRequest buildWithoutInvocationCallback() {
            PerformAiDataPlatformInferSchemaWithPreviewRequest request = new PerformAiDataPlatformInferSchemaWithPreviewRequest();
            ...
            return request;
            // new PerformAiDataPlatformInferSchemaWithPreviewRequest(aiDataPlatformId, schemaKey, performInferSchemaDetails, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PerformAiDataPlatformInferSchemaWithPreviewRequest)) {
            return false;
        }

        PerformAiDataPlatformInferSchemaWithPreviewRequest other = (PerformAiDataPlatformInferSchemaWithPreviewRequest) o;
