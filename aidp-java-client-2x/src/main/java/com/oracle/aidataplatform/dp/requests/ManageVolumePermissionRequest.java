...
public class ManageVolumePermissionRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ManageVolumePermissionDetails> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ManageVolumePermissionRequest, com.oracle.aidataplatform.dp.model.ManageVolumePermissionDetails> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ManageVolumePermissionRequest o) {
        ...
        /**
         * Build the instance of ManageVolumePermissionRequest as configured by this builder
         *
         ...
         *
         * @return instance of ManageVolumePermissionRequest
         */
        public ManageVolumePermissionRequest build() {
            ManageVolumePermissionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ManageVolumePermissionRequest
         */
        public ManageVolumePermissionRequest buildWithoutInvocationCallback() {
            ManageVolumePermissionRequest request = new ManageVolumePermissionRequest();
            ...
            return request;
            // new ManageVolumePermissionRequest(aiDataPlatformId, volumeKey, manageVolumePermissionDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManageVolumePermissionRequest)) {
            return false;
        }

        ManageVolumePermissionRequest other = (ManageVolumePermissionRequest) o;
