...
public class CredentialsAsyncClient implements CredentialsAsync {
    /**
    ...
    */
    ...
    public static class Builder extends com.oracle.bmc.common.RegionalClientBuilder<Builder, CredentialsAsyncClient> {
         ...
         * @return the client
         */
    public CredentialsAsyncClient build(@javax.annotation.Nonnull com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider) {
        if (authenticationDetailsProvider == null) {
            throw new NullPointerException("authenticationDetailsProvider is marked non-null but is null");
        }
        return new CredentialsAsyncClient(authenticationDetailsProvider,
                configuration,
                clientConfigurator,
