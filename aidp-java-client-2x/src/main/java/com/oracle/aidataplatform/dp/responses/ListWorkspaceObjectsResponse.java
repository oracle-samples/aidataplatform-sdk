...
public class ListWorkspaceObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListWorkspaceObjectsResponse(int __httpStatusCode__, javax.ws.rs.core.MultivaluedMap<String, String> headers, String opcRequestId, String opcNextPage, com.oracle.aidataplatform.dp.model.WorkspaceObjectCollection workspaceObjectCollection) {
