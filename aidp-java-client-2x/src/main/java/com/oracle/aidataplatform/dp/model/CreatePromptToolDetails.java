...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=CreatePromptToolDetails.Builder.class)
...
public final class CreatePromptToolDetails extends CreateToolDetails {
     ...
     **/
        ...
        public CreatePromptToolDetails build() {
            CreatePromptToolDetails model = new CreatePromptToolDetails(this.displayName
                    , this.description
                    , this.properties
                    , this.inputSchema
        ...
        public Builder copy(CreatePromptToolDetails model) {
...
return this;
    ...
    @Deprecated
    public CreatePromptToolDetails(String displayName, String description, java.util.Map<String, Object> properties, java.util.Map<String, Object> inputSchema, PromptToolConfiguration toolConfig) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreatePromptToolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePromptToolDetails)) {
            return false;
        }

        CreatePromptToolDetails other = (CreatePromptToolDetails) o;
