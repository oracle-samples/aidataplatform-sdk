...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=RevokeViewPermissionDetails.Builder.class)

public final class RevokeViewPermissionDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"assignees", "permissions", "includeColumns", "excludeColumns"})
    public RevokeViewPermissionDetails(PermissionAssignees assignees, java.util.List<ViewPrivilegeForManage> permissions, java.util.List<String> includeColumns, java.util.List<String> excludeColumns) {
        super();
     ...
     **/
        ...
        public RevokeViewPermissionDetails build() {
            RevokeViewPermissionDetails model = new RevokeViewPermissionDetails(this.assignees
                    , this.permissions
                    , this.includeColumns
        ...
        public Builder copy(RevokeViewPermissionDetails model) {
...
return this;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RevokeViewPermissionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeViewPermissionDetails)) {
            return false;
        }

        RevokeViewPermissionDetails other = (RevokeViewPermissionDetails) o;
