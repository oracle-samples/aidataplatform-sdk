...
public class ResolveAiDataPlatformGitConflictsRequest extends com.oracle.bmc.requests.BmcRequest<com.oracle.aidataplatform.dp.model.ConflictResolveDetails> {
...
* 
    ...
    public com.oracle.aidataplatform.dp.model.ConflictResolveDetails getBody$() {
        return conflictResolveDetails;
    }

    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<ResolveAiDataPlatformGitConflictsRequest, com.oracle.aidataplatform.dp.model.ConflictResolveDetails> {
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder conflictResolveDetails(com.oracle.aidataplatform.dp.model.ConflictResolveDetails conflictResolveDetails) {
            this.conflictResolveDetails = conflictResolveDetails;
            return this;
        }
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(ResolveAiDataPlatformGitConflictsRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());workspaceKey(o.getWorkspaceKey());gitRepositoryKey(o.getGitRepositoryKey());conflictResolveDetails(o.getConflictResolveDetails());opcRetryToken(o.getOpcRetryToken());opcRequestId(o.getOpcRequestId());ifMatch(o.getIfMatch());
        ...
        /**
         * Build the instance of ResolveAiDataPlatformGitConflictsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResolveAiDataPlatformGitConflictsRequest
         */
        public ResolveAiDataPlatformGitConflictsRequest build() {
            ResolveAiDataPlatformGitConflictsRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.aidataplatform.dp.model.ConflictResolveDetails body) {
            conflictResolveDetails(body);
            return this;
        }
         ...
         * @return instance of ResolveAiDataPlatformGitConflictsRequest
         */
        public ResolveAiDataPlatformGitConflictsRequest buildWithoutInvocationCallback() {
            ResolveAiDataPlatformGitConflictsRequest request = new ResolveAiDataPlatformGitConflictsRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.workspaceKey = workspaceKey;
            request.gitRepositoryKey = gitRepositoryKey;
            request.conflictResolveDetails = conflictResolveDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new ResolveAiDataPlatformGitConflictsRequest(aiDataPlatformId, workspaceKey, gitRepositoryKey, conflictResolveDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",conflictResolveDetails=").append(String.valueOf(this.conflictResolveDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResolveAiDataPlatformGitConflictsRequest)) {
            return false;
        }

        ResolveAiDataPlatformGitConflictsRequest other = (ResolveAiDataPlatformGitConflictsRequest) o;
        return super.equals(o)
            ...
            && java.util.Objects.equals(this.conflictResolveDetails, other.conflictResolveDetails)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.conflictResolveDetails == null ? 43 : this.conflictResolveDetails.hashCode());
