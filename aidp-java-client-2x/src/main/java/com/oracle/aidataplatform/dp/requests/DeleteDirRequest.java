...
public class DeleteDirRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteDirRequest, java.lang.Void> {
...
* 
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDirRequest o) {
        ...
        /**
         * Build the instance of DeleteDirRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDirRequest
         */
        public DeleteDirRequest build() {
            DeleteDirRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDirRequest
         */
        public DeleteDirRequest buildWithoutInvocationCallback() {
            DeleteDirRequest request = new DeleteDirRequest();
            ...
            return request;
            // new DeleteDirRequest(aiDataPlatformId, volumeKey, path, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDirRequest)) {
            return false;
        }

        DeleteDirRequest other = (DeleteDirRequest) o;
