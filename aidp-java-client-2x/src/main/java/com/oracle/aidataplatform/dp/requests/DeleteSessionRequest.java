...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteSessionRequest, java.lang.Void> {
...
* 
         ...
         * @return instance of DeleteSessionRequest
         */
        public DeleteSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteSessionRequest(aiDataPlatformId, workspaceKey, sessionId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSessionRequest)) {
            return false;
        }
