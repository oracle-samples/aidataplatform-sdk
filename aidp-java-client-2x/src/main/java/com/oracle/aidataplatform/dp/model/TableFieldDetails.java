...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=TableFieldDetails.Builder.class)

public final class TableFieldDetails  {
    @Deprecated
    @java.beans.ConstructorProperties({"fieldName", "fieldType", "fieldPrecision", "fieldScale", "fieldDescription"})
    public TableFieldDetails(String fieldName, String fieldType, String fieldPrecision, String fieldScale, String fieldDescription) {
        super();
     ...
     **/
        ...
        public TableFieldDetails build() {
            TableFieldDetails model = new TableFieldDetails(this.fieldName
                    , this.fieldType
                    , this.fieldPrecision
                    , this.fieldScale
        ...
        public Builder copy(TableFieldDetails model) {
...
return this;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TableFieldDetails)) {
            return false;
        }

        TableFieldDetails other = (TableFieldDetails) o;
