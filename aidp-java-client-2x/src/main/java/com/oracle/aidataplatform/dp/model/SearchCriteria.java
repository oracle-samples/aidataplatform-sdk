...
public final class SearchCriteria  {
    @Deprecated
    @java.beans.ConstructorProperties({"query", "limit", "offset", "aggregations", "filter", "sort"})
    public SearchCriteria(String query, Integer limit, Integer offset, java.util.List<AggregationEnum> aggregations, FilterTypes filter, java.util.List<SortDetails> sort) {
        super();
        this.query = query;
        this.limit = limit;
        this.offset = offset;
     ...
     **/
        ...
        public SearchCriteria build() {
            SearchCriteria model = new SearchCriteria(this.query
                    , this.limit
                    , this.offset
                    , this.aggregations
                    , this.filter
