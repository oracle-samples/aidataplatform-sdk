...
public class CreateAiDataPlatformJobRunConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CreateAiDataPlatformJobRunConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformJobRunRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformJobRunRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformJobRunRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformJobRunResponse responseWrapper = builder.build();
