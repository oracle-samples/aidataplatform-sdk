...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OracleSchemaSummary.Builder.class)
...
public final class OracleSchemaSummary extends SchemaSummary {
    ...
    public static class Builder {
        ...
        public OracleSchemaSummary build() {
            OracleSchemaSummary model = new OracleSchemaSummary(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(OracleSchemaSummary model) {
...
return this;
    ...
    @Deprecated
    public OracleSchemaSummary(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, SchemaLifecycleState lifecycleState, java.util.Map<String, String> details, CrawlerLastRefreshStatus lastRefreshStatus, java.util.Date timeLastRefresh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleSchemaSummary)) {
            return false;
        }

        OracleSchemaSummary other = (OracleSchemaSummary) o;
