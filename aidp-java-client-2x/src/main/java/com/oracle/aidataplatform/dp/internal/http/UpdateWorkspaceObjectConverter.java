...
public class UpdateWorkspaceObjectConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(UpdateWorkspaceObjectConverter.class);

    public static com.oracle.aidataplatform.dp.requests.UpdateWorkspaceObjectRequest interceptRequest(com.oracle.aidataplatform.dp.requests.UpdateWorkspaceObjectRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.UpdateWorkspaceObjectRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse");
        ...
        com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse.Builder builder = com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.UpdateWorkspaceObjectResponse responseWrapper = builder.build();
