...
public class RetrieveAiDataPlatformParRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<RetrieveAiDataPlatformParRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(RetrieveAiDataPlatformParRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());tableKey(o.getTableKey());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of RetrieveAiDataPlatformParRequest as configured by this builder
         *
         ...
         *
         * @return instance of RetrieveAiDataPlatformParRequest
         */
        public RetrieveAiDataPlatformParRequest build() {
            RetrieveAiDataPlatformParRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RetrieveAiDataPlatformParRequest
         */
        public RetrieveAiDataPlatformParRequest buildWithoutInvocationCallback() {
            RetrieveAiDataPlatformParRequest request = new RetrieveAiDataPlatformParRequest();
            ...
            return request;
            // new RetrieveAiDataPlatformParRequest(aiDataPlatformId, tableKey, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetrieveAiDataPlatformParRequest)) {
            return false;
        }

        RetrieveAiDataPlatformParRequest other = (RetrieveAiDataPlatformParRequest) o;
