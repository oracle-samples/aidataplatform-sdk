...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder=OacSchema.Builder.class)
...
public final class OacSchema extends Schema {
    ...
    public static class Builder {
        ...
        public OacSchema build() {
            OacSchema model = new OacSchema(this.key
                    , this.displayName
                    , this.description
                    , this.timeCreated
                    , this.timeUpdated
        ...
        public Builder copy(OacSchema model) {
...
return this;
    ...
    @Deprecated
    public OacSchema(String key, String displayName, String description, java.util.Date timeCreated, java.util.Date timeUpdated, String createdBy, String updatedBy, java.util.Map<String, String> properties, String catalogName, SchemaLifecycleState lifecycleState, String lifecycleStateDetails, java.util.Map<String, String> details) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OacSchema)) {
            return false;
        }

        OacSchema other = (OacSchema) o;
