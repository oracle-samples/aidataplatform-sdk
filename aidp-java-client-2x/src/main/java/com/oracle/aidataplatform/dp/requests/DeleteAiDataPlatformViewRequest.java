...
public class DeleteAiDataPlatformViewRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
...
* 
    ...
    public static class Builder implements com.oracle.bmc.requests.BmcRequest.Builder<DeleteAiDataPlatformViewRequest, java.lang.Void> {
...
* 
     ...
     */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformViewRequest o) {
            aiDataPlatformId(o.getAiDataPlatformId());viewKey(o.getViewKey());displayName(o.getDisplayName());ifMatch(o.getIfMatch());opcRequestId(o.getOpcRequestId());shouldUpdateRecent(o.getShouldUpdateRecent());
        ...
        /**
         * Build the instance of DeleteAiDataPlatformViewRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformViewRequest
         */
        public DeleteAiDataPlatformViewRequest build() {
            DeleteAiDataPlatformViewRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformViewRequest
         */
        public DeleteAiDataPlatformViewRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformViewRequest request = new DeleteAiDataPlatformViewRequest();
            ...
            return request;
            // new DeleteAiDataPlatformViewRequest(aiDataPlatformId, viewKey, displayName, ifMatch, opcRequestId, shouldUpdateRecent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformViewRequest)) {
            return false;
        }

        DeleteAiDataPlatformViewRequest other = (DeleteAiDataPlatformViewRequest) o;
