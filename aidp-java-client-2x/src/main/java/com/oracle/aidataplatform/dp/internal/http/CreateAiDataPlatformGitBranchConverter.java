...
public class CreateAiDataPlatformGitBranchConverter {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CreateAiDataPlatformGitBranchConverter.class);

    public static com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformGitBranchRequest interceptRequest(com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformGitBranchRequest request) {
      
        return request;
    }

    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(com.oracle.bmc.http.internal.RestClient client, com.oracle.aidataplatform.dp.requests.CreateAiDataPlatformGitBranchRequest request) {
    ...
    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse> fromResponse() {
        return fromResponse(java.util.Optional.empty());
    }

    public static java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse> fromResponse(java.util.Optional<com.oracle.bmc.ServiceDetails> serviceDetails) {
    final java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse> transformer = new java.util.function.Function<javax.ws.rs.core.Response, com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse>() {
    @Override
    public com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse apply(javax.ws.rs.core.Response rawResponse) {
        LOG.trace("Transform function invoked for com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse");
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse.Builder builder = com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse.builder().__httpStatusCode__(rawResponse.getStatus()).headers(headers);
        ...
        com.oracle.aidataplatform.dp.responses.CreateAiDataPlatformGitBranchResponse responseWrapper = builder.build();
